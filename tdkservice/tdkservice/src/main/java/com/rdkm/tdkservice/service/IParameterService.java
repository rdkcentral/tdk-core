...
public interface IParameterService {
     ...
     *
     * @param parameterTypeCreateDTO the data transfer object containing the parameter type details
     ...
     *
     * @param parameterDTO the data transfer object containing the updated parameter type details
     ...
     *
     * @return a list of data transfer objects containing the details of all parameter types
     */
     ...
     * @return a list of data transfer objects containing the details of all parameters for the specified function
     */
