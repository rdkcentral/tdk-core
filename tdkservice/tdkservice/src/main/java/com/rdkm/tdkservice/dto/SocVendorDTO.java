...
public class SocVendorDTO {

	/**
	 * Represents the unique identifier for the SocVendor. This field is
	 * automatically generated and managed by the system.
	 */
	private Integer socVendorId;

	/**
	 * Represents the name of the SocVendor. This field is mandatory, hence it
	 * cannot be blank.
	 */
	@NotBlank(message = "Socvendor name is required")
	private String socVendorName;

	/**
	 * Represents the category of the SocVendor. This field is mandatory, hence it
	 * cannot be blank.
	 */
	@NotBlank(message = "Category is required")
	private String socVendorCategory;

	/**
	 * Represents the user group of the SocVendor. This field is optional and can be
	 * null.
	 */
	@NotBlank(message = "Usergroup is required")
	private String socVendorUserGroup;
