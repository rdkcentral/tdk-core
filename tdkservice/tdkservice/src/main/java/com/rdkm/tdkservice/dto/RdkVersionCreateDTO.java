...
import lombok.Data;
/*
 * The RDk version create DTO.
 */

@Data
public class RdkVersionCreateDTO {

	/*
	 * The build version name.
	 */

	@NotBlank(message = "Build version name cannot be null")
	private String buildVersionName;

	/*
	 * The rdk version category.
	 */
	@NotBlank(message = "Rdk version category cannot be null")
