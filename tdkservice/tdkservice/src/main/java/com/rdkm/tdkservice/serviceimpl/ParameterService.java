...
import static com.rdkm.tdkservice.util.MapperUtils.mapDTOToEntity;
...
public class ParameterService implements IParameterService {
     ...
     *
     * @param parameterDTO the data transfer object containing the updated parameter details
    ...
    public boolean updateParameter(ParameterDTO parameterDTO) {
        LOGGER.info("Updating parameter : {}", parameterDTO);
            ...
            if (!Utils.isEmpty(parameterDTO.getParameterName()) && !parameterDTO.getParameterName().equals(parameter.getName())) {
            ...
            if (!Utils.isEmpty(String.valueOf(parameterDTO.getParameterDataType()))) {
     ...
     * Finds all parameter.
     *
     * @return a list of data transfer objects containing the details of all parameter
     */
    @Override
    public List<ParameterDTO> findAllParameters() {
        LOGGER.info("Retrieving all parameter ");
        List<Parameter> parameters = parameterRepository.findAll();
        List<ParameterDTO> parameterDTOs = parameters.stream().map(MapperUtils::convertToParameterTypeDTO).collect(Collectors.toList());
    ...
    public ParameterDTO findParameterById(Integer id) {
        ...
        try {
            Parameter parameter = parameterRepository.findById(id)
                    .orElseThrow(() -> new ResourceNotFoundException("ParameterType not found for this id :: ", id.toString()));
     ...
     * @return a list of data transfer objects containing the details of all parameters
     */
    @Override
    public List<ParameterDTO> findAllParametersByFunction(String functionName) {
        ...
        return parameters.stream()
                .map(MapperUtils::convertToParameterTypeDTO)
