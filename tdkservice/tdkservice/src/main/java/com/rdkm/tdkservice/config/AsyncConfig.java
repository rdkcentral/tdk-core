...
public class AsyncConfig {
	...
	public Executor taskExecutor() {
		...
		try {
			...
			if (corePoolSizeStr != null) corePoolSize = Integer.parseInt(corePoolSizeStr);
			if (maxPoolSizeStr != null) maxPoolSize = Integer.parseInt(maxPoolSizeStr);
			if (queueCapacityStr != null) queueCapacity = Integer.parseInt(queueCapacityStr);
		} catch (Exception e) {
