...
VALUES ('4855c65b-86e9-11ef-8802-c025a54ddaf9', 'admin', 'test', (SELECT id FROM user_role WHERE name = 'admin'), (SELECT id FROM user_group WHERE name = 'usergroup1'), 'admin@gmail.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'DARK', 'Admin User')
