...
/**
 * This class is used to test the DeviceController class. It uses Mockito to
 * mock the service layer and JUnit for the testing framework.
 */
public class DeviceControllerTest {
	...
	/*
	 * This test checks if the createDevice method in the controller returns a
	...
	/*
	 * This test checks if the deleteDevice method in the controller returns a
	 * successful response when the service layer operation is successful.
	 */
	@Test
	...
	/*
	 * This test checks if the updateDevice method in the controller returns a
	 * successful response when the service layer operation is successful.
	 */
	@Test
	public void testUpdateDevice() {
		...
		when(deviceService.updateDevice(deviceUpdateDTO)).thenReturn(true);
	...
	/*
	 * This test checks if the updateDevice method in the controller returns an
	 * error response when the service layer operation fails.
	 */
	@Test
	public void testGetAllDevices() {
		List<DeviceResponseDTO> response = new ArrayList<>();
		DeviceResponseDTO response1 = new DeviceResponseDTO();
		response1.setId(UUID.randomUUID());
		response1.setDeviceName("TestDevice");
		response1.setMacId("00:11:22:33:44:55");
		response.add(response1);

		when(deviceService.getAllDeviceDetails()).thenReturn(response);

		ResponseEntity<?> responseObtained = deviceController.getAllDevices();

		assertEquals(HttpStatus.OK, responseObtained.getStatusCode());
		assertEquals(response, responseObtained.getBody());
	}
	...
	public void testGetAllDevicesByCategory() {
		...
		response1.setDeviceName("TestDevice");
		response1.setMacId("00:11:22:33:44:55");
		response1.setCategory("RDKV");
		response.add(response1);

		String category = "RDKV";

		when(deviceService.getAllDeviceDetailsByCategory(category)).thenReturn(response);

		ResponseEntity<?> res = deviceController.getAllDevicesByCategory(category);
	...
	public void testGetDeviceById() {
		...
		ResponseEntity<?> response = deviceController.getDeviceById(deviceId);
	...
	/*
	 * This test checks if the getDeviceById method in the controller returns an
	 * error response when the service layer operation fails.
	 */
	@Test
...
//	}
	...
	public void testCreateDeviceFromXML() throws Exception {
		...
		when(deviceService.parseXMLForDevice(any())).thenReturn(true);
	 ...
	 */
	@Test
	public void testGetAllDeviceNotFound() {
		when(deviceService.getAllDeviceDetails()).thenReturn(null);
	 ...
	 */
	@Test
	public void testGetAllDevicesByCategoryNotFound() {
		String category = "testCategory";
		when(deviceService.getAllDeviceDetailsByCategory(category)).thenReturn(null);
