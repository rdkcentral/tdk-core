...
> **Module:** HDMI CEC HAL (`HDMICEC`) | **Req ID Prefix:** `VTS-HDMICEC` **Total requirements:** 7 | **Total test cases:** 17 (16 L1 + 1 L2) **Source:** [test_l1_hdmi_cec_driver.c](https://github.com/rdkcentral/rdk-halif-test-hdmi_cec/blob/1.6.1/src/test_l1_hdmi_cec_driver.c) · [test_l2_hdmi_cec_source_driver.c](https://github.com/rdkcentral/rdk-halif-test-hdmi_cec/blob/1.6.1/src/test_l2_hdmi_cec_source_driver.c)
...
└── testcases/
    ...
    └── VTS-HDMICEC-007/   (6 tests   — API error handling)
```
