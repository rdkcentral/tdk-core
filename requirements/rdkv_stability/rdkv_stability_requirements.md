...
| `RVS-REQ-006` | SHALL sustain long-duration continuous 4K video playback over DASH and HLS protocols for the defined minimum duration without pipeline crash, stream interruption, or memory growth beyond defined thresholds. Applicability is determined by the device 4K capability declaration. |
