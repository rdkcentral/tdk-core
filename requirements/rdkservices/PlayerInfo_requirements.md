...
| `PI‑REQ‑003` | SHALL successfully enable and disable Dolby Atmos output mode and confirm the resulting state, and set and verify all supported display resolutions |
| `PI‑REQ‑004` | SHALL emit the dolby audiomodechanged event when the Dolby audio mode changes |
