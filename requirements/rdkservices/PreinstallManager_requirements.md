...
| Req ID | Test Scope |
|:-------|:--------------------------------------|
| `PIM‑REQ‑001` | SHALL successfully trigger a pre-install operation when startPreinstall is invoked with forceInstall set to true, and return the correct response when forceInstall is set to false |
