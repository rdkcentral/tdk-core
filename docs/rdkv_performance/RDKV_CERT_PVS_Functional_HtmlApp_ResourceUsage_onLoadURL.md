...
## Objective
To validate that CPU load and memory usage are within acceptable ranges when a URL is loaded in HtmlApp.
...
| 3 | Load URL in HtmlApp | Set the test URL: <br>`{"jsonrpc":"2.0","id":1234567890,"method":"HtmlApp.1.url","params":{"url":"<test_url>"}}` | URL loading started. |
