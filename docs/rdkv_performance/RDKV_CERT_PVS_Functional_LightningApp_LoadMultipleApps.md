## TestCase ID
RDKV_PERFORMANCE_216
## TestCase Name
RDKV_CERT_PVS_Functional_LightningApp_LoadMultipleApps
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To validate that multiple LightningApp instances or LightningApp alongside other applications can be loaded simultaneously without stability issues.
...
|2|LightningApp and other supported plugins should be available in the device build.|
