...
## TestCase Name
RDKV_CERT_PVS_Functional_HtmlApp_LoadMultipleApps
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To validate that multiple HtmlApp instances or HtmlApp alongside other applications can be loaded simultaneously without stability issues.
...
|2|HtmlApp and other supported plugins should be available in the device build.|
