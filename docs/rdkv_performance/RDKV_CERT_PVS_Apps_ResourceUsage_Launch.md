...
| 8 | Verify the application installation | Confirm the application is installed by querying the package list: <br>`{"jsonrpc":"2.0","id":1,"method":"org.rdk.AppPackageManager.1.listPackages"}` | The installed app name should appear in the package list with an INSTALLED state. |
