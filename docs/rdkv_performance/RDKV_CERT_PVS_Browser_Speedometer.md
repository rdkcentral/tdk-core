...
| 5 | Install Speedometer application bundle | Install the downloaded Speedometer bundle using AppPackageManager with the file locator from device configuration: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.install", "params": {"packageId": "com.rdkcentral.speedometer", "version": "0.1.0", "additionalMetadata": [{"name": "type", "value": "native/dac-app"}], "fileLocator": "<PACKAGEMANAGER_FILE_LOCATOR>/package<download_id>"}}` | The Speedometer app bundle should be installed successfully. |
| 6 | Verify Speedometer application is installed | Confirm the Speedometer app appears in the installed packages list: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.1.listPackages"}` | com.rdkcentral.speedometer should appear in the installed packages list. |
