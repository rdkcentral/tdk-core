...
| 6 | Uninstall the launched application | Send an uninstall request for the currently launched application. <br>`{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.uninstall", "params": {"packageId": "<PACKAGEMANAGER_APPLICATION_NAME>"}}` | The uninstall request should succeed and the onAppUninstalled event should be received. |
