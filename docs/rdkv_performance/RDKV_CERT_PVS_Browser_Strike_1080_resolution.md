...
## Objective
To validate the browser performance score obtained from the Strike benchmark tool at 1080p (1920x1080) resolution using WebKitBrowser and confirm the score meets the configured threshold value.
...
| 5 | Set screen resolution to 1080p | Set the screen resolution to 1920x1080 (1080p) using RDKShell: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.RDKShell.1.setScreenResolution", "params": {"w": 1920, "h": 1080}}` | Screen resolution should be set to 1920x1080 successfully. |
| 6 | Validate screen resolution is set to 1080p | Confirm that the screen resolution was applied correctly: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.RDKShell.1.getScreenResolution"}` | Screen resolution returned should match the target resolution of 1920x1080. |
