...
## Objective
To validate that the browser performance score using the Strike benchmark tool at 1080p resolution is within the expected range.
...
|3|Strike benchmark test URL for 1080p resolution must be configured in `BrowserPerformanceVariables`.|
...
| 4 | Load Strike 1080p Benchmark URL | Set the Strike benchmark URL configured for 1080p resolution: <br>`{"jsonrpc":"2.0","id":1234567890,"method":"WebKitBrowser.1.url","params":{"url":"<strike_1080p_url>"}}` | Strike 1080p benchmark URL loaded. |
...
| 6 | Validate Strike 1080p Score | Compare the Strike 1080p score against configured threshold in `BrowserPerformanceVariables`. | Strike 1080p score is within the expected range. |
