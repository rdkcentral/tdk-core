...
| 5 | Uninstall the application | Send an uninstall request for the installed application without launching it first. <br>`{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.uninstall", "params": {"packageId": "<PACKAGEMANAGER_APPLICATION_NAME>"}}` | The uninstall request should succeed and the onAppUninstalled event should be received confirming removal. |
...
| 7 | Verify essential plugins remain responsive | Check that org.rdk.AppManager and org.rdk.AppPackageManager are still responsive and functional following the uninstall. <br>`{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppManager.1.getPluginStatus", "params": {}}` <br><br>`{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.1.getPluginStatus", "params": {}}` | All essential plugins should remain responsive after the uninstall operation. |
