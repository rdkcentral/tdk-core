...
| 5 | Install CSS3 application bundle | Install the downloaded CSS3 bundle using AppPackageManager with the file locator path from device configuration: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.install", "params": {"packageId": "com.rdkcentral.css3", "version": "0.1.0", "additionalMetadata": [{"name": "type", "value": "native/dac-app"}], "fileLocator": "<PACKAGEMANAGER_FILE_LOCATOR>/package<download_id>"}}` | The CSS3 app bundle should be installed successfully. |
| 6 | Verify CSS3 application is installed | Confirm the CSS3 app appears in the installed packages list: `{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.1.listPackages"}` | com.rdkcentral.css3 should appear in the installed packages list. |
