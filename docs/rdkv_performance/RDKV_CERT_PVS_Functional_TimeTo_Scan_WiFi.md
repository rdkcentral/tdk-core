...
| 4 | Configure WIFI_SSID_NAME in device config | `WIFI_SSID_NAME` must be set to the target WiFi SSID to scan for in the device-specific config file. | The SSID name should be configured correctly. |
