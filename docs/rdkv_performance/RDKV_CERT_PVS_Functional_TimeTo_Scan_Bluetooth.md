...
| 2 | Confirm org.rdk.Bluetooth plugin is available | The org.rdk.Bluetooth plugin must be present and activatable in the device build. | The Bluetooth plugin should be available in the build. |
...
| 4 | Ensure a Bluetooth emulator is available | A Bluetooth emulator device must be accessible and configurable during the test. Time in the DUT and Test Manager should be in sync. | The Bluetooth emulator should be reachable and its time should be synchronized with the DUT. |
