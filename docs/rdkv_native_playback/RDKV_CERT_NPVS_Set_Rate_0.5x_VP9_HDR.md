## TestCase ID
RDKV_NATIVE_PLAYBACK_381

## TestCase Name
RDKV_CERT_NPVS_Set_Rate_0.5x_VP9_HDR
...
## Objective
Test to verify playback rate control at 0.5x speed function with VP9 HDR (High Dynamic Range) content in WebM container. Validate that position advances at exactly 0.5x speed (half normal speed) through periodic polling with position increment expected at +/-25% tolerance around 0.05 seconds per 100ms interval. Verify WebM container parsing and HDR metadata preservation during rate change, audio/video remain synchronized, and frame rendering continues without discontinuities.
## Preconditions
