## TestCase ID
RDKV_NATIVE_PLAYBACK_190

## TestCase Name
RDKV_CERT_NPVS_Channel_Change_OPUS_to_AAC
...
| 10 | Release Pipeline and Cleanup Resources | Set pipeline to NULL state to stop playback and terminate AAC/H.264 stream<br> Unreference GStreamer objects and free allocated memory<br> Close logging file | Verify pipeline reaches NULL state, all resources released, logging closed, system ready for next test |
