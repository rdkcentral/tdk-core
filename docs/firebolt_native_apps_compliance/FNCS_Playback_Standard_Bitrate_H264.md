# FNCS_Playback_Standard_Bitrate_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_183

## TestCase Name
FNCS_Playback_Standard_Bitrate_H264

## Objective
To verify whether the video is playing with Loe bitrate using H264 stream
