...
## TestCase Name
**FNCS_Playback_PlaySeek_Forward_Only_Audio_Webm**
...
## Objective
To validate that an OPUS audio stream in Webm format supports forward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
...
| 5 | Verify Playback Resumption After Seek | Confirm that playback resumes smoothly at the new position after the seek operation completes | Audio playback must continue seamlessly from the seek position without interruption or artifacts |
