...
## TestCase Name
**FNCS_Playback_PauseSeek_Forward_HEVC**
...
## Objective
To validate that DASH stream playback with HEVC video codec supports forward seek operations after pause, ensuring proper playback state transitions from paused state to seek position and resumption of playback with HEVC decoding.
