# FNCS_Playback_Standard_Bitrate_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_184

## TestCase Name
FNCS_Playback_Standard_Bitrate_HEVC

## Objective
To verify whether the video is playing with Loe bitrate using HEVC stream
