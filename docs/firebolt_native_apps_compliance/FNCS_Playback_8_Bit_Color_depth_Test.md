# FNCS_Playback_8_Bit_Color_depth_Test Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_133

## TestCase Name
FNCS_Playback_8_Bit_Color_depth_Test

## Objective
To verify whether the video is playing with 8 color bit depth
