...
## TestCase Name
**FNCS_Playback_PlayPause_ExtendedDuration_H264**
...
## Objective
To validate that DASH stream playback with H264 video codec supports extended duration play and pause operations, ensuring stable playback state transitions and resumption across multiple prolonged playback cycles.
