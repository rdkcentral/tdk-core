# FNCS_Playback_ResolutionSwitch_up_VP9 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_270

## TestCase Name
FNCS_Playback_ResolutionSwitch_up_VP9

## Objective
To test the video playback by switching resolutions from 144p resolution to very high resolution (4K) through 'playbin' and 'westerossink' gst elements
