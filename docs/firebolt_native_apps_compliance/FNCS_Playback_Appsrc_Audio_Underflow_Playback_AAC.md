# FNCS_Playback_Appsrc_Audio_Underflow_Playback_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_254

## TestCase Name
FNCS_Playback_Appsrc_Audio_Underflow_Playback_AAC
...
| 11 | audio_src_url_mp4_aac variable in MediaValidationVariables.py contains AAC audio stream URL (atfms_291_dash_tdk_avc_aac_fmp4_audio_1.mp4) for appsrc underflow testing |
...
| 11 | Update Buffer Threshold | Double the buffer threshold value to 1096818 bytes and prepare for additional audio buffer feeding | Buffer threshold updated successfully, ready for extended audio buffer feeding |
...
| 16 | Validate Test Output | Parse tdk_mediapipelinetests output for success indicators "Failures: 0", "Errors: 0", or "failed: 0" | Test output contains success strings indicating AAC appsrc audio underflow recovery completed without errors |
