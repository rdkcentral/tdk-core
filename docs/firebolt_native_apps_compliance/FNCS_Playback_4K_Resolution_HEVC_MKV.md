# FNCS_Playback_4K_Resolution_HEVC_MKV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_352

## TestCase Name
FNCS_Playback_4K_Resolution_HEVC_MKV

## Objective
To test the video playback using HEVC_MKV with resolution set to 2160p through 'playbin' and 'westerossink' gst elements
