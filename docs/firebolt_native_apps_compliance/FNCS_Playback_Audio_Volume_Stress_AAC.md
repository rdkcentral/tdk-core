# FNCS_Playback_Audio_Volume_Stress_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_137

## TestCase Name
FNCS_Playback_Audio_Volume_Stress_AAC

## Objective
to verify whether audio volume is playing in decreasing order using AAC stream
...
| 3 | video_src_url_aac variable must be configured with DASH_H264_AAC/atfms_291_dash_tdk_avc_aac_fmp4.mpd in MediaValidationVariables.py as URL or file path for the test stream |
