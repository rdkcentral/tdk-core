# FNCS_Playback_Appsrc_Audio_Underflow_Signal_MKV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_298

## TestCase Name
FNCS_Playback_Appsrc_Audio_Underflow_Signal_MKV
...
| 2 | Test stream for MKV audio underflow signal testing must be available and referenced in MediaValidationVariables.audio_src_url_mkv |
...
| 11 | audio_src_url_mkv variable in MediaValidationVariables.py contains MKV audio stream URL for appsrc underflow signal testing |
...
| 11 | Validate Test Output | Parse tdk_mediapipelinetests output for success indicators "Failures: 0", "Errors: 0", or "failed: 0" | Test output contains success strings indicating MKV appsrc audio underflow signal detection completed without errors |
