# FNCS_Playback_PlayPause_48kHz_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_168

## TestCase Name
FNCS_Playback_PlayPause_48kHz_AAC

## Objective
to verify whether 48Khz audio is being rendered properly using AAC stream
