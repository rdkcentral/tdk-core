...
## TestCase Name
**FNCS_Playback_PlaySeek_Forward_Only_Audio_WAV**
...
## Objective
To validate that a WAV audio stream (PCM format) supports forward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
