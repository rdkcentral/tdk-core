# FNCS_Playback_CheckLatency_Seek_Backward_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_222

## TestCase Name
FNCS_Playback_CheckLatency_Seek_Backward_HEVC

## Objective
Test to do backward seek on a HEVC stream and verify latency
