# FNCS_Playback_Live_DASH Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_08

## TestCase Name
FNCS_Playback_Live_DASH

## Objective
To test the video playback of LIVE_DASH stream through 'playbin' and 'westerossink' gst elements
