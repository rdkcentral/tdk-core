...
## TestCase Name
**FNCS_Playback_Seek_Towards_EOS_Webm**
...
## Objective
To validate that WebM container format content supports seek operations towards the end of stream and properly detects the End Of Stream (EOS) signal after seeking near the stream end, ensuring correct stream termination handling for WebM media files.
