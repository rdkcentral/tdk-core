...
## TestCase Name
**FNCS_Playback_PlaySeek_Forward_AV1**
...
## Objective
To validate that an AV1 stream supports forward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
