# FNCS_Playback_CheckLatency_Seek_Backward_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_221

## TestCase Name
FNCS_Playback_CheckLatency_Seek_Backward_H264

## Objective
Test to do backward seek on a H264 stream and verify latency
