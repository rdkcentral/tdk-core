...
## TestCase Name
**FNCS_Playback_Set_Rate_0.5x_AV1**
...
## Objective
To validate that an AV1 stream can be played back at a reduced playback rate of 0.5x (half speed), ensuring smooth slow-motion playback and proper rate transitions.
