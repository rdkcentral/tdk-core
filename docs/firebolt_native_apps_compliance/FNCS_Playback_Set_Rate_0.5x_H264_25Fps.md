...
## TestCase Name
**FNCS_Playback_Set_Rate_0.5x_H264_25Fps**
...
## Objective
To validate that a 25 Fps H264 stream can be played back at a reduced playback rate of 0.5x (half speed), ensuring smooth slow-motion playback with proper frame rate management and rate transitions.
...
| 4 | Apply Slow Motion Rate Transition | Execute the slowMotion0.5x operation which reduces the playback rate to 50% of normal speed (0.5x rate), adjusting frame delivery to 12.5 Fps for the 25 Fps stream | Playback rate must transition to 0.5x successfully, and media continues playing at reduced speed with adjusted frame rate |
