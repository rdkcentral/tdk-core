...
## TestCase Name
**FNCS_Playback_PlayPause_MultipleTimes_DASH**
...
## Objective
To validate that DASH adaptive streaming content supports multiple sequential play and pause operations over stressed iterations, ensuring proper playback state transitions and smooth resumption across repeated play/pause cycles.
