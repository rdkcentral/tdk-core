...
| 4 | Start SD Playback | Begin playback with SD stream (360p) as first channel, monitor for proper 360p video decoding and H264 codec performance | SD playback starts successfully with proper 360p video resolution, H264 codec decoding, and AAC audio processing |
