# FNCS_Playback_PlayPause_Vorbis Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_89

## TestCase Name
FNCS_Playback_PlayPause_Vorbis

## Objective
To test the play-pause scenario of pipeline for Vorbis stream through playbin gst element and westerossink
