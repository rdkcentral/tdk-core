# FNCS_Playback_PlayPause_48kHz_OPUS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_169

## TestCase Name
FNCS_Playback_PlayPause_48kHz_OPUS

## Objective
to verify whether 48Khz audio is being rendered properly using OPUS stream
