# FNCS_Playback_480p_Resolution_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_109

## TestCase Name
FNCS_Playback_480p_Resolution_H264

## Objective
To test the video playback with resolution set to 480p through 'playbin' and 'westerossink' gst elements
