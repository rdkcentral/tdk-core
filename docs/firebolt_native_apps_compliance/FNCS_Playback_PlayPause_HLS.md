# FNCS_Playback_PlayPause_HLS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_90

## TestCase Name
FNCS_Playback_PlayPause_HLS

## Objective
To test the play-pause scenario of pipeline for HLS stream through playbin gst element and westerossink
