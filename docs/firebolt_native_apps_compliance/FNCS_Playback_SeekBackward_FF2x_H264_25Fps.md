...
## TestCase Name
**FNCS_Playback_SeekBackward_FF2x_H264_25Fps**
...
## Objective
To validate that a 25 Fps H264 stream supports backward seek operation followed by fast-forward playback at 2x speed, ensuring proper seeking accuracy and fast playback with correct frame rate management.
