# FNCS_Playback_PlayPause_DASH Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_18

## TestCase Name
FNCS_Playback_PlayPause_DASH

## Objective
To test the play-pause scenario of pipeline for DASH stream through playbin gst element and westerossink
