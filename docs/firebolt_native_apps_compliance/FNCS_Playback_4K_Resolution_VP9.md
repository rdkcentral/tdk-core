# FNCS_Playback_4K_Resolution_VP9 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_293

## TestCase Name
FNCS_Playback_4K_Resolution_VP9

## Objective
To test the video playback with resolution set to 2160p through 'playbin' and 'westerossink' gst elements
