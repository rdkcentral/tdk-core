...
## TestCase Name
**FNCS_Playback_Set_Rate_0.75x_H264_29Fps**
...
## Objective
To validate that a 29 Fps H264 stream can be played back at a reduced playback rate of 0.75x (three-quarters speed), ensuring smooth slow-motion playback with proper frame rate management and rate transitions.
...
| 4 | Apply Slow Motion Rate Transition | Execute the slowMotion0.75x operation which reduces the playback rate to 75% of normal speed (0.75x rate), adjusting frame delivery to approximately 21.75 Fps for the 29 Fps stream | Playback rate must transition to 0.75x successfully, and media continues playing at reduced speed with adjusted frame rate |
