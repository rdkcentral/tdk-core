...
## Objective
To validate that DASH adaptive streaming content supports rewind playback at 3x speed (negative playback rate), ensuring proper backward playback at accelerated speed with correct adaptive bitrate handling during rewind operations.
