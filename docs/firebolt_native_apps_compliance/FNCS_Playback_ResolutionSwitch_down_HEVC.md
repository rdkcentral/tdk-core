# FNCS_Playback_ResolutionSwitch_down_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_118

## TestCase Name
FNCS_Playback_ResolutionSwitch_down_HEVC
