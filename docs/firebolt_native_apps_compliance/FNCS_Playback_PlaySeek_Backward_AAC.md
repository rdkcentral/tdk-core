...
## TestCase Name
**FNCS_Playback_PlaySeek_Backward_AAC**
...
## Objective
To validate that an AAC audio stream supports backward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
