...
## TestCase Name
**FNCS_Playback_PlaySeek_Backward_Stress_H264**
...
## Objective
To validate that an H264 stream supports multiple backward seek operations during playback, ensuring proper seeking accuracy under stress conditions and consistent smooth playback resumption across repeated seek operations.
