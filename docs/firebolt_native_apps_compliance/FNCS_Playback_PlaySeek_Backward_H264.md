...
## TestCase Name
**FNCS_Playback_PlaySeek_Backward_H264**
...
## Objective
To validate that an H264 stream supports backward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
