# FNCS_Playback_PlayPause_60Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_25

## TestCase Name
FNCS_Playback_PlayPause_60Fps

## Objective
To test the play-pause scenario of pipeline for 60 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
