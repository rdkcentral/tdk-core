# FNCS_Playback_Only_Audio_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_156

## TestCase Name
FNCS_Playback_Only_Audio_AAC

## Objective
To test the pipeline is playing only audio using AAC stream
