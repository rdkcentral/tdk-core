# FNCS_Playback_360p_Resolution_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_108

## TestCase Name
FNCS_Playback_360p_Resolution_H264

## Objective
To test the video playback with resolution set to 360p through 'playbin' and 'westerossink' gst elements
