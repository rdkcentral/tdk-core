# FNCS_Playback_1080p_Resolution_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_107

## TestCase Name
FNCS_Playback_1080p_Resolution_H264

## Objective
To test the video playback with resolution set to 1080p through 'playbin' and 'westerossink' gst elements
