# FNCS_Playback_Audio_Underflow_Signal_Test Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_145

## TestCase Name
FNCS_Playback_Audio_Underflow_Signal_Test

## Objective
To test if buffer underflow callback is received upon audio underrun from westerossink
