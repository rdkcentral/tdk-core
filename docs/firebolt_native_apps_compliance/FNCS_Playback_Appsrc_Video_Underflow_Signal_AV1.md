# FNCS_Playback_Appsrc_Video_Underflow_Signal_AV1 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_245

## TestCase Name
FNCS_Playback_Appsrc_Video_Underflow_Signal_AV1
...
| 11 | video_src_url_mp4_720p_av1 variable in MediaValidationVariables.py contains AV1 MP4 video stream URL (720p) for appsrc underflow signal testing |
...
| 7 | Reach Buffer Threshold | Continue feeding video buffers via appsrc until threshold bytes (17002704) are reached | Threshold limit reached successfully, pipeline consuming all provided video buffer data |
...
| 11 | Validate Test Output | Parse tdk_mediapipelinetests output for success indicators "Failures: 0", "Errors: 0", or "failed: 0" | Test output contains success strings indicating AV1 appsrc video underflow signal detection completed without errors |
