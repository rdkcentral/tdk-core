...
## TestCase Name
**FNCS_Playback_PauseSeek_Backward_AV1**
...
## Objective
To validate that DASH stream playback with AV1 video codec supports backward seek operations after pause, ensuring proper playback state transitions from paused state to the beginning position and resumption of playback.
