...
## TestCase Name
**FNCS_Playback_Set_Rate_0.5x_HEVC**
...
## Objective
To validate that a HEVC stream can be played back at a reduced playback rate of 0.5x (half speed), ensuring smooth slow-motion playback and proper rate transitions.
