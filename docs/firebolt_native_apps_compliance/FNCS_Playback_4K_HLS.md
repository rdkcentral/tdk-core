# FNCS_Playback_4K_HLS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_12

## TestCase Name
FNCS_Playback_4K_HLS

## Objective
To test the video playback of HLS 4K stream through 'playbin' and 'westerossink' gst elements
