# FNCS_Playback_PlayPause_44kHz_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_167

## TestCase Name
FNCS_Playback_PlayPause_44kHz_AAC

## Objective
to verify whether 44Khz audio is being rendered properly using AAC stream
