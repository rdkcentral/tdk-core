# FNCS_Playback_PlayPause_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_17

## TestCase Name
FNCS_Playback_PlayPause_H264

## Objective
To test the play-pause scenario of pipeline for H264 stream through playbin gst element and westerossink
