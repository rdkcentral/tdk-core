...
## TestCase Name
**FNCS_Playback_Video_PTS_Sync_VP9**
...
## Objective
To verify that VP9 video stream playback maintains synchronized Presentation Time Stamp (PTS) values using the westeros-sink element's 'last-sample' property during frame-drop scenarios, ensuring video timing accuracy throughout playback under stress conditions.
