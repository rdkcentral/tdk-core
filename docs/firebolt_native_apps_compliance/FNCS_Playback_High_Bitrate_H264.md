# FNCS_Playback_High_Bitrate_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_152

## TestCase Name
FNCS_Playback_High_Bitrate_H264

## Objective
To verify whether the video is playing with High bitrate using H264 stream
