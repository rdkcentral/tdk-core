# FNCS_Playback_PlayPause_29Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_22

## TestCase Name
FNCS_Playback_PlayPause_29Fps

## Objective
To test the play-pause scenario of pipeline for 29 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
