# FNCS_Playback_ResolutionSwitch_up_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_115

## TestCase Name
FNCS_Playback_ResolutionSwitch_up_HEVC
