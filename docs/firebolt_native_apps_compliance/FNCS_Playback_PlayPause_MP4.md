# FNCS_Playback_PlayPause_MP4 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_91

## TestCase Name
FNCS_Playback_PlayPause_MP4

## Objective
To test the play-pause scenario of pipeline for MP4 stream through playbin gst element and westerossink
