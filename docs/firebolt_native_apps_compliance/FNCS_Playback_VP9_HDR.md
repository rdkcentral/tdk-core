# FNCS_Playback_VP9_HDR Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_373

## TestCase Name
FNCS_Playback_VP9_HDR

## Objective
To test the video playback of VP9 HDR stream through 'playbin' and 'westerossink' gst elements
