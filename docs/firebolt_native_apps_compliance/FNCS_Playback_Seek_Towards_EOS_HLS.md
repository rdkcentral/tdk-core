...
## TestCase Name
**FNCS_Playback_Seek_Towards_EOS_HLS**
...
## Objective
To validate that HLS adaptive streaming content supports seek operations towards the end of stream and properly detects the End Of Stream (EOS) signal after seeking near the stream end, ensuring correct stream termination handling over HTTP Live Streaming protocol.
