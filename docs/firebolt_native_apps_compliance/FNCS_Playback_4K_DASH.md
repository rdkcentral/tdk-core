# FNCS_Playback_4K_DASH Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_11

## TestCase Name
FNCS_Playback_4K_DASH

## Objective
To test the video playback of DASH 4K stream through 'playbin' and 'westerossink' gst elements
