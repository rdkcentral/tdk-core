...
## TestCase Name
**FNCS_Playback_SeekBackward_FF2x_H264**
...
## Objective
To validate that an H264 stream supports backward seek operation followed by fast-forward playback at 2x speed, ensuring proper seeking accuracy and fast playback with correct frame rate management.
