...
## Objective
To validate that H264 video stream supports rewind playback at 3x speed (negative playback rate), ensuring proper backward playback at accelerated speed and smooth video rendering with correct frame delivery.
