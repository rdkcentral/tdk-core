# FNCS_Playback_Audio_Underflow_Playback_Test Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_144

## TestCase Name
FNCS_Playback_Audio_Underflow_Playback_Test

## Objective
Verify buffer underflow signal is received upon audio underrun and fill the audio buffer by seeking to audioStart point and verify playback is as expected.
...
| 6 | FIREBOLT_COMPLIANCE_UNDERFLOW_AUDIO_END_POINT configuration should be set to 10 (default) in Video_Accelerator.config / RPI-Client.config |
| 7 | FIREBOLT_COMPLIANCE_UNDERFLOW_AUDIO_START_POINT configuration should be set to 240 (default) in Video_Accelerator.config / RPI-Client.config |
