# FNCS_Playback_PlayPause_H264_MOV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_364

## TestCase Name
FNCS_Playback_PlayPause_H264_MOV

## Objective
To test the play-pause scenario of pipeline for H264_MOV stream through playbin gst element and westerossink
