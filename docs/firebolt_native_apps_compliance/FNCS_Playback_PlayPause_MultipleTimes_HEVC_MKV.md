...
## TestCase Name
**FNCS_Playback_PlayPause_MultipleTimes_HEVC_MKV**
...
## Objective
To validate that MKV container format content with HEVC video codec supports multiple sequential play and pause operations over stressed iterations, ensuring proper playback state transitions and smooth resumption across repeated play/pause cycles.
