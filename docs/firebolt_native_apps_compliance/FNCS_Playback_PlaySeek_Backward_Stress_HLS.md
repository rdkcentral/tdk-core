...
## TestCase Name
**FNCS_Playback_PlaySeek_Backward_Stress_HLS**
...
## Objective
To validate that HLS adaptive streaming content supports multiple backward seek operations during playback, ensuring proper seeking accuracy under stress conditions with correct media delivery over HTTP Live Streaming protocol.
