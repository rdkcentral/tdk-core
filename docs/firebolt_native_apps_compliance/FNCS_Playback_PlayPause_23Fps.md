# FNCS_Playback_PlayPause_23Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_20

## TestCase Name
FNCS_Playback_PlayPause_23Fps

## Objective
To test the play-pause scenario of pipeline for 23 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
