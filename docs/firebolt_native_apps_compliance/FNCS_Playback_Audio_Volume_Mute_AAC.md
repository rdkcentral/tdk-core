# FNCS_Playback_Audio_Volume_Mute_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_140

## TestCase Name
FNCS_Playback_Audio_Volume_Mute_AAC

## Objective
to verify whether audio is playing in mute state using AAC stream
