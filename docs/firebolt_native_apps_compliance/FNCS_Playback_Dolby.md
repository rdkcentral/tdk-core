# FNCS_Playback_Dolby Test Case Documentation
...
## Objective
To test the video playback of Dolby stream through 'playbin' and 'westerossink' gst elements
...
| 3 | video_src_url_dolby variable must be configured with DASH_H264_EC3/atfms_291_dash_tdk_avc_eac3_fmp4.mpd in MediaValidationVariables.py as URL or file path for the test stream |
