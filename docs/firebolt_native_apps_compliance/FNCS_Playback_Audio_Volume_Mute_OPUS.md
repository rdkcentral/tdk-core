# FNCS_Playback_Audio_Volume_Mute_OPUS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_142

## TestCase Name
FNCS_Playback_Audio_Volume_Mute_OPUS

## Objective
to verify whether audio is playing in mute state using OPUS stream
