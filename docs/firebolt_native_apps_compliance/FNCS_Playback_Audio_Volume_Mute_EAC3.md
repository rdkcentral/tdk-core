# FNCS_Playback_Audio_Volume_Mute_EAC3 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_141

## TestCase Name
FNCS_Playback_Audio_Volume_Mute_EAC3

## Objective
to verify whether audio is playing in mute state using EAC3 stream
