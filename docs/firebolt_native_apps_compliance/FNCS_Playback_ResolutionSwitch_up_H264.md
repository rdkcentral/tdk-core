# FNCS_Playback_ResolutionSwitch_up_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_114

## TestCase Name
FNCS_Playback_ResolutionSwitch_up_H264

## Objective
To test the video playback by switching resolutions from very low (144p) to 4K resolution through 'playbin' and 'westerossink' gst elements
