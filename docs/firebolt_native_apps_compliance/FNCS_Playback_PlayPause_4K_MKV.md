# FNCS_Playback_PlayPause_4K_MKV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_295

## TestCase Name
FNCS_Playback_PlayPause_4K_MKV

## Objective
To test the play-pause scenario of pipeline for 4K_MKV stream through playbin gst element and westerossink
