...
## Objective
To validate that HLS adaptive streaming content supports rewind playback at 4x speed (negative playback rate), ensuring proper backward playback at accelerated speed with correct adaptive bitrate handling during rewind operations.
