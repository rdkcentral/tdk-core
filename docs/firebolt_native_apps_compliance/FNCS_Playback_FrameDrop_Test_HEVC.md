# FNCS_Playback_FrameDrop_Test_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_336

## TestCase Name
FNCS_Playback_FrameDrop_Test_HEVC

## Objective
To test the video playback of FrameDrop_Test HEVC stream through videotestsrc gst element
