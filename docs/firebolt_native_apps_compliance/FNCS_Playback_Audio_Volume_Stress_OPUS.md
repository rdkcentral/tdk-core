# FNCS_Playback_Audio_Volume_Stress_OPUS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_139

## TestCase Name
FNCS_Playback_Audio_Volume_Stress_OPUS

## Objective
to verify whether audio volume is playing in decreasing order using OPUS stream
