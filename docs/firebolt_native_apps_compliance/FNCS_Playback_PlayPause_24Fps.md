# FNCS_Playback_PlayPause_24Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_19

## TestCase Name
FNCS_Playback_PlayPause_24Fps

## Objective
To test the play-pause scenario of pipeline for 24 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
