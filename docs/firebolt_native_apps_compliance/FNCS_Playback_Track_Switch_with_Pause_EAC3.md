# FNCS_Playback_Track_Switch_with_Pause_EAC3 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_130

## TestCase Name
FNCS_Playback_Track_Switch_with_Pause_EAC3

## Objective
Switch to different audio codec present in the same stream without changing the video
