# FNCS_Playback_PlayPause_25Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_21

## TestCase Name
FNCS_Playback_PlayPause_25Fps

## Objective
To test the play-pause scenario of pipeline for 25 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
