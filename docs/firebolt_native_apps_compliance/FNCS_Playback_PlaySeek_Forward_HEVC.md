...
## TestCase Name
**FNCS_Playback_PlaySeek_Forward_HEVC**
...
## Objective
To validate that a HEVC stream supports forward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption at the target position.
