# FNCS_Playback_PlayPause_OPUS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_93

## TestCase Name
FNCS_Playback_PlayPause_OPUS

## Objective
To test the play-pause scenario of pipeline for OPUS stream through playbin gst element and westerossink
...
| 3 | video_src_url_opus variable must be configured with DASH_VP9_OPUS_WebM/master.mpd in MediaValidationVariables.py as URL or file path for the test stream |
