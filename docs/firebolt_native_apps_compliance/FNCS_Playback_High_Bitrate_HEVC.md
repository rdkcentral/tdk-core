# FNCS_Playback_High_Bitrate_HEVC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_153

## TestCase Name
FNCS_Playback_High_Bitrate_HEVC

## Objective
To verify whether the video is playing with High bitrate using HEVC stream
