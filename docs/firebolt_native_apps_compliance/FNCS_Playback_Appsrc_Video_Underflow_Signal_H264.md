# FNCS_Playback_Appsrc_Video_Underflow_Signal_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_243

## TestCase Name
FNCS_Playback_Appsrc_Video_Underflow_Signal_H264
...
| 11 | video_src_url_mp4_30fps variable in MediaValidationVariables.py contains H264 MP4 video stream URL (30fps) for appsrc underflow signal testing |
...
| 7 | Reach Buffer Threshold | Continue feeding video buffers via appsrc until threshold bytes (2796910) are reached | Threshold limit reached successfully, pipeline consuming all provided video buffer data |
...
| 11 | Validate Test Output | Parse tdk_mediapipelinetests output for success indicators "Failures: 0", "Errors: 0", or "failed: 0" | Test output contains success strings indicating H264 appsrc video underflow signal detection completed without errors |
