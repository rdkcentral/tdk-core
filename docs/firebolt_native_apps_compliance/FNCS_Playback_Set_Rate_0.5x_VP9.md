...
## TestCase Name
**FNCS_Playback_Set_Rate_0.5x_VP9**
...
## Objective
To validate that a 4K VP9 stream can be played back at a reduced playback rate of 0.5x (half speed), ensuring smooth slow-motion playback with proper 4K resolution handling and rate transitions.
