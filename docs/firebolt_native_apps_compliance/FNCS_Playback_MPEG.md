# FNCS_Playback_MPEG Test Case Documentation
...
## Objective
To test the video playback of MPEG stream through 'playbin' and 'westerossink' gst elements
