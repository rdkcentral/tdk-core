# FNCS_Playback_PlayPause_59Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_24

## TestCase Name
FNCS_Playback_PlayPause_59Fps

## Objective
To test the play-pause scenario of pipeline for 59 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
