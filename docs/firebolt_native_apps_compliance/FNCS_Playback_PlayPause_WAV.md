# FNCS_Playback_PlayPause_WAV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_227

## TestCase Name
FNCS_Playback_PlayPause_WAV

## Objective
To test the play-pause scenario of pipeline for WAV stream through playbin gst element and westerossink
