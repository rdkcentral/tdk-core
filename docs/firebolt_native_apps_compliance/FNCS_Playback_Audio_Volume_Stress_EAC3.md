# FNCS_Playback_Audio_Volume_Stress_EAC3 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_138

## TestCase Name
FNCS_Playback_Audio_Volume_Stress_EAC3

## Objective
to verify whether audio volume is playing in decreasing order using EAC3 stream
