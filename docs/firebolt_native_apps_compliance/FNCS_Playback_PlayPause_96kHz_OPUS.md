# FNCS_Playback_PlayPause_96kHz_OPUS Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_171

## TestCase Name
FNCS_Playback_PlayPause_96kHz_OPUS

## Objective
to verify whether 96Khz audio is being rendered properly using OPUS stream
