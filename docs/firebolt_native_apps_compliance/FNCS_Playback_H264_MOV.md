# FNCS_Playback_H264_MOV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_363

## TestCase Name
FNCS_Playback_H264_MOV

## Objective
To test the video playback of H264 MOV stream through 'playbin' and 'westerossink' gst elements
