...
## TestCase Name
**FNCS_Playback_PlaySeek_Forward_HLS**
...
## Objective
To validate that HLS adaptive streaming content supports forward seek operation during playback, ensuring proper seeking accuracy and smooth playback resumption with correct media delivery over HTTP Live Streaming protocol.
