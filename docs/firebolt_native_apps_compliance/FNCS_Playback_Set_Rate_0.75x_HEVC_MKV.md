...
## TestCase Name
**FNCS_Playback_Set_Rate_0.75x_HEVC_MKV**
...
## Objective
To validate that a HEVC stream in MKV container format can be played back at a reduced playback rate of 0.75x (three-quarters speed), ensuring smooth slow-motion playback with proper format handling and rate transitions.
