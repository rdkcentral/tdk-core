# FNCS_Playback_ResolutionSwitch_down_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_117

## TestCase Name
FNCS_Playback_ResolutionSwitch_down_H264

## Objective
To test the video playback by switching resolutions from 4K resolution to very low resolution (144p) through 'playbin' and 'westerossink' gst elements
