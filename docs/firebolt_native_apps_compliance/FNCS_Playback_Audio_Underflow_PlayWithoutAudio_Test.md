# FNCS_Playback_Audio_Underflow_PlayWithoutAudio_Test Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_143

## TestCase Name
FNCS_Playback_Audio_Underflow_PlayWithoutAudio_Test

## Objective
To verify only video is played if audio buffer is empty
...
| 7 | FIREBOLT_COMPLIANCE_AVSYNC_ENABLED configuration should be set to no (default) in Video_Accelerator.config / RPI-Client.config |
