# FNCS_Playback_PlayPause_96kHz_AAC Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_170

## TestCase Name
FNCS_Playback_PlayPause_96kHz_AAC

## Objective
to verify whether 96Khz audio is being rendered properly using AAC stream
