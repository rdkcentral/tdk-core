# FNCS_Playback_PlayPause_50Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_216

## TestCase Name
FNCS_Playback_PlayPause_50Fps

## Objective
To test the play-pause scenario of pipeline for 50 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
