...
## TestCase Name
**FNCS_Playback_PauseSeek_Forward_VP9_HDR**
...
## Objective
To validate that DASH stream playback with VP9 video codec in HDR (High Dynamic Range) format supports forward seek operations after pause, ensuring proper playback state transitions from paused state to seek position and resumption of playback with HDR content.
