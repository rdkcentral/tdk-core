# FNCS_Playback_720p_Resolution_H264 Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_112

## TestCase Name
FNCS_Playback_720p_Resolution_H264

## Objective
To test the video playback with resolution set to 720p through 'playbin' and 'westerossink' gst elements
