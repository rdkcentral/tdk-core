...
## TestCase Name
**FNCS_Playback_PauseSeek_Backward_H264_29Fps**
...
## Objective
To validate that DASH stream playback with H264 video codec at 29 frames per second supports backward seek operations after pause, ensuring proper playback state transitions from paused state to the beginning position and resumption of playback at the specified frame rate.
