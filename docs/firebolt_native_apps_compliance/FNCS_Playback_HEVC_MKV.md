# FNCS_Playback_HEVC_MKV Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_350

## TestCase Name
FNCS_Playback_HEVC_MKV

## Objective
To test the video playback of HEVC_MKV stream through 'playbin' and 'westerossink' gst elements
