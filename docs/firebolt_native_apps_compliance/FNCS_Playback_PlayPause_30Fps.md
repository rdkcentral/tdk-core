# FNCS_Playback_PlayPause_30Fps Test Case Documentation

## TestCase ID
FNCS_PLAYBACK_23

## TestCase Name
FNCS_Playback_PlayPause_30Fps

## Objective
To test the play-pause scenario of pipeline for 30 Fps stream through 'playbin', 'fpsdisplaysink' and 'westerossink' gst elements
