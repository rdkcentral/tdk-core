...
## Objective
To validate that Widevine DRM-encrypted stream playback is functional on the DUT.
...
| 2 | Navigate to Widevine section and initiate playback | Navigate to the section in the MVT App where the Widevine encrypted asset is present and initiate playback of the asset. | The Widevine encrypted asset should play with proper audio and video without any artifacts or errors. |
