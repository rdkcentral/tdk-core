...
## Objective
To validate that AAC audio stream playback is functional on the DUT.
...
| 2 | Navigate to AAC section and initiate playback | Navigate to the section in the MVT App where the AAC asset is present and initiate playback of the asset. | The AAC asset should play with proper audio without any distortion or errors. |
