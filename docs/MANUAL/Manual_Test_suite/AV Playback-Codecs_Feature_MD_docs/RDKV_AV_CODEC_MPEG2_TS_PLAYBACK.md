...
## Objective
To validate that MPEG2-TS stream playback is functional on the DUT.
...
| 2 | Navigate to MPEG2-TS section and initiate playback | Navigate to the section in the MVT App where the MPEG2-TS asset is present and initiate playback of the asset. | The MPEG2-TS asset should play with proper audio and video without any artifacts or errors. |
