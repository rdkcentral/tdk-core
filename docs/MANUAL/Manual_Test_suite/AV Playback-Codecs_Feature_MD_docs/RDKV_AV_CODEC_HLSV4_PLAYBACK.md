...
RDKV_MANUAL_AV_07
## TestCase Name
RDKV_CERT_MANUAL_AV_CODEC_HLSV4_PLAYBACK
...
## Objective
To validate that HLSv4 stream playback is functional on the DUT.
...
| 2 | Navigate to HLSv4 section and initiate playback | Navigate to the section in the MVT App where the HLSv4 asset is present and initiate playback of the asset. | The HLSv4 asset should play with proper audio and video without any artifacts or errors. |
