...
RDKV_MANUAL_APPS_21
## TestCase Name
RDKV_CERT_MANUAL_APP_NETFLIX_EXIT_BACK_KEY
...
## Objective
To validate that the Netflix application can be exited gracefully using the Back key press on the remote control.
