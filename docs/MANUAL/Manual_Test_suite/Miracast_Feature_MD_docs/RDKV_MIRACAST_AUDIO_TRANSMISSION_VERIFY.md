...
## Objective
To validate that audio is correctly transmitted from the mobile device to the DUT during Miracast screen mirroring, including play and pause controls.
...
| 6 | Play video content and verify mirroring on DUT | Play any video content that includes audio on the mobile device. | The video should play on the DUT with proper audio and video output. |
| 7 | Pause video on mobile and verify DUT | Pause the video playback on the mobile device. | The video should pause on the DUT display. |
| 8 | Resume video on mobile and verify DUT | Resume the video playback on the mobile device. | The video should resume playing on the DUT with proper audio and video output. |
