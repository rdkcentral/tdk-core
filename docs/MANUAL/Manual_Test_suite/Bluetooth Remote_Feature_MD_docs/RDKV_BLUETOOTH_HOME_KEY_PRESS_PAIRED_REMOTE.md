...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_HOME_KEY_PRESS_PAIRED_REMOTE
...
## Objective
To validate that the HOME key press on the paired Bluetooth remote navigates back to the RDK UI Home screen.
