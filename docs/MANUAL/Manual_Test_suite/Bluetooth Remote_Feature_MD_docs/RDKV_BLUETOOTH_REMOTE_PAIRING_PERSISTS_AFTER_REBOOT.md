...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_REMOTE_PAIRING_PERSISTS_AFTER_REBOOT
...
## Objective
To validate that Bluetooth remote pairing is preserved and key presses remain functional after a DUT reboot.
