## TestCase ID
RDKV_MANUAL_BLUETOOTH_06
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_BACK_KEY_PRESS_PAIRED_REMOTE
...
## Objective
To validate that the BACK key press on the paired Bluetooth remote navigates back to the previous screen.
...
| 2 |  Press BACK key  | Press the BACK key on the remote. | The RDK UI should navigate back to the Home screen successfully. |
