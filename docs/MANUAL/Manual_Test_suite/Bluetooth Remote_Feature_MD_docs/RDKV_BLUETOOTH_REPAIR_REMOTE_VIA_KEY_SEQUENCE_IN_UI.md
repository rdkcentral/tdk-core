...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_REPAIR_REMOTE_VIA_KEY_SEQUENCE_IN_UI
...
## Objective
To validate that a Bluetooth remote can be successfully re-paired with the DUT using the pairing key sequence after remote pairing has been intentionally removed via the Thunder (WPEFramework) API.
