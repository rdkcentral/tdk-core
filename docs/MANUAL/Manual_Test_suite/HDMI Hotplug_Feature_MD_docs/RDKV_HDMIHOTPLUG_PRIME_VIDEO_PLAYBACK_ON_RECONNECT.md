...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_PRIME_VIDEO_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that Amazon Prime Video playback resumes correctly from the same playback position after an HDMI cable reconnect.
