...
## TestCase Name
RDKV_CERT_MANUAL_WEBAUDIO_MULTIMEDIA_PARALLEL_PLAYBACK
...
## Objective
To validate that the DUT can simultaneously handle video playback, audio playback, and speech synthesis in parallel using the WebAudio API without any interruption or error.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_08 tab | Navigate to the TC_WEBAUDIO_MANUAL_08 tab using the Tab key and press Enter. | The TC_WEBAUDIO_MANUAL_08 HTML page should load correctly, displaying three buttons: "Start Video", "Play Audio", and "Start Speech Synthesis". |
| 3 | Click all three buttons to initiate parallel playback | Navigate using Tab keys and click all three buttons — "Start Video", "Play Audio", and "Start Speech Synthesis" — to initiate simultaneous playback. | Video playback should start and be displayed on screen simultaneously with audio output and speech synthesis sound, all playing concurrently without errors. |
