...
## Objective
To validate that on every device boot, the RDK UI Recommended Apps row lists the first four available apps from the App Catalogue in alphabetical order, along with a "More Apps" tile.
