...
3. [Test Cases](#test-cases)
   ...
   - [Warehouse_Is_Clean](#warehouse_is_clean)
   - [Warehouse_Reset_Device](#warehouse_reset_device)
   - [Warehouse_Internal_Reset](#warehouse_internal_reset)
   - [Warehouse_Event_On_Device_Reset](#warehouse_event_on_device_reset)
...
<a id="warehouse_event_on_device_reset"></a>
### TestCase Name
Warehouse_Event_On_Device_Reset
