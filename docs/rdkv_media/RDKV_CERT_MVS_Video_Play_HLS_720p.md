...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operation of HLS content with 720p display resolution for few minutes and close the player
