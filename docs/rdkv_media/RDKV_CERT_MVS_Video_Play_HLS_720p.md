...
|3| Precondition Met | TV should be connected with the test device. If the 720p resolution is not supported then the test will be marked as failure| Condition is met successfully.|
...
|#|StepName | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Execute Test Step | Get the current video display resolution and set resolution as 720p | Step executed successfully. |
