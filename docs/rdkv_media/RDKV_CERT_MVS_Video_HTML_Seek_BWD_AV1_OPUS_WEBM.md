...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video seek backward operation of WEBM content with AV1 and OPUS codecs for few minutes and close the player
