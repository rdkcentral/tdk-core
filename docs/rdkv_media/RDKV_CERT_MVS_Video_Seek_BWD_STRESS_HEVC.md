...
| 8 | Verify that the required configuration is set correctly. | MediaValidationVariables.hevc_url_type should be set to the HEVC stream type value. | Verify that MediaValidationVariables.hevc_url_type is configured with the required value. |
