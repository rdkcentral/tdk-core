## TestCase ID
RDKV_Media_Validation_13
## TestCase Name
RDKV_CERT_MVS_Video_PlayPause_4K_HLS
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of 4K HLS content
