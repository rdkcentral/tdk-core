## TestCase ID
RDKV_Media_Validation_34
## TestCase Name
RDKV_CERT_MVS_Video_FF3X_Play_DASH_H264
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video fast forward operation in 3x speed for few seconds, continue video play of DASH H264 video codec content and close the player
