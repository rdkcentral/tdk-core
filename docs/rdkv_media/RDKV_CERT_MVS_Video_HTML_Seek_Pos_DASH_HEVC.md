...
## Objective
Test script to launch a HTML5 Player application via AppManager and perform seek forward and seek backward of HEVC/H265 content, validating the expected media events and player behaviour.
