...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation on WEBM content with VORBIS and VP8 codecs with 720p resolution for few minutes and then close the player.
