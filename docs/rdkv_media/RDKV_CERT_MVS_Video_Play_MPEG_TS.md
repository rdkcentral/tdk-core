...
|4| Mpegts URL Type Configured | MediaValidationVariables.mpegts_url_type should be set to the MPEG-TS stream type value.| MediaValidationVariables.mpegts_url_type is configured with the required value.|
