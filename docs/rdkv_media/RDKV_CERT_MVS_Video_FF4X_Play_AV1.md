...
|4| Av1 URL Type Configured | MediaValidationVariables.av1_url_type should be set to the AV1 stream type value.| MediaValidationVariables.av1_url_type is configured with the required value.|
