...
| 4 | Verify that the required configuration is set correctly. | MediaValidationVariables.audio_url_type should be set to the audio stream type value. | Verify that MediaValidationVariables.audio_url_type is configured with the required value. |
