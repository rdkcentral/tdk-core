...
## Objective
Test script to launch a HTML5 Player application via AppManager and perform seek forward of HLS content, validating the expected media events and player behaviour.
