...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation on MP4 content with H265 and AC3 codecs with 720p resolution for few minutes and then close the player.
