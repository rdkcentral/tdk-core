...
| 2 | Build the test URL using video_src_url_live_dash. | Build the test URL with the video_src_url_live_dash. | Verify that the test URL is built using video_src_url_live_dash. |
