...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform playback of DASH H264 content, validating the expected media events and player behaviour.
...
| 2 | Build the test URL using video_src_url_widevine_clear_lead_dash_h264_ac3. | Build the test URL with the video_src_url_widevine_clear_lead_dash_h264_ac3 (DASH stream). | Verify that the test URL is built using video_src_url_widevine_clear_lead_dash_h264_ac3. |
