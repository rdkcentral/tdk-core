...
## Objective
Test script to launch an HTML video player application via AppManager and perform mute and unmute operations on WEBM content with OPUS and VP8 codecs for a few minutes and then close the player.
