...
| 2 | Build the test URL using video_src_url_widevine_cbcs_dash_h264_ec3. | Build the test URL with the video_src_url_widevine_cbcs_dash_h264_ec3 (DASH stream). | Verify that the test URL is built using video_src_url_widevine_cbcs_dash_h264_ec3. |
