...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.mpegts_url_type should be set to the MPEG-TS stream type value. | Verify that MediaValidationVariables.mpegts_url_type is configured with the required value. |
