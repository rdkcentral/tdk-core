...
| 2 | Build the test URL using video_src_url_widevine_cbcs_hls_hevc_aac. | Build the test URL with the video_src_url_widevine_cbcs_hls_hevc_aac (HLS stream). | Verify that the test URL is built using video_src_url_widevine_cbcs_hls_hevc_aac. |
