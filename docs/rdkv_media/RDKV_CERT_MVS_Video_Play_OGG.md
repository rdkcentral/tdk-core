...
|4| Ogg URL Type Configured | MediaValidationVariables.ogg_url_type should be set to the OGG stream type value.| MediaValidationVariables.ogg_url_type is configured with the required value.|
