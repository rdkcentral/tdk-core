...
## Objective
Test script to launch a HTML5 Player application via AppManager and perform mute audio and unmute audio of DASH content, validating the expected media events and player behaviour.
