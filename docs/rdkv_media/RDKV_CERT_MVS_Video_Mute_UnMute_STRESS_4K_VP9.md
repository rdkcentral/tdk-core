...
## Objective
Test Script to launch a lightning Video player application via AppManager to play 4k VP9 video content and perform mute, unmute operations repeatedly for given number of times
...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.vp9_4k_url_type should be set to the VP9 4K stream type value. | Verify that MediaValidationVariables.vp9_4k_url_type is configured with the required value. |
