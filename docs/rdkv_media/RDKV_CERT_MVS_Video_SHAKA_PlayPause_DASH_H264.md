...
## Objective
Test Script to launch a lightning Shaka player application via AppManager and perform video play pause operation of DASH H264 codec stream
