## TestCase ID
RDKV_Media_Validation_52
## TestCase Name
RDKV_CERT_MVS_Video_SHAKA_PlayPause_DASH_H264
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Shaka player application via AppManager and perform video play pause operation of DASH H.264 codec stream
...
| 3 | Perform Pause / Play Content and Validate Media Events | App performs the play, pause operations and validates each operation using media events<br>('Observed Event: play') | Ensure that the app performs all configured operations and validates them using media events.<br>Operations should complete successfully without errors. |
