...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of hdr content
...
| 4 | Validate Event Result and Update Test Status | If expected events video pause and play occurs for pause and play operations, then app gives<br>the validation result as SUCCESS or else FAILURE | Ensure that expected events video pause and play occurs for pause and play operations. Ensure<br>that the test result is updated as SUCCESS. |
