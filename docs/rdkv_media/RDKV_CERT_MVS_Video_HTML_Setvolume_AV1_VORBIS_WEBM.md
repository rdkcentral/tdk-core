...
## Objective
Test script to launch an HTML video player application through AppManager and perform volume level operation on WEBM content with AV1 and VORBIS codecs for a few minutes and then close the player.
