...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform playback of DASH content, validating the expected media events and player behaviour.
