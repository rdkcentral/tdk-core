...
## Objective
Test script to launch a Lightning Unified Player application through AppManager and perform pause and play of HEVC/H265 content, validating the expected media events and player behaviour.
