...
|3| Audio Src URL Mp3 Configured | MediaValidationVariables.audio_src_url_mp3 should be set to the MP3 audio stream URL.| MediaValidationVariables.audio_src_url_mp3 is configured with the required value.|
|4| Audio Close Interval Configured | MediaValidationVariables.audio_close_interval should be set to the audio close interval value (in seconds).| MediaValidationVariables.audio_close_interval is configured with the required value.|
