...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform audio play operation for MP3 audio content for few minutes and close the player.
...
| 3 | Audio Src URL Mp3 Configured | MediaValidationVariables.audio_src_url_mp3 should be set to the MP3 audio stream URL. | Ensure that MediaValidationVariables.audio_src_url_mp3 is configured with the required value. |
