...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operations of AV1 codec stream till the end
...
| 4 | Verify that the required configuration is set correctly. | MediaValidationVariables.av1_url_type should be set to the AV1 stream type value. | Verify that MediaValidationVariables.av1_url_type is configured with the required value. |
