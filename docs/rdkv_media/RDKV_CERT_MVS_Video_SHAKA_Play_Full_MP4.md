...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform play till end of content of MP4 content, validating the expected media events and player behaviour.
...
| 2 | Build the test URL using video_src_url_short_duration_mp4. | Build the test URL with the video_src_url_short_duration_mp4. | Verify that the test URL is built using video_src_url_short_duration_mp4. |
