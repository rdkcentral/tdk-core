...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operations of MKV content till the end
...
| 2 | Build the test URL using video_src_url_short_duration_mkv. | Build the test URL with the video_src_url_short_duration_mkv (MKV stream). | Verify that the test URL is built using video_src_url_short_duration_mkv. |
