...
## Objective
Test script to launch a HTML5 Player application via AppManager and perform fast-forward at 2x speed and resume playback of HLS content, validating the expected media events and player behaviour.
