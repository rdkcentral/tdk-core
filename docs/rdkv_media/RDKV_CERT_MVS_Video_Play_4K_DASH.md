## TestCase ID
RDKV_Media_Validation_27
## TestCase Name
RDKV_CERT_MVS_Video_Play_4K_DASH
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of 4K DASH content for few minutes and close the player
