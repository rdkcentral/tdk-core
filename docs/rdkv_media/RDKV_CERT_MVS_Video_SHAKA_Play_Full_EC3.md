...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform play till end of content of EC3 content, validating the expected media events and player behaviour.
