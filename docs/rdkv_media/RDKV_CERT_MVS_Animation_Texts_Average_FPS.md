...
| 3 | Perform Run Animation and Validate Media Events | App performs objects animation by rendering given number of text strings for 60 sec and stops<br>after that. | Ensure that objects animation by rendering given number of text strings completes successfully<br>without errors. |
| 4 | Execute Test Step | App gives average FPS value after duration of 60 sec | Ensure that Step executed successfully. |
