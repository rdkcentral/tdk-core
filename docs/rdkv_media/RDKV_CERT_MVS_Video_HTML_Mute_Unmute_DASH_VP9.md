...
## Objective
Test script to launch a HTML5 Player application through AppManager and perform mute audio and unmute audio of VP9 content, validating the expected media events and player behaviour.
