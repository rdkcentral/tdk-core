...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of DASH h264 video codec content for few minutes and close the player
