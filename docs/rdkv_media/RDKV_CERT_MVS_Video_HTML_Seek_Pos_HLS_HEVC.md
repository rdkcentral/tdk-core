...
## Objective
Test script to launch a HTML5 Player application via AppManager and perform playback of HLS content, validating the expected media events and player behaviour.
...
| 2 | Build the test URL using video_src_url_4k_hls. | Build the test URL with the video_src_url_4k_hls. | Verify that the test URL is built using video_src_url_4k_hls. |
