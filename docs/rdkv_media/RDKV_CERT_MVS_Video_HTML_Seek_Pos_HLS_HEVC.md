...
|6| Close Interval Configured | MediaValidationVariables.close_interval should be set to the close interval value (in seconds).| MediaValidationVariables.close_interval is configured with the required value.|
