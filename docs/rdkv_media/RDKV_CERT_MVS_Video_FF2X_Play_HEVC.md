...
|4| Hevc URL Type Configured | MediaValidationVariables.hevc_url_type should be set to the HEVC stream type value.| MediaValidationVariables.hevc_url_type is configured with the required value.|
