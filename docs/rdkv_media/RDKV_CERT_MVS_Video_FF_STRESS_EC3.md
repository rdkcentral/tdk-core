...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.ec3_url_type should be set to the EC3 stream type value. | Verify that MediaValidationVariables.ec3_url_type is configured with the required value. |
