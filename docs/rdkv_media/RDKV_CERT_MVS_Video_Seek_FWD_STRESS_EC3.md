...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video seek forward operation of EC3 codec stream repeatedly for given number of times in provided interval
