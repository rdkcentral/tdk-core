...
## TestCase Name
RDKV_CERT_MVS_Video_PlayPause_STRESS_4K_DASH
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operations of 4k DASH content continuously for given number of times
