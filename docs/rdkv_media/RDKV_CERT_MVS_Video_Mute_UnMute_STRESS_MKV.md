...
## Objective
Test Script to launch a lightning Video player application via AppManager to play MKV video content and perform mute, unmute operations repeatedly for given number of times
