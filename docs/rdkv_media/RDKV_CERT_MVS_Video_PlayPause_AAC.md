...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.aac_url_type should be set to the AAC stream type value. | Verify that MediaValidationVariables.aac_url_type is configured with the required value. |
