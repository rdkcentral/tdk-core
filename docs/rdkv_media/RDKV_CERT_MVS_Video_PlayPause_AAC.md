...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of AAC codec stream
...
| 5 | AAC URL Type Configured | MediaValidationVariables.aac_url_type should be set to the AAC stream type value. | Ensure that MediaValidationVariables.aac_url_type is configured with the required value. |
