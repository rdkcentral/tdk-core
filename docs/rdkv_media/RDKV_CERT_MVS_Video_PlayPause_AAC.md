...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play pause operation of AAC codec stream
...
| 6 | Verify that the required URL type configuration is set correctly. | MediaValidationVariables.aac_url_type should be set to the AAC stream type value. | Ensure that the required URL type configuration should be set correctly. |
