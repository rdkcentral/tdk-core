...
## Objective
Test Script to launch a lightning Video player application via AppManager to play 4k AV1 video codec content and perform mute, unmute operations repeatedly for given number of times
...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.av1_url_type_fps should be set to the AV1 (FPS) stream type value. | Verify that MediaValidationVariables.av1_url_type_fps is configured with the required value. |
