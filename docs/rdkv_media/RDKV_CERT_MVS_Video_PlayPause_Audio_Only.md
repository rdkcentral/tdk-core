## TestCase ID
RDKV_Media_Validation_61
## TestCase Name
RDKV_CERT_MVS_Video_PlayPause_Audio_Only
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of Audio only stream
