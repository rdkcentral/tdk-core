...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play pause operations of DASH H264 video codec content continuously for given number of times
...
| 6 | Run play/pause operations and validate events. | App performs the pause and play operation of DASH h264 video codec stream repeatedly and validates using events. | Ensure that play/pause operations complete and expected events are observed. |
