...
## Objective
Test script to launch a Lightning Unified Player application through AppManager and perform pause and play of VP9 content, validating the expected media events and player behaviour.
