...
| 3 | Perform Run Animation and Validate Media Events | App performs objects animation by rendering given number of rectangles for 60 sec and stops<br>after that. | Ensure that objects animation by rendering given number of rectangles completes successfully<br>without errors. |
