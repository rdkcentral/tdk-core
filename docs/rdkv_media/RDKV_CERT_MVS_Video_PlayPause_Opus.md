...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of Opus codec stream
...
| 5 | Opus URL Type Configured | MediaValidationVariables.opus_url_type should be set to the OPUS stream type value. | Ensure that MediaValidationVariables.opus_url_type is configured with the required value. |
