...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.opus_url_type should be set to the OPUS stream type value. | Verify that MediaValidationVariables.opus_url_type is configured with the required value. |
