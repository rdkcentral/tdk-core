...
|5| Opus URL Type Configured | MediaValidationVariables.opus_url_type should be set to the OPUS stream type value.| MediaValidationVariables.opus_url_type is configured with the required value.|
