...
## Objective
Test Script to launch a lightning Shaka player application via AppManager and perform video play pause operation of HLS H.264 codec stream
