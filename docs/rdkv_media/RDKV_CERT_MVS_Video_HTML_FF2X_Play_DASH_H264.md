...
RDKV_MEDIA_1021
## TestCase Name
RDKV_CERT_MVS_Video_HTML_FF2X_Play_DASH_H264
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To launch a HTML Video Player application via AppManager and perform fast-forward at 2x speed and resume playback of DASH content, validating the expected media events and player behaviour. The test confirms that the video fast-forwards at twice the normal speed and that the video position advances at least twice as fast as during normal playback. It also confirms that normal speed playback resumes correctly after the fast-forward period.
