...
## Objective
Test Script to launch a HTML Video player application via AppManager and perform video fast forward operation of WEBM content with AV1 and OPUS codecs with playback rate 4x for few minutes and close the player
