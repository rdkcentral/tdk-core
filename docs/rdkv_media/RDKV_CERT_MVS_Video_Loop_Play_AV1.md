...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video loop playback of dash av1 video codec content
...
|3| Av1 URL Type Configured | MediaValidationVariables.av1_url_type should be set to the AV1 stream type value.| MediaValidationVariables.av1_url_type is configured with the required value.|
