...
| 8 | Verify that the required configuration is set correctly. | MediaValidationVariables.av1_url_type should be set to the AV1 stream type value. | Verify that MediaValidationVariables.av1_url_type is configured with the required value. |
