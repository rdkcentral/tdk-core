...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform playback of HEVC/H265 content, validating the expected media events and player behaviour.
...
| 2 | Build the test URL using video_src_url_hevc_hdr. | Build the test URL with the video_src_url_hevc_hdr. | Verify that the test URL is built using video_src_url_hevc_hdr. |
