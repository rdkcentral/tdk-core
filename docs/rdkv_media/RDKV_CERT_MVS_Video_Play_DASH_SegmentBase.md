## TestCase ID
RDKV_Media_Validation_161
## TestCase Name
RDKV_CERT_MVS_Video_Play_DASH_SegmentBase
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operations of segementBase MPD variant DASH content till the end
...
| 2 | Build the test URL using video_src_url_dash_segement_base. | Build the test URL with the video_src_url_dash_segement_base (DASH stream). | Verify that the test URL is built using video_src_url_dash_segement_base. |
