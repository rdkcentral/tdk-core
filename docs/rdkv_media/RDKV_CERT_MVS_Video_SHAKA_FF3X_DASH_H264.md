## TestCase ID
RDKV_Media_Validation_728
## TestCase Name
RDKV_CERT_MVS_Video_SHAKA_FF3X_DASH_H264
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Shaka player application through AppManager and perform video fast forward operation in 3x speed for few seconds, continue video play of DASH H264 video codec content and close the player
