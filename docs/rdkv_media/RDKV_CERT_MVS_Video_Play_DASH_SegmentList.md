## TestCase ID
RDKV_Media_Validation_162
## TestCase Name
RDKV_CERT_MVS_Video_Play_DASH_SegmentList
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operations of segementList MPD variant DASH content till the end
...
| 2 | Build the test URL using video_src_url_dash_segement_list. | Build the test URL with the video_src_url_dash_segement_list (DASH stream). | Verify that the test URL is built using video_src_url_dash_segement_list. |
