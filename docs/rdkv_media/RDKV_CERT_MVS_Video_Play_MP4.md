## TestCase ID
RDKV_Media_Validation_39
## TestCase Name
RDKV_CERT_MVS_Video_Play_MP4
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of MP4 content for few minutes and close the player
