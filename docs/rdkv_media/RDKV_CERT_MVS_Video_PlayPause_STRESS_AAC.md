...
|6| Aac URL Type Configured | MediaValidationVariables.aac_url_type should be set to the AAC stream type value.| MediaValidationVariables.aac_url_type is configured with the required value.|
