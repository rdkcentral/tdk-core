...
## Objective
Test script to launch a Lightning Unified Player application through AppManager and perform mute audio, unmute audio, and repeat playback of DASH H264 (MAIN Profile) content, validating the expected media events and player behaviour.
