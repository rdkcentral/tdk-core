...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation on WEBM content with AV1 and OPUS codecs with 720p resolution for few minutes and then close the player.
