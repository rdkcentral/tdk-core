...
## Objective
Test Script to launch a HTML Video player application via AppManager and perform video play pause operation on WEBM content with AV1 and OPUS codecs with 720p resolution for few minutes and then close the player.
...
| 2 | Build the test URL using video_src_url_av1_opus_720p. | Build the test URL with the video_src_url_av1_opus_720p. | Verify that the test URL is built using video_src_url_av1_opus_720p. |
