...
|4| Vp9 URL Type Configured | MediaValidationVariables.vp9_url_type should be set to the VP9 stream type value.| MediaValidationVariables.vp9_url_type is configured with the required value.|
