...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform mute audio and unmute audio of HEVC/H265 content, validating the expected media events and player behaviour.
