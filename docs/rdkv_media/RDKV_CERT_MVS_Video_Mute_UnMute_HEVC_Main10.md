...
## Objective
Test script to launch a Lightning Unified Player application through AppManager and perform mute audio and unmute audio of HEVC/H265 content, validating the expected media events and player behaviour.
...
| 2 | Build the test URL using video_src_url_hevc_main10. | Build the test URL with the video_src_url_hevc_main10 (DASH stream). | Verify that the test URL is built using video_src_url_hevc_main10. |
