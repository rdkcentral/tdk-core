...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation on MP4 content with AV1 and AAC codecs with 480p resolution for few minutes and then close the player.
...
| 2 | Build the test URL using video_src_url_av1_aac_480p. | Build the test URL with the video_src_url_av1_aac_480p. | Verify that the test URL is built using video_src_url_av1_aac_480p. |
