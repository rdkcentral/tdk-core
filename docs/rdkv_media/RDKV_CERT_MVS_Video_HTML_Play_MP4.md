## TestCase ID
RDKV_Media_Validation_96
## TestCase Name
RDKV_CERT_MVS_Video_HTML_Play_MP4
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play operation of MP4 content for few minutes and close the player
...
| 4 | Run playback operations and validate media events. | App starts playing the MP4 video and closes the player after the provided duration. The 'playing' event is monitored to validate successful playback. | Ensure that expected media events are observed for the configured operations. |
