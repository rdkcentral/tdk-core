...
## Objective
Test script to launch an HTML video player application through AppManager and perform mute and unmute operations on WEBM content with VORBIS and VP9 codecs for a few minutes and then close the player.
