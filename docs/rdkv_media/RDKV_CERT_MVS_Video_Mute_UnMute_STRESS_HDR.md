## TestCase ID
RDKV_Media_Validation_323
## TestCase Name
RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_HDR
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager to play HDR codec video content and perform mute, unmute operations repeatedly for given number of times
