...
## Objective
Test Script to launch a lightning Video player application through AppManager to play HDR codec video content and perform mute, unmute operations repeatedly for given number of times
