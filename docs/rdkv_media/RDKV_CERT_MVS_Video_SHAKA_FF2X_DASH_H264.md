...
| 6 | Execute fast-forward/rewind operations and validate media events. | App performs the provided operations and validates each operation using media events | Ensure that expected media events are observed for the configured operations. |
