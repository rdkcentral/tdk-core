...
| 5 | Run playback operations and validate media events. | App performs animation to render Rectangles and Texts for 60 seconds. | Ensure that expected media events are observed for the configured operations. |
