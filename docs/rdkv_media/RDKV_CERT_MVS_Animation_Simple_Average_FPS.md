...
## Objective
Test Script to launch a lightning Animation application through AppManager to render combination of Rectangles and Texts and check whether the average FPS calculated for 60 sec duration value is as expected
...
| 4 | Run animation operations and validate outcomes. | App performs animation to render Rectangles and Texts for 60 seconds. | Ensure that animation to render rectangles and texts completes successfully without errors. |
