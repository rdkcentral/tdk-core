...
|3| Audio Close Interval Configured | MediaValidationVariables.audio_close_interval should be set to the audio close interval value (in seconds).| MediaValidationVariables.audio_close_interval is configured with the required value.|
|4| Audio URL Type Configured | MediaValidationVariables.audio_url_type should be set to the audio stream type value.| MediaValidationVariables.audio_url_type is configured with the required value.|
