...
|#| StepName | Step Description | Expected Result |
|-|---------|-----------------|----------------|
| 1 | Set playback operations for the scenario. | Set playback operations: Change stream URL (60s), close the player (60s). | Ensure playback operations are set as specified. |
