...
## Objective
Test Script to launch a lightning Video player application via AppManager to play HEVC video content and perform mute, unmute operations repeatedly for given number of times
