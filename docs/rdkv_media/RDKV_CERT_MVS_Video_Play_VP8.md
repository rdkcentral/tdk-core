...
|4| Vp8 URL Type Configured | MediaValidationVariables.vp8_url_type should be set to the VP8 stream type value.| MediaValidationVariables.vp8_url_type is configured with the required value.|
