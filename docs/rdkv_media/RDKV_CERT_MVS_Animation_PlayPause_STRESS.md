...
| 7 | Monitor animation progress. | Monitor animation progress. | Ensure that the 'pause, play, repeat' event should be received and animation completes successfully. Ensure that the validation result and average CPU load value should be retrieved. |
