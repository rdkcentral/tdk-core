...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation on MP4 content with H264 and AAC codecs with 480p resolution for few minutes and then close the player.
