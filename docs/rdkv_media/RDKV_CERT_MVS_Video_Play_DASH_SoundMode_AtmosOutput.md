...
|3| Precondition Met | TV should be connected with the test device If the audio atmos  is not supported then the test will be marked as failure| Condition is met successfully.|
...
|#|StepName | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Execute Test Step | Enable audio atmos output sound mode | Step executed successfully. |
