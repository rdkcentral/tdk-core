...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play pause operation of WEBM content with AV1 and OPUS codecs for few minutes and close the player
