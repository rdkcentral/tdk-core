## TestCase ID
RDKV_Media_Validation_129
## TestCase Name
RDKV_CERT_MVS_Video_FF3X_Play_VP9
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video fast forward operation in 3x speed for few seconds, continue video play of VP9 content and close the player
