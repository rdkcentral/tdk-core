...
| 3 | Perform Run Animation and Validate Media Events | App performs animation to render Rectangles, Texts and Images for 60 seconds. | Ensure that animation to render rectangles, texts and images completes successfully without<br>errors. |
