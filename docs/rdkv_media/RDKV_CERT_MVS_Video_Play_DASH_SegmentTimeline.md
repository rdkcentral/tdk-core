## TestCase ID
RDKV_Media_Validation_163
## TestCase Name
RDKV_CERT_MVS_Video_Play_DASH_SegmentTimeline
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operations of segementTimeline $Time$ MPD variant DASH content till the end
...
| 2 | Build the test URL using video_src_url_dash_segement_timeline. | Build the test URL with the video_src_url_dash_segement_timeline (DASH stream). | Verify that the test URL is built using video_src_url_dash_segement_timeline. |
