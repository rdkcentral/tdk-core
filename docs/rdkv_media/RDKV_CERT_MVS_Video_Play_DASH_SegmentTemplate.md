## TestCase ID
RDKV_Media_Validation_164
## TestCase Name
RDKV_CERT_MVS_Video_Play_DASH_SegmentTemplate
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operations of segementTemplate $Number$ MPD variant DASH content till the end
...
| 2 | Build the test URL using video_src_url_dash_segement_template. | Build the test URL with the video_src_url_dash_segement_template (DASH stream). | Verify that the test URL is built using video_src_url_dash_segement_template. |
