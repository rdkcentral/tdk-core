...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of HEVC MKV stream for few minutes and close the player
