...
## Objective
To launch a Shaka Player integrated with lightning application via AppManager and perform playback of HLS content, validating the expected media events and player behaviour. The test confirms that the live stream starts playing successfully and that the video position advances in real time, indicating the live feed is being consumed continuously. No natural end is expected for a live stream.
