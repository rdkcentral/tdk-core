...
## Objective
Test Script to launch a HTML Video player application via AppManager and perform video play pause operation on WEBM content with AV1 and VORBIS codecs with 1080p resolution for few minutes and then close the player.
...
| 2 | Build the test URL using video_src_url_av1_vorbis_1080p. | Build the test URL with the video_src_url_av1_vorbis_1080p. | Verify that the test URL is built using video_src_url_av1_vorbis_1080p. |
