...
| 2 | Build the test URL using video_src_url_dash_h264_main. | Build the test URL with the video_src_url_dash_h264_main. | Verify that the test URL is built using video_src_url_dash_h264_main. |
