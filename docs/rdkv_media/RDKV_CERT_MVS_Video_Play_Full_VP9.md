...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operations of VP9 content till the end
...
| 4 | Verify that the required configuration is set correctly. | MediaValidationVariables.vp9_url_type should be set to the VP9 stream type value. | Verify that MediaValidationVariables.vp9_url_type is configured with the required value. |
