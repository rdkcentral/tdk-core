...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video trickplay operations of Playready DRM protected HLS H264 video codec content
...
| 2 | Build the test URL using video_src_url_playready_hls_h264. | Build the test URL with the video_src_url_playready_hls_h264 (HLS stream). | Verify that the test URL is built using video_src_url_playready_hls_h264. |
