...
| 2 | Build the test URL using video_src_url_hls. | Build the test URL with the video_src_url_hls. | Verify that the test URL is built using video_src_url_hls. |
