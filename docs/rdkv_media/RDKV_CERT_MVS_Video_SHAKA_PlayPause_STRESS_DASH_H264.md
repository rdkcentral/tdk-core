...
## Objective
Test Script to launch a lightning Shaka player application via AppManager and perform video play pause operations of DASH H264 codec stream continuously for given number of times
