...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video seek forward operation of HEVC content repeatedly for given number of times in provided interval
