## TestCase ID
RDKV_Media_Validation_667
## TestCase Name
RDKV_CERT_MVS_Video_HTML_Play_VORBIS_VP9_WEBM
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play operation of WEBM content with VORBIS and VP9 codecs for few minutes and close the player
