...
## Objective
Test script to launch an HTML video player application through AppManager and perform mute and unmute operations on MP4 content with AV1 and AAC codecs for a few minutes and then close the player.
