## TestCase ID
RDKV_Media_Validation_658
## TestCase Name
RDKV_CERT_MVS_Video_HTML_Play_AAC_H265_MP4
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a HTML Video player application through AppManager and perform video play operation of MP4 content with H265 and AAC codecs for few minutes and close the player
