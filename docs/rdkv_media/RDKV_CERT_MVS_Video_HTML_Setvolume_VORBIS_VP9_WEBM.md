...
## Objective
Test script to launch an HTML video player application via AppManager and perform volume level operation on WEBM content with VORBIS and VP9 codecs for a few minutes and then close the player.
