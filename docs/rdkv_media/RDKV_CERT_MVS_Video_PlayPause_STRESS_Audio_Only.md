...
|6| Audio URL Type Configured | MediaValidationVariables.audio_url_type should be set to the audio stream type value.| MediaValidationVariables.audio_url_type is configured with the required value.|
