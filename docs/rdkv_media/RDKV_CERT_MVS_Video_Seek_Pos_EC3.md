...
|6| Ec3 URL Type Configured | MediaValidationVariables.ec3_url_type should be set to the EC3 stream type value.| MediaValidationVariables.ec3_url_type is configured with the required value.|
