...
| 6 | Verify that the required configuration is set correctly. | MediaValidationVariables.ogg_url_type should be set to the OGG stream type value. | Verify that MediaValidationVariables.ogg_url_type is configured with the required value. |
