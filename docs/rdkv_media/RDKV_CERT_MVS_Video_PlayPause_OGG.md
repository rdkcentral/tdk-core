...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play pause operation of Ogg stream
...
| 5 | Ogg URL Type Configured | MediaValidationVariables.ogg_url_type should be set to the OGG stream type value. | Ensure that MediaValidationVariables.ogg_url_type is configured with the required value. |
