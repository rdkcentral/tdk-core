...
## Objective
Test script to launch a HTML5 Player application through AppManager and perform seek backward of HEVC/H265 content, validating the expected media events and player behaviour.
