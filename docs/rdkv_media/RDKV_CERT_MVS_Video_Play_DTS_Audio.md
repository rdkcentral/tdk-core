...
|3| Audio Src URL Dts Configured | MediaValidationVariables.audio_src_url_dts should be set to the DTS audio stream URL.| MediaValidationVariables.audio_src_url_dts is configured with the required value.|
