...
## Objective
Test script to launch a Lightning Unified Player application via AppManager and perform playback of HEVC/H.265 content, validating the expected media events and player behaviour.
