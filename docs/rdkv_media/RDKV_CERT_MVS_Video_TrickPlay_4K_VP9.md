...
| 5 | Verify that the required configuration is set correctly. | MediaValidationVariables.vp9_4k_url_type should be set to the VP9 4K stream type value. | Verify that MediaValidationVariables.vp9_4k_url_type is configured with the required value. |
