...
## Objective
Test Script to launch a HTML Video player application via AppManager and perform video play pause operation on MP4 content with AV1 and AAC codecs with 1080p resolution for few minutes and then close the player.
