## TestCase ID
RDKV_Media_Validation_103
## TestCase Name
RDKV_CERT_MVS_Video_Play_DASH_1080p
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of DASH content with 1080p display resolution for few minutes and close the player
