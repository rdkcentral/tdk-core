## TestCase ID
RDKV_Media_Validation_499
## TestCase Name
RDKV_CERT_MVS_Video_Play_4K_AV1
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
Test Script to launch a lightning Video player application via AppManager and perform video play operation of 4K AV1 codec stream for few minutes and close the player
