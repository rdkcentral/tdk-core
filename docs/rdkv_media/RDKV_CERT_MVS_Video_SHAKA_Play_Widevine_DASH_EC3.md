...
## Objective
Test Script to launch a lightning Shaka player application via AppManager and perform video play operation of Widevine DRM protected EC3 codec DASH stream for few minutes and close the player
...
| 2 | Build the test URL using video_src_url_widevine_dash_ec3. | Build the test URL with the video_src_url_widevine_dash_ec3. | Verify that the test URL is built using video_src_url_widevine_dash_ec3. |
