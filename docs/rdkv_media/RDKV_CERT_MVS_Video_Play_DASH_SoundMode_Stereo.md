...
| 2 | Build the test URL using video_src_url_dash. | Build the test URL with the video_src_url_dash (DASH stream). | Verify that the test URL is built using video_src_url_dash. |
