...
|3| Precondition Met | TV should be connected with the test device If the stereo sound mode  is not supported then the test will be marked as failure| Condition is met successfully.|
...
|#|StepName | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Execute Test Step | Get the current sound mode and set audio sound mode as stereo | Step executed successfully. |
