...
## Objective
Test Script to launch a HTML Video player application via AppManager and perform video seek forward operation of WEBM content with OPUS and VP8 codecs for few minutes and close the player
