...
RDKV_MEDIA_1048
## TestCase Name
RDKV_CERT_MVS_Video_SHAKA_FF2X_Play_DASH_H264_Main
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To launch a Shaka Player integrated with lightning application via AppManager and perform fast-forward at 2x speed and resume playback of DASH H264 (Main Profile) content, validating the expected media events and player behaviour. The test confirms that the video fast-forwards at twice the normal speed and that the video position advances at least twice as fast as during normal playback. It also confirms that normal speed playback resumes correctly after the fast-forward period.
