...
## Objective
Test Script to launch a lightning Video player application through AppManager and perform video play operation of HLS live content
...
| 5 | Run playback operations and validate media events. | App should play the live HLS content and event video playing should occur. | Ensure that expected media events are observed for the configured operations. |
