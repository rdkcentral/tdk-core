...
|#|Step Name | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Launch app from Recommended/My Apps | Select the App tile from the My Apps/Recommended Apps section/row of RDK UI Home screen and press Enter/OK on the remote | Selected App should be launched successfully  either as a cold launch or hot launch depending on the app's previous state. if new version of App is available App shouldn't launch|
...
| 3 | Launch app from Recommended/My Apps | Select the App tile again from the My Apps/Recommended Apps section/row of RDK UI Home screen and press Enter/OK on the remote | Selected App should be launched successfully with Newer Version  either as a cold launch or hot launch depending on the app's previous state.|
