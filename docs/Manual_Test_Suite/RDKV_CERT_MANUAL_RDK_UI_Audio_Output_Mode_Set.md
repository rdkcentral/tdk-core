...
| 7 | Repeat for all audio output modes | Repeat steps 3 to 6 for all audio modes available in Settings/Audio/Output Mode screen | Expected results are similar to steps 3 to 6|
