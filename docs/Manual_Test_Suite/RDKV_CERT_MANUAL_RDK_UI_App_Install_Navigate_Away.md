...
| 4 | Validate downloaded app available in My Apps | After some time, validate that the App which we tried to download is available in My Apps | Even though we navigated away during download, app should be downloaded and installed and should be available in My Apps section|
