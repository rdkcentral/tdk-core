...
| 4 | Navigate and select video using DUT remote | Using the DUT remote (not the smartphone), navigate the YouTube interface on the TV and select a video by pressing OK. | The selected video should start playing on the TV.|
