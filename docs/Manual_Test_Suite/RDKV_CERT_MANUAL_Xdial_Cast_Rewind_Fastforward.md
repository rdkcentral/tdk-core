...
## Objective
To validate that fast-forward and rewind controls on the smartphone function correctly on the DUT during an active YouTube XDial casting session. This test confirms that fast-forward and rewind commands from the smartphone are accurately reflected in the video playback position on the DUT, ensuring trick-play control functionality during XDial casting meets certification requirements.
...
| 7 | Fast-forward video via smartphone remote | To fast-forward: Press and hold the Right Arrow button on the remote control screen for 2 seconds, then press OK (Play/Pause) to resume playback. | The video should fast-forward accordingly on YouTube on the TV. Pressing OK should resume normal playback.|
| 8 | Rewind video via smartphone remote | To rewind: Press and hold the Left Arrow button on the remote control screen for 2 seconds, then press OK (Play/Pause) to resume playback. | The video should rewind accordingly on YouTube on the TV. Pressing OK should resume normal playback.|
