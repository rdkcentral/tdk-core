## TestCase ID
RDKV_MANUAL_XDIAL_08
## TestCase Name
RDKV_CERT_MANUAL_Xdial_Cast_Volume_Control
...
| 7 | Adjust volume via smartphone and verify TV | Using the volume control on the cast popup, gradually decrease the volume level to 0, then increase it back to maximum. | The YouTube application volume on the TV should adjust according to the volume control changes on the smartphone. The TV system volume should remain unaffected by these adjustments.|
