## TestCase ID
RDKV_MANUAL_APPMGR_FUNCTIONAL_16
## TestCase Name
RDKV_CERT_MANUAL_APPMGR_FUN_UPDATE_BTN_VERSION_BASED
...
## Objective
To validate that the Update button in the App Info screen is activated based on the versioning information provided by the AppManager.
...
| 4 | Launch updated app from App Info page | Select Launch button of the same App and press enter/Ok button on remote | Updated Selected App with latest vesrion should be launched succesfully |
