...
| 4 |  Ensure two mobile hotspots available  | Ensure at least two mobile hotspot SSIDs are available and accessible for connection. | At least two mobile hotspot SSIDs should be available and visible in the Wi-Fi network list.|
