## TestCase ID
RDKV_MANUAL_XDIAL_20
## TestCase Name
RDKV_CERT_MANUAL_Xdial_Cast_Eth_To_Wifi_Switch
...
| 4 | Connect DUT via Ethernet | The DUT shall be connected via Ethernet prior to test execution. | The DUT should be connected via Ethernet with a valid IP address assigned.|
...
| 7 | Switch DUT from Ethernet to Wi-Fi | Connect the DUT to Wi-Fi and disconnect the Ethernet connection. | The DUT should successfully connect to the Wi-Fi network and the Ethernet connection should be disconnected.|
