...
## Objective
To validate that a video can be selected and played directly from the smartphone during an active XDial casting session, without using the Dial remote control screen.
