...
| 3 | Connect DUT via Wi-Fi | The DUT shall be connected via Wi-Fi prior to test execution. | The DUT should be connected via Wi-Fi with a valid IP address assigned.|
