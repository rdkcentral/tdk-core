...
## Objective
To validate the Netflix application hibernate behavior when the Home key is pressed during playback, and subsequent hot launch from the last hibernated state.
