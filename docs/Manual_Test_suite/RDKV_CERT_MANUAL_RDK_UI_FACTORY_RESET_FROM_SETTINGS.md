...
## Objective
To validate that a Factory Reset can be performed from the RDK UI Settings and that all user settings and installed apps are restored to factory defaults after the reset.
