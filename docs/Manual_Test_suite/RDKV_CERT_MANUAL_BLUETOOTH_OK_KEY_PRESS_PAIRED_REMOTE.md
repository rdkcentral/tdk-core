...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_OK_KEY_PRESS_PAIRED_REMOTE
...
## Objective
To validate that the OK key press on the paired Bluetooth remote functions correctly in the RDK UI.
