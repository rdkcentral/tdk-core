...
## Objective
To validate that H.265/HEVC stream playback is functional on the DUT. This test exercises the RDK media pipeline, AV decoder plugins, and the video player application to drive codec-specific playback scenarios. The test confirms that the H.265/HEVC asset should play with proper audio and video without any artifacts or errors.
...
| 2 | Navigate to H.265/HEVC section and initiate playback | Navigate to the section in the MVT App where the H.265/HEVC asset is present and initiate playback of the asset. | The H.265/HEVC asset should play with proper audio and video without any artifacts or errors.|
