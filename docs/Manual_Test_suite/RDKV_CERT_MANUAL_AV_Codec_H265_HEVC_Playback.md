...
## Objective
To validate that H.265/HEVC video codec playback is functional on the DUT using the RDK media pipeline. This test confirms that the H.265/HEVC asset plays with proper audio and video output without artifacts or errors, ensuring H.265/HEVC codec support meets certification requirements.
