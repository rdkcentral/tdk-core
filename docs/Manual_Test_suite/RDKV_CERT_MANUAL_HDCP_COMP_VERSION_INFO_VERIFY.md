...
| 5 | Query HDCP version information via API | Immediately after initiating playback, execute the following curl command to query the HDCP status.<br>Command: `curl --data-binary '{"jsonrpc":"2.0", "id":3, "method":"org.rdk.HdcpProfile.getHDCPStatus", "params":{}}' -H 'content-type:text/plain;' http://127.0.0.1:9998/jsonrpc` | The response should contain the supported, receiver, and current HDCP version fields. Expected response: {"jsonrpc":"2.0","id":3,"result":{"HDCPStatus":{"isConnected":true,"isHDCPCompliant":true,"isHDCPEnabled":true,"hdcpReason":2,"supportedHDCPVersion":"2.2","receiverHDCPVersion":"2.2","currentHDCPVersion":"2.2"},"success":true}}. The fields "supportedHDCPVersion":"2.2", "receiverHDCPVersion":"2.2", and "currentHDCPVersion":"2.2" shall be present in the response. |
