...
| 5 | Select the voice search option from | Select the Voice Search option from the popup. | A screen should appear on the smartphone directing the user to speak a search query.|
