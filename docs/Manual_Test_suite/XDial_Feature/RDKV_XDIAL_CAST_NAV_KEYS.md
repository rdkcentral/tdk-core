...
## Objective
To validate that the navigation keys (Up, Down, Left, Right) on the external device (smartphone) function correctly on the DUT during an active YouTube XDial casting session.
