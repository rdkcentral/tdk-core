...
## Objective
To validate that the YouTube application can be exited on the DUT using the Back button from the external device (smartphone) Dial remote control screen during an active casting session.
