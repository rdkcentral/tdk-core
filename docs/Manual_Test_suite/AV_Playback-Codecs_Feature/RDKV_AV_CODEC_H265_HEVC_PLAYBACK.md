...
## Objective
To validate that H.265/HEVC stream playback is functional on the DUT.
...
| 3 | Verify package in /opt/CDL/ | Validate that the downloaded package is available in the /opt/CDL/ directory of the DUT.<br>Command: `ls -lh /opt/CDL/` | The downloaded MVT Test bolt package should be listed in the /opt/CDL/ directory of the DUT. |
