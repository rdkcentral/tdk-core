...
RDKV_MANUAL_APPS_22
## TestCase Name
RDKV_CERT_MANUAL_APP_FEATURED_VOD_FIRST_TRICKPLAY
...
## Objective
To validate the trickplay (fast forward, rewind, pause, and resume) functionality for the first Featured Video On Demand (VOD) content from the RDK UI Home screen.
