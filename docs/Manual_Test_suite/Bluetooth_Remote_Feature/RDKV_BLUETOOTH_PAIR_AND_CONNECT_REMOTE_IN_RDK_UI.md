...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_PAIR_AND_CONNECT_REMOTE_IN_RDK_UI
...
## Objective
To validate that a Bluetooth remote can be successfully paired and connected to the DUT while the RDK UI is active.
