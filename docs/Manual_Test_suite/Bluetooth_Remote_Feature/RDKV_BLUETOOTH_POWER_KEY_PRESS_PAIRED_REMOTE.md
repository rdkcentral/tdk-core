...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_POWER_KEY_PRESS_PAIRED_REMOTE
...
## Objective
To validate that the POWER key press on the paired Bluetooth remote correctly toggles the DUT display state.
