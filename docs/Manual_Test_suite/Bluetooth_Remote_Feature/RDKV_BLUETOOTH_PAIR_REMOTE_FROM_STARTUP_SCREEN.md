...
## TestCase Name
RDKV_CERT_MANUAL_BLUETOOTH_PAIR_REMOTE_FROM_STARTUP_SCREEN
...
## Objective
To validate that a Bluetooth remote control can be successfully paired with the DUT from the startup pairing screen immediately after a fresh firmware flash.
