...
## TestCase Name
RDKV_CERT_MANUAL_HDMI_Hotplug_VOD_Playback_Resume_On_Reconnect
...
## Objective
To validate that On Demand video playback resumes correctly on the DUT after an HDMI cable reconnect. This test exercises the RDK HDMI hotplug detection service and display manager to validate display connection and disconnection event handling. The test confirms that the video that was playing prior to HDMI disconnection should resume playback with proper audio and video output.
