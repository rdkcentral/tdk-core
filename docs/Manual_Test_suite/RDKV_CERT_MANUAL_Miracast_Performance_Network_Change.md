...
| 6 | Play video content and verify mirroring on DUT | Play any video content on the smartphone. | The video should stream correctly on the DUT.|
| 7 | Switch smartphone to 5 GHz Wi-Fi SSID | Switch the smartphone to a 5 GHz Wi-Fi SSID. | The 5 GHz SSID should connect successfully on the smartphone.|
