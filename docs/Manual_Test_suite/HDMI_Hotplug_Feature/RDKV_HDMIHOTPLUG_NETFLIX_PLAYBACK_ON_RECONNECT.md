...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_NETFLIX_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that Netflix video playback resumes correctly from the same playback position after an HDMI cable reconnect.
