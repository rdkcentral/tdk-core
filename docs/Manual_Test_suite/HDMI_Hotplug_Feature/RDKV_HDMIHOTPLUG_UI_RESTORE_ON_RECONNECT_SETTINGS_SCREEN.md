...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_UI_RESTORE_ON_RECONNECT_SETTINGS_SCREEN
...
## Objective
To validate that the Settings screen is correctly restored on the display after an HDMI cable reconnect.
