...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_PLAYREADY_DRM_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that PlayReady DRM encrypted stream playback continues without interruption after an HDMI cable reconnect on the DUT.
