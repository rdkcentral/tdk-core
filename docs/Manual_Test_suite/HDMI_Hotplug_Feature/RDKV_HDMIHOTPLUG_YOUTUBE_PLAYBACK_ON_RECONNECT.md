...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_YOUTUBE_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that YouTube video playback resumes correctly from the same playback position after an HDMI cable reconnect.
