...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_UI_RESTORE_ON_RECONNECT_HOME_SCREEN
...
## Objective
To validate that the RDK UI Home screen is correctly restored on the display after an HDMI cable reconnect.
