...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_PRIME_VIDEO_PAUSED_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that a paused Amazon Prime Video playback remains in the paused state after an HDMI cable reconnect, when paused prior to disconnection.
