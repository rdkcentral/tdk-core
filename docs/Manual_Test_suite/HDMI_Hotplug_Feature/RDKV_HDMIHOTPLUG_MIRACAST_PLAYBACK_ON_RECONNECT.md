...
## TestCase Name
RDKV_CERT_MANUAL_HDMIHOTPLUG_MIRACAST_PLAYBACK_ON_RECONNECT
...
## Objective
To validate that Miracast screen casting from a smartphone continues without interruption after an HDMI cable reconnect on the DUT.
