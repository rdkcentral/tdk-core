...
RDKV_MANUAL_APPS_23
## TestCase Name
RDKV_CERT_MANUAL_APP_FEATURED_VOD_FIRST_HOME_EXIT
...
## Objective
To validate that the RDK UI Home screen is launched when the Home button is pressed during the first Featured Video On Demand (VOD) content playback.
