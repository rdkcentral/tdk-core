...
| 3 | Connect DUT and two smartphones to same network | The DUT and two external devices (smartphones) shall be connected to the same network. | The DUT and both smartphones should be on the same network and reachable from each other.|
