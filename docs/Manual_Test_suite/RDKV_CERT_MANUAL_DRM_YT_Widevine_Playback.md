...
| 4 | Verify YouTube app on home screen | Validate that the YouTube App is available in the My Apps section/row of the RDK UI Homepage. If not present, install the YouTube App from the Recommended Apps row. | The YouTube App should be available and ready to launch from the RDK UI Homepage.|
...
|#|Step Name | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Launch YouTube app | Select the YouTube App tile from the My Apps/Recommended Apps section/row of the RDK UI Homepage and press the Enter/OK button on the remote. | The YouTube App should be launched successfully (either cold launch or hot launch based on the app's previous state).|
...
| 5 | Exit YouTube app | Close/Exit the YouTube App by pressing the Back key on the remote. | The YouTube App should be terminated gracefully and the RDK UI Homepage should be visible on the TV.|
