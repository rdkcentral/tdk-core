...
## TestCase Name
RDKV_CERT_MANUAL_WEBAUDIO_SPEECH_SYNTHESIS_BASIC
...
## Objective
To validate that the WebAudio Speech Synthesis API can successfully synthesize and output a given text as audio on the DUT.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_01 tab | Navigate to the TC_WEBAUDIO_MANUAL_01 tab using the Tab key and press Enter to load the HTML page. | The TC_WEBAUDIO_MANUAL_01 HTML page should load correctly, displaying a text box and a Speak button. |
| 3 | Click Speak button and verify audio output | Navigate using Tab keys and click the Speak button. | Audio speech output should be heard when the Speak button is pressed. |
