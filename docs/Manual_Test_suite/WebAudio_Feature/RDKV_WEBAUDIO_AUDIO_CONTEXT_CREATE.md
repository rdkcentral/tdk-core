...
## TestCase Name
RDKV_CERT_MANUAL_WEBAUDIO_AUDIO_CONTEXT_CREATE
...
## Objective
To validate that an AudioContext object can be successfully created using the WebAudio API on the DUT.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_04 tab | Navigate to the TC_WEBAUDIO_MANUAL_04 tab using the Tab key and press Enter. | The TC_WEBAUDIO_MANUAL_04 HTML page should load correctly, displaying the "Audio Context Example" message confirming successful AudioContext creation. |
