...
## TestCase Name
RDKV_CERT_MANUAL_WEBAUDIO_CODEC_VORBIS_VBR_70K_44KHZ
...
## Objective
To validate that the DUT can successfully decode a Vorbis audio file (VBR 70 kbps, 44 kHz) using the WebAudio API and report the correct codec metadata.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_11 tab and verify codec info | Navigate to the TC_WEBAUDIO_MANUAL_11 tab using the Tab key and press Enter. | The TC_WEBAUDIO_MANUAL_11 HTML page should load correctly, displaying the decoded audio codec information. Expected output: Audio Codec Information: Sample Rate: 44100 Hz, Channels: 1, Duration: 0.3613605442176871 seconds |
