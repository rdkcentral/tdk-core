## TestCase ID
RDKV_MANUAL_WEBAUDIO_15
## TestCase Name
RDKV_CERT_MANUAL_Webaudio_Codec_WAV_24bit_44khz
...
## Objective
To validate that the DUT can successfully decode a WAV audio file encoded at 24-bit, 44 kHz using the WebAudio API. This test confirms that the codec is decoded correctly and the expected metadata is reported accurately, ensuring WAV 24-bit codec support meets certification requirements.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_15 tab and verify codec info | Navigate to the TC_WEBAUDIO_MANUAL_15 tab using the Tab key and press Enter. | The TC_WEBAUDIO_MANUAL_15 HTML page should load correctly, displaying the decoded audio codec information. Expected output: Audio Codec Information: Sample Rate: 44100 Hz, Channels: 1, Duration: 1 seconds|
