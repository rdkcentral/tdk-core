...
| 2 | Navigate to PlayReady section and initiate playback | Navigate to the section in the MVT App where the PlayReady encrypted asset is present and initiate playback of the asset. | The PlayReady encrypted asset should play with proper audio and video without any artifacts or errors.|
