...
| 4 |  Ensure mobile hotspot available  | Ensure a mobile hotspot is available for connection prior to the test. | The mobile hotspot should be active and visible in the Wi-Fi network list.|
