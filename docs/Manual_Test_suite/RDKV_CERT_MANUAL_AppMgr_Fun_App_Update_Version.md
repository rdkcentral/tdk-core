...
| 3 | Select Update button if active | If Update button is in active state select and  press Enter/OK on the remote | A buffering/loading indicator should be displayed on the app tile during updating to the latest version and a green tick should be displayed for 2-3 seconds on the app tile after successful update.|
