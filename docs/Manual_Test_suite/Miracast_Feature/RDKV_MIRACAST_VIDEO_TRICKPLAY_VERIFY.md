...
| 6 | Play video content and verify mirroring on DUT | Play any video content (e.g., from YouTube) on the mobile device. | The video should play on the DUT display as well. |
| 7 | Perform trick-play operations and verify on DUT | Perform the following trick-play operations on the mobile device: Play, Pause, Rewind, Fast-Forward, and Seek. | All trick-play operations performed on the mobile device should be accurately reflected on the DUT display. |
