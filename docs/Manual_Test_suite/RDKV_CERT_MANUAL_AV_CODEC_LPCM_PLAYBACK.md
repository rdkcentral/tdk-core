...
RDKV_MANUAL_AV_10
## TestCase Name
RDKV_CERT_MANUAL_AV_CODEC_LPCM_PLAYBACK
...
## Objective
To validate that LPCM audio stream playback is functional on the DUT.
...
| 2 | Navigate to LPCM section and initiate playback | Navigate to the section in the MVT App where the LPCM asset is present and initiate playback of the asset. | The LPCM audio asset should play without any distortion or errors. |
