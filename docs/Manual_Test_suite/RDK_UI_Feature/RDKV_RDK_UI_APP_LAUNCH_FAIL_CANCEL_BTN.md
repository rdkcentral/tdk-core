...
## Objective
To validate that when an app launch fails due to a network issue, an appropriate error overlay is displayed, and the overlay can be dismissed using the Cancel button on the top left corner.
