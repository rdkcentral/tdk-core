...
## Objective
To validate that selecting an uninstalled app tile from the Recommended Apps row initiates the app download and installation, and that the newly installed app appears in the My Apps row.
