...
## Objective
To validate that after all apps have been uninstalled, any app can be reinstalled and launched successfully from the My Apps section, More Apps page, and App Info page.
