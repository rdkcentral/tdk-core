...
| 3 | Verify Amazon Prime app on home screen | Validate that the Amazon Prime App is available in the My Apps section/row of the RDK UI Homepage. If not present, install the Amazon Prime App from the Recommended Apps row. | The Amazon Prime App should be available and ready to launch from the RDK UI Homepage. |
...
|#|Step Name | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Launch Amazon Prime app | Select the Amazon Prime App tile from the My Apps/Recommended Apps section/row of the RDK UI Homepage and press the Enter/OK button on the remote. | The Amazon Prime App should be launched successfully (either cold launch or hot launch based on the app's previous state). |
...
| 5 | Exit Amazon Prime app | Close/Exit the Amazon Prime App by pressing the Back key on the remote. | The Amazon Prime App should be terminated gracefully and the RDK UI Homepage should be visible on the TV. |
