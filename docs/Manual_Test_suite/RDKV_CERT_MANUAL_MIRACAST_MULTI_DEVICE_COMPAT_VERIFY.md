...
| 4 | Connect mobile device to Wi-Fi SSID | Connect the mobile device to a Wi-Fi SSID prior to the test. | The mobile device should be connected to a Wi-Fi SSID with a valid IP address assigned. |
...
| 6 | Repeat steps with other devices/conditions | Repeat Steps 1–5 with other mobile devices (Android and iOS). | Miracast screen casting should establish successfully with each different mobile device. The results for Steps 1–5 should be consistent across all tested device types. |
