...
|#|Step Name | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Press on uninstalled app tile | In Recommended Apps, press on an app tile which is not yet installed | It should start downloading the app and a buffering/loading icon should be displayed on the app tile|
...
| 4 | Press on uninstalled app tile | In Recommended Apps, press on an app tile which is not yet installed | It should start downloading the app and a buffering/loading icon should be displayed on the app tile|
