...
| 5 | Exit Amazon Prime Video application | Exit the Amazon Prime Video application by pressing the Back key on the Bluetooth remote. | The Amazon Prime Video application should terminate gracefully and the RDK UI Home screen should be visible on the TV/display.|
