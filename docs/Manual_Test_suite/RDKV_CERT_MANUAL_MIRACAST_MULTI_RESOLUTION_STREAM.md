...
## Objective
To validate that the DUT can stream Miracast content correctly at different video resolutions (720p, 1080p, 4K).
...
| 6 | Play video at different resolutions | Play video content on the mobile device at different resolutions (e.g., 720p, 1080p, 4K). | The video should stream correctly on the DUT at each resolution without errors or quality degradation. |
