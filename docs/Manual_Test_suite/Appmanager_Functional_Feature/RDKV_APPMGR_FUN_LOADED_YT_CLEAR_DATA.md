## TestCase ID
RDKV_MANUAL_APPMGR_FUNCTIONAL_01
## TestCase Name
RDKV_CERT_MANUAL_APPMGR_FUN_LOADED_YT_CLEAR_DATA
...
## Objective
To validate that the user account login for the YouTube application is cleared when the clearAppData API is called while the application is in a loaded state.
