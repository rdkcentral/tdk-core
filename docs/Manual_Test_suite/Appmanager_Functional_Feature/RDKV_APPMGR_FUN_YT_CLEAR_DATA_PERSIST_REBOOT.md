## TestCase ID
RDKV_MANUAL_APPMGR_FUNCTIONAL_03
## TestCase Name
RDKV_CERT_MANUAL_APPMGR_FUN_YT_CLEAR_DATA_PERSIST_REBOOT
...
## Objective
To validate that after a clearAppData operation on the YouTube application, the logged-out state persists across a DUT power cycle and that the application remains functional.
...
|#|Step Name | Step Description| Expected Result|
|-|---------|-----------------|----------------|
| 1 | Select youtube app tile from the | Select YouTube App tile from the My Apps/Recommended Apps section/row of RDK UI Homepage and press enter/Ok button on remote | YouTube App should be launched succesfully  (Either cold launch /hot launch based on the app's previous state) |
...
| 4 | Relaunch YouTube app after data clear | Launch Youtube App again from the My Apps/Recommended Apps section/row of RDK UI Homepage and press enter/Ok button on remote | YouTube App should be launched succesfully (cold launch) |
...
| 8 | Relaunch YouTube app after data clear | Launch Youtube App again from the My Apps/Recommended Apps section/row of RDK UI Homepage and press enter/Ok button on remote | YouTube App should be launched succesfully (cold launch mostly beacuse after reboot ) |
