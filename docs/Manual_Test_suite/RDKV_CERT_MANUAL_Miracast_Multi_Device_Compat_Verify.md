...
| 5 | Connect smartphone to Wi-Fi SSID | Connect the smartphone to a Wi-Fi SSID prior to the test. | The smartphone should be connected to a Wi-Fi SSID with a valid IP address assigned.|
