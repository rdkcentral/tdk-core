...
| 3 | Exit the error overlay by pressing | Exit the error overlay by pressing the cancel button on top left of the overlay | The overlay should exit and return the user to previous screen|
...
| 8 | Exit the error overlay by pressing | Exit the error overlay by pressing the cancel button on top left of the overlay | The overlay should exit and return the user to previous screen|
