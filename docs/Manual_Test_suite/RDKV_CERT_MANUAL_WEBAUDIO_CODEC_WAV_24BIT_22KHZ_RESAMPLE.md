## TestCase ID
RDKV_MANUAL_WEBAUDIO_14
## TestCase Name
RDKV_CERT_MANUAL_WEBAUDIO_CODEC_WAV_24BIT_22KHZ_RESAMPLE
...
## Objective
To validate that the DUT can successfully decode a WAV audio file (24-bit, 22 kHz with resampling) using the WebAudio API and report the correct codec metadata.
...
| 2 | Navigate to TC_WEBAUDIO_MANUAL_14 tab and verify codec info | Navigate to the TC_WEBAUDIO_MANUAL_14 tab using the Tab key and press Enter. | The TC_WEBAUDIO_MANUAL_14 HTML page should load correctly, displaying the decoded audio codec information. Expected output: Audio Codec Information: Sample Rate: 44100 Hz, Channels: 1, Duration: 0.3689795918367347 seconds |
