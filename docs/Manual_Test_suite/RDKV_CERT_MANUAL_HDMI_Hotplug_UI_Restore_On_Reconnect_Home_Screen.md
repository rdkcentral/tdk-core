...
## Objective
To validate that the RDK UI Home screen is correctly restored on the display after an HDMI cable reconnect. This test confirms that the Home screen is restored automatically without manual intervention upon HDMI reconnection, ensuring HDMI hotplug display recovery meets certification requirements.
