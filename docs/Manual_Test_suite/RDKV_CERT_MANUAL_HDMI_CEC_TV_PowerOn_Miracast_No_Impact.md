...
| 2 | Search for Miracast devices from mobile | Search for available Miracast-enabled devices from the smartphone. | The DUT (with Miracast enabled) should appear in the list of discoverable devices on the smartphone.|
| 3 | Select DUT from discovered devices list | Select the DUT from the discovered devices list on the smartphone. | The DUT should be selected for Miracast connection.|
...
| 5 | Initiate screen mirroring from mobile | Initiate screen mirroring from the smartphone. | The smartphone screen should be mirrored and visible on the DUT via the connected TV/display.|
