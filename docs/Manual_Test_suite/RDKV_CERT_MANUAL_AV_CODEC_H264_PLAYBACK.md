...
## Objective
To validate that H.264 stream playback is functional on the DUT.
...
| 2 | Navigate to H.264 section and initiate playback | Navigate to the section in the MVT App where the H.264 asset is present and initiate playback of the asset. | The H.264 asset should play with proper audio and video without any artifacts or errors. |
