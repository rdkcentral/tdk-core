...
| 2 | Relaunch YouTube app after data clear | Launch YouTube App again from the My Apps/Recommended Apps section/row of RDK UI Homepage and press enter/Ok button on remote | YouTube App should be launched successfully (cold launch)|
...
| 6 | Relaunch YouTube app after data clear | Launch YouTube App again from the My Apps/Recommended Apps section/row of RDK UI Homepage and press enter/Ok button on remote | YouTube App should be launched successfully (cold launch)|
| 7 | Validate that the "sign in" option is visible | Validate that the "Sign in" option is prominently visible in the sidebar or account menu, indicating no account is currently linked | "Sign in" option should be visible in the sidebar or account menu of YouTube App and no account should be linked|
