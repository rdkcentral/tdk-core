...
## Objective
Validate seamless stream switching from VP9/OPUS WebM to H.264/AAC DASH. The test pauses playback, switches to the new stream, and resumes playback to verify smooth transition without interruption. Confirm playback position advances correctly and rendering quality remains consistent across streams.
