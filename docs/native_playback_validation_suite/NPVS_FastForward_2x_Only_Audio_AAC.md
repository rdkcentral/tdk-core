...
## TestCase Name
NPVS_FastForward_2x_Only_Audio_AAC
## Table of Contents
...
## Objective
Validate fast-forward playback at 2.0x rate via  on supported stream. Verify playback rate acceleration through  to retrieve current playback rate and compare against requested 2.0x rate. Test confirms position advancement at double-speed and pipeline stability during accelerated playback.
