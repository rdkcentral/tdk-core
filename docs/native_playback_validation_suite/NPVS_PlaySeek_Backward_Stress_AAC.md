...
## Objective
Validate backward seek operation under stress conditions on AAC audio streams. The test performs multiple sequential backward seek operations and verifies accurate positioning, seamless playback recovery, audio rendering consistency, and error-free operation under repeated seek load.
