...
## Objective
Validate forward seek operation on H.264 DASH streams. The test verifies accurate positioning to the target seek point within ±1 second tolerance, seamless playback recovery after seek completion, frame rendering without interruption, and error-free playback.
