...
| 3 | Construct H.264 Pipeline with Resolution Stream | Create `playbin` element; Configure `uri` to video_src_url_dash (DASH); Set `westerossink` as video sink; Trigger state  | Verify playbin reaches , DASH parsed successfully |
