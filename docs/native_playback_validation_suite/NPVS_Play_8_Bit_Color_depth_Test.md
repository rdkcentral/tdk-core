...
| 2 | Configure Test with Bit Depth Parameter | Retrieve `NATIVE_PLAYBACK_MEDIAPLAYBACK_TIMEOUT`, and bit depth target (8); Execute `mediapipelinetests test_color_depth <URL> bit_depth=8 timeout=<seconds>` | Verify mediapipelinetests initializes with 8-bit parameter |
