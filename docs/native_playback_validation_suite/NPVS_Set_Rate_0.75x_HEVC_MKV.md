...
## Objective
Validate playback rate control at 0.75x speed (three-quarter normal) with HEVC in MKV container. The test sets rate to 0.75 and verifies position advances at exactly three-quarter the normal speed. Confirm MKV container parsing, audio/video synchronization, and frame rendering consistency during rate changes.
