...
## Objective
Test validates duration metadata accuracy for H.264 video content in MOV container format. Verifies that duration query accurately reports media duration matching the 9-second baseline, confirming proper parsing and duration extraction for MOV-contained H.264 streams.
