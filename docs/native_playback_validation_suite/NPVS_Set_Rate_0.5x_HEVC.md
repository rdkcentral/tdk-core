...
## Objective
Validate playback rate control at 0.5x speed (half normal) with HEVC H.265 codec. The test sets rate to 0.5 and verifies position advances at exactly half the normal speed. Confirm audio/video remain synchronized during rate changes and frame rendering continues without discontinuities.
