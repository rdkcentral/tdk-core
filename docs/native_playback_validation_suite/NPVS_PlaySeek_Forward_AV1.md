...
## Objective
Validate forward seek operation on AV1 DASH streams. The test verifies accurate positioning to the target seek point within ±1 second tolerance, seamless playback recovery after seek, frame rendering without interruption, and error-free playback.
