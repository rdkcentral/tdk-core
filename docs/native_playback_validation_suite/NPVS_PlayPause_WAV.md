...
-audio` property via `g_object_get()` to verify PCM stream present; Log stream properties | Verify video dimensions valid; Verify n-audio >= 1 confirming PCM stream detected |
