...
## Objective
Validate playback rate control at 0.5x speed (half normal) with H.264 24fps baseline. The test sets rate to 0.5 and verifies position advances at exactly half the normal speed. Confirm audio/video synchronization and frame rendering consistency at 24fps framerate during rate changes.
