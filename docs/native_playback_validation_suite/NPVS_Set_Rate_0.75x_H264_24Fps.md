...
## TestCase Name
NPVS_Set_Rate_0.75x_H264_24Fps
...
## Objective
Validate playback rate control at 0.75x speed (three-quarter normal) with H.264 24fps baseline. The test sets rate to 0.75 and verifies position advances at exactly three-quarter the normal speed. Confirm audio/video synchronization and frame rendering consistency at 24fps framerate during rate changes.
