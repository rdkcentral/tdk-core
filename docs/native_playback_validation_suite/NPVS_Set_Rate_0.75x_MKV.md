...
## Objective
Validate playback rate control at 0.75x speed (three-quarter normal) with 4K video in MKV container. The test sets rate to 0.75 and verifies position advances at exactly three-quarter the normal speed. Confirm MKV demuxer handles 4K resolution, audio/video synchronization, and frame rendering continue without discontinuities during rate changes.
