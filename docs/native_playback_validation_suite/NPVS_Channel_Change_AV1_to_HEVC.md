...
## Objective
Validate seamless video codec switching from AV1 to HEVC. The test pauses playback, switches to the new codec stream, and resumes playback to verify smooth transition without interruption. Confirm playback position advances correctly and video quality remains consistent across streams.
