...
## Objective
Validate backward seek operation under stress conditions on H.264 streams. The test performs multiple sequential backward seek operations and verifies accurate positioning, seamless playback recovery, frame rendering consistency, and error-free operation under repeated seek load.
