...
## Objective
Validate playback rate control at 0.75x speed (three-quarter normal) with H.264 codec. The test sets rate to 0.75 and verifies position advances at exactly three-quarter the normal speed. Confirm audio/video remain synchronized during rate changes and frame rendering continues without discontinuities.
