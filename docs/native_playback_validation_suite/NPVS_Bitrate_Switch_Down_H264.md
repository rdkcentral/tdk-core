...
## Objective
Validate adaptive bitrate downgrade on H.264 DASH streams. The test progressively lowers bitrate and resolution from highest to lowest available tiers. Verify each bitrate switch happens seamlessly without pipeline interruption, audio/video synchronization loss, or decoding errors. Confirm video resolution adapts correctly during downgrade progression.
