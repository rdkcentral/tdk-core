...
## Objective
Validate seamless resolution switching from SD (360p) to HD (1080p). The test pauses playback, switches to higher resolution, and resumes playback to verify smooth transition without interruption. Confirm playback position advances correctly and rendering quality remains consistent across different resolutions.
