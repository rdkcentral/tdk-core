...
## Objective
Validate playback rate control at 0.75x speed (three-quarter normal) with VP9 HDR content. The test sets rate to 0.75 and verifies position advances at exactly three-quarter the normal speed. Confirm WebM container parsing, HDR metadata preservation, and audio/video synchronization during rate changes without discontinuities.
