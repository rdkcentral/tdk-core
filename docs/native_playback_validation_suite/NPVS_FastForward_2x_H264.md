...
## Objective
Validate fast-forward playback at 2.0x rate. The test verifies playback rate acceleration, position advancement at double-speed, and pipeline stability during accelerated playback without stalls or errors.
