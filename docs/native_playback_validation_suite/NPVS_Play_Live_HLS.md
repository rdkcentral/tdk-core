...
| 3 | Construct Live H.264 Pipeline | Create `playbin` element; Configure `uri` to video_src_url_hls (live HLS manifest); Set `westerossink` as video sink;  | Verify playbin reaches , manifest fetched |
