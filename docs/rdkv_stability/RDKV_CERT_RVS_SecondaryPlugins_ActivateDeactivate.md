...
RDKV_STABILITY_21
## TestCase Name
RDKV_CERT_RVS_SecondaryPlugins_ActivateDeactivate
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To validate device stability by repeatedly activating and deactivating secondary plugins (org.rdk.AVInput, org.rdk.HdcpProfile, org.rdk.Timer, org.rdk.Warehouse, org.rdk.UserPreferences, HtmlApp, LightningApp, Messenger, org.rdk.LoggingPreferences) for activate_deactivate_max_count iterations, verifying CPU and memory usage remains within expected limits.
...
|2|Secondary plugins (org.rdk.AVInput, org.rdk.HdcpProfile, org.rdk.Timer, org.rdk.Warehouse, org.rdk.UserPreferences, HtmlApp, LightningApp, Messenger, org.rdk.LoggingPreferences) must be available in the SUPPORTED_PLUGINS list.|
