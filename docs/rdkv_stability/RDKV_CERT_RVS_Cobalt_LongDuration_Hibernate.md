...
| 7 | Validate resource usage | Validate CPU load and memory usage via applicable API calls. | CPU load and memory usage should be within expected limits after long-duration hibernate. |
