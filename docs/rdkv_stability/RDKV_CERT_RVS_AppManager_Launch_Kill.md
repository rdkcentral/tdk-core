...
| 5 | Configure launch_kill_count in StabilityTestVariables | `launch_kill_count` must be set to the desired number of launch/kill cycle iterations in StabilityTestVariables (default: 100). | The launch_kill_count variable should be configured with a valid integer value. |
