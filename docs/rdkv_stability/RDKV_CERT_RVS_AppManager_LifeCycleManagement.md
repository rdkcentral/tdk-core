...
| 7 | Uninstall application (Per Iteration) | After a 30-second wait following termination, uninstall the application using the AppPackageManager uninstall API. <br>`{"jsonrpc": "2.0", "id": 1234567890, "method": "org.rdk.AppPackageManager.uninstall", "params": {"packageId": "com.rdkcentral.google"}}` | The application should be uninstalled successfully. |
