...
RDKV_STABILITY_20
## TestCase Name
RDKV_CERT_RVS_PrimaryPlugins_ActivateDeactivate
<a name="head.TOC"></a>
## Table Of Contents
...
## Objective
To validate device stability by repeatedly activating and deactivating primary plugins (org.rdk.System and FirmwareControl) for activate_deactivate_max_count iterations, verifying CPU and memory usage remains within expected limits.
...
|2|org.rdk.System and FirmwareControl plugins must be available in the SUPPORTED_PLUGINS list in the device config.|
