...
| 6 | Set video URL and validate playback | Set video URL via deeplink: `{"jsonrpc":"2.0","id":1234567890,"method":"Cobalt.1.deeplink","params":{"url":"<cobalt_test_url>"}}` Validate video is playing via `rdkservice_validateProcEntry`. | Video should play successfully after restoring from long-duration hibernate. |
