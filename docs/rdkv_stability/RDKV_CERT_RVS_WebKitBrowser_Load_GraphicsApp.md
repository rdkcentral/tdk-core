...
| 5 | Configure animation_app_download_url in MediaValidationVariables | `animation_app_download_url` must be set to the full download URL of the graphics application bundle in MediaValidationVariables (e.g., `com.rdkcentral.animation-app+0.1.0.bolt`). | The app download URL should be configured and the bundle should be reachable. |
