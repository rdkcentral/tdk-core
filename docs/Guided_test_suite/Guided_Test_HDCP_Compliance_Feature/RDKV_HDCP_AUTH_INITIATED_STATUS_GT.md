...
## TestCase Name
RDKV_HDCP_AUTH_INITIATED_STATUS_GT
...
## Objective
To validate that HDCP authentication is correctly initiated after an HDMI hotplug operation and that the expected authentication log entries are present in the device logs.
