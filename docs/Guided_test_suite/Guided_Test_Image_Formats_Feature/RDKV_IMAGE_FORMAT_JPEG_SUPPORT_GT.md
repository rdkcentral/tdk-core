## TestCase ID
TC_IMAGEFORMATS_MANUAL_02
## TestCase Name
RDKV_IMAGE_FORMAT_JPEG_SUPPORT_GT
...
## Objective
To validate that the JPEG image format is correctly loaded and rendered by the Browser Test application on the DUT.
