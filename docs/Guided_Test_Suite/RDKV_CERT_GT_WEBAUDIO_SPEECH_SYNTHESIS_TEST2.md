...
## Objective
To validate that the Webaudio_manual App supports speech synthesis with supported audio languages, and that activating the [speak] button in the second speech synthesis test produces audible text-to-speech audio output on the DUT.
