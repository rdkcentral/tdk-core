...
## Objective
To validate that the DUT reports consistent HDCP 2.2 version information, covering supported, received, and current version parameters, during active AV playback. This test confirms that HDCP 2.2 version negotiation between the DUT and the connected HDMI display is functioning correctly.
