...
## Objective
To validate that the Webaudio_manual App can decode a Vorbis audio file encoded at VBR-70kbps-44kHz and display the decoded audio codec information on an inner HTML page.
