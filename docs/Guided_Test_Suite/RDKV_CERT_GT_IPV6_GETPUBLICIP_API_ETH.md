...
TC_IPV6_MANUAL_08
## TestCase Name
RDKV_IPV6_GETPUBLICIP_API_ETH_GT
...
## Objective
To validate the behavior of the GetPublicIP API response when called with an explicit Ethernet interface parameter while the DUT is connected to an IPv6-supported SSID with Ethernet connected.
