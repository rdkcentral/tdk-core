...
## Objective
To validate that the Webaudio_manual App can launch the first speech synthesis test, navigate to and activate the [speak] button, and produce audible text-to-speech audio output on the DUT.
