...
## Objective
To validate that the Webaudio_manual App can decode a WAV audio file encoded at 24-bit depth with 22kHz resampling and display the decoded audio codec information on an inner HTML page.
