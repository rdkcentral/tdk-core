...
## Objective
To validate that the Webaudio_manual App can decode an MP3 audio file encoded at 128kbps-44kHz and display the decoded audio codec information on an inner HTML page.
