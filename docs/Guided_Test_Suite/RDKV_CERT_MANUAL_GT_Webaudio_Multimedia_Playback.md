...
## Objective
To validate that the DUT's WebKit browser and Web Audio API implementation can concurrently handle multiple active media streams — video, audio, and speech synthesis — initiated simultaneously through the Webaudio_manual application. This test confirms that concurrent multimedia playback does not cause conflict or failure, ensuring the DUT meets Web Audio API multi-stream certification requirements.
...
| 2 | Navigate to multimedia playback test and activate all media buttons | The script sets focus on the Webaudio_manual App via `org.rdk.RDKWindowManager.setFocus`, then sends the following key sequence via `org.rdk.RDKWindowManager.generateKey` to navigate and click each multimedia button:<br>— Press the **Tab** key **8 times** to navigate to the multimedia playback test case, then press the **Enter** key **once** to select it<br>— Press the **Tab** key **1 more time** to navigate to the **[start Video]** button, then press the **Enter** key **once** to activate it<br>— Press the **Tab** key **8 more times** to navigate to the next multimedia control section, then press the **Enter** key **once** to proceed<br>— Press the **Tab** key **1 more time** to navigate to the **[Play audio]** and **[Start speech synthesis]** buttons, then press the **Enter** key **once** to activate them | The app should navigate to the multimedia playback test case and all three multimedia buttons — [start Video], [Play audio], and [Start speech synthesis] — should be activated successfully. |
