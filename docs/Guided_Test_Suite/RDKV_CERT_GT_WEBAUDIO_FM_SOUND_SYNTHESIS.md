...
## Objective
To validate that the Webaudio_manual App can generate an FM synthesized sound using the WebAudio API, and that pressing the [start synthesis] button produces an audible buzzer/warning sound on the DUT.
