...
## Objective
To validate that the Webaudio_manual App can continuously synthesize speech in three different audio languages by activating the [speak with Random Voices] button, and that the random voice audio output is audible on the DUT.
