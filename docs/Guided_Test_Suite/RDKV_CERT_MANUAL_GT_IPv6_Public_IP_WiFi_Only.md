## TestCase ID
RDKV_MANUAL_GT_IPV6_03
## TestCase Name
RDKV_CERT_MANUAL_GT_IPv6_Public_IP_WiFi_Only
...
## Objective
To validate that the DUT correctly retrieves and reports a valid public IPv6 address for the WiFi interface via the NetworkManager IP settings API when Ethernet is disconnected. This test confirms the DUT's WiFi interface is correctly assigned and reporting a valid public IPv6 address in a WiFi-only network environment.
