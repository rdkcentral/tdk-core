...
## Objective
To validate that the Webaudio_manual App can initiate audio playback via the WebAudio API, and that pressing the [play] button produces an audible alarm sound on the DUT.
