...
export class RdkVersionsService {
    ...
    createRdkVersion(data: any): Observable<any> {
        ...
        return this.http.post(`${apiUrl}api/v1/rdkversion/create`, data, { headers, responseType: 'text' })
      }
      ...
      getRdkVersionByList(category: any): Observable<any> {
        ...
        return this.http.get(`${apiUrl}api/v1/rdkversion/findallbycategory?category=${category}`, { headers, responseType: 'text' });
      }
      ...
      updateRdkVersion(data: any): Observable<any> {
        ...
        return this.http.put(`${apiUrl}api/v1/rdkversion/update`, data, { headers,  responseType: 'text'})
      }
      ...
      deleteRdkVersion(id: any): Observable<any>{
        ...
        return this.http.delete(`${apiUrl}api/v1/rdkversion/delete/${id}`, { headers, responseType: 'text' });
      }
}