...
export class SocVendorService {
  ...
  getSocVendor(category: any): Observable<any> {
  ...
  createSocVendor(data: any): Observable<any> {
    ...
    return this.http.post(`${apiUrl}api/v1/socvendor/create`, data, { headers, responseType: 'text' })
  }
  ...
  updateSocVendor(id: any, data: any): Observable<any> {
    ...
    return this.http.put(`${apiUrl}api/v1/socvendor/update/${id}`, data, { headers })
  }

  deleteSocVendor(id: any): Observable<any> {
    const headers = new HttpHeaders({
      'Authorization': this.authService.getApiToken()
    });
    return this.http.delete(`${apiUrl}api/v1/socvendor/delete/${id}`, { headers, responseType: 'text' });
  }
