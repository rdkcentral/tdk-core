...
@Component({
  selector: 'app-list-box-manufacturer',
  standalone: true,
  imports: [FooterComponent, RouterLink, CommonModule, ReactiveFormsModule, AgGridAngular, HttpClientModule],
  templateUrl: './list-box-manufacturer.component.html',
  styleUrl: './list-box-manufacturer.component.css'
})

/**
 * Component for listing box manufacturers.
 */
export class ListBoxManufacturerComponent {
  ...
  */
  ngOnInit(): void {
    this.service.getboxManufactureByList(this.authservice.selectedConfigVal).subscribe(res => {
   ...
   */
  createBoxManufacturer() {
    this.router.navigate(['/configure/create-boxManufacturer']);
  }
