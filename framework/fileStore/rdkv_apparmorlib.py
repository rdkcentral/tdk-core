...
#----------------------------------------------------------------------
def rdkvapparmor_getDeviceConfig (basePath, configKey):
    deviceConfigFile=""
    configValue = ""
    output = ""
...
#-------------------------------------------------------------------
def rdkvapparmor_executeInDUT (sshMethod, credentials, command):
    output = ""
...
# REBOOT THE DEVICE
#------------------------------------------------------------------
def rdkvapparmor_rebootDevice(waitTime):
...
# Check Device Status
#------------------------------------------------------------------
def rdkvapparmor_getTestDeviceStatus():
    try:
...
# GET PLUGIN STATUS
#-----------------------------------------------------------------
def rdkvapparmor_getPluginStatus(plugin):
...
#------------------------------------------------------------------
def rdkvapparmor_setValue(method,value):
