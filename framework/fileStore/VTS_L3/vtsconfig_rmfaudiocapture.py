...
BASE_PATH = os.getcwd() + "/rdk-halif-test-rmf_audio_capture"

#========== REPO DETAILS ========================

REPO_URL = "https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture.git"
REPO_DIR = "rdk-halif-test-rmf_audio_capture"
CHECKOUT_VER = "1.5.4"

#========== PROFILE PATH =========================
PROFILE_PATH = "../../../profiles/rmfAudioCaptureAuxNotSupported.yaml"
...
# Test Directories
TARGET_DIR = os.path.join(BASE_PATH, "host", "tests", "rmfAudio_L3_TestCases")
