...
# Test Directories
TARGET_DIR = os.path.join(BASE_PATH, "host", "tests", "L3_TestCases", "dsDisplay")
...
# Path to the dsDisplay YAML to be updated in place
MONITOR_YAML_PATH = os.path.join(TARGET_DIR, "dsDisplay_test_MonitorDetails.yml")
...
TEST_SCRIPT = [
    ...
    "dsDisplay_test04_TestVerifyDisplayEdidBytes.py",
