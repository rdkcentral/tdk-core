...
import VideoPlayerApp from './VideoPlayerApp.js'
import UVEAAMPPlayerApp from './UVEAAMPPlayerApp.js'
import SHAKAPlayerApp from './SHAKAPlayerApp.js'
...
(async function getValueFromPersistentStore() {
  try {
    ...
    if (current === url) {
      console.log('[GetValuePS] The current lightning URL matches the URL obtained from PersistentStore')
      return
    }

    console.log('[GetValuePS] Loading the formatted lightning URL fetched from PersistentStore: ' + url)
