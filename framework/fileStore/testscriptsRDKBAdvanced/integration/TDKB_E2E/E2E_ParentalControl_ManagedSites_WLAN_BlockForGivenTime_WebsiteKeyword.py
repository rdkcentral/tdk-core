...
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_WLAN_BlockForGivenTime_WebsiteKeyword')
            ...
            if status == "SUCCESS":
                ...
                if expectedresult in actualresult:
                    ...
                    if int(instance) > 0:
                        ...
                        #Set a blocking url by giving a keyword
                        ...
                        step = step + 1
                        print(f"\nTEST STEP {step}: Set all fields of new rule added")
                        print(f"EXPECTED RESULT {step}: Should set all fields of new rule added")
                        ...
                        if expectedresult in actualresult:
                            ...
                            step = step + 1
                            print(f"\nTEST STEP {step}: Get the current value of all fields of new rule")
                            print(f"EXPECTED RESULT {step}: Should retrieve the current values of all fields of new rule")
                                    ...
                                    if wlanIP:
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step = step + 1
                                                print(f"\nTEST STEP {step}: Add static route to reach blocked URL from WLAN client")
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    step = step + 1
                                                    print(f"\nTEST STEP {step}: Check the HTTP connectivity from WLAN to blocked URL keyword")
                                                    print(f"EXPECTED RESULT {step}: HTTP connection should be blocked during configured time")
                                                    status = parentalCntrlWgetToWAN("WGET_HTTP", wlanIP, curIPAddress, tdkbE2EUtility.website_url)

                                                    if expectedresult not in status:
                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                        finalStatus = "SUCCESS"
                                                        print(f"ACTUAL RESULT {step}: HTTP connection from WLAN to the URL keyword is blocked")
                                                        print("[TEST EXECUTION RESULT] : SUCCESS")
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
                                                        print(f"ACTUAL RESULT {step}: HTTP connection from WLAN to the URL keyword is success")
                                                        print("[TEST EXECUTION RESULT] : FAILURE")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE")
