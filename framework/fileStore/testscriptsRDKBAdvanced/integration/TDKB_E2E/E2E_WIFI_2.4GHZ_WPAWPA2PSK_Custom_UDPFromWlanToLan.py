...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_WPAWPA2PSK_Custom_UDPFromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that UDP Traffic should be successfull with destination as wired client and source as wireless client  where client association in wpawpa2-psk security wlan on 2.4ghz band with firewall set to custom.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_432</test_case_id>
    <test_objective>Verify that UDP Traffic should be successfull with destination as wired client and source as wireless client  where client association in wpawpa2-psk security wlan on 2.4ghz band with firewall set to custom.</test_objective>
...
5. From the wlan client, do UDP to the LAN client and check whether  UDP is success when the security mode for 2.4GHz is set to WPAWPA2PSK
...
8.Unload tdkb_e2e module</automation_approch>
    <except_output>UDP should be success between wired and wireless clients when firewall is Custom and Security mode to WPAWPA2PSK</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_WPAWPA2PSK_Custom_UDPFromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPAWPA2PSK_Custom_UDPFromWlanToLan');
