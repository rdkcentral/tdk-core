...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>E2E_WIFI_2.4GHZ_802.11n_OperatingStandard</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that only 802.11n clients should be able to connect to WG when mode is n for frequency band 2.4GHZ</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_05</test_case_id>
    <test_objective>Verify that only 802.11n clients should be able to connect to WG when mode is n for frequency band 2.4GHZ</test_objective>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_802.11n_OperatingStandard');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'n'];
