...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_WPAWPA2PSK_HttpToRouterPrivateIP</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that http connection from 5G WLAN client to router's private ip is success  with security mode WPA-WPA2-PSK</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_549</test_case_id>
    <test_objective>Verify that http connection from 5G WLAN client to router's private ip is success  with security mode WPA-WPA2-PSK</test_objective>
...
3.Connect the WiFi client to the 5G SSID  of gateway with security mode WPA-WPA2-PSK
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPAWPA2PSK_HttpToRouterPrivateIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPAWPA2PSK_HttpToRouterPrivateIP');
