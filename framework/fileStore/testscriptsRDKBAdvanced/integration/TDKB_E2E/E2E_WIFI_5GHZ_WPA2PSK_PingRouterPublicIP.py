...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_WPA2PSK_PingRouterPublicIP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that ping from 5G WLAN client to router's public ip is success with security mode WPA2-PSK</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_534</test_case_id>
    <test_objective>Verify that ping from 5G WLAN client to router's public ip is success</test_objective>
...
5. From WLAN client check if ping to gateway's public ip is success or not
6. Disconnect the WiFi client
7.Unload tdkb_e2e module</automation_approch>
    <expected_output>ping from 5G WLAN client to router's public ip is success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_PingRouterPublicIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPA2PSK_PingRouterPublicIP');
