...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilteringModeAllow2.4GHZ_WithInvalidMACFilterEntry')
obj1.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilteringModeAllow2.4GHZ_WithInvalidMACFilterEntry')
obj2.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilteringModeAllow2.4GHZ_WithInvalidMACFilterEntry')
