...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_OpenSecurity_SSIDDisabled')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_OpenSecurity_SSIDDisabled')
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        if "SUCCESS" not in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step}: Telnet traffic not successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                            ...
                                                            tdkTestObj.setResultStatus("FAILURE")
                                                            print(f"ACTUAL RESULT {step}: Telnet traffic successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
