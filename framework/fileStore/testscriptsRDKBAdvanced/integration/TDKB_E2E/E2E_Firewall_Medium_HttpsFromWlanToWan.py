...
<xml>
  ...
  <name>E2E_Firewall_Medium_HttpsFromWlanToWan</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_78</test_case_id>
    <test_objective>Verify that when Firewall Config is set to Medium HTTPs traffic from WLAN to WAN should pass through</test_objective>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Firewall_Medium_HttpsFromWlanToWan');
