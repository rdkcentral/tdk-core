...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterAllow2.4GHZ_Block5GHZ_WIFIClient')
obj1.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterAllow2.4GHZ_Block5GHZ_WIFIClient')
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                macAddress = tdkbE2EUtility.getWlanMACAddress_SSH(tdkbE2EUtility.wlan_2ghz_interface)
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in actualresult and bssid1 and (re.match("^[0-9a-f]{2}([-:])[0-9a-f]{2}(\\1[0-9a-f]{2}){4}$", bssid1.lower()) is not None):
                                        ...
                                        if expectedresult in actualresult and bssid2 and (re.match("^[0-9a-f]{2}([-:])[0-9a-f]{2}(\\1[0-9a-f]{2}){4}$", bssid2.lower()) is not None):
                                            ...
                                            securityMode2 = "Device.WiFi.AccessPoint.%s.Security.ModeEnabled" %tdkbE2EUtility.ssid_2ghz_index
                                            ...
                                            paramList=[ssidName2,keyPassPhrase2,radioEnable2,ssidName5,keyPassPhrase5,radioEnable5]
                                            step+=1
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step+=1
                                                print(f"\nTEST STEP {step}: Set the ssid,keypassphrase,Radio enable status.")
                                                ...
                                                if expectedresult in actualresult and expectedresult in actualresult1:
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        if expectedresult in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step} : Connection from client succeed via 2.4Ghz as expected  : {status}.")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                            step+=1
                                                        ...
                                                        if expectedresult not in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step} : Connection attempt failed via 5Ghz as expected  : {status}.")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                        else:
                                                            tdkTestObj.setResultStatus("FAILURE")
                                                            print(f"ACTUAL RESULT {step} : Connection with client is success via 5Ghz which is not expected  : {status}.")
                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                            channel5 = 0
                                                            channel = tdkbE2EUtility.getChannelNumberBssid()
                                                            if channel !="":
                                                ...
                                                list4 = [ssidName5,orgValue[3],'string']
                                                list5 = [keyPassPhrase5,orgValue[4],'string']
                                                list6 = [radioEnable5,orgValue[5],'bool']
