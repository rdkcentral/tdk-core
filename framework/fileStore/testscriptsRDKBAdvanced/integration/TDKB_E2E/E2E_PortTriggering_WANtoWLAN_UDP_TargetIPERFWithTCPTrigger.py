...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_UDP_TargetIPERFWithTCPTrigger</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_577</test_case_id>
...
12. Send an outbound packet to trigger the port 12345 with a TCP packet which is not the trigger protocol configured in the rule
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_UDP_TargetIPERFWithTCPTrigger</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetIPERFWithTCPTrigger');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetIPERFWithTCPTrigger');
