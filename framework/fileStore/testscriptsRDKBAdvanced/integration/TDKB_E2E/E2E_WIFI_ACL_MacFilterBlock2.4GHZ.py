...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterBlock2.4GHZ')
obj1.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterBlock2.4GHZ')
obj2.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterBlock2.4GHZ')
    ...
    if expectedresult in status:
        ...
        if "SUCCESS" in preRequisiteStatus:
            ...
            if macAddress and (re.match("^[0-9a-f]{2}([-:])[0-9a-f]{2}(\\1[0-9a-f]{2}){4}$", macAddress.lower()) is not None):
                ...
                step+=1
                print(f"\nTEST STEP {step}: Set Mac FilterAsBlacklist of 2.4Ghz to true.")
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in actualresult  and mode == "Deny" :
                        ...
                        # Adding a new MACFilter rule for 2.4GHz
                        step+=1
                                        ...
                                        if expectedresult in actualresult:
                                            ...
                                            if expectedresult in status and setValuesList == newValues:
                                                ...
                                                if expectedresult not in status:
                                                    ...
                                                    print(f"ACTUAL RESULT {step}: Connection from client is success via 2.4Ghz which is not expected.")
                    ...
                    #Reverting FilterAsBlacklist of 2.4GHz to false
                    step+=1
                    ...
                    if expectedresult in actualresult:
                        tdkTestObj.setResultStatus("SUCCESS")
                        print(f"ACTUAL RESULT {step}: Revert Mac FilterAsBlacklist of 2.4Ghz to false successfully.")
                        print("[TEST EXECUTION RESULT] : SUCCESS")
                    else:
                        tdkTestObj.setResultStatus("FAILURE")
