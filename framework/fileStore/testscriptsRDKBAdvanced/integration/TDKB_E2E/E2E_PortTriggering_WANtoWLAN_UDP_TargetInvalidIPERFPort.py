...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_UDP_TargetInvalidIPERFPort</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_649</test_case_id>
...
8. To the added instance, configure the rule: Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - UDP, Target Protocol - UDP, Description - MyPTRule
...
12. Send an outbound packet to trigger the port 12345 with UDP packet
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_UDP_TargetInvalidIPERFPort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetInvalidIPERFPort');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetInvalidIPERFPort');
