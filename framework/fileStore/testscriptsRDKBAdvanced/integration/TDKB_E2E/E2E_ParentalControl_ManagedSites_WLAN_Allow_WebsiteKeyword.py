...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_WLAN_Allow_WebsiteKeyword')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_WLAN_Allow_WebsiteKeyword')
