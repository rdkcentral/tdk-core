...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedSites_LAN_Block_WebsiteKeyword</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG supports blocking of websites using keyword (google) through Parental control (managed sites)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_392</test_case_id>
    <test_objective>Verify that WG supports blocking of websites using keyword (google) through Parental control (managed sites)</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedSites_LAN_Block_WebsiteKeyword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_LAN_Block_WebsiteKeyword');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_LAN_Block_WebsiteKeyword');
