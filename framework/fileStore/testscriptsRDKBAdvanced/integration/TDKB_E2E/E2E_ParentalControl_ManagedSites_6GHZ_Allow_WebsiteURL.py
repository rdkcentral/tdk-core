...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteURL')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteURL')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteURL')
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the url
