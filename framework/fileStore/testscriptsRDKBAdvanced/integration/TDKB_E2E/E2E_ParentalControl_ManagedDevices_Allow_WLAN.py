...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_Allow_WLAN')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_Allow_WLAN')
                            ...
                            if expectedresult in status:
                                ...
                                if expectedresult in status:
                                    ...
                                    if MAC:
                                        ...
                                        step = step + 1
                                        print(f"\nTEST STEP {step}: Adding new rule for managed device")
                                        print(f"EXPECTED RESULT {step}: Should add new managed device rule")
                                        if expectedresult in actualresult:
                                            tdkTestObj.setResultStatus("SUCCESS")
                                            print(f"ACTUAL RESULT {step}: Added new managed device rule. Details: {details}")
                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                            temp = details.split(':')
                                            instance = temp[1]
                                            ...
                                            if int(instance) > 0:
                                                ...
                                                ruleValuesList = ['Allow', 'rootNAT', MAC, 'false']
                                                        ...
                                                        if expectedresult in status:
                                                            ...
                                                            if wlanIP:
                                                                ...
                                                                if expectedresult in status:
                                                                    ...
                                                                    print(f"TEST STEP: Refreshed wifi network")
                                                                    time.sleep(60)
                                                                    ...
                                                                    if expectedresult in status:
                                                                        ...
                                                                        print(f"EXPECTED RESULT {step}: HTTP connection should succeed (device is allowed)")
                                            ...
                                            tdkTestObj.setResultStatus("FAILURE")
                                            print(f"ACTUAL RESULT {step}: Failed to add new managed device rule. Details: {details}")
                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE")
