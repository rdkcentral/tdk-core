...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_802.11bgn_OperatingStandard</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that 802.11b 802.11g and 802.11n clients should be able to connect to WG when mode is b/g/n for frequency band 2.4GHZ</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_06</test_case_id>
    <test_objective>Verify that 802.11b 802.11g and 802.11n clients should be able to connect to WG when mode is b/g/n for frequency band 2.4GHZ</test_objective>
...
3. Set operating standard "b,g,n" using tdkb_e2e_SetMultipleParams
3. Try to connect to Wifi client and check whether the wifi client is connected to the DUT using operating standard "b,g,n"
4. Revert the values of operating standard</automation_approch>
    <except_output>WIFI client should be able to connect to the DUT with the using operating standard "b,g,n"</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_802.11bgn_OperatingStandard</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_802.11bgn_OperatingStandard');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the operating standard as b,g,n
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'b,g,n'];
            ...
            list3 = [operatingStandard,'b,g,n','string']
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 8: Check whether wlan client connected with 802.11 b/g/n operating standard")
                                    operating_standard = getOperatingStandard(tdkbE2EUtility.ssid_2ghz_name);
                                    operating_standard_list = ['802.11b','802.11g','802.11n']
