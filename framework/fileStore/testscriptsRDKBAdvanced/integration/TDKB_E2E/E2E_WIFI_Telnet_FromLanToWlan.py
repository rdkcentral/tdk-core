...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_Telnet_FromLanToWlan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            #Send Telnet request from LAN to WLAN client
                                            print("TEST STEP 8: Check Telnet from LAN to WLAN");
                                            status = telnetToClient("WLAN", wlanIP)
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("Telnet traffic successful between LAN and WLAN clients")
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 8: Telnet from LAN to WLAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
