...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_BlockForGivenTime_WebsiteURL')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_BlockForGivenTime_WebsiteURL')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_BlockForGivenTime_WebsiteURL')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper():
    ...
    if expectedresult in status:
        ...
        step += 1
        print(f"\nTEST STEP {step}: Get the current ssid,keypassphrase,managedSiteEnable and securityMode")
        print(f"EXPECTED RESULT {step}: Should retrieve the current ssid,keypassphrase,managedSiteEnable and securityMode")
        if expectedresult in status:
            ...
            if exit_flag != 1:
                # Set the SSID name,password,managedSiteEnable"
                ...
                if expectedresult in actualresult and expectedresult in actualresult1:
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        print(f"current UTC time is : {utcTime}")
                        start = start_Time.split(":")
                        start_Time = str(int(start[0])) + ":00"
                        end_Time = str(int(start[0])+ 3) + ":15"
                        day = calendar.day_name[utcTime.weekday()][:3]
                        print(f"Start time is : {start_Time}, End time is : {end_Time}, day is : {day}")
                        ...
                        step += 1
                        print(f"\nTEST STEP {step}: Add new rule for site blocking")
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the url using keyword for given time
                                ...
                                startTime = f"Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.{instance}.StartTime"
                                endTime = f"Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.{instance}.EndTime"
                                blockdays = f"Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.{instance}.BlockDays"

                                blocked_url = "http://"+tdkbE2EUtility.website_url
                                setValuesList = ['URL',blocked_url,'false',start_Time,end_Time,day]
                                print(f"Parameter values that are set: {setValuesList}")
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if wlanIP:
                                                ...
                                                if expectedresult in status and curIPAddress:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        #set new static route to url
                                                        step += 1
                                                        print(f"\nTEST STEP {step}: Add static route")
                                                        ...
                                                        if expectedresult in status:
                                                            ...
                                                            step += 1
                                                            print(f"\nTEST STEP {step}:Check the Http connectivity from WLAN to URL")
                                                            ...
                                                            if expectedresult not in status:
                                                                tdkTestObj.setResultStatus("SUCCESS")
                                                                print("ACTUAL RESULT: Http connection from WLAN to the URL keyword is blocked")
                                                                print("[TEST EXECUTION RESULT] : SUCCESS")
                                                            else:
                                                                tdkTestObj.setResultStatus("FAILURE")
                                                                print("ACTUAL RESULT: Http connection from WLAN to the URL keyword is success")
                                                                print("[TEST EXECUTION RESULT] : FAILURE")
                                        ...
                                        tdkTestObj.setResultStatus("FAILURE")
                                        print(f"ACTUAL RESULT {step}: Failed to retrieve all fields of added rule or parameter are not reflected in GET: {newValues}")
                                        print("[TEST EXECUTION RESULT] : FAILURE")
                                else:
                                    tdkTestObj.setResultStatus("FAILURE")
