...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_TriggerInRange</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_602</test_case_id>
...
Device.NAT.X_CISCO_COM_PortTriggers.Enable - true/false
...
8. To the added instance, configure the rule: Trigger Port(start:end) - 1234:1244, TargetPort(start:end) - 54321:54321 (for NETCAT), Trigger Protocol - UDP, Target Protocol - UDP, Description - MyPTRule
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_TriggerInRange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_TriggerInRange');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_TriggerInRange');
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        print("EXPECTED RESULT %d: NETCAT client runing in WAN machine should connect to the server running in WLAN with the GW WAN IP of DUT" %step)
