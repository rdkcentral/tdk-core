...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_BOTH_TargetIPERF_TriggerTCP</name>
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_BOTH_TargetIPERF_TriggerTCP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_BOTH_TargetIPERF_TriggerTCP');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_BOTH_TargetIPERF_TriggerTCP');
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                #Since targetProtocol BOTH is not supported in server side, passing the trigger protocol TCP
                                                target_protocol = "TCP"
