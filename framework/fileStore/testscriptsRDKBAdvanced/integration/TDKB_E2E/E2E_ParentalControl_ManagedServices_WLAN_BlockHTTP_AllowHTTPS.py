...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_BlockHTTP_AllowHTTPS')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_BlockHTTP_AllowHTTPS')
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print(f"EXPECTED RESULT {step}: Allowed service HTTPS should be reachable")
                                                    status = wgetToWAN("WGET_HTTPS", wlanIP, curIPAddress)

                                                    if expectedresult in status:
                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                        print(f"ACTUAL RESULT {step}: The allowed service 'HTTPS' can be reached")
                                                        print("[TEST EXECUTION RESULT] : SUCCESS")
                                                        finalStatus = "SUCCESS"
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
                                                        print(f"ACTUAL RESULT {step}: The allowed service 'HTTPS' cannot be reached")
                                                        print("[TEST EXECUTION RESULT] : FAILURE")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE")
