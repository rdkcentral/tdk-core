...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_FirewallCustom_UDPFromWlanToLan');
            ...
            if expectedresult in status:
                ...
                if tdkbE2EUtility.ssid_name == orgValue[0] and tdkbE2EUtility.ssid_pwd == orgValue[1]:
                    ...
                    if expectedresult in firewallResult:
                        tdkTestObj.setResultStatus("SUCCESS")
                        print("TEST STEP 2: Set firewallLevel to Custom")
                        print("EXPECTED RESULT 2: Should set firewallLevel to Custom")
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print("TEST STEP 2: Set firewallLevel to Custom: FAILED")
