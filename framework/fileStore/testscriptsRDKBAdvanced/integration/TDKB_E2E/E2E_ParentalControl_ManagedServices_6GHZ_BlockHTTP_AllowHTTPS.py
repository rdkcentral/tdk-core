...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockHTTP_AllowHTTPS')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockHTTP_AllowHTTPS')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockHTTP_AllowHTTPS')
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the HTTP Service and allow HTTPS
                                                ...
                                                if expectedresult in status and curIPAddress:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        if expectedresult in status:
                                                            ...
                                                            print(f"EXPECTED RESULT {step}: Https connection should be success")
