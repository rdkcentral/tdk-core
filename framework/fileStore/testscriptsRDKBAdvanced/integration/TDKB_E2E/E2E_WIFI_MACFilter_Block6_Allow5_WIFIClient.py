...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block6_Allow5_WIFIClient')
obj1.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block6_Allow5_WIFIClient')
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult and expectedresult in actualresult1:
                ...
                if expectedresult in status and setValuesList == newValues:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        if MAC_6GHZ:
                                                            ...
                                                            if expectedresult in status:
                                                                ...
                                                                list2 = [macFilterBlackList5_g,'false','bool']
                                                                                        ...
                                                                                        if expectedresult in actualresult and expectedresult in actualresult1:
                                                                                            ...
                                                                                            if expectedresult in status and setValuesList == newValues:
                                                                                                ...
                                                                                                if expectedresult in status:
                                                                                                    ...
                                                                                                    tdkTestObj.setResultStatus("FAILURE")
                                                                                                    print(f"ACTUAL RESULT {step}: Failed to connect WLAN client to 5ghz SSID")
                                                                                                    print("[TEST EXECUTION RESULT] : FAILURE")
                                                                                            else:
                                                                                                tdkTestObj.setResultStatus("FAILURE")
                    ...
                    tdkTestObj.setResultStatus("FAILURE")
                    print(f"ACTUAL RESULT {step}: GET operation failed or parameter values are not updated after SET : {newValues}")
                    print("[TEST EXECUTION RESULT] : FAILURE")
            else:
                tdkTestObj.setResultStatus("FAILURE")
