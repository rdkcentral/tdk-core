...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_GetThroughput</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify the performance of 2.4GHz radio by getting the throughput</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_468</test_case_id>
    <test_objective>To verify the performance of 2.4GHz radio by getting the throughput</test_objective>
...
6.Validate the throughput obtained from TCP server and client
7. Revert the security mode to original value
8.Unload tdkb_e2e module</automation_approch>
    <except_output>The throughput obtained must be greater than 80Mbps</except_output>
    <priority>High</priority>
    <test_stub_interface>TDKB_E2E</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_WPA2PSK_GetThroughput</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_GetThroughput');
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if throughput > 80:
                                                    tdkTestObj.setResultStatus("SUCCESS");
                                                    print("Throughtput is more than 80Mbps")

                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE");
                                                    print("Throughtput is less than 80Mbps")
