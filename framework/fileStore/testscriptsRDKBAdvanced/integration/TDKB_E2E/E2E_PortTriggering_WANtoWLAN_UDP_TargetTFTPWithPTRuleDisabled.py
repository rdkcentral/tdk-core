...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_UDP_TargetTFTPWithPTRuleDisabled</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_591</test_case_id>
...
13. From WAN client, send an inbound packet to the target port 69 via the DUT GW WAN IP. The packet should NOT be successfully forwarded to the WLAN client since PT rule is disabled.
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_UDP_TargetTFTPWithPTRuleDisabled</test_script>
    <skipped>No</skipped>
