...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_FTP_FromWlanToLan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            #FTP file download from LAN server to WLAN client
                                            print("TEST STEP 8: Check FTP file download from LAN to WLAN");
                                            ...
                                            if expectedresult in status:
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 8: FTP file download from LAN to WLAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
