...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block2.4_Allow6_WIFIClient')
obj1.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block2.4_Allow6_WIFIClient')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        step += 1
        print(f"\nTEST STEP {step}: Get the current ssid,keypassphrase,Radio enable status,macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
        print(f"EXPECTED RESULT {step}: Should retrieve the current ssid, keypassphrase, Radio enable status, macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
        if expectedresult in status:
            tdkTestObj.setResultStatus("SUCCESS")
            print(f"ACTUAL RESULT {step}: Current values: {orgValue}")
            print("[TEST EXECUTION RESULT] : SUCCESS")

            # Set the SSID name,Keypassphrase,Radio enable status for  2ghz and 6ghz
            ...
            step += 1
            print(f"\nTEST STEP {step}: Set the ssid, keypassphrase, Radio enable status for 2ghz and 6ghz")
            print(f"EXPECTED RESULT {step}: Should set the ssid, keypassphrase, Radio enable status for 2ghz and 6ghz")
            ...
            if expectedresult in actualresult and expectedresult in actualresult1:
                ...
                step += 1
                print(f"\nTEST STEP {step}: Get the current ssid, keypassphrase, Radio enable status for 2ghz and 6ghz")
                print(f"EXPECTED RESULT {step}: Should retrieve the current ssid, keypassphrase, Radio enable status for 2ghz and 6ghz")
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    # Connect to the 2ghz wifi ssid from wlan client
                    step += 1
                    print(f"\nTEST STEP {step}: Connect to the 2ghz wifi ssid from WLAN client")
                    ...
                    if expectedresult in status:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    if MAC_2GHZ:
                                        ...
                                        step += 1
                                        print(f"\nTEST STEP {step}: Disconnect WLAN client from the 2ghz wifi ssid")
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        if MAC_6GHZ:
                                                            ...
                                                            if expectedresult in status:
                                                                ...
                                                                # Set macFilterEnable, macFilterBlackList for 2ghz and 6ghz
                                                                setValuesList = ['true','true','true','false']
                                                                print(f"Parameter values that are set: {setValuesList}")

                                                                list1 = [macFilterEnable2_g,'true','bool']
                                                                list2 = [macFilterBlackList2_g,'true','bool']
                                                                ...
                                                                step += 1
                                                                print(f"\nTEST STEP {step}: Set macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
                                                                print(f"EXPECTED RESULT {step}: Should set the macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
                                                                ...
                                                                if expectedresult in actualresult and expectedresult in actualresult1:
                                                                    ...
                                                                    step += 1
                                                                    print(f"\nTEST STEP {step}: Get the current macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
                                                                    print(f"EXPECTED RESULT {step}: Should Get the macFilterEnable, macFilterBlackList for 2ghz and 6ghz")
                                                                    ...
                                                                    if expectedresult in status and setValuesList == newValues:
                                                                        ...
                                                                        # Adding a new MACFilter rule for 2GHz
                                                                        ...
                                                                        step += 1
                                                                        print(f"\nTEST STEP {step}: Add a new MACFilter rule for 2GHz")
                                                                        ...
                                                                        if expectedresult in actualresult:
                                                                            ...
                                                                            temp = details.split(':')
                                                                            instance2_g= temp[1]
                                                                            print(f"2ghz INSTANCE VALUE: {instance2_g}")
                                                                            ...
                                                                            if (int(instance2_g) > 0):
                                                                                                ...
                                                                                                if expectedresult in status:
                                                                                                    ...
                                                                                                    if expectedresult in status:
                                                                                                        ...
                                                                                                        if expectedresult not in status:
                                                                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                                                                            print(f"ACTUAL RESULT {step}: Connection attempt for 2ghz ssid should fail after enabling the MAC filter")
                                                                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                                                                            ...
                                                                                                            if expectedresult in status:
                                                                                                                ...
                                                                                                                print(f"ACTUAL RESULT {step}: Failed to disconnect from 2ghz WIFI SSID")
                                                                                                                print("[TEST EXECUTION RESULT] : FAILURE")
                                                                                                        else:
                                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                                            print(f"ACTUAL RESULT {step}: Connection from wlan client to 2ghz ssid is success even after enabling the MAC filter")
                                                                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                                                                    else:
                                                                                                        tdkTestObj.setResultStatus("FAILURE")
                                                                                ...
                                                                                step += 1
                                                                                print(f"\nTEST STEP {step}: Delete the added rule for 2ghz")
                                                                                print(f"EXPECTED RESULT {step}: Should delete the added rule")
                                                                                ...
                                                                                tdkTestObj.setResultStatus("FAILURE")
                                                                                print(f"Invalid INSTANCE VALUE returned for 2ghz: {instance2_g}")
                                                                        else:
                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                            print(f"ACTUAL RESULT {step}: Failed to add new rule")
                                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print(f"ACTUAL RESULT {step}: Failed to connect WLAN client to 2ghz SSID")
                        print("[TEST EXECUTION RESULT] : FAILURE")
                else:
                    tdkTestObj.setResultStatus("FAILURE")
