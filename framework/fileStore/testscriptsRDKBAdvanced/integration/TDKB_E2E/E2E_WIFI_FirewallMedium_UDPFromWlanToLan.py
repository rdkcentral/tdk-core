...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_FirewallMedium_UDPFromWlanToLan');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if tdkbE2EUtility.mlo_capability == "True":
            ...
            #Get the value of the wifi parameters and firewallLevel that are currently set.
            ...
            if expectedresult in status:
                ...
                # Check if same SSID and keypassphrase are configured in the device configuration file
                if tdkbE2EUtility.ssid_name == orgValue[0] and tdkbE2EUtility.ssid_pwd == orgValue[1]:
                    ...
                    if expectedresult in firewallResult:
                        tdkTestObj.setResultStatus("SUCCESS")
                        print("TEST STEP 2: Set firewallLevel to Medium")
                        print("EXPECTED RESULT 2: Should set firewallLevel to Medium")
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                print("TEST STEP 9: Check UDP from WLAN to LAN");
                                                ...
                                                if expectedresult in status and lossPercentage=="0%":
                                                    ...
                                                    tdkTestObj.setResultStatus("FAILURE");
                                                    print("TEST STEP 9: UDP from WLAN to LAN failed")
                                            else:
                                                tdkTestObj.setResultStatus("FAILURE");
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print("TEST STEP 2: Set firewallLevel to Medium: FAILED")
                        print("[TEST EXECUTION RESULT] : FAILURE")

                    # Revert firewallLevel to original value
