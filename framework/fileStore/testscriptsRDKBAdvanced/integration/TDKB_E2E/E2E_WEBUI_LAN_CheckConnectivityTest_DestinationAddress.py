...
<xml>
  ...
  <name>E2E_WEBUI_LAN_CheckConnectivityTest_DestinationAddress</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the default destination address used for the connectivity test</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_488</test_case_id>
    <test_objective>To check the default destination address used for the connectivity test</test_objective>
...
10. Check the default destination address used for the connectivity test is displayed
11. Kill selenium hub and node
12. unload module</automation_approch>
    <except_output>Destination address used for connectivity test should be displayed</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_CheckConnectivityTest_DestinationAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_CheckConnectivityTest_DestinationAddress');
                        ...
                        if expectedresult in status:
                            ...
                            if status == "SUCCESS":
                                try:
                                    ...
                                    time.sleep(10);
                                    destination_details1 = tdkbE2EUtility.connectivity_test_destination_address;
                                    destination_details2 = driver.find_element_by_xpath('//*[@id="destination_address"]').get_attribute("value")
                                    if destination_details1 == destination_details2:
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("TEST STEP 6: Get the default destination address used for the connectivity test")
                                        print("EXPECTED RESULT 6: Should display the default destination address used for the connectivity test")
                                        print("ACTUAL RESULT 6: Default destination address used for the connectivity test is displayed");
                                        print("[TEST EXECUTION RESULT] : SUCCESS");
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("TEST STEP 6:Getting the default destination address used for the connectivity test failed");
                            ...
                            if status == "SUCCESS":
                                print("TEST STEP 7: Executing Post-requistes")
                                tdkTestObj.setResultStatus("SUCCESS");
