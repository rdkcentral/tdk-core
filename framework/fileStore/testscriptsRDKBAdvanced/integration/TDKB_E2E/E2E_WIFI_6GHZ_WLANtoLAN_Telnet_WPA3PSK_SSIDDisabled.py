...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_WPA3PSK_SSIDDisabled')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_WPA3PSK_SSIDDisabled')
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        step += 1
                                                        print(f"\nTEST STEP {step}: Check Telnet traffic from LAN to WLAN Client")
