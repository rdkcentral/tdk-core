...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_BOTH_TargetNETCAT_TriggerUDP</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_613</test_case_id>
...
8. To the added instance, configure the rule: Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 54321:54321 (for NETCAT), Trigger Protocol - BOTH, Target Protocol - BOTH, Description - MyPTRule
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_BOTH_TargetNETCAT_TriggerUDP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_BOTH_TargetNETCAT_TriggerUDP');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_BOTH_TargetNETCAT_TriggerUDP');
