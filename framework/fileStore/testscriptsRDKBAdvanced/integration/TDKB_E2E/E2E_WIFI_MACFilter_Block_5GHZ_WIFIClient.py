...
<xml>
  ...
  <name>E2E_WIFI_MACFilter_Block_5GHZ_WIFIClient</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that MAC Filter based Access control deny specific clients that are connected via 5GHz radio</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_139</test_case_id>
    <test_objective>Verify that MAC Filter based Access control deny specific clients that are connected via 5GHz radio</test_objective>
...
4.  Connect to the WIFI client to 5GHZ and get the MAC address of the WLAN  interface
...
10.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_MACFilter_Block_5GHZ_WIFIClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block_5GHZ_WIFIClient');
obj1.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block_5GHZ_WIFIClient');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'true','true','true'];
