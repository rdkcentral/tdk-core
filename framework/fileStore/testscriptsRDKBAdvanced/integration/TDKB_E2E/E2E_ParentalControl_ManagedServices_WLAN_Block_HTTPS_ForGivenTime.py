...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_WLAN_HTTPS_ForGivenTime')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_WLAN_HTTPS_ForGivenTime')
                                    ...
                                    if wlanIP:
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step = step + 1
                                                print(f"\nTEST STEP {step}: Add static route to reach HTTPS WAN client from WLAN client")
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print(f"EXPECTED RESULT {step}: Blocked service HTTPS should not be reachable during configured time")
                                                    status = wgetToWAN("WGET_HTTPS", wlanIP, curIPAddress)

                                                    if expectedresult not in status:
                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                        print(f"ACTUAL RESULT {step}: The blocked service 'HTTPS' cannot be reached")
                                                        print("[TEST EXECUTION RESULT] : SUCCESS")
                                                        finalStatus = "SUCCESS"
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
                                                        print(f"ACTUAL RESULT {step}: The blocked service 'HTTPS' can be reached")
                                                        print("[TEST EXECUTION RESULT] : FAILURE")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE")
