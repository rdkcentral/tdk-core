...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_WPAWPA2PSK_FTP_FromLanToWlan</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_145</test_case_id>
...
5. From the wlan client, try to connect to the LAN client via ftp and check whether ftp connection and file transfer are success when the security mode for 5GHz is set to WPA2PSK
6. Revert the security mode to original value
7.Unload tdkb_e2e module</automation_approch>
    <except_output>ftp connection from LAN client to WLAN client and file transfer should be success</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_WPAWPA2PSK_FTP_FromLanToWlan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPAWPA2PSK_FTP_FromLanToWlan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            print("TEST STEP 10:Check FTP from LAN to WLAN");
                                            ...
                                            if expectedresult in status:
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 10:File download FTP from LAN to WLAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
