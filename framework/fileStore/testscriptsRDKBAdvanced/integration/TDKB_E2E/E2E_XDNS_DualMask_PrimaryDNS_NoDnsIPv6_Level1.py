...
<xml>
  ...
  <name>E2E_XDNS_DualMask_PrimaryDNS_NoDnsIPv6_Level1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set dual dns masq with level1 primary xdns server, but skip adding ipv6 xdns server config. Check if default dns is used instead of xdns and level1 site is accessible from client.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_499</test_case_id>
    <test_objective>Set dual dns masq with level1 primary xdns server, but skip adding ipv6 xdns server config. Check if default dns is used instead of xdns and level1 site is accessible from client.</test_objective>
...
5. Add new rule in this table with LAN client MAC, level 1 DNS ipv4 primary dns ips and a tag name for rule
...
12. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_XDNS_DualMask_PrimaryDNS_NoDnsIPv6_Level1</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_DualMask_PrimaryDNS_NoDnsIPv6_Level1');
obj1.configureTestCase(ip,port,'E2E_XDNS_DualMask_PrimaryDNS_NoDnsIPv6_Level1');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = [lanMAC,tdkbE2EUtility.xdns_level1_dns_server,"Default"];
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level1 site accessible from the blocked device")
