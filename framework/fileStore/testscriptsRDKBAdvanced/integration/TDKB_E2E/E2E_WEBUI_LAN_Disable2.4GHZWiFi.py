...
<xml>
  ...
  <name>E2E_WEBUI_LAN_Disable2.4GHZWiFi</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To disable 2.4GHZ wifi via GUI page and check if the broadcasting of 2.4GHZ SSID is stopped or not.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To disable 2.4GHZ wifi via GUI page and check if the broadcasting of 2.4GHZ SSID is stopped or not.</test_objective>
...
9. Disable 2.4GHZ wifi from UI
10. Check if 2.4GHZ SSID is broadcasting or not
11. Kill selenium hub and node
12.  unload module</automation_approch>
    <except_output>The 2.4GHZ SSID should not broadcast when the 2.4GHZ SSID is disabled from UI</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_Disable2.4GHZWiFi</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_Disable2.4GHZWiFi');
