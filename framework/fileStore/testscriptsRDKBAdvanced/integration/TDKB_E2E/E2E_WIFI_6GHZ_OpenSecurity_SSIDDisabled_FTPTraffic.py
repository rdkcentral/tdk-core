...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_SSIDDisabled_FTPTraffic')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_SSIDDisabled_FTPTraffic')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus2.upper():
    ...
    if expectedresult in status:
        ...
        if initial_secMode == "WPA3-Enterprise":
            sm_flag = 1
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                step += 1
                print(f"\nTEST STEP {step}: Set the ssid,security mode, radioEnable and ssidEnable")
                print(f"EXPECTED RESULT {step}: Should set the ssid, security mode,radioEnable and ssidEnable")
                ...
                if expectedresult in actualresult:
                    ...
                    step += 1
                    print(f"\nTEST STEP {step}: Get the current ssid,security mode, radioEnable and ssidEnable after set")
                    print(f"EXPECTED RESULT {step}: Should retrieve the updated ssid,security mode,radioEnable and ssidEnable")
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step += 1
                                                print(f"\nTEST STEP {step}: Set ssidEnable to false")
                                                print(f"EXPECTED RESULT {step}: Should set the ssidEnable false")
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    step += 1
                                                    print(f"\nTEST STEP {step}: Get the current ssidEnable")
                                                    print(f"EXPECTED RESULT {step}: Should retrieve the current ssidEnable")
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        step += 1
                                                        print(f"\nTEST STEP {step}: Connect to LAN Client and send FTP Request to WLAN Client")
                                                        print(f"EXPECTED RESULT {step}: FTP traffic should not be successful between LAN and WLAN client")
                                                        status = tdkbE2EUtility.ftpToClient("WLAN",wlanIP)
                                                        if "SUCCESS" not in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step}: FTP traffic not successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                            ...
                                                            tdkTestObj.setResultStatus("FAILURE")
                                                            print(f"ACTUAL RESULT {step}: FTP traffic successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
