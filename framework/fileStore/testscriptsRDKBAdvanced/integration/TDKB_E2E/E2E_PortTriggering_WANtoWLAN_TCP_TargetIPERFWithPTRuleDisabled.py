...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERFWithPTRuleDisabled</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_587</test_case_id>
...
9. Disable the added port trigger rule
10. Check if the rule is added and disabled successfully by fetching the values of corresponding DMs
...
13. From WAN client, send an inbound packet to the target port 5001 via the DUT GW WAN IP. The packet should NOT be successfully forwarded to the WLAN client since PT rule is disabled.
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERFWithPTRuleDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERFWithPTRuleDisabled');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERFWithPTRuleDisabled');
                            ...
                            if wlanIP != "":
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        #Set the Port Triggering rule and disable it:- Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
                                        step = step + 1
                                        triggerStart = "12345"
                                        triggerEnd = "12345"
                                        targetStart = "5001"
