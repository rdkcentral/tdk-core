...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_Block_HTTPS')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_Block_HTTPS')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_Block_HTTPS')
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the HTTPS Service
