...
<xml>
  ...
  <name>E2E_PF_FirewallHigh_HTTPFromWanToWlan</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify Port forwarding with HTTP service running on Wi-Fi Client and Firewall mode set to High HTTP traffic should be successful from WAN to WLAN</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_79</test_case_id>
    <test_objective>Verify Port forwarding with HTTP service running on Wi-Fi Client and Firewall mode set to High HTTP traffic should be successful from WAN to WLAN</test_objective>
...
13.Unload tdkb_e2e and advancedconfig modules</automation_approch>
    ...
    <test_script>E2E_PF_FirewallHigh_HTTPFromWanToWlan</test_script>
    <skipped>No</skipped>
