...
<xml>
  ...
  <name>E2E_XfinityWiFi_Connect5GHZ_PreferPrivate</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if connection to xfinity WiFi 5GHZ is failing when PreferPrivate Wifi option is enabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_463</test_case_id>
    <test_objective>Check if connection to xfinity WiFi 5GHZ is failing when PreferPrivate Wifi option is enabled</test_objective>
...
10. Unload wifiagent and tdkb_e2e module</automation_approch>
    <except_output>WiFi client should not be able to connect to  XfinityWiFi5GHZ</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e,wifiagent</test_stub_interface>
    <test_script>E2E_XfinityWiFi_Connect5GHZ_PreferPrivate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XfinityWiFi_Connect5GHZ_PreferPrivate');
                    ...
                    if expectedresult in prefResult:
                        ...
                        if expectedresult in retStatus and newPrefValue == "true":
                            ...
                            if expectedresult not in status:
                                ...
                                print("FAILURE:Connection to the xfinity5GHZ SSID success")
