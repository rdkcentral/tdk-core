...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_Firewall_Medium_HttpsFromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that when Firewall Config is set to Medium HTTPs access from LAN to LAN should pass through</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_63</test_case_id>
    <test_objective>Verify that when Firewall Config is set to Medium HTTPs access from LAN to LAN should pass through</test_objective>
...
5. From the wlan client, do HTTPS to the LAN client and check whether HTTPS is success when the firewall level is set to Medium
6. Revert the firewall level to original value
7.Unload tdkb_e2e module</automation_approch>
    <except_output>From the wlan client, do HTTPS to the LAN client and check whether HTTPS is success when the firewall level is set to Medium</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_Firewall_Medium_HttpsFromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Firewall_Medium_HttpsFromWlanToLan');
