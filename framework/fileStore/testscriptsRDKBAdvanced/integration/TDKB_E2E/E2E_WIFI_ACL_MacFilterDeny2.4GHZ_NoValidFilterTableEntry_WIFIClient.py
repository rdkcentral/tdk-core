...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterDeny2.4GHZ_NoValidFilterTableEntry_WIFIClient')
obj1.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterDeny2.4GHZ_NoValidFilterTableEntry_WIFIClient')
