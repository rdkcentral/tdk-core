...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_WPAPSK_SSIDDisabled_FTPTraffic</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that ftp traffic between WLan to LAN should be denied when wifi client assocation in wpa-psk authentication for 2.4GHZ and SSID interface parameter for 2.4GHZ [Device.WiFi.SSID.1.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_388</test_case_id>
    <test_objective>Verify that ftp traffic between WLan to LAN should be denied when wifi client assocation in wpa-psk authentication for 2.4GHZ and SSID interface parameter for 2.4GHZ [Device.WiFi.SSID.1.Enable] is disabled.</test_objective>
...
4. Disable ssid for 2.4GHz and send ftp request to wlan client from lan client
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WPAPSK_SSIDDisabled_FTPTraffic</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPAPSK_SSIDDisabled_FTPTraffic');
