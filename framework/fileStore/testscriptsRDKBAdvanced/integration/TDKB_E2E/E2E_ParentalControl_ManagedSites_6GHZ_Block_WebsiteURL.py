...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Block_WebsiteURL')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Block_WebsiteURL')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Block_WebsiteURL')
