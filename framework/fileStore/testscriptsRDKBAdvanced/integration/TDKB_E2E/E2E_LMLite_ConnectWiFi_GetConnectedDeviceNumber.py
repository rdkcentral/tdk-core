...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>10</version>
  <name>E2E_LMLite_ConnectWiFi_GetConnectedDeviceNumber</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that total number of clients connected in LAN segment matches with the Parameter value (Device.Hosts.X_CISCO_COM_ConnectedDeviceNumber)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_164</test_case_id>
    <test_objective>Verify that total number of clients connected in LAN segment matches with the Parameter value (Device.Hosts.X_CISCO_COM_ConnectedDeviceNumber)</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    <except_output>Device.Hosts.X_CISCO_COM_ConnectedDeviceNumber should be incremented by one after successfully connected to wifi.</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_LMLite_ConnectWiFi_GetConnectedDeviceNumber</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_LMLite_ConnectWiFi_GetConnectedDeviceNumber');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in status:
                            ...
                            if wlanIP:
                                ...
                                param = "Device.Hosts.X_CISCO_COM_ConnectedDeviceNumber"
                                tdkTestObj,status,curConnectedDeviceNumber = getParameterValue(obj,param)
                                print("Current Connected device number: %s" %curConnectedDeviceNumber);
                                ...
                                if expectedresult in status and (int(connectedDeviceNumber)+1) == int(curConnectedDeviceNumber):
                                    tdkTestObj.setResultStatus("SUCCESS");
