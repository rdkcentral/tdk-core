...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPA2PSK</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in wpa2-psk authentication for 5GHZ.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_375</test_case_id>
    <test_objective>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in wpa2-psk authentication for 5GHZ.</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPA2PSK</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPA2PSK');
