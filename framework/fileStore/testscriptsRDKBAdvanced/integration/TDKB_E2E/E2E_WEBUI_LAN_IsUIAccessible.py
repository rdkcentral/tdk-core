...
<xml>
  <id/>
  <version>3</version>
  <name>E2E_WEBUI_LAN_IsUIAccessible</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the UI page of gateway is accessible from lan client.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check if the UI page of gateway is accessible from lan client.</test_objective>
...
9. unload module</automation_approch>
    <except_output>The UI page of gateway should be accessible from LAN cleint</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_IsUIAccessible</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_IsUIAccessible');
