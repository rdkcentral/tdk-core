...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_UDP_TargetTFTPWithTCPTrigger</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_578</test_case_id>
...
11. From WAN client, send an inbound packet to the target port 69 via the DUT GW WAN IP. The packet should NOT be successfully forwarded to the LAN client.
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_UDP_TargetTFTPWithTCPTrigger</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetTFTPWithTCPTrigger');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetTFTPWithTCPTrigger');
