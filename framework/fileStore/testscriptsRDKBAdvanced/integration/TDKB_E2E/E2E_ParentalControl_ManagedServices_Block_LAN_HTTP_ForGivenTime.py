...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedServices_Block_LAN_HTTP_ForGivenTime</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of HTTP service only during specific day and time period through parental control (managed services)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_396</test_case_id>
    <test_objective>Verify that WG supports blocking of HTTP service only during specific day and time period through parental control (managed services)</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    <expected_output>LAN client should not be able to establish http connection during the specified time period</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_Block_LAN_HTTP_ForGivenTime</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_HTTP_ForGivenTime');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_HTTP_ForGivenTime');
