...
<xml>
  ...
  <name>E2E_DHCP_GetLanIPAddress_OnReconnection_WithActiveLease</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that DHCPv4 client retains the same IP address when disconnected and reconnected when the Lease period is active</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_276</test_case_id>
    <test_objective>Verify that DHCPv4 client retains the same IP address when disconnected and reconnected when the Lease period is active</test_objective>
...
5. Disconnect the lan clilent and connect again
...
7.Unload tdkb_e2e module</automation_approch>
    <except_output>LAN client should retain the same IP address when disconnected and reconnected when the Lease period is active</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_DHCP_GetLlanIPAddress_OnReconnection_WithActiveLease</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_GetLanIPAddress_OnReconnection_WithActiveLease');
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    if lanIP:
                        ...
                        if expectedresult in status:
                            ...
                            print("TEST STEP 6: Get the IP address of the lan client when lease time is active")
                            ...
                            if lanIP1:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 8: Checking whether LAN Client retains the same IP address when disconnected and reconnected when the Lease period is active")
                                    if lanIP == lanIP1:
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("LAN Client retains the same IP address when disconnected and reconnected when the Lease period is active")
                                        finalStatus = "SUCCESS";
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("LAN Client did not retain the same IP address when disconnected and reconnected when the Lease period is active")
                                else:
                                    tdkTestObj.setResultStatus("FAILURE");
