...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_SSIDDisabled_TCPFromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_SSIDDisabled_TCPFromWlanToLan')
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        step += 1
                                                        print(f"\nTEST STEP {step}: Check TCP between LAN and WLAN Client")
                                                        print(f"EXPECTED RESULT {step}: TCP request between LAN and WLAN client should fail")
                                                        ...
                                                        print(f"Bandwidth recieved from client : {clientOutput}" )
                                                        if "SUCCESS" not in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step}: TCP traffic not successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                            ...
                                                            tdkTestObj.setResultStatus("FAILURE")
                                                            print(f"ACTUAL RESULT {step}: TCP traffic successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
