...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_Block_HTTPS')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_Block_HTTPS')
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print(f"EXPECTED RESULT {step}: Blocked service HTTPS should not be reachable")
