...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_WithInvalidPort</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_633</test_case_id>
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_WithInvalidPort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_WithInvalidPort');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_UDP_TargetNETCAT_WithInvalidPort');
