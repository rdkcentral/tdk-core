...
<xml>
  ...
  <name>E2E_DNS_5GHZ_ResolveDomainName</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that the DNS server of WG successfully resolves the DNS queries in 5GHz WLAN client</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_455</test_case_id>
    <test_objective>Verify that the DNS server of WG successfully resolves the DNS queries in 5GHz WLAN client</test_objective>
...
3.Connect the WiFi client to the 5GHz SSID  of gateway
...
7.Unload tdkb_e2e module</automation_approch>
    <except_output>WLAN client should be able to resolve the domain name with Primary DNS Server</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_DNS_5GHZ_ResolveDomainName</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DNS_5GHZ_ResolveDomainName');
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 8:Connect to 5WLAN Client and do NSLookup")
