...
<xml>
  ...
  <name>E2E_WEBUI_WLAN_2.4GHZ_LogoutFromUI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if we can logout from the UI page connected from WLAN client after connecting to 2.4GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check if we can logout from the UI page connected from WLAN client after connecting to 2.4GHz</test_objective>
...
12.  unload module</automation_approch>
    <except_output>The UI page of gateway should be accessible from WLAN cleint and should be able to logout from the page</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_WLAN_2.4GHZ_LogoutFromUI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WLAN_2.4GHZ_LogoutFromUI');
