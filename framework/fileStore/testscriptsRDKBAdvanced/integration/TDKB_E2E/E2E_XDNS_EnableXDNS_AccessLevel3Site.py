...
<xml>
  ...
  <name>E2E_XDNS_EnableXDNS_AccessLevel3Site</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Enable xDNS and setup default parameters (level3). Try to access websites and check if the default parameter policies are applied</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Enable xDNS and setup default parameters (level3). Try to access websites and check if the default parameter policies are applied</test_objective>
...
5. Add new rule in this table with LAN client MAC, level3 DNS ipv4 and ipv6 ips and a tag name for rule
6. If the default DNS ips are empty, set dns ip values
7. Enable Device.DeviceInfo.X_RDKCENTRAL-COM_EnableXDNS
8. From LAN client do a nslookup to any level3 site via level3 dns server
9. Nslookup should not resolve succesfully
...
12. Unload tdkb_e2e module</automation_approch>
    <except_output>Nslookup shouldn't resolve level3 site succesfully</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_XDNS_EnableXDNS_AccessLevel3Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_EnableXDNS_AccessLevel3Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_EnableXDNS_AccessLevel3Site');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = [lanMAC,tdkbE2EUtility.xdns_level3_dns_server,tdkbE2EUtility.xdns_level3_ipv6_dns_server,"Default"];
                                ...
                                list3 = [dnsipv6,tdkbE2EUtility.xdns_level3_ipv6_dns_server,'string']
