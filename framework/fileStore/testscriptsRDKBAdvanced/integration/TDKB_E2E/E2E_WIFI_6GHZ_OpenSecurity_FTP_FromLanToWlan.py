...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_FTP_FromLanToWlan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_FTP_FromLanToWlan')
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                print(f"\nTEST STEP {step}: Check FTP from LAN to WLAN")
