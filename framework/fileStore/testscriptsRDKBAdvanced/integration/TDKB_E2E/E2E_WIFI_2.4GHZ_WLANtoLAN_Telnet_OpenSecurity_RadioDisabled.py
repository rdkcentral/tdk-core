...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_WLANtoLAN_Telnet_OpenSecurity_RadioDisabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that telnet traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_380</test_case_id>
    <test_objective>Verify that telnet traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WLANtoLAN_Telnet_OpenSecurity_RadioDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WLANtoLAN_Telnet_OpenSecurity_RadioDisabled');
