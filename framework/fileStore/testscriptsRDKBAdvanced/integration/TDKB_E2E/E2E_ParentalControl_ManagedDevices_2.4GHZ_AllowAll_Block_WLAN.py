...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedDevices_2.4GHZ_AllowAll_Block_WLAN</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that when managed devices state is set as Allow All, WG supports blocking of a specific 2.4GHZ Wi-Fi client</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Verify that when managed devices state is set as Allow All, WG supports blocking of a specific 2.4GHZ Wi-Fi client</test_objective>
...
7.Check whether the WLAN client's internet access is blocked using wget
8.Delete the added rule and revert all params values
9.Unload tdkb_e2e module</automation_approch>
    <except_output>The WLAN client should not be able to access the internet</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedDevices_2.4GHZ_AllowAll_Block_WLAN</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_AllowAll_Block_WLAN');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_AllowAll_Block_WLAN');
