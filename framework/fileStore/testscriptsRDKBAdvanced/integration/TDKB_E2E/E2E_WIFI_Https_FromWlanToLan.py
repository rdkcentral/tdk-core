...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_Https_FromWlanToLan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            print("TEST STEP 8: Check the HTTPS from WLAN to LAN");
                                            ...
                                            if expectedresult in status:
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 8: HTTPS from WLAN to LAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
