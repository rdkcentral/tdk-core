...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedServices_2.4GHZ_Block_HTTP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of HTTP service for Wi-Fi Client associated using 2.4GHZ radio through Parental control (managed services)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_106</test_case_id>
    <test_objective>Verify that WG supports blocking of HTTP service for Wi-Fi Client associated using 2.4GHZ radio through Parental control (managed services)</test_objective>
...
9.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedServices_2.4GHZ_Block_HTTP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_2.4GHZ_Block_HTTP');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_2.4GHZ_Block_HTTP');
