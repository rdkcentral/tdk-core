...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block5_Allow6_WIFIClient')
obj1.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block5_Allow6_WIFIClient')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        ssidName5_g = f"Device.WiFi.SSID.{tdkbE2EUtility.ssid_5ghz_index}.SSID"
        keyPassPhrase5_g = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.Security.KeyPassphrase"
        radioEnable5_g = f"Device.WiFi.Radio.{tdkbE2EUtility.radio_5ghz_index}.Enable"
        macFilterEnable5_g = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MACFilter.Enable"
        macFilterBlackList5_g = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MACFilter.FilterAsBlackList"
        ...
        paramList = [
            ssidName5_g, keyPassPhrase5_g, radioEnable5_g, macFilterEnable5_g, macFilterBlackList5_g,
        ...
        step += 1
        print(f"\nTEST STEP {step}: Get the current ssid,keypassphrase,Radio enable status,macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
        print(f"EXPECTED RESULT {step}: Should retrieve the current ssid, keypassphrase, Radio enable status, macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
        if expectedresult in status:
            tdkTestObj.setResultStatus("SUCCESS")
            print(f"ACTUAL RESULT {step}: Current values: {orgValue}")
            print("[TEST EXECUTION RESULT] : SUCCESS")

            # Set the SSID name,Keypassphrase,Radio enable status for 5 ghz and 6ghz
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'true',tdkbE2EUtility.ssid_6ghz_name,tdkbE2EUtility.ssid_6ghz_pwd,'true']
            print(f"Parameter values that are set: {setValuesList}" )

            list1 = [ssidName5_g,tdkbE2EUtility.ssid_5ghz_name,'string']
            list2 = [keyPassPhrase5_g,tdkbE2EUtility.ssid_5ghz_pwd,'string']
            list3 = [radioEnable5_g,'true','bool']
            ...
            setParamList5_g = list1 + list2 + list3
            setParamList6_g = list4 + list5 + list6
            setParamList5_g = "|".join(map(str, setParamList5_g))
            setParamList6_g = "|".join(map(str, setParamList6_g))

            tdkTestObj,actualresult,details = tdkbE2EUtility.setMultipleParameterValues(obj,setParamList5_g)
            tdkTestObj,actualresult1,details1 = tdkbE2EUtility.setMultipleParameterValues(obj,setParamList6_g)

            step += 1
            print(f"\nTEST STEP {step}: Set the ssid, keypassphrase, Radio enable status for 5ghz and 6ghz")
            print(f"EXPECTED RESULT {step}: Should set the ssid, keypassphrase, Radio enable status for 5ghz and 6ghz")
            ...
            if expectedresult in actualresult and expectedresult in actualresult1:
                ...
                newParamList=[ssidName5_g,keyPassPhrase5_g,radioEnable5_g,ssidName6_g,keyPassPhrase6_g,radioEnable6_g]
                tdkTestObj,status,newValues = tdkbE2EUtility.getMultipleParameterValues(obj,newParamList)

                step += 1
                print(f"\nTEST STEP {step}: Get the current ssid, keypassphrase, Radio enable status for 5ghz and 6ghz")
                print(f"EXPECTED RESULT {step}: Should retrieve the current ssid, keypassphrase, Radio enable status for 5ghz and 6ghz")
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    step += 1
                    print(f"\nTEST STEP {step}: Connect to the 5ghz wifi ssid from WLAN client")
                    print(f"EXPECTED RESULT {step}: Wlan client should connect to the wifi ssid")
                    status = tdkbE2EUtility.wlanConnectWifiSsid(tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,tdkbE2EUtility.wlan_5ghz_interface)
                    ...
                    if expectedresult in status:
                        ...
                        wlanIP_5ghz = tdkbE2EUtility.getWlanIPAddress(tdkbE2EUtility.wlan_5ghz_interface)
                        if wlanIP_5ghz:
                            tdkTestObj.setResultStatus("SUCCESS")
                            print(f"ACTUAL RESULT {step}: WLAN client IP is {wlanIP_5ghz}")
                            print("[TEST EXECUTION RESULT] : SUCCESS")
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                status = tdkbE2EUtility.checkIpRange(curIPAddress, wlanIP_5ghz)
                                if expectedresult in status:
                                    tdkTestObj.setResultStatus("SUCCESS")
                                    ...
                                    MAC_5GHZ = tdkbE2EUtility.getWlanMACAddress(tdkbE2EUtility.wlan_5ghz_interface)

                                    if MAC_5GHZ:
                                        tdkTestObj.setResultStatus("SUCCESS")
                                        print(f"ACTUAL RESULT {step}: MAC address of 5ghz WLAN client is {MAC_5GHZ}")
                                        print("[TEST EXECUTION RESULT] : SUCCESS")

                                        step += 1
                                        print(f"\nTEST STEP {step}: Disconnect WLAN client from the 5ghz wifi ssid")
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        if MAC_6GHZ:
                                                            ...
                                                            if expectedresult in status:
                                                                ...
                                                                # Set macFilterEnable, macFilterBlackList for 5ghz and 6ghz
                                                                setValuesList = ['true','true','true','false']
                                                                print(f"Parameter values that are set: {setValuesList}")

                                                                list1 = [macFilterEnable5_g,'true','bool']
                                                                list2 = [macFilterBlackList5_g,'true','bool']

                                                                list3 = [macFilterEnable6_g,'true','bool']
                                                                list4 = [macFilterBlackList6_g,'false','bool']

                                                                #Concatenate the lists with the elements separated by pipe
                                                                setParamList5_g = list1 + list2
                                                                ...
                                                                step += 1
                                                                print(f"\nTEST STEP {step}: Set macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
                                                                print(f"EXPECTED RESULT {step}: Should set the macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
                                                                ...
                                                                if expectedresult in actualresult and expectedresult in actualresult1:
                                                                    ...
                                                                    #Retrieve the values after set and compare
                                                                    newParamList=[macFilterEnable5_g,macFilterBlackList5_g,macFilterEnable6_g,macFilterBlackList6_g]
                                                                    tdkTestObj,status,newValues = tdkbE2EUtility.getMultipleParameterValues(obj,newParamList)

                                                                    step += 1
                                                                    print(f"\nTEST STEP {step}: Get the current macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
                                                                    print(f"EXPECTED RESULT {step}: Should Get the macFilterEnable, macFilterBlackList for 5ghz and 6ghz")
                                                                    ...
                                                                    if expectedresult in status and setValuesList == newValues:
                                                                        ...
                                                                        tdkTestObj.addParameter("paramName",f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MacFilterTable.")
                                                                        tdkTestObj.executeTestCase(expectedresult)
                                                                        actualresult = tdkTestObj.getResult()
                                                                        details = tdkTestObj.getResultDetails()

                                                                        step += 1
                                                                        print(f"\nTEST STEP {step}: Add a new MACFilter rule for 5 GHz")
                                                                        ...
                                                                        if expectedresult in actualresult:
                                                                            ...
                                                                            temp = details.split(':')
                                                                            instance5_g= temp[1]
                                                                            print(f"5ghz INSTANCE VALUE: {instance5_g}")

                                                                            if (int(instance5_g) > 0):
                                                                                ...
                                                                                if expectedresult in actualresult:
                                                                                    ...
                                                                                    if (int(instance6_g) > 0):
                                                                                        ...
                                                                                        deviceName5_g = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MacFilterTable.{instance5_g}.DeviceName"
                                                                                        deviceMAC5_g = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MacFilterTable.{instance5_g}.MACAddress"
                                                                                        ...
                                                                                        setValuesList = [tdkbE2EUtility.ssid_5ghz_name, MAC_5GHZ, tdkbE2EUtility.ssid_6ghz_name, MAC_6GHZ]

                                                                                        # Print parameter values using f-string
                                                                                        print(f"Parameter values that are set: {setValuesList}")

                                                                                        list1 = [deviceName5_g, tdkbE2EUtility.ssid_5ghz_name, 'string']
                                                                                        list2 = [deviceMAC5_g, MAC_5GHZ, 'string']
                                                                                        ...
                                                                                        setParamList5_g = "|".join(map(str, list1 + list2))
                                                                                        ...
                                                                                        if expectedresult in actualresult and expectedresult in actualresult1:
                                                                                            ...
                                                                                            #Retrieve the values after set and compare
                                                                                            newParamList=[deviceName5_g,deviceMAC5_g,deviceName6_g,deviceMAC6_g]
                                                                                                ...
                                                                                                if expectedresult in status:
                                                                                                    ...
                                                                                                    if expectedresult in status:
                                                                                                        ...
                                                                                                        if expectedresult not in status:
                                                                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                                                                            print(f"ACTUAL RESULT {step}: Connection attempt for 5ghz ssid should fail after enabling the MAC filter")
                                                                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                                                                            ...
                                                                                                            if expectedresult in status:
                                                                                                                ...
                                                                                                                print(f"ACTUAL RESULT {step}: Failed to disconnect from 5ghz WIFI SSID")
                                                                                                                print("[TEST EXECUTION RESULT] : FAILURE")
                                                                                                        else:
                                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                                            print(f"ACTUAL RESULT {step}: Connection from wlan client to 5ghz ssid is success even after enabling the MAC filter")
                                                                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                                                                    else:
                                                                                                        tdkTestObj.setResultStatus("FAILURE")
                                                                                ...
                                                                                #Delete the created table entry
                                                                                tdkTestObj = obj1.createTestStep("AdvancedConfig_DelObject")
                                                                                tdkTestObj.addParameter("paramName",f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_5ghz_index}.X_CISCO_COM_MacFilterTable.{instance5_g}." )
                                                                                tdkTestObj.executeTestCase(expectedresult)
                                                                                actualresult = tdkTestObj.getResult()
                                                                                details = tdkTestObj.getResultDetails()
                                                                                ...
                                                                                tdkTestObj.setResultStatus("FAILURE")
                                                                                print(f"Invalid INSTANCE VALUE returned for 5ghz: {instance5_g}")
                                                                        else:
                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                            print(f"ACTUAL RESULT {step}: Failed to add new rule")
                                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print(f"ACTUAL RESULT {step}: Failed to connect WLAN client to 5 ghz SSID")
                        print("[TEST EXECUTION RESULT] : FAILURE")
                else:
                    tdkTestObj.setResultStatus("FAILURE")
            ...
            list1 = [ssidName5_g,orgValue[0],'string']
            list2 = [keyPassPhrase5_g,orgValue[1],'string']
            list3 = [radioEnable5_g,orgValue[2],'bool']
            list4 = [macFilterEnable5_g,orgValue[3],'bool']
            list5 = [macFilterBlackList5_g,orgValue[4],'bool']
            ...
            #Concatenate the lists with the elements separated by pipe
            setParamList5_g = list1 + list2 + list3 + list4 + list5
