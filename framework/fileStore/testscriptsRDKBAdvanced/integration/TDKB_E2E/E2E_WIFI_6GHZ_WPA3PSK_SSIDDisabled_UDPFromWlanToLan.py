...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_SSIDDisabled_UDPFromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_SSIDDisabled_UDPFromWlanToLan')
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                #Disabling 6GHz ssid interface of the gateway
                                                setValuesList = ['false']
                                                print(f"WIFI parameter values that are set: {setValuesList}")
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    if expectedresult in status and setValuesList == newValues:
                                                        ...
                                                        step += 1
                                                        print(f"\nTEST STEP {step}: Check UDP between LAN and WLAN Client")
                                                        print(f"EXPECTED RESULT {step}: UDP request between LAN and WLAN client should fail")
                                                        status,Output,clientOutput = tdkbE2EUtility.tcp_udpInClients("WLAN","LAN",lanIP,wlanIP,"UDP")
                                                        ...
                                                        if "SUCCESS" in status and lossPercentage == "0%":
                                                            tdkTestObj.setResultStatus("FAILURE")
                                                            print(f"ACTUAL RESULT {step}: UDP traffic successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                                            ...
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            print(f"ACTUAL RESULT {step}: UDP traffic not successful between LAN and WLAN client")
                                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
