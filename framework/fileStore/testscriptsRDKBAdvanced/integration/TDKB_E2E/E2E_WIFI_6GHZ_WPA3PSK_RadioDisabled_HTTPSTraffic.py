...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_RadioDisabled_HTTPSTraffic')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_RadioDisabled_HTTPSTraffic')
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step += 1
                                                print(f"TEST STEP {step}: Set RadioEnable to false")
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    step += 1
                                                    print(f"TEST STEP {step}: Get the current radioEnable")
