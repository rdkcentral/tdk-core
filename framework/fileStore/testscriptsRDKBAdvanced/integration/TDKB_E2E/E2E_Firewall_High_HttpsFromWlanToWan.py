...
<xml>
  ...
  <name>E2E_Firewall_High_HttpsFromWlanToWan</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that when Firewall Config is set to High HTTPs traffic from WLAN to WAN should pass through</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_68</test_case_id>
    <test_objective>Verify that when Firewall Config is set to High HTTPs traffic from WLAN to WAN should pass through</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_Firewall_High_HttpsFromWlanToWan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Firewall_High_HttpsFromWlanToWan');
