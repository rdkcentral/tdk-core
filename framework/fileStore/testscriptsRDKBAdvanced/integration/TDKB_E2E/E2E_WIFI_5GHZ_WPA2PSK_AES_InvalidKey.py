...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>E2E_WIFI_5GHZ_WPA2PSK_AES_InvalidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using invalid key for 5GHZ SSID. Ensure that client should not be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_16</test_case_id>
    <test_objective>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using invalid key for 5GHZ SSID. Ensure that client should not be able to connect to WG</test_objective>
...
4. Revert the values of encryption method and security mode</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPA2PSK_AES_InvalidKey</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPA2PSK_AES_InvalidKey');
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    status = wlanConnectWifiSsid(tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_invalid_pwd,tdkbE2EUtility.wlan_5ghz_interface);
