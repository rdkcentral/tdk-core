...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_WLAN_BlockForGivenTime_WebsiteURL')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_WLAN_BlockForGivenTime_WebsiteURL')
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    step = step + 1
                                                    print(f"\nTEST STEP {step}: Check the HTTP connectivity from WLAN to blocked URL")
