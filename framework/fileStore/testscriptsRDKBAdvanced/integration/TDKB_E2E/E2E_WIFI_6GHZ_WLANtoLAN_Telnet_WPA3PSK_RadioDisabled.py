...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_WPA3PSK_RadioDisabled')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WLANtoLAN_Telnet_WPA3PSK_RadioDisabled')
