...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_BlockFTP_AllowHTTP')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_WLAN_BlockFTP_AllowHTTP')
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print(f"EXPECTED RESULT {step}: Allowed service HTTP should be reachable")
                                                    status = wgetToWAN("WGET_HTTP", wlanIP, curIPAddress)

                                                    if expectedresult in status:
                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                        print(f"ACTUAL RESULT {step}: The allowed service 'HTTP' can be reached")
                                                        print("[TEST EXECUTION RESULT] : SUCCESS")
                                                        finalStatus = "SUCCESS"
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE")
                                                        print(f"ACTUAL RESULT {step}: The allowed service 'HTTP' cannot be reached")
                                                        print("[TEST EXECUTION RESULT] : FAILURE")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE")
