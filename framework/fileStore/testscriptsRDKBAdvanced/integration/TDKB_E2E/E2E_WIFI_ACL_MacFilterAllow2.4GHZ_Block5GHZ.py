...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterAllow2.4GHZ_Block5GHZ')
obj1.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterAllow2.4GHZ_Block5GHZ')
obj2.configureTestCase(ip,port,'E2E_WIFI_ACL_MacFilterAllow2.4GHZ_Block5GHZ')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() and loadmodulestatus2.upper() :
