    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            if tdkbE2EUtility.mlo_capability == "False":
                ...
                step = step + 1
                setList = ['10.0.0.1','255.0.0.0','10.0.0.2','10.0.0.253']
            ...
            if status == "SUCCESS":
                ...
                if expectedresult in status:
                    ...
                    if wlanSubnetMask:
                        ...
                        step = step + 1
                        print(f"\nTEST STEP {step}: Check whether subnet mask is 255.0.0.0")
                        ...
                        if expectedresult in opstatus:
                            tdkTestObj.setResultStatus("SUCCESS")
                            print(f"ACTUAL RESULT {step}: The subnet mask is 255.0.0.0")
                            print("[TEST EXECUTION RESULT] : SUCCESS")
                            ...
                            tdkTestObj.setResultStatus("FAILURE")
                            print(f"\nTEST STEP {step}:The subnet mask is not 255.0.0.0")
                    else:
                        tdkTestObj.setResultStatus("FAILURE")
