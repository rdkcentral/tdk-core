...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockFTP_AllowHTTP')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockFTP_AllowHTTP')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_6GHZ_BlockFTP_AllowHTTP')
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the FTP Service and allow HTTP
