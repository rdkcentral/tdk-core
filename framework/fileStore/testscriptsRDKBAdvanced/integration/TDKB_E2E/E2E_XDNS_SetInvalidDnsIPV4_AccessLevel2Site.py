...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_XDNS_SetInvalidDnsIPV4_AccessLevel2Site</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set Invalid DNSIPV4 address and try to access the level2 site</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Set Invalid DNSIPV4 address and try to access the level2 site</test_objective>
...
12. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_XDNS_SetInvalidDnsIPV4_AccessLevel2Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_SetInvalidDnsIPV4_AccessLevel2Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_SetInvalidDnsIPV4_AccessLevel2Site');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = [lanMAC,"A.B.C.D",tdkbE2EUtility.xdns_level2_ipv6_dns_server,"Default"];
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in  actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level2 site accessible after setting invalid dnsipv4 address")
                                                print("EXPECTED RESULT 9:The level2 site should be accessible after setting invalid dnsipv4 address")
                                                print("[TEST EXECUTION RESULT] : SUCCESS");
                                                finalStatus = "SUCCESS"
                                            else:
