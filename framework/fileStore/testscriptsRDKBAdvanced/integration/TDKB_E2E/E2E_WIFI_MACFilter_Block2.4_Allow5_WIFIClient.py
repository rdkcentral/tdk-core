...
<xml>
  ...
  <name>E2E_WIFI_MACFilter_Block2.4_Allow5_WIFIClient</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that MAC address based Access control allows 5GHZ SSID to connect to WG and deny access for 2.4GHZ SSID.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_46</test_case_id>
    <test_objective>Verify that MAC address based Access control allows 5GHZ SSID to connect to WG and deny access for 2.4GHZ SSID.</test_objective>
...
7. Enable MACFilter.Enable and disable MACFilter.FilterAsBlackList of 5GHZ accesspoint
8. Enable both MACFilter.Enable and MACFilter.FilterAsBlackList of 2.4GHZ accesspoint
...
13.Try to connect the blocked client to the GW's 5GHZ SSID. That connection attempt should be success
14.Try to connect the blocked client to the GW's 2.4GHZ SSID. That connection attempt should fail
15.Delete the added rules and revert all params values
16.Unload tdkb_e2e module</automation_approch>
    <except_output>Connection attempt to 5GHZ SSID should succeed and connection to 2.4GHZ should fail</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_MACFilter_Block2.4_Allow5_WIFIClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block2.4_Allow5_WIFIClient');
obj1.configureTestCase(ip,port,'E2E_WIFI_MACFilter_Block2.4_Allow5_WIFIClient');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            print("TEST STEP 1: Get the current ssid,keypassphrase,Radio enable status")
            print("EXPECTED RESULT 1: Should retrieve the current ssid,keypassphrase,Radio enable status")
            ...
            if expectedresult in actualresult and expectedresult in actualresult1:
                ...
                print("ACTUAL RESULT 2: %s %s" %(details,details1));
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        if expectedresult in status:
                                                            ...
                                                            if MAC5:
                                                                ...
                                                                list2 = [macFilterBlackList2,'true','bool']

                                                                list3 = [macFilterEnable5,'true','bool']
                                                                list4 = [macFilterBlackList5,'false','bool']
                                                                                ...
                                                                                if expectedresult in actualresult:
                                                                                    ...
                                                                                    if (int(instance5) > 0):
                                                                                        ...
                                                                                        if expectedresult in actualresult and expectedresult in actualresult1:
                                                                                            ...
                                                                                            print("ACTUAL RESULT 16: %s %s" %(details, details1));
                                                                                            print("[TEST EXECUTION RESULT] : SUCCESS");
                                                                                            ...
                                                                                            if expectedresult in status and setValuesList == newValues:
                                                                                                ...
                                                                                                #Connect to the 5GHZ wifi ssid from wlan client after enabling MAC filtering
                                                                                                print("TEST STEP 18: From wlan client, try to Connect to the 5GHZ wifi ssid with mac filtering enabled")
                                                                                                status = wlanConnectWifiSsid(tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,tdkbE2EUtility.wlan_5ghz_interface);
                                                                                                if expectedresult in status:
                                                                                                    tdkTestObj.setResultStatus("SUCCESS");
                                                                                                    ...
                                                                                                    if expectedresult in status:
                                                                                                        tdkTestObj.setResultStatus("SUCCESS");
                                                                                                        print("Disconnect from WIFI SSID: SUCCESS")
                                                                                                        #Connect to the 2.4ghz wifi ssid from wlan client after enabling MAC filtering
                                                                                                        print("TEST STEP 20: From wlan client, try to Connect to the 2.4GHz wifi ssid with mac filtering enabled")
                                                                                                        status = wlanConnectWifiSsid(tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,tdkbE2EUtility.wlan_2ghz_interface);
                                                                                                        if expectedresult not in status:
                                                                                                            ...
                                                                                                            if expectedresult in status:
                                                                                                                ...
                                                                                                                tdkTestObj.setResultStatus("FAILURE");
                                                                                                                print("TEST STEP 21:Disconnect from 2.4GHz WIFI SSID: FAILED")
                                                                                                    else:
                                                                                                        tdkTestObj.setResultStatus("FAILURE");
                                                                                                        print("TEST STEP 19:Disconnect from 5GHz WIFI SSID: FAILED")
                                                                                                else:
                                                                                                    tdkTestObj.setResultStatus("FAILURE");
                                                                                                    print("EXPECTED RESULT 18: Connection attempt should be success after enabling the MAC filter")
                                                                                                    print("ACTUAL RESULT 18: Connection from client failed after enabling the MAC filter")
                                                                                            else:
                                                                                                tdkTestObj.setResultStatus("FAILURE");
                                                                                                print("TEST STEP 17: Get the current value of name and MAC of client device in the filter")
                                                                                                print("EXPECTED RESULT 17: Should retrieve the current name and mac of client device in the filter")
                                                                                            ...
                                                                                            print("TEST STEP 16: Set the name and MAC of client device in the filter")
                                                                                            print("EXPECTED RESULT 16: Should set the name and MAC of client device in the filter")
                                                                                            print("ACTUAL RESULT 16: %s" %(details, details1));
                                                                                            print("[TEST EXECUTION RESULT] : FAILURE");
                                                                                    ...
                                                                                    print("TEST STEP 15: Adding new Mac filter rule");
                                                                                    print("EXPECTED RESULT 15: Should add new rule");
                                                                                    print("ACTUAL RESULT 15: adding new rule failed%s" %details);
                                                                                    print("[TEST EXECUTION RESULT] : FAILURE");
                                                                ...
                                                                tdkTestObj.setResultStatus("FAILURE");print("[TEST EXECUTION RESULT] : FAILURE")
            ...
            if expectedresult in actualresult and expectedresult in actualresult1 and expectedresult in finalStatus1 and expectedresult in finalStatus2:
                ...
                print("ACTUAL RESULT 20: %s %s" %(details,details1));
                print("[TEST EXECUTION RESULT] : %s %s" %(actualresult, actualresult1));
            else:
                tdkTestObj.setResultStatus("FAILURE");
                print("TEST STEP 20: Set the ssid,keypassphrase,Radio enable status,macFilterEnable, macFilterBlackList")
