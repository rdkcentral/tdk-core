...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_FirewallLow_UDPFromWlanToLan');
            ...
            if expectedresult in status:
                ...
                if tdkbE2EUtility.ssid_name == orgValue[0] and tdkbE2EUtility.ssid_pwd == orgValue[1]:
                    ...
                    if expectedresult in firewallResult:
                        tdkTestObj.setResultStatus("SUCCESS")
                        print("TEST STEP 2: Set firewallLevel to Low")
                        print("EXPECTED RESULT 2: Should set firewallLevel to Low")
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print("TEST STEP 2: Set firewallLevel to Low: FAILED")
