...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_PingRouterPublicIP');
                ...
                if tdkbE2EUtility.ssid_name == orgValue[0] and tdkbE2EUtility.ssid_pwd == orgValue[1]:
                    ...
                    if expectedresult in status:
                        ...
                        if wlanIP:
                            ...
                            print("TEST STEP 4: Get the current GW IP address")
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 6: Check the PING from WLAN to router's public WAN IP")
                                    status = verifyNetworkConnectivity(tdkbE2EUtility.gw_wan_ip, "PING", wlanIP, curIPAddress)
                                    if expectedresult in status:
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("Ping successful from WLAN to router's public WAN IP")
                                        ...
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("TEST STEP 6: Ping from WLAN to router's public WAN IP failed")
                                else:
                                    tdkTestObj.setResultStatus("FAILURE");
