...
<xml>
  ...
  <name>E2E_WEBUI_LAN_AdminAccountLockout</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if account is locked for 3 incorrect login attempts</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_505</test_case_id>
    <test_objective>To check if account is locked for 3 incorrect login attempts</test_objective>
...
9. unload module</automation_approch>
    <except_output>Account should be locked after 3 incorrect login attempts</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_AdminAccountLockout</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_AdminAccountLockout');
