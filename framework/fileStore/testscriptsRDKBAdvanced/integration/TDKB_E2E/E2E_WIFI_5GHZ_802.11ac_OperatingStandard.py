...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_802.11ac_OperatingStandard</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that only 802.11ac clients should be able to connect to WG, when mode is 'ac' for frequency band 5GHZ</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
3. Set operating standard "ac" using tdkb_e2e_SetMultipleParams
3. Try to connect to Wifi client and check whether the wifi client is connected to the DUT using operating standard "ac"
4. Revert the values of operating standard</automation_approch>
    <except_output>WIFI client should be able to connect to the DUT with the using operating standard "ac"</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_802.11ac_OperatingStandard</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_802.11ac_OperatingStandard');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the operating standard as 'ac'
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'ac'];
            ...
            list3 = [operatingStandard,'ac','string']
