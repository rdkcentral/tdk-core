...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_WPAWPA2PSK_AESTKIP_InvalidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPAWPA2-PSK (TKIP/AES)á encryption security mechanism using invalid key for 5GHZ SSID. Ensure that client should not be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_18</test_case_id>
    <test_objective>Verify whether WG supports WPAWPA2-PSK (TKIP/AES)Ã¡ encryption security mechanism using invalid key for 5GHZ SSID. Ensure that client should not be able to connect to WG</test_objective>
...
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPAWPA2PSK_AESTKIP_InvalidKey');
