...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerTCP</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_606</test_case_id>
...
6. To the added instance, configure the rule: Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - BOTH, Target Protocol - BOTH, Description - MyPTRule
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerTCP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerTCP');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerTCP');
            ...
            if lanIP != "":
                ...
                if expectedresult in status and curIPAddress:
                    ...
                    if expectedresult in status:
                        ...
                        print("[TEST EXECUTION RESULT] : SUCCESS");
                        #Set the Port Triggering rule and enable it:- Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - BOTH, Target Protocol - TCP, Description - MyPTRule
                        step = step + 1
                        triggerStart = "12345"
                        triggerEnd = "12345"
                        targetStart = "5001"
                        ...
                        if expectedresult in status:
                            ...
                            if expectedresult in status:
                                ...
                                target_protocol = "TCP"
                                status = PTinitServer("IPERF", lanIP, targetStart, target_protocol, tdkbE2EUtility.server_logfile, source="LAN")
                                if expectedresult in status:
                                    tdkTestObj.setResultStatus("SUCCESS");
                                    ...
                                    if expectedresult in status:
                                        ...
                                        print("EXPECTED RESULT %d: IPERF client running in WAN machine should connect to the server running in LAN with the GW WAN IP of DUT" %step)
                                        #Since targetProtocol BOTH is not supported in server side, passing the trigger protocol TCP
