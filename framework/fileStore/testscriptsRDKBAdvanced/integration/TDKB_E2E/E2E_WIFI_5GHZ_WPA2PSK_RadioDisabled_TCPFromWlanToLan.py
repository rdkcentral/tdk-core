...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_TCPFromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that tcp traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_220</test_case_id>
    <test_objective>Verify that tcp traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled.</test_objective>
...
4. Disable radio and usinf iperf check tcp traffic from wlan to lan
...
6. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_TCPFromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_TCPFromWlanToLan');
                                            ...
                                            if expectedresult in actualresult:
                                                ...
                                                if expectedresult in status and setValuesList == newValues:
                                                    ...
                                                    if "SUCCESS" in status:
                                                        ...
                                                        tdkTestObj.setResultStatus("SUCCESS");
                                                        print("TEST STEP 12: SUCCESS: TCP from WLAN to LAN failed")
                                                        finalStatus = "SUCCESS"
