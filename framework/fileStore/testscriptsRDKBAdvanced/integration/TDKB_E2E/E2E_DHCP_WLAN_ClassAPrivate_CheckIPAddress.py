...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_WLAN_ClassAPrivate_CheckIPAddress')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        #Get the value of the wifi and lan parameters that are currently set.
        step = 1
        status = "SUCCESS"
        ...
        if expectedresult in status:
            ...
            if tdkbE2EUtility.mlo_capability == "False":
                ...
                #Set the Lan IP Addres, Lan Subnet Mask, Min and Max address
                step = step + 1
            ...
            if tdkbE2EUtility.mlo_capability == "False":
                ...
                #Revert the Lan IP Addres, Lan Subnet Mask, Min and Max address
                step = step + 1
