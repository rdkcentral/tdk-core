...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_802.11ac_AutoGuardInterval_80MHzBW</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether Wireless client can connect to WG when Guard interval is auto and Channel BW is 80MHZ for frequency band 5GHZ (802.11ac clients only)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_29</test_case_id>
    <test_objective>Verify whether Wireless client can connect to WG when Guard interval is auto and Channel BW is 80MHZ for frequency band 5GHZ (802.11ac clients only)</test_objective>
...
3. Set Guardinterval and channelBW to Auto and 80MHz using tdkb_e2e_SetMultipleParams
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_802.11ac_AutoGuardInterval_80MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the Guard interval as "Auto" and ChannelBW as "80MHz"
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'Auto','80MHz'];
