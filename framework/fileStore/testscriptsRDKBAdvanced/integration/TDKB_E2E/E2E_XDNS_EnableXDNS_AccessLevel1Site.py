...
<xml>
  ...
  <name>E2E_XDNS_EnableXDNS_AccessLevel1Site</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Enable xDNS and setup default parameters (level1). Try to access websites and check if the default parameter policies are applied</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Enable xDNS and setup default parameters (level1). Try to access websites and check if the default parameter policies are applied</test_objective>
...
8. From LAN client do a nslookup to any level1 site via level1 dns server
...
12. Unload tdkb_e2e module</automation_approch>
    <except_output>Nslookup shouldn't resolve level1 site succesfully</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_XDNS_EnableXDNS_AccessLevel1Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_EnableXDNS_AccessLevel1Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_EnableXDNS_AccessLevel1Site');
