...
<xml>
  ...
  <name>E2E_WEBUI_LAN_Admin_DefaultPassword</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Default_PWD when Device.Users.User.3.X_RDKCENTRAL-COM_PasswordReset is set true</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_510</test_case_id>
    <test_objective>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Default_PWD when Device.Users.User.3.X_RDKCENTRAL-COM_PasswordReset is set true</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components in DUT should be in a running state that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword</input_parameters>
...
6. Set Device.Users.User.3.X_RDKCENTRAL-COM_PasswordReset to true
7. Login with default password
8. Check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Default_PWD
9. Kill selenium hub and node
10. unload module</automation_approch>
    <except_output> Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword should give Default_PWD when Device.Users.User.3.X_RDKCENTRAL-COM_PasswordReset is set true</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script> E2E_WEBUI_LAN_Admin_DefaultPassword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,' E2E_WEBUI_LAN_Admin_DefaultPassword');
tadobj.configureTestCase(ip,port,' E2E_WEBUI_LAN_Admin_DefaultPassword');
pamobj.configureTestCase(ip,port,' E2E_WEBUI_LAN_Admin_DefaultPassword');

#Get the result of connection with test component
loadmodulestatus =obj.getLoadModuleResult();
loadmodulestatus1 =tadobj.getLoadModuleResult();
                        ...
                        if expectedresult in status:
                            ...
                            if status == "SUCCESS":
                                try:
                                    ...
                                    time.sleep(30);
                                    print("TEST STEP 6: Get the value of compare password")
                                    param = "Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword"
                                    tdkTestObj,status,password = getParameterValue(obj,param)
                                    if expectedresult in status and password == "Default_PWD":
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("TEST STEP 7: Check if compare password gives Default_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Default_PWD")
                                        print("ACTUAL RESULT 7: Compare password value:%s" %password);
                                        print("[TEST EXECUTION RESULT] : SUCCESS");
                                        ...
                                        print("TEST STEP 7: Check if compare password gives Default_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Default_PWD")
                                        print("ACTUAL RESULT 7: Failed to get compare password value as Default_PWD");
