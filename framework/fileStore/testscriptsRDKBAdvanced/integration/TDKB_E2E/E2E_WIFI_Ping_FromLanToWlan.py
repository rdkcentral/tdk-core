...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_Ping_FromLanToWlan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            print("TEST STEP 8: Check the PING from LAN to WLAN");
                                            ...
                                            if expectedresult in status:
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 8: Ping from LAN to WLAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
