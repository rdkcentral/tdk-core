...
<xml>
  ...
  <name>E2E_WAN_HttpTo5GWLan_WPA2PSK</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that http connection from WAN to 5GHZ WLAN client with WPA2PSK security mode is not success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_539</test_case_id>
    <test_objective>Verify that http connection from WAN to 5GHZ WLAN client ip is not success</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WAN_HttpTo5GWLanClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WAN_HttpTo5GWLan_WPA2PSK');
