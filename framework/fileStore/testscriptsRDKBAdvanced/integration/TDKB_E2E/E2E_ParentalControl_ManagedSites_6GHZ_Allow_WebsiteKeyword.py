...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteKeyword')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteKeyword')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_6GHZ_Allow_WebsiteKeyword')
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if int(instance) > 0:
                                ...
                                #SET the parameters to block the url using keyword
                                            ...
                                            if wlanIP:
                                                ...
                                                if expectedresult in status and curIPAddress:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        status = tdkbE2EUtility.addStaticRoute(tdkbE2EUtility.allowed_url, curIPAddress,tdkbE2EUtility.wlan_6ghz_interface)
                                                        if expectedresult in status:
                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                            ...
                                                            print(f"EXPECTED RESULT {step}: Http connection should be success")
                                                            status = tdkbE2EUtility.parentalCntrlWgetToWAN("WGET_HTTP", wlanIP, curIPAddress,tdkbE2EUtility.allowed_url)
                                                            ...
                                                            status = tdkbE2EUtility.delStaticRoute(tdkbE2EUtility.allowed_url, curIPAddress,tdkbE2EUtility.wlan_6ghz_interface)
                                                            if expectedresult in status:
                                                                tdkTestObj.setResultStatus("SUCCESS")
