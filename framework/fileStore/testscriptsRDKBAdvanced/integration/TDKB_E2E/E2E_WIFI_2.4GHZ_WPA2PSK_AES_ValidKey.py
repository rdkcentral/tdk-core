...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>72</version>
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_AES_ValidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using valid key for 2.4GHZ SSID. Ensure that client should be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_01</test_case_id>
    <test_objective>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using valid key for 2.4GHZ SSID. Ensure that client should be able to connect to WG</test_objective>
...
4. Revert the values of encryption method and security mode</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WPA2PSK_AES_ValidKey</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_AES_ValidKey');
