...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_800nsGuardInterval_40MHzBW</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_14</test_case_id>
...
Device.WiFi.Radio.1.OperatingChannelBandwidth : 40MHz</input_parameters>
    <automation_approch>1. Load tdkb_e2e module
2. Using tdkb_e2e_Get, get and save GuardInterval and channelBW
3. Set Guardinterval and channelBW to 800nsec and 40MHz using tdkb_e2e_SetMultipleParams
...
4. Revert the values of guardinterval and channelBW
    ...
    <test_script>E2E_WIFI_2.4GHZ_800nsGuardInterval_40MHzBW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_800nsGuardInterval_40MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the Guard interval as "800ns" and ChannelBW as "40MHz"
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'800nsec','40MHz'];
