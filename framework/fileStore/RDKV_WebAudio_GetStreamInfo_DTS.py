    ...
    if expectedResult in pre_req_status:
        ...
        if status == "SUCCESS" :
            if log_check_method == "WebinspectPageLogs":
                ...
                webinspect_logs=WebAudiolib.webaudio_getLogs_webinspectpage(obj,app_name,grep_line,[["9","9","9","9","9","13"],[]])
                ...
                webinspect_logs = WebAudiolib.webaudio_getLogs_fromDevicelogs(obj,app_name,grep_line,[["9","9","9","9","9","13"],[]])
            if webinspect_logs != "":
