...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_FMSynthesisTest</name>
  <primitive_test_id/>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_WebAudio_FMSynthesisTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_FMSynthesisTest');
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if status == "SUCCESS" :
            navigate_key = ["9","9","9","9","9","9","9","9","9","13"]
            select_key = ["9","13"]
