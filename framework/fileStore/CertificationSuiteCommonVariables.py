...
#REST API url for getting the output of a command from DUT(only if applicable)
rest_url = ""

#Method of authentication for the REST API access. The default method is token.
auth_method = "TOKEN"
