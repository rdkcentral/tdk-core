...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_NPVS_CheckLatency_Seek_Forward_HEVC');
...
if "SUCCESS" in result.upper():
    ...
    #Retrieve the value of configuration parameter 'NATIVE_PLAYBACK_TRICKPLAY_LATENCY_THRESHOLD' that specifies the  latency threshold in milliseconds
    tdkTestObj = obj.createTestStep('getDeviceConfigValue')
    tdkTestObj.addParameter("configKey","NATIVE_PLAYBACK_TRICKPLAY_LATENCY_THRESHOLD")
    tdkTestObj.executeTestCase(expectedResult);
    actualresult = tdkTestObj.getResult();
    latencyThresholdValueConfigValue = tdkTestObj.getResultDetails();

    #If the value of NATIVE_PLAYBACK_TRICKPLAY_LATENCY_THRESHOLD is retrieved correctly and its value is not empty, latency threshold value should be passed to the test application
    ...
    #Retrieve the value of configuration parameter 'NATIVE_PLAYBACK_SEEK_POSITION' that specifies the video position in seconds to which the pipeline should seek
    tdkTestObj = obj.createTestStep('getDeviceConfigValue')
    tdkTestObj.addParameter("configKey","NATIVE_PLAYBACK_SEEK_POSITION")
    tdkTestObj.executeTestCase(expectedResult);
    actualresult = tdkTestObj.getResult();
    seek_position = tdkTestObj.getResultDetails();

    #If the value of NATIVE_PLAYBACK_SEEK_POSITION is retrieved correctly and its value is not empty, seek_position value should be passed to the test application
