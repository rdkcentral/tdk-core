...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_MEMORY_MODEL');
...
info_filename = "dEQP-VK.memory_model"
qpa_file_name = "memory_model.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS MEMORY MODEL : %s" %details)
