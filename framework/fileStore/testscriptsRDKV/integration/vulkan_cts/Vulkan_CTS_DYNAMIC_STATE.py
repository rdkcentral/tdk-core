...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_DYNAMIC_STATE');
...
info_filename = "dEQP-VK.dynamic_state"
qpa_file_name = "dynamic_state.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS DYNAMIC-STATE : %s" %details)
