...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_RASTERIZATION');
...
info_filename = "dEQP-VK.rasterization"
qpa_file_name = "rasterization.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS RASTERIZATION : %s" %details)
