...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_SYNCHRONIZATION');
...
info_filename = "dEQP-VK.synchronization"
qpa_file_name = "synchronization.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS SYNCHRONIZATION : %s" %details)
