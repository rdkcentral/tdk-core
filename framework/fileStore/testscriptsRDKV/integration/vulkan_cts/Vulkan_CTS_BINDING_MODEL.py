...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_BINDING_MODEL');
...
info_filename = "dEQP-VK.binding_model"
qpa_file_name = "binding_model.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS BINDING-MODEL : %s" %details)
