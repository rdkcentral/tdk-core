...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Vulkan_CTS_DEVICE_GROUP');
...
info_filename = "dEQP-VK.device_group"
qpa_file_name = "device_group.qpa"
...
if expectedresult in result.upper():
    ...
    print ("Vulkan CTS Device Group : %s" %details)
