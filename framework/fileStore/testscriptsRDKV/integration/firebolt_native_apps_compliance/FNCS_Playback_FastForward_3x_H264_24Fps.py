...
<xml>
  ...
  <name>FNCS_Playback_FastForward_3x_H264_24Fps</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do fast forward of a 24 Fps H264 stream with playback rate 3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_239</test_case_id>
    <test_objective>Test to do fast forward of a 24 Fps H264 stream with playback rate 3</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RDK TV,Video Accelerator, RPI</test_setup>
    <pre_requisite>1.tdk_mediapipelinetests_trickplay application should be installed in the DUT
2. Test stream url for an 24 Fps H264 stream should be updated in the config variable video_src_url_dash_h264_24fps inside MediaValidationVariables.py library inside filestore
...
test_url - 24 Fps H264 url from MediaValidationVariables library (MediaValidationVariables.video_src_url_dash_h264_24fps)
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_FastForward_3x_H264_24Fps</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_FastForward_3x_H264_24Fps');
...
if "SUCCESS" in result.upper() and supported != "no":
    ...
    # Sample operations strings is "operations=fastforward3x:30"
    tdkTestObj = obj.createTestStep('setOperations')
    tdkTestObj.addParameter("operation","fastforward3x")
