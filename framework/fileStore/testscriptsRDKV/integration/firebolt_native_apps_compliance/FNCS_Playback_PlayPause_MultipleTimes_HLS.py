...
<xml>
  ...
  <name>FNCS_Playback_PlayPause_MultipleTimes_HLS</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_180</test_case_id>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0" or it contains the string "failed: 0"</expected_output>    
    ...
    <test_script>FNCS_Playback_PlayPause_MultipleTimes_HLS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_PlayPause_MultipleTimes_HLS');
...
if "SUCCESS" in result.upper():
    ...
    if expectedResult in actualresult.upper() and output:
        ...
        if expectedResult in executionStatus:
            ...
            print("Multiple play,pause operations on HLS stream was failed")
    else:
        tdkTestObj.setResultStatus("FAILURE")
