...
<xml>
  ...
  <name>FNCS_Playback_Set_Rate_0.5x_H264_24Fps</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do set rate operation of a 24 Fps H264 stream with playback rate 0.5</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_249</test_case_id>
    <test_objective>Test to do set rate operation of a 24 Fps H264 stream with playback rate 0.5</test_objective>
...
operations=slowMotion0.5x:&lt;timeout&gt; - a ":" seperated string to specify the slowMotion operation to be executed and the time in seconds for which the operation should be continued. The timeout should be configured in the device configuration(FIREBOLT_COMPLIANCE_MEDIAPLAYBACK_TIMEOUT) from Device Config file
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0" or it contains the string "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Set_Rate_0.5x_H264_24Fps</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Set_Rate_0.5x_H264_24Fps');
...
if "SUCCESS" in result.upper():
    ...
    # Sample operations strings is "operations=slowMotion0.5x:20"
    tdkTestObj = obj.createTestStep('setOperations')
    tdkTestObj.addParameter("operation","slowMotion0.5x")
