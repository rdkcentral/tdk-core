...
<xml>
  ...
  <name>FNCS_Playback_Appsrc_Video_Underflow_Signal_4K_VP9</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_289</test_case_id>
...
2. Test stream url for an Appsrc_Video_Underflow_Signal_4k_VP9 stream should be updated in the config variable video_src_url_webm_4k_vp9 inside MediaValidationVariables.py library inside filestore
...
test_url - Appsrc_Video_Underflow_Signal_4k_VP9 url from MediaValidationVariables library (MediaValidationVariables.video_src_url_h264_30fps)
...
Checkpoint 2. Verify that the output returned from tdk_mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Appsrc_Video_Underflow_Signal_4K_VP9</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Appsrc_Video_Underflow_Signal_4K_VP9');
...
if "SUCCESS" in result.upper():
    ...
    #Sample command = "tdk_mediapipelinetests test_appsrc_video_underflow_signal <Appsrc_Video_Underflow_Signal_VP9_STREAM_URL> checkavstatus=yes timeout=20"
