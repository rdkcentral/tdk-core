...
<xml>
  ...
  <name>FNCS_Playback_PlayPause_ExtendedDuration_H264</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_172</test_case_id>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0" or it contains the string "failed: 0"</expected_output>    
    ...
    <test_script>FNCS_Playback_PlayPause_ExtendedDuration_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_PlayPause_ExtendedDuration_H264');
