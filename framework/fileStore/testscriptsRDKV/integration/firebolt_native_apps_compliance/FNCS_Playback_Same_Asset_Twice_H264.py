...
<xml>
  ...
  <name>FNCS_Playback_Same_Asset_Twice_H264</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_15</test_case_id>
...
2. Test stream url for an H264 stream should be updated in the config variable video_src_url_h264 inside MediaValidationVariables.py library inside filestore
...
test_url - H264 url from MediaValidationVariables library (MediaValidationVariables.video_src_url_h264)
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Same_Asset_Twice_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Same_Asset_Twice_H264');
