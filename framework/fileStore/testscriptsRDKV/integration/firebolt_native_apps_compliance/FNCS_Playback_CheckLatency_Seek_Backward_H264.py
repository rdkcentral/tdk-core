...
<xml>
  ...
  <name>FNCS_Playback_CheckLatency_Seek_Backward_H264</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do backward seek on a H264 stream and verify latency </synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_221</test_case_id>
    <test_objective>Test to do backward seek on a H264 stream and verify latency</test_objective>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_CheckLatency_Seek_Backward_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_CheckLatency_Seek_Backward_H264');
