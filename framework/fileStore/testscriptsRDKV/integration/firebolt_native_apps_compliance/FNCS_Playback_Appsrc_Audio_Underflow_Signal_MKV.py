...
<xml>
  ...
  <name>FNCS_Playback_Appsrc_Audio_Underflow_Signal_MKV</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_298</test_case_id>
...
3.Retrieve the audio_src_url_mkv variable from MediaValidationVariables library
...
Checkpoint 2. Verify that the output returned from tdk_mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Appsrc_Audio_Underflow_Signal_MKV</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Appsrc_Audio_Underflow_Signal_MKV');
...
if "SUCCESS" in result.upper():
    ...
    #Sample command = "tdk_mediapipelinetests test_appsrc_audio_underflow_signal <Appsrc_Audio_Underflow_Signal_AV1_STREAM_URL> checkavstatus=yes timeout=20"
