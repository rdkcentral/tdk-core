...
<xml>
  ...
  <name>FNCS_Playback_Audio_Change_AC3_AAC</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_121</test_case_id>
...
2. Test stream url for a multi codec AC3 AAC stream should be updated in the config variable video_src_url_ac3_aac inside MediaValidationVariables.py library inside filestore.
...
test_url - multi codec url with AC3 and AAC audio streams from MediaValidationVariables library (MediaValidationVariables.video_src_url_ac3_aac)
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FNCS_Playback_Audio_Change_AC3_AAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Audio_Change_AC3_AAC');
...
if "SUCCESS" in result.upper():
    ...
    test_url = MediaValidationVariables.video_src_url_ac3_aac
    ...
    #Sample command = "mediapipelinetests test_audio_change <AC3_STREAM_URL> checkavstatus=yes timeout=20"
