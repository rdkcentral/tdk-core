...
<xml>
  ...
  <name>FNCS_Playback_FastForward_3x_MKV</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do fast forward of a MKV stream with playback rate 3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_303</test_case_id>
    <test_objective>Test to do fast forward of a MKV stream with playback rate 3</test_objective>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_FastForward_3x_MKV</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_FastForward_3x_MKV');
