...
<xml>
  ...
  <name>Rialto_Server_Start_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify if rialto server is running after launching cobalt dac bundle</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RIALTO_CONTAINER_01</test_case_id>
    <test_objective>To verify if rialto server is running after launching cobalt dac bundle</test_objective>
    ...
    <api_or_interface_used>LISA.1.install,LISA.1.getList, org.rdk.RDKShell.1.launchApplication, org.rdk.RDKShell.1.setFocus, org.rdk.RDKShell.1.kill</api_or_interface_used>
    ...
    5. check if RialtoServer is running after cobalt application is launched.
    6. kill the cobalt application</automation_approch>
    <expected_output>RialtoServer must be running after launching cobalt application</expected_output>
    <priority>High</priority>
    <test_stub_interface>LISA, RDKShell</test_stub_interface>
    <test_script>Rialto_Server_Start_Test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rialto_Server_Start_Test');
