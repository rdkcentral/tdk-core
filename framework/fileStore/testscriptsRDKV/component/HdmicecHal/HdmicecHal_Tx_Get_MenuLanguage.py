...
<xml>
  ...
  <name>HdmicecHal_Tx_Get_MenuLanguage</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to get the currently set menu language</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HdmicecHal_05</test_case_id>
    <test_objective>Test Script to get the currently set menu language</test_objective>
...
6. Unload the module</automation_approch>
    ...
    <test_script>HdmicecHal_Tx_Get_MenuLanguage</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'HdmicecHal_Tx_Get_MenuLanguage');
