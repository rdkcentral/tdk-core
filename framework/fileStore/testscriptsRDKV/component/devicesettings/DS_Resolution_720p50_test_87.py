...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>662</id>
  <version>1</version>
  <name>DS_Resolution_720p50_test_87</name>
  <primitive_test_id>83</primitive_test_id>
  <primitive_test_name>DS_SetResolution</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the 720p50 Resolution of Video Output Port
...
Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_87</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution setting with 720p50</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_720p50_test_87</test_script>
    <skipped>No</skipped>
