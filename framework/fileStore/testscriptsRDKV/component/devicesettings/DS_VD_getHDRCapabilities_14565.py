...
<xml>
  ...
  <name>DS_VD_getHDRCapabilities_14565</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>get HDR Capabilities an check if it returns 0
RDK-14565</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'DS_VD_getHDRCapabilities_14565');
