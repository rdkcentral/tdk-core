...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>657</id>
  <version>4</version>
  <name>DS_SetColor_invalid_test_37</name>
  ...
  <status>FREE</status>
  <synopsis>This test script Sets and gets the truncated value of the Invalid Color for the Front panel Indicator
Test Case ID : CT_DS_37.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_37</test_case_id>
    <test_objective>Device Setting – Get and Set the color of the POWER LED to truncated value of INVALID color.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetColor_invalid_test_37</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>Agent Crash</remarks>
  </test_cases>
</xml>
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		setcolor = "%s"%(color & 0x00FFFFFF);
			...
			if setcolor in  color:
				tdkTestObj.setResultStatus("SUCCESS");
	                        print "SUCCESS :Failed to get and set the invalid color, instead color is set to %s"%color;
			else:
				tdkTestObj.setResultStatus("FAILURE");
				print "FAILURE : Application Failed to set truncated value of color";
                else:
                        tdkTestObj.setResultStatus("FAILURE");
