...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>193</id>
  <version>2</version>
  <name>DS_SetBrightness test_01</name>
  <primitive_test_id>76</primitive_test_id>
  <primitive_test_name>DS_SetBrightness</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the Brightness of the given Front panel Indicator
Test Case ID : CT_DS_01</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_1</test_case_id>
    <test_objective>Device Setting – Get and Set brightness for front panel Indicator</test_objective>
...
E.g.: Range 0 to 100</input_parameters>
...
6.TM makes RPC calls for getting the POWER Indicator brightness value from Device_Settings_Agent and verify whether the brightness has changed.</automation_approch>
    <except_output>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetBrightness test_01</test_script>
    <skipped>No</skipped>
