...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DS_FP_getColorMode_153</name>
  <primitive_test_id/>
  <primitive_test_name>DS_FP_getColorMode</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script is used to get the color mode (single or multi color mode) of the front panel indicator.
TestcaseID: CT_DS153</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_153</test_case_id>
    <test_objective>This test script is used to get the color mode (single or multi color mode) of the front panel indicator.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. dsMgrMain should be up and running.
2. IARMDaemonMain should be up and running.</pre_requisite>
    <api_or_interface_used>int  getColorMode()</api_or_interface_used>
    <input_parameters>string indicator_name ("Message", "Power", "Record", "Remote" and "RfByPass")</input_parameters>
    <automation_approch>1. TM loads the Device_Settings_Agent via the test agent.
2.Device_Settings_Agent will get the front panel indicator color mode.
...
4.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    ...
    <test_script>DS_FP_getColorMode_153</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DS_FP_getColorMode_153');
