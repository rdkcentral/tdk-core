...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>625</id>
  <version>2</version>
  <name>DS_SetDFC_FULL_ZOOM_test_75</name>
  <primitive_test_id>79</primitive_test_id>
  <primitive_test_name>DS_SetDFC</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the FULL Zoom Settings of Video Device
Test Case ID : CT_DS_75</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_75</test_case_id>
    <test_objective>Device Setting –  Get and Set the display video device mode for the video device with full zoom</test_objective>
...
device::Manager::DeInitialize()</api_or_interface_used>
    <input_parameters>setDFC : int -Id- 1
setDFC : String -
E.g.: full</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetDFC_FULL_ZOOM_test_75</test_script>
    <skipped>No</skipped>
