...
Test Case ID : CT_DS_114</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS114</test_case_id>
    <test_objective>Device Setting –  Checking the current Aspect Ratio  with available Aspect Ratio formats before and after rebooting device.</test_objective>
...
4.TM issues command to reboot the device.
5.Device_Settings_Agent will check for the current aspect Ratio with the list of available aspect Ratio formats after rebooting the box.
6.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step(3rd). 
</automation_approch>
    <except_output>Checkpoint 1. Check the current aspect Ratio present in the list of available aspect Ratio formats before and after rebooting the device.</except_output>
    <priority>High</priority>
    <test_stub_interface>TestMgr_DS_managerInitialize
TestMgr_DS_VOP_isDisplayConnected
TestMgr_DS_VOP_getAspectRatio
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_GetAspect_Ratio_Reboot_test_114</test_script>
    <skipped>No</skipped>
