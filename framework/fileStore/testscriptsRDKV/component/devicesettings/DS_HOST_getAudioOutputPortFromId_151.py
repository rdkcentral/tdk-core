...
TestcaseID: CT_DS151</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_151</test_case_id>
    <test_objective>This test script is used to get a reference to the Audio output port by its id.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. dsMgrMain should be up and running.
2. IARMDaemonMain should be up and running.</pre_requisite>
    <api_or_interface_used>AudioOutputPort &amp;getAudioOutputPort(int id)</api_or_interface_used>
...
4.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    ...
    <test_script>DS_HOST_getAudioOutputPortFromId_151</test_script>
    <skipped>No</skipped>
