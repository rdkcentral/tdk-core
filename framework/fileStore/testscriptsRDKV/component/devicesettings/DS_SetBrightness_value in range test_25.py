...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>588</id>
  <version>2</version>
  <name>DS_SetBrightness_value in range test_25</name>
  <primitive_test_id>76</primitive_test_id>
  <primitive_test_name>DS_SetBrightness</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the in range value Brightness of the given Front panel Indicator
Test Case ID : CT_DS_25</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_25</test_case_id>
    <test_objective>Device Setting – Get and Set brightness for front panel Indicator within valid range.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetBrightness_value in range test_25</test_script>
    <skipped>No</skipped>
