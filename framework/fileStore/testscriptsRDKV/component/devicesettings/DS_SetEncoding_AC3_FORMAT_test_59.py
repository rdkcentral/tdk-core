...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>609</id>
  <version>1</version>
  <name>DS_SetEncoding_AC3_FORMAT_test_59</name>
  <primitive_test_id>81</primitive_test_id>
  <primitive_test_name>DS_SetEncoding</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the AC3 Encoding Format of Audio.Test Case ID : CT_DS_59.  Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_59</test_case_id>
    <test_objective>Device Setting –  Get and set  encoding format to AC3</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetEncoding_AC3_FORMAT_test_59</test_script>
    <skipped>No</skipped>
