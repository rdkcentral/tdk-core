...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>622</id>
  <version>2</version>
  <name>DS_SetStereoMode_UNKNOWN_72</name>
  <primitive_test_id>85</primitive_test_id>
  <primitive_test_name>DS_SetStereoMode</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the UNKNOWN Stereo Mode of Audio.
...
Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_72</test_case_id>
    <test_objective>Device Setting –  Get and set stereo format to UNKNOWN</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetStereoMode_UNKNOWN_72</test_script>
    <skipped>No</skipped>
