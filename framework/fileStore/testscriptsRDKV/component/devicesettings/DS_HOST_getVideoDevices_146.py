...
TestcaseID: CT_DS146</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_146</test_case_id>
    <test_objective>This test script is used to get the list of the video devices (i.e. Decoders) supported on the device.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. dsMgrMain should be up and running.
2. IARMDaemonMain should be up and running.</pre_requisite>
    <api_or_interface_used>List&lt;VideoDevice&gt; getVideoDevices()</api_or_interface_used>
...
4.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    ...
    <test_script>DS_HOST_getVideoDevices_146</test_script>
    <skipped>No</skipped>
