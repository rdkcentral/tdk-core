...
Test Case ID:CT_DS_94.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_94</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution setting with invalid value for valid port name.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_Invalid_value_test_94</test_script>
    <skipped>No</skipped>
