...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>DS_EnableHDCP_128</name>
  <primitive_test_id/>
  <primitive_test_name>DS_EnableHDCP</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test to enable HDCP authentication.
TestcaseID: CT_DS128</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS128</test_case_id>
    <test_objective>Test to enable HDCP authentication</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_EnableHDCP_128</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'DS_EnableHDCP_128');
