...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>DS_AOP_getStereoAuto_174</name>
  <primitive_test_id/>
  <primitive_test_name>DS_AOP_getStereoAuto</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: This API is used to get the current auto mode.
Test Case Id: CT_DS_174
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_174</test_case_id>
    <test_objective>This API is used to get the current auto mode.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. dsMgrMain should be up and running.
2. IARMDaemonMain should be up and running.</pre_requisite>
    <api_or_interface_used>bool getStereoAuto()</api_or_interface_used>
    <input_parameters>string port_name("HDMI0")</input_parameters>
    <automation_approch>1. TM loads the Device_Settings_Agent via the test agent.
2.Device_Settings_Agent will get the audio output port stereo auto mode.
3.Device_Settings_Agent will check the current stereo auto mode is retrieved successfully.
6.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    <except_output>Checkpoint 1. Check the stereo auto mode  is retrieved successfully.</except_output>
    <priority>High</priority>
    <test_stub_interface>none</test_stub_interface>
    <test_script>DS_AOP_getStereoAuto_174</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DS_AOP_getStereoAuto_174');
        ...
        if expectedresult in actualresult:
	        ...
	        #Get the Audio types supported.
                ...
                if expectedresult in actualresult:
	                ...
	                #calling Device Settings - Get Stereo Auto Mode.
        	        tdkTestObj = obj.createTestStep('DS_AOP_getStereoAuto');
