...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DS_VideoDevice_getSupportedDFCs_185</name>
  <primitive_test_id/>
  <primitive_test_name>DS_VD_getSupportedDFCs</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This tests get to fetch the list of supported DFC (i.e. Zoom Settings) for decoder.
TestcaseID: CT_DS185</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_185</test_case_id>
    <test_objective>This tests get to fetch the list of supported DFC (i.e. Zoom Settings) for decoder.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. dsMgrMain should be up and running.
2. IARMDaemonMain should be up and running.</pre_requisite>
    <api_or_interface_used>const List &lt;VideoDFC&gt;  getSupportedDFCs()</api_or_interface_used>
...
4.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    ...
    <test_script>DS_VideoDevice_getSupportedDFCs_185</test_script>
    <skipped>No</skipped>
...
dsObj.configureTestCase(ip,port,'DS_VideoDevice_getSupportedDFCs_185');
