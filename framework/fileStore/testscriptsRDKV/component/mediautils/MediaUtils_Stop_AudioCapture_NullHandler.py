...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>MediaUtils_Stop_AudioCapture_NullHandler</name>
  <primitive_test_id/>
  <primitive_test_name>MediaUtils_AudioCaptureStop</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a negative test to check if the API to stop Audio Capture will return SUCCESS with NULL handler</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MediaUtils_08</test_case_id>
    <test_objective>This is  negative test to check if audio capture is stopped when a NULL handler is passed </test_objective>
...
MediaUtils_AudioCaptureStop - string "NULL"
...
7.MediaUtils_Agent will return SUCCESS or FAILURE based on the result of above step
8.If FAILURE, then stop the audio capture once again with VALID parameter
...
Checkpoint 4:MediaUtils_AudioCapture_Stop should be a failure
Checkpoint 5:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Stop_AudioCapture_NullHandler</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'MediaUtils_Stop_AudioCapture_NullHandler');
                ...
                if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                                ...
                                if expectedresult in actualresult:
                                        ...
                                        print("MediaUtils_AudioCaptureStop call is NOT SUCCESSFUL with NULL handler");
                                        print(details);
                                        ...
                                        if expectedresult in actualresult:
                                                ...
                                                print(details);
                                                print("Unable to stop audio capture");
                                else:
                                        print("MediaUtils_AudioCaptureStop call is SUCCESSFUL with NULL handler");
                                        tdkTestObj.setResultStatus("FAILURE");
