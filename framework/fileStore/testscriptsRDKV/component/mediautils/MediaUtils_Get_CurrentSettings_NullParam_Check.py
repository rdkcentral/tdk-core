...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>MediaUtils_Get_CurrentSettings_NullParam_Check</name>
  <primitive_test_id/>
  <primitive_test_name>MediaUtils_Get_Current_Settings</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a negative test trying to get current settings if audiocapture manager by passing null param</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MediaUtils_14</test_case_id>
    <test_objective>To validate the current settings API by passing null param</test_objective>
...
Checkpoint 6:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Get_CurrentSettings_NullParam_Checck</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'MediaUtils_Get_CurrentSettings_NullParam_Check');
    ...
    if result:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    tdkTestObj.setResultStatus("SUCCESS");
                    print("MediaUtils_Get_CurrentSettings call is NOT SUCCESSFUL with NULL param being passed");
                    print(resultDetails);
                else:
                    print("MediaUtils_Get_CurrentSettings call is SUCCESSFUL even though with the NULL param being passed");
