...
<xml>
  <id></id>
  <version>1</version>
  <name>RDKV_AppManager_22_ClearAppData_Positive</name>
  <primitive_test_id></primitive_test_id>
  <primitive_test_name>RdkService_Test</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test AppManager clearAppData API - Positive scenarios</synopsis>
  <groups_id />
  ...
  <test_cases>
    ...
    <test_objective>Test AppManager clearAppData API - Positive scenarios</test_objective>
...
4. Report test results</automation_approch>
    <expected_output>clearAppData API should return appropriate responses for Positive scenarios</expected_output>
    <priority>High</priority>
    <test_stub_interface>librdkservicesstub.so</test_stub_interface>
    <test_script>RDKV_AppManager_22_ClearAppData_Positive</test_script>
    <skipped>No</skipped>
    <release_version>M128</release_version>
    <remarks>Test case for clearAppData API Positive scenarios</remarks>
  </test_cases>
</xml>
'''
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    try:
        ...
        if not thunder_is_plugin_active(plugin_name, jsonrpc_url=jsonrpc_url):
            ...
            print("
[TEST] clearAppData API - Positive scenarios")
