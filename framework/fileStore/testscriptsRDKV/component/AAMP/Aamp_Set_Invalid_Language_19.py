...
<xml>
  ...
  <name>Aamp_Set_Invalid_Language_19</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check that invalid audio language is not set using SetLanguage API</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_19</test_case_id>
    <test_objective>Check that invalid audio language is not set using SetLanguage API</test_objective>
...
SetLanguage</api_or_interface_used>
    <input_parameters>HLS streaming URL</input_parameters>
    <automation_approch>1. TM loads the Aamp Agent and systemutil Agent.
2. Aamp Agent invokes Tune API with HLS streaming URL
3. Aamp Agent invokes GetCurrentAudioLanguage API
4. Aamp Agent invokes SetLanguage API with invalid parameter
5. Aamp Agent invokes GetCurrentAudioLanguage API
6. TM checks if the invalid language is not set and returns SUCCESS/FAILURE
7. TM unloads the Aamp Agent and systemutil Agent.</automation_approch>
    <except_output>Checkpoint 1. invalid audio language is not set using SetLanguage API</except_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Set_Invalid_Language_19</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Set_Invalid_Language_19');
sysObj.configureTestCase(ip,port,'Aamp_Set_Invalid_Language_19');
