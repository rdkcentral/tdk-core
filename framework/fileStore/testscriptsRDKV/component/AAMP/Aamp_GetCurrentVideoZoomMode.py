...
<xml>
  ...
  <name>Aamp_GetCurrentVideoZoomMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to verify the current video zoom mode while playing HLS stream content</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_86</test_case_id>
    <test_objective>Test script to verify the current video zoom mode while playing HLS stream content</test_objective>
...
AampGetVideoZoom</api_or_interface_used>
...
4. TM checks the return value and returns SUCCESS/FAILURE
5. TM unloads the Aamp Agent.</automation_approch>
    <expected_output>Should get the current video zoom mode value</expected_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetCurrentVideoZoomMode</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetCurrentVideoZoomMode');
