...
<xml>
  ...
  <name>Aamp_GetState_Live_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current State value for live stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_53</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetState_Live_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetState_Live_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetState_Live_URL');
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            ...
            if expectedResult in actualResult and "PLAYING" in details:
                ...
                print("State retrieved is valid for Live stream");
            else:
                #Set the result status of execution
                tdkTestObj.setResultStatus("FAILURE");
                print("State not retrievd correctly for Live stream");
        else:
