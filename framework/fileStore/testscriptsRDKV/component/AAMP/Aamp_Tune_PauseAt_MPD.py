...
<xml>
  ...
  <name>Aamp_Tune_PauseAt_MPD</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_81</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Tune_PauseAt_MPD</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Tune_PauseAt_MPD');
sysObj.configureTestCase(ip,port,'Aamp_Tune_PauseAt_MPD');
