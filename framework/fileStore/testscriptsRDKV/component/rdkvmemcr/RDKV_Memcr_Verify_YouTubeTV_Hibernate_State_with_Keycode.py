...
<xml>
  ...
  <name>RDKV_Memcr_Verify_YouTubeTV_Hibernate_State_with_Keycode</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_25</test_case_id>
    <test_objective>Verify whether the youtubetv app enters a hibernated state by using the Home keycode(36) instead of the suspend API</test_objective>
    ...
    <api_or_interface_used>org.rdk.RDKShell.1.getClients,org.rdk.RDKShell.1.getState,org.rdk.RDKShell.1.restore,org.rdk.RDKShell.1.launch,org.rdk.RDKShell.1.generateKey</api_or_interface_used>
...
5. Check if the youtubetv app enters a hibernated state by using the Home keycode(36), without relying on the suspend API</automation_approch>
...
5. The YouTube TV app should successfully enter the hibernated state when the Home keycode (36) is used</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_Verify_YouTubeTV_Hibernate_State_with_Keycode</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Verify_YouTubeTV_Hibernate_State_with_Keycode');
