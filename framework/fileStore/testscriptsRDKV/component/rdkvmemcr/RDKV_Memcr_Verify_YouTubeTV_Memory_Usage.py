...
<xml>
  ...
  <name>RDKV_Memcr_Verify_YouTubeTV_Memory_Usage</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_15</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Verify_YouTubeTV_Memory_Usage');
