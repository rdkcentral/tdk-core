...
<xml>
  ...
  <name>RDKV_Memcr_RestoreApp_FromSuspendAndHibernate_API_Test</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_09</test_case_id>
...
5. Suspend the cobalt app and verify the application's state
6. Restore the cobalt app and verify the application's state
7. Hibernate the cobalt app and verify the application's state</automation_approch>
...
5. When the cobalt app is suspended, its state should reflect hibernated as expected
6. After restoring the cobalt app, its state should reflect suspended as expected
7. When the cobalt app is hibernated, its state should reflect hibernated as expected</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_RestoreApp_FromSuspendAndHibernate_API_Test</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_RestoreApp_FromSuspendAndHibernate_API_Test');
