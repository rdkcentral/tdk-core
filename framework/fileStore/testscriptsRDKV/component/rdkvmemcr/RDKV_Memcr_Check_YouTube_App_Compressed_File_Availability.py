...
<xml>
  ...
  <name>RDKV_Memcr_Check_YouTube_App_Compressed_File_Availability</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_03</test_case_id>
...
6. After the app is restored, the compressed .img file should no longer be present</expected_output>
    ...
    <test_script>RDKV_Memcr_Check_YouTube_App_Compressed_File_Availability</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Check_YouTube_App_Compressed_File_Availability');
