...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RDKLogger_14</test_case_id>
    <test_objective>To log a TRACE1 level message</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-1/XI3-1</test_setup>
    <pre_requisite>1. RDK debug manager module should be intialized
2. Module should have TRACE1 level configured in debug.ini file</pre_requisite>
    <api_or_interface_used>rdk_dbg_MsgRaw()</api_or_interface_used>
    <input_parameters>rdk_dbg_MsgRaw:
string – level (e.g., TRACE1)
string – module (e.g., TEST)
string - message (e.g., "Test Trace1")</input_parameters>
...
TestMgr_RDKLogger_Log_Msg</test_stub_interface>
    <test_script>RDKLogger_Log_Trace1</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'RDKLogger_Log_Trace1');
