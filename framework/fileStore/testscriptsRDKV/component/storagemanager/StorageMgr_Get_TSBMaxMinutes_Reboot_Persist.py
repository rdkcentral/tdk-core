...
<xml>
  ...
  <name>StorageMgr_Get_TSBMaxMinutes_Reboot_Persist</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to set and get the number of minutes allowed for TSB storage with reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_StorageMgr_14</test_case_id>
    <test_objective>Test Script to set and get the number of minutes allowed for TSB storage with reboot</test_objective>
...
2.Invoke the getTSBMaxMinutes API.
3.Should return the minutes allowed for TSB storage.
4.After rebooting the device it should be the same minutes as user setted.
</automation_approch>
    <expected_output>Should return the minutes allowed for TSB storage after reboot</expected_output>
    <priority>High</priority>
    <test_stub_interface>libstoragemanagerstub.so.0.0.0</test_stub_interface>
    <test_script>StorageMgr_Get_TSBMaxMinutes_Reboot_Persist</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadModuleStatus.upper():
    ...
    if expectedResult in actualResult:
        ...
        print("\nTEST STEP 3 : Get the number of minutes allowed for TSB storage using rdkStorage_getTSBMaxMinutes API")
