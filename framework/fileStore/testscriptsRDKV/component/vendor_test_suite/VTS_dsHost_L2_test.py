...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsHost L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_07</test_case_id>
    <test_objective>Execute VTS dsHost L2 testcases</test_objective>
    ...
    <test_script>VTS_dsHost_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsHost_L2_test');
