...
<xml>
  ...
  <name>VTS_dsVideoPort_L1_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsVideoPort L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  <execution_time>80</execution_time>
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Execute VTS dsVideoPort L1 testcases</test_objective>
    ...
    <test_script>VTS_dsVideoPort_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsVideoPort_L1_test');
...
if "SUCCESS" in result.upper():
    ...
    #Set module
    module = "L1 dsVideoPort"
    print("Module : ",module)
    #Set binary name
    binaryName = DeviceSettings_binaryName
    print ("BinaryName : ",binaryName)
    #Set TestCase Config
    binaryConfig = VideoPort_SOURCE_binaryConfig if "SOURCE" in DEVICE_TYPE.upper() else VideoPort_SINK_binaryConfig
    print("BinaryConfig : ",binaryConfig)
    #Set Custom List of TestCases
    testCaseList = VideoPort_L1_List
    #Set basepath of test
    basePath = VTS_Binary_basePath + DeviceSettings_basePath
    #SkipTestCaseList
    SkipTestCaseList = VideoPort_L1_SkipTestCaseList
    boxtype = obj.getDeviceBoxType();
    if ("RPI-Client" in boxtype):
        SkipTestCaseList = VideoPort_L1_SkipTestCaseList_RPI
