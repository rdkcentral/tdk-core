...
<xml>
  ...
  <name>VTS_PowerManager_L2_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS PowerManager L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_14</test_case_id>
    <test_objective>Execute VTS PowerManager L2 testcases</test_objective>
    ...
    <test_script>VTS_PowerManager_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_PowerManager_L2_test');
...
if "SUCCESS" in result.upper():
    ...
    try:
        if testList:
            ...
            executionSummary = runTest(binaryPath, module, plugin_name, testList, testCaseList,PowerManager_L2_SkipTestCaseList, binaryConfig)
