...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsAudio L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_08</test_case_id>
    <test_objective>Execute VTS dsAudio L2 testcases</test_objective>
    ...
    <test_script>VTS_dsAudio_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsAudio_L2_test');
