...
<xml>
  ...
  <name>VTS_DeepSleep_L2_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS DeepSleep L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_16</test_case_id>
    <test_objective>Execute VTS DeepSleep L2 testcases</test_objective>
    ...
    <test_script>VTS_DeepSleep_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_DeepSleep_L2_test');
