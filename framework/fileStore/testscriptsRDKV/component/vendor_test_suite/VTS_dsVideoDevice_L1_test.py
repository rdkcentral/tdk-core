...
<xml>
  ...
  <name>VTS_dsVideoDevice_L1_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsVideoDevice L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_script>VTS_dsVideoDevice_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsVideoDevice_L1_test');
