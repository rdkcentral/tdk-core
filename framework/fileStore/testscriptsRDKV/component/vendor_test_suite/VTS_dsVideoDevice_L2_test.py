...
<xml>
  ...
  <name>VTS_dsVideoDevice_L2_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsVideoDevice L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_05</test_case_id>
    <test_objective>Execute VTS dsVideoDevice L2 testcases</test_objective>
    ...
    <input_parameters>dsVideoDevice config yaml</input_parameters>
    ...
    <test_script>VTS_dsVideoDevice_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsVideoDevice_L2_test');
...
if "SUCCESS" in result.upper():
    ...
    #Set module
    module = "L2 dsVideoDevice - Source"
    #Set binary name
