...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS HDMICEC L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_12</test_case_id>
    <test_objective>Execute VTS HDMICEC L2 testcases</test_objective>
    ...
    <input_parameters>HDMICEC config yaml</input_parameters>
    ...
    <test_script>VTS_HDMICEC_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_HDMICEC_L2_test');
...
if "SUCCESS" in result.upper():
    ...
    #Set module
    module = "L2 HDMICEC Source Test Case"
    #Set binary name
