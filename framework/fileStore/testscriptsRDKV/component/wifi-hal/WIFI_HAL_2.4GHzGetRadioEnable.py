...
<xml>
  <id/>
  <version>5</version>
  <name>WIFI_HAL_2.4GHzGetRadioEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke wifi_getRadioEnable() api and get the Radio Enable value for 2.4GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_26</test_case_id>
...
7.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_2.4GHzGetRadioEnable</test_script>
    <skipped>No</skipped>
