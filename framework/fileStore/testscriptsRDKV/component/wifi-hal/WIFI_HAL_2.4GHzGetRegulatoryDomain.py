...
<xml>
  <id/>
  <version>2</version>
  <name>WIFI_HAL_2.4GHzGetRegulatoryDomain</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_9</test_case_id>
...
5.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_2.4GHzGetRegulatoryDomain</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_2.4GHzGetRegulatoryDomain');
