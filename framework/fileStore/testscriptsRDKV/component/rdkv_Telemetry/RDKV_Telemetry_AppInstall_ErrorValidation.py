...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppInstall_ErrorValidation')
...
event_name = "RDKAMInstallError_split"
component_name = "AppManager"
profile_name = "RDKV-AppInstallErrorProfile"
description = "Report to validate App Install Error"
...
if profile_set:
    ...
    tdkTestObj = obj.createTestStep('telemetry_executeCmdInDUT')
    monitor_cmd = ('rm -f /tmp/Install_monitor.log; ' 'tail -F /opt/logs/telemetry2_0.txt > ''/tmp/Install_monitor.log 2>&1 & echo $!')
            ...
            try:
                ...
                if match:
                    ...
                    if len(report) == 0:
                        ...
                        print(result_data)
                        print("SUCCESS : Install telemetry data found")
                ...
                print("FAILURE : Unable to obtain Install telemetry data")
                print(e)
                print("\n[TEST STEP RESULT] : FAILURE\n")
                tdkTestObj.setResultStatus("FAILURE")
        else:
