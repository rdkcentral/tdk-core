...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppClose_TimeValidation')
...
event_name = "RDKAMAppCloseTime_split"
component_name = "AppManager"
profile_name = "RDKV-AppCloseProfile"
description = "Report to validate App Close Time"
