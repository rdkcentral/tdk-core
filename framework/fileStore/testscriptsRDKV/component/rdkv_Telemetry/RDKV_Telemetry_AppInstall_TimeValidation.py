...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppInstall_TimeValidation')
...
event_name = "RDKAMInstallTime_split"
component_name = "AppManager"
profile_name = "RDKV-AppInstallProfile"
description = "Report to validate App Install Time"
