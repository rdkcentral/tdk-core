...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppDownload_ErrorValidation')
...
event_name = "RDKAMDownloadError_split"
component_name = "AppManager"
profile_name = "RDKV-AppDowloadErrorProfile"
description = "Report to validate App Download Error"
...
if profile_set:
    ...
    if status == "SUCCESS":
        print("SUCCESS : Application Download was successful")
    else:
        print("FAILURE : Application download was failed")
