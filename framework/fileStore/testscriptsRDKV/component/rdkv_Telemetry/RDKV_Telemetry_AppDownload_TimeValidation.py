...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppDownload_TimeValidation')
...
event_name = "RDKAMDownloadTime_split"
component_name = "AppManager"
profile_name = "RDKV-AppDownloadProfile"
description = "Report to validate App Download Time"
