...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppLaunch_TimeValidation')
...
event_name = "RDKAMAppLaunchTime_split"
component_name = "AppManager"
profile_name = "RDKV-AppLaunchProfile"
description = "Report to validate App Launch Time"
...
if profile_set:
    ...
    if status == "SUCCESS":
        ...
        command = "grep OverallLaunchTime_split /opt/logs/wpeframework.log | tail -20"
        tdkTestObj = obj.createTestStep('telemetry_executeCmdInDUT')
        tdkTestObj.addParameter("command",command)
        tdkTestObj.executeTestCase(expectedResult)
        ...
        if "OverallLaunchTime_split" in marker_details:
