...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppUninstall_ErrorValidation')
...
event_name = "RDKAMUninstallError_split"
component_name = "AppManager"
profile_name = "RDKV-AppUninstallErrorProfile"
description = "Report to validate App Uninstall Error"
