...
obj.configureTestCase(ip,port,'RDKV_Telemetry_AppClose_ErrorValidation')
...
event_name = "RDKAMAppCloseError_split"
component_name = "AppManager"
profile_name = "RDKV-AppCloseErrorProfile"
description = "Report to validate App Close Error"
...
if profile_set:
    ...
    tdkTestObj = obj.createTestStep('telemetry_executeCmdInDUT')
    monitor_cmd = ('rm -f /tmp/close_monitor.log; ' 'tail -F /opt/logs/telemetry2_0.txt > ''/tmp/close_monitor.log 2>&1 & echo $!')
    ...
    if status == "SUCCESS":
        ...
        print(details)
        if status == "SUCCESS":
            print("SUCCESS : Application was closed successfully")
            ...
            try:
                ...
                if match:
                    ...
                    if len(report) == 0:
                        ...
                        print("\nApp Close Telemetry Data :")
                        print(result_data)
                        print("SUCCESS : App close telemetry data found")
                ...
                print("FAILURE : Unable to obtain close telemetry data")
                print(e)
                print("\n[TEST STEP RESULT] : FAILURE\n")
                tdkTestObj.setResultStatus("FAILURE")
        else:
