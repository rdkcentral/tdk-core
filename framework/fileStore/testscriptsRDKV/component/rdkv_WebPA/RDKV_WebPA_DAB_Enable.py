...
<xml>
  ...
  <name>RDKV_WebPA_DAB_Enable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to ensure DAB feature can be toggled via WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_08</test_case_id>
    <test_objective>Test to ensure DAB feature can be toggled via WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.DAB.Enable will fetch the WebPA server url from the device.
...
2.DAB service should be enabled</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_DAB_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_DAB_Enable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.DAB.Enable"
    testValue = "1"
