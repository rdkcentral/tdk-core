...
<xml>
  ...
  <name>RDKV_WebPA_AccountID</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to validate the Account ID parameter using WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AccountInfo.AccountID will fetch the WebPA server url from the device.
...
2.Account ID should be retrived using the WebPA server</expected_output>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_AccountID')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AccountInfo.AccountID"
    testValue = "TEST123"
