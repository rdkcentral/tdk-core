...
<xml>
  ...
  <name>RDKV_WebPA_STB_Manufacturer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the device manufacturer information using the WebPA interface</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_31</test_case_id>
    <test_objective>To get the device manufacturer information using the WebPA interface</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.Manufacturer will fetch the WebPA server url from the device.
...
2. API must return the device manufacturer information</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_STB_Manufacturer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_STB_Manufacturer')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.Manufacturer"
