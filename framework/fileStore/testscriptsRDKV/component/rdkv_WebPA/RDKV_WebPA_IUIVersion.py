...
<xml>
  ...
  <name>RDKV_WebPA_IUIVersion</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the IUI version reported by the device using the WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_13</test_case_id>
    <test_objective>To validate the IUI version reported by the device using the WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM.IUI.Version will fetch the WebPA server url from the device.
...
2.API via Webpa server should return the IUI version</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_IUIVersion</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_IUIVersion')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM.IUI.Version"
    testValue = "1"
