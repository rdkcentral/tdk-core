...
<xml>
  ...
  <test_cases>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_xOpsDeviceMgmt.Logging.xOpsDMUploadLogsNow will fetch the WebPA server url from the device.
...
2.API should return logs are uploaded in the device</expected_output>
