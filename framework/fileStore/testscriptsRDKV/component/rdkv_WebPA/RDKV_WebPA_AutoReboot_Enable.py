...
<xml>
  ...
  <name>RDKV_WebPA_AutoReboot_Enable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to validate the AutoReboot parameter enabled or not using WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AutoReboot.Enable will fetch the WebPA server url from the device.
...
2.Parameter should return whwther the Auto Reboot feature is enabled or not</expected_output>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_AutoReboot_Enable')
