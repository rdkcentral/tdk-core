...
<xml>
  ...
  <name>RDKV_WebPA_AppHibernate_Enable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to ensure AppHibernate feature enabled or not using WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_09</test_case_id>
    <test_objective>Test to ensure AppHibernate feature enabled or not using WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AppHibernate.Enable will fetch the WebPA server url from the device.
...
2.API should give the feature is enabled or not</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_AppHibernate_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_AppHibernate_Enable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AppHibernate.Enable"
    testValue = "1"
