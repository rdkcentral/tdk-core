...
<xml>
  ...
  <test_cases>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.MTLS.Enable will fetch the WebPA server url from the device.
...
2.API should return TLS Telemetry feature is enabled or not</expected_output>
