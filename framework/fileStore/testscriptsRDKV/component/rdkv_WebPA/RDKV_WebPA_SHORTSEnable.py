...
<xml>
  ...
  <name>RDKV_WebPA_SHORTSEnable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the SHORTS feature enable status using the WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_15</test_case_id>
    <test_objective>To validate the SHORTS feature enable status using the WebPA server</test_objective>
    ...
    <automation_approch>1.Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.SHORTS.Enable  will fetch the WebPA server url from the device.
...
2.API should return the SHORTS feature is enable or not</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_SHORTSEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_SHORTSEnable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.SHORTS.Enable"
    testValue = "1"
