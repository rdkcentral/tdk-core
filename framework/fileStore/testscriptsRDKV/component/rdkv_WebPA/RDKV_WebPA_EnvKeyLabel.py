...
<xml>
  ...
  <name>RDKV_WebPA_EnvKeyLabel</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the LaunchDarkly environment key label using WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_12</test_case_id>
    <test_objective>To validate the LaunchDarkly environment key label using WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.LaunchDarkly.EnvKeyLabel will fetch the WebPA server url from the device.
...
2.API using WebPA server should return and set the Environment key label for LaunchDarkly</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_EnvKeyLabel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_EnvKeyLabel')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.LaunchDarkly.EnvKeyLabel"
    testValue = "1"
