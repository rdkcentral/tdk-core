...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DSHal_SetFPBlink_POWER_Indicator</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_66</test_case_id>
...
2.DSHAL agent will invoke the API dsSetFPBlink with parameter LED indicator 1 [POWER LED]
...
5.Unload the module</automation_approch>
    ...
    <test_script>DSHal_SetFPBlink_POWER_Indicator</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_SetFPBlink_POWER_Indicator');
...
if "SUCCESS" in loadModuleStatus.upper() and capable:
    ...
    print("EXEPECTED RESULT : Should set the power led to blink for given number of time for given duration")
