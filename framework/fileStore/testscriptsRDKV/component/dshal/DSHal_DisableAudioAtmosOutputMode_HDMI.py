...
<xml>
  ...
  <name>DSHal_DisableAudioAtmosOutputMode_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To disable AudioAtmosOutputMode for the audio port HDMI</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
3. TM checks if the API call is success and return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>DSHal_DisableAudioAtmosOutputMode_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_DisableAudioAtmosOutputMode_HDMI');
