...
<xml>
  ...
  <name>DSHal_GetVideoPortHandle_BB</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if video port handle is retrieved for BB</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_17</test_case_id>
    <test_objective>To check if video port handle is retrieved for BB</test_objective>
...
2 . DSHAL agent will invoke the api dsGetVideoPort for BB0
...
Checkpoint 2 Verify that handle is retrieved</expected_output>
    ...
    <test_script>DSHal_GetVideoPortHandle_BB</test_script>
    <skipped>No</skipped>
