...
<xml>
  ...
  <name>DSHal_SetSurroundVirtualizer_ValidMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the Surround Virtualizer mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_160</test_case_id>
    <test_objective>To set the surround virtualizer in normal mode and check whether boost levels are set properly.</test_objective>
...
4. TM checks if the virtualizer mode and boost are returned as expected and return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>DSHal_SetSurroundVirtualizer_ValidMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_SetSurroundVirtualizer_ValidMode');
