...
<xml>
  ...
  <name>DSHal_EnableSurroundDecoder_InvalidHandle_Check</name>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_186</test_case_id>
    <test_objective>To validate enablesurround decoder API using invalid handle param</test_objective>
...
dsError_t  dsEnableSurroundDecoder(intptr_t handle, bool enabled)</api_or_interface_used>
...
Checkpoint 2 Verify that the status is correct</expected_output>
    ...
    <test_script>DSHal_EnableSurroundDecoder_InvalidHandle_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_EnableSurroundDecoder_InvalidHandle_Check');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            print("Test step to validate EnableSurroundDecoder API by passing an invalid handle");
            ...
            if expectedResult in actualResult:
                print(details);
                print("ACTUAL RESULT : dsEnableSurroundDecoder call is failed due to invalid handle");
                tdkTestObj.setResultStatus("SUCCESS");
                print("[TEST EXECUTION RESULT] : SUCCESS");
            else:
                print("Value returned : ", details);
                print("ACTUAL RESULT : dsEnableSurroundDecoder call is success eventhough with an invalid handle");
