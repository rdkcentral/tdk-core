...
<xml>
  ...
  <name>DSHal_Enable_IntelligentEqualizerMode</name>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_122</test_case_id>
...
2 . DSHAL agent will invoke the api dsSetIntelligentEqualizerMode to set the mode to 1
...
Checkpoint 2 Verify that the mode is set</expected_output>
    ...
    <test_script>DSHal_Enable_IntelligentEqualizerMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_Enable_IntelligentEqualizerMode');
