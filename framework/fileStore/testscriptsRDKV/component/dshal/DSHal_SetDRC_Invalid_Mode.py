...
<xml>
  ...
  <name>DSHal_SetDRC_Invalid_Mode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to set DRC mode to invalid mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_173</test_case_id>
    <test_objective>Test to set DRC mode to invalid mode</test_objective>
...
Checkpoint 2 Verify that the invalid mode is not set</expected_output>
    <priority>High</priority>
    <test_stub_interface>libdshalstub.so.0.0.0</test_stub_interface>
    <test_script>DSHal_SetDRC_Invalid_Mode</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetDRC_Invalid_Mode');
...
if "SUCCESS" in dshalloadModuleStatus.upper() and capable:
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            ...
            print "SetDRCMode failed as expected for Invalid Mode"
