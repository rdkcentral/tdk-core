...
<xml>
  ...
  <name>DSHal_GetAudioCompression_UnSupported_PortType</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if AudioCompression is retrieved for unsupported port type</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_145</test_case_id>
    <test_objective>To check if AudioCompression is retrieved for unsupported port type</test_objective>
...
Checkpoint 2 Verify that the value is not retrieved</expected_output>
    ...
    <test_script>DSHal_GetAudioCompression_UnSupported_PortType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetAudioCompression_UnSupported_PortType');
