...
<xml>
  ...
  <name>DSHal_GetVideoEOTF_RF</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the video Electro-Optical Transfer Function for RF port</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_103</test_case_id>
    <test_objective>To check the video Electro-Optical Transfer Function for RF port</test_objective>
...
2 . DSHAL agent will invoke the api dsGetVideoPort to get the handle for RF port
...
Checkpoint 2 Verify that the eotf is valid</expected_output>
    ...
    <test_script>DSHal_GetVideoEOTF_RF</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetVideoEOTF_RF');
