...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>DSHal_SetandGet_FPBrightness_Record_Indicator</name>
  <primitive_test_id/>
  <primitive_test_name>DSHal_SetFPBrightness</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get brightness of Record indicator</synopsis>
  <groups_id/>
...
Checkpoint 2 Verify that the brightness is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_FPBrightness_Record_Indicator</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_FPBrightness_Record_Indicator');
