...
<xml>
  ...
  <name>DSHal_SetBassEnhancer_Min</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set Bass Enhancer to minimum value</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To set Bass Enhancer to minimum value</test_objective>
...
Checkpoint 2 Verify that the mode is set</expected_output>
    ...
    <test_script>DSHal_SetBassEnhancer_Min</test_script>
    <skipped>No</skipped>
