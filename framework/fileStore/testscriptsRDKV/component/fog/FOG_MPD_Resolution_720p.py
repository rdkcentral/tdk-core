...
<xml>
  ...
  <name>FOG_MPD_Resolution_720p</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate resolution in FOG with respect to set resolution to 720p</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_MPD_Resolution_720p</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FOG_MPD_Resolution_720p');
...
if resolution_set == "True":
    ...
    sysObj.configureTestCase(ip,port,'FOG_MPD_Resolution_720p');
    aampObj.configureTestCase(ip,port,'FOG_MPD_Resolution_720p');
