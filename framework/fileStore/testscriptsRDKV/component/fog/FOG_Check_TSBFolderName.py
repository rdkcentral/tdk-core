...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>FOG_Check_TSBFolderName</name>
  <primitive_test_id/>
  <primitive_test_name>Fog_Do_Nothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check whether the tsb folder name and recording id are equal</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_FOG_01</test_case_id>
    <test_objective>Check if tsb folder name and recording id are equal</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Check_TSBFolderName</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Check_TSBFolderName');
aampObj.configureTestCase(ip,port,'FOG_Check_TSBFolderName');
