...
obj.configureTestCase(ip,port,'PackageMgr_DAC_05_UninstallAllApps');
        ...
        if not dac_installed:
            ...
            for idx, pkg in enumerate(dac_installed, 1):
                ...
                try:
                    ...
                    uninstall_result = thunder_uninstall_package(obj, app_id, app_name)
            ...
            if success_count == len(uninstall_results) and len(remaining_dac) == 0:
                ...
                print("\n[TEST RESULT] FAILURE - Uninstall incomplete or remaining packages present")
                obj.setLoadModuleStatus("FAILURE")
