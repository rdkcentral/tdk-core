...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_DNSStrictOrder_Enable')
        ...
        if "FAILURE" not in detail:
            ...
            if "FAILURE" not in detail:
                ...
                if "FAILURE" not in detail:
                    ...
                    rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.DNSStrictOrder.Enable"
                    ...
                    if "true" in actualvalue or "false" in actualvalue or len(actualvalue)==0:
                        ...
                        feature_name="DNSStrictOrder_Enable"
