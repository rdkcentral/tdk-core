...
<xml>
  ...
  <name>RDKV_RFC_USB_AutoMount_Enable</name>
  ...
  <test_cases>
    <test_case_id>rdkvxconfrfc_20</test_case_id>
    <test_objective>Verify if the xconf server setting for Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.USB_AutoMount.Enable is correctly applied on the device</test_objective>
    ...
    <test_script>RDKV_RFC_USB_AutoMount_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_USB_AutoMount_Enable');
...
if "SUCCESS" in result.upper():
    ...
    if expectedResult in actualresult.upper():
        ...
        if expectedResult in actualresult.upper():
            ...
            rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.USB_AutoMount.Enable"
            ...
            if "true" in actualvalue or "false" in actualvalue or len(actualvalue)==0:
                ...
                feature_name="USB_AutoMount.Enable"
