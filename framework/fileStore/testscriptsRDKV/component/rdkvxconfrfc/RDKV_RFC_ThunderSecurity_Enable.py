...
5: ThunderSecurity.Enable RFC parameter value should be checked and noted before making changes
...
10: Confirm that the value set for the ThunderSecurity.Enable RFC parameter on the Xconf server is correctly applied and reflected in the device
11: ThunderSecurity.Enable RFC parameter value must be reverted to its original state
