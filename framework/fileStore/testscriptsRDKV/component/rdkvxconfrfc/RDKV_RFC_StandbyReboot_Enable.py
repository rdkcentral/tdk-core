...
5: StandbyReboot.Enable RFC parameter value should be checked and noted before making changes
...
10: Confirm that the value set for the StandbyReboot.Enable RFC parameter on the Xconf server is correctly applied and reflected in the device
11: StandbyReboot.Enable RFC parameter value must be reverted to its original state
