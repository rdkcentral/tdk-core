...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1324</id>
  <version>2</version>
  <name>IARM_BUS_DiskMgr_Event_ExtHDD_On_21</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type
Test case Id - CT_IARMBUS_21</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_21</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type DISKMGR_EVENT_EXTHDD_ON.</test_objective>
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_DiskMgr_Event_ExtHDD_On_21</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #passing parameter for receiving Ext HDD event State ON for disk manager
            ...
            if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("argv1","ON");
                expectedresult="SUCCESS"
                tdkTestObj.executeTestCase(expectedresult);
                actualresult = tdkTestObj.getResult();
