...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1316</id>
  <version>1</version>
  <name>IARMBUS_DiskMgr_Event_HwDisk_18</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_HWDISK” event.
Test case Id - CT_IARMBUS_18</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_18</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_HWDISK” event.</test_objective>
...
const char * - IARM_BUS_DISKMGR_NAME , IARM_EventId_t - IARM_BUS_DISKMGR_EVENT_HWDISK, IARM_EventHandler_t - _evthandler
IARM_Bus_BroadcastEvent :
Const char* - IARM_BUS_DISKMGR_NAME,
IARM_EventId_t – IARM_BUS_DISKMGR_EVENT_HWDISK ,
Void * - eventdata, size_t – sizeof (eventdata)
IARM_Bus_UnRegisterEventHandler :
const char* – IARM_BUS_DISKMGR_NAME , IARM_EventId_t – IARM_BUS_DISKMGR_EVENT_HWDISK
...
4.IARMBUS_Agent will register for “IARM_BUS_DISKMGR_EVENT_HWDISK” event and waits on event.
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARMBUS_DiskMgr_Event_HwDisk_18</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #passing parameter for receving HWdisk event for disk manager
