...
<xml>
  ...
  <name>TWC_IRKEY_VOLUMECONTROLS_ITER</name>
...
IRKEY_VOLUMECONTROLS_ITER_TC_01
IRKEY_VOLUMECONTROLS_ITER_TC_02
IRKEY_VOLUMECONTROLS_ITER_TC_03
IRKEY_VOLUMECONTROLS_ITER_TC_04
IRKEY_VOLUMECONTROLS_ITER_TC_05
IRKEY_VOLUMECONTROLS_ITER_TC_06</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TWC_IRKEY_VOLUMECONTROLS_ITER');
loadmodulestatus =obj.getLoadModuleResult();
print("[LIB LOAD STATUS]  :  %s" %loadmodulestatus );
if "SUCCESS" in loadmodulestatus.upper():
    obj.setLoadModuleStatus('SUCCESS');
    timeval = 0.0;
    with open(obj.realpath + '/fileStore/testscriptsRDKV/component/iarmbus/IRkey_VolumeControls_Iter.txt', 'r') as f:
        #print obj.realpath;
        data = f.readlines();
