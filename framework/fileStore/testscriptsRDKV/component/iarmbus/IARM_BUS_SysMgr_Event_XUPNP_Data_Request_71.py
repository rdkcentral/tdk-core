...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1334</id>
  <version>1</version>
  <name>IARM_BUS_SysMgr_Event_XUPNP_Data_Request_71</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST” event.
Test case Id - CT_IARMBUS_71</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_71</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST” event.</test_objective>
...
const char * - IARM_BUS_SYSMGR_NAME , IARM_EventId_t - IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST, IARM_EventHandler_t - _evthandler
IARM_Bus_BroadcastEvent :
Const char* - IARM_BUS_SYSMGR_NAME,
IARM_EventId_t – IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST ,
Void * - eventdata, size_t – sizeof (eventdata)
IARM_Bus_UnRegisterEventHandler :
const char* – IARM_BUS_SYSMGR_NAME , IARM_EventId_t – IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST
...
3.IARMBUS_Agent will register for “IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_REQUEST” event and waits on event.
4.IARMBUS_Agent will broadcast the event to the bus using IARM_Bus_BroadcastEvent api.
5.IARMBUS_Agent should receive the event and event handler should handle the event(printing some log message) .
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_XUPNP_Data_Request_71</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_IARMBUS_71');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #passing parameter for receiving Xupnp data  request frm Receiver to UPNP
