...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>97</id>
  <version>1</version>
  <name>IARMBUS BusCall MFR-OUI test</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script queries the Manufacturer Organizationally Unique Identifier
Test Case ID : CT_IARMBUS_32</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_31</test_case_id>
    <test_objective>IARMBUS – Querying board (STB) manufacture OUI(
Organizationally Unique Identifier).</test_objective>
...
Void * - IARM_BUS_MFR_SERIALIZED_TYPE_MANUFACTUREROUI ,
size_t - sizeof(param)
...
3.IARMBUS_Agent invokes the RPC method for querying board manufacture OUI(Originally Unique Identifier).
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS BusCall MFR-OUI test</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>Test will fail on boxes not running mfrMgrMain</remarks>
  </test_cases>
</xml>
