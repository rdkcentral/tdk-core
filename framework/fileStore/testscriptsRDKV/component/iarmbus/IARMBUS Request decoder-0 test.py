...
Test Case ID : CT_IARMBUS_9</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_9</test_case_id>
    <test_objective>IARMBUS -Request for Decoder-0 resource.</test_objective>
...
IARM_BusDaemon_RequestOwnership : IARM_Bus_ResrcType_t - IARM_BUS_RESOURCE_DECODER_0
...
3.IARMBUS_Agent will request for resource IARM_BUS_RESOURCE_DECODER_0.
4.IARMBUS_Agent will release resource IARM_BUS_RESOURCE_DECODER_0.
...
6.TestMgr_IARMBUS_ReleaseResource</test_stub_interface>
    <test_script>IARMBUS Request decoder-0 test</test_script>
    <skipped>No</skipped>
