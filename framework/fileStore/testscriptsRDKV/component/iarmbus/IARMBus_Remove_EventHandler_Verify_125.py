...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>IARMBus_Remove_EventHandler_Verify_125</name>
  <primitive_test_id/>
  <primitive_test_name>IARMBUS_RemoveEventHandler</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS – IARM_Bus_RemoveEventHandler() remove a specifc handler and the handler is no longer invoked.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_125</test_case_id>
    <test_objective>IARMBUS – IARM_Bus_RemoveEventHandler() remove a specifc handler and the handler is no longer invoked.</test_objective>
...
3.IARMBUS_Agent will broadcast the dummy events to the bus using IARM_Bus_BroadcastEvent api.
...
5.IARMBUS_Agent will remove the event handler for “IARM_BUS_EVENT_RESOLUTIONCHANGE” event .
6.IARMBUS_Agent should not receive the event and event handler should handle the event(printing some log message) .
...
9.TestMgr_IARMBUS_RemoveEventHandler</priority>
    <test_stub_interface>IARMBus_Remove_EventHandler_Verify_125.py</test_stub_interface>
    <test_script>IARMBus_Remove_EventHandler_Verify_125</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks>M35</remarks>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBus_Remove_EventHandler_Verify_125');
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                            ...
                            tdkTestObj.setResultStatus("FAILURE");
                            print("FAILURE: Event is Received after remove event handler");
