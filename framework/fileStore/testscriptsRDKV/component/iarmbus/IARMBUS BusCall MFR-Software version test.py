...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>103</id>
  <version>1</version>
  <name>IARMBUS BusCall MFR-Software version test</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script queries the MFR Software version
Test Case ID : CT_IARMBUS_38</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_37</test_case_id>
    <test_objective>IARMBUS – Querying board (STB) software version.</test_objective>
...
Void * - IARM_BUS_MFR_SERIALIZED_TYPE_SOFTWAREVERSION,
Size_t sizeof(param)
...
3.IARMBUS_Agent invokes the RPC method for querying board software version.
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS BusCall MFR-Software version test</test_script>
    <skipped>No</skipped>
