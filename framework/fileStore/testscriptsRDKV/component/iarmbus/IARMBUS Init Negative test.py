...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_2</test_case_id>
    <test_objective>IARMBUS – Joining application with IARMBUS where the application is already joined with the IARMBUS.</test_objective>
...
4.TestMgr_IARMBUS_Disconnect</test_stub_interface>
    <test_script>IARMBUS Init Negative test</test_script>
    <skipped>No</skipped>
