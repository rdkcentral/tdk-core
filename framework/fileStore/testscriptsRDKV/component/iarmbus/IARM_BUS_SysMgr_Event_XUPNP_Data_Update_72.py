...
Test case Id - CT_IARMBUS_72</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_72</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_UPDATE” event.</test_objective>
...
const char * - IARM_BUS_SYSMGR_NAME , IARM_EventId_t - IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_UPDATE, IARM_EventHandler_t - _evthandler
IARM_Bus_BroadcastEvent :
Const char* - IARM_BUS_SYSMGR_NAME,
IARM_EventId_t – IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_UPDATE ,
Void * - eventdata, size_t – sizeof (eventdata)
IARM_Bus_UnRegisterEventHandler :
const char* – IARM_BUS_SYSMGR_NAME , IARM_EventId_t – IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_UPDATE
...
3.IARMBUS_Agent will register for “IARM_BUS_SYSMGR_EVENT_XUPNP_DATA_UPDATE” event and waits on event.
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_XUPNP_Data_Update_72</test_script>
    <skipped>No</skipped>
