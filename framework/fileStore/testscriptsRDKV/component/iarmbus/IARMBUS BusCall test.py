...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>79</id>
  <version>2</version>
  <name>IARMBUS BusCall test</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script tests the invocation of an RPC method registered in another application
Test Case ID : CT_IARMBUS_16</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_16</test_case_id>
    <test_objective>IARMBUS – Invoke RPC methods that is registered in another application.</test_objective>
...
6.IARMBUS_Agent deregister from the IARM Bus Daemon.
...
5.TestMgr_IARMBUS_RegisterCall
6.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS BusCall test</test_script>
    <skipped>No</skipped>
