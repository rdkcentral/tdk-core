...
<xml>
  ...
  <name>NM_WifiMgr_setDisabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective:To disable wifi adapter
Test CaseID:CT_NET_SRV_MGR_WIFI_6
Test Type: Positive</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>To disable wifi adapter</test_objective>
