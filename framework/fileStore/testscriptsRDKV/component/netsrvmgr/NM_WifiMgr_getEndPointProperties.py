...
<xml>
  ...
  <name>NM_WifiMgr_getEndPointProperties</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective:To get the end point properties of wifi manager
Test CaseID:CT_NM_24
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_NM_40</test_case_id>
    <test_objective>To get the end point properties of wifi manager</test_objective>
...
IARM_Bus_Connect()
IARM_Bus_Call(IARM_BUS_WIFI_MGR_API_getEndPointProps)
IARM_Bus_Disconnect()
...
2.NetSrvMgr_Agent should retrieve the end point properties of wifi manager
3.NetSrvMgr_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    <except_output>Checkpoint 1.Wifi manager should retrieve the end point properties successfully</except_output>
    <priority>High</priority>
    <test_stub_interface>libnetsrvmgrstub.so</test_stub_interface>
    <test_script>NM_WifiMgr_getEndPointProperties</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'NM_WifiMgr_getEndPointProperties');
...
if "SUCCESS" in iarmLoadStatus.upper():
    ...
    if "SUCCESS" in result:
        ...
        if "SUCCESS" in result:
            ...
            netsrvObj.configureTestCase(ip,port,'NM_WifiMgr_getEndPointProperties');
            ...
            if "SUCCESS" in netsrvLoadStatus.upper():
                ...
                tdkTestObj.addParameter("method_name", "getEndPointProps");
                ...
                print("getEndPointProps returned : %s" %actualresult)
