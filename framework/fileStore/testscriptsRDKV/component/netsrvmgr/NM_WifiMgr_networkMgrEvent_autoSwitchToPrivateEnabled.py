...
<xml>
  ...
  <name>NM_WifiMgr_networkMgrEvent_autoSwitchToPrivateEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective:To broadcast network manager auto switch to private enabled event and check if netsrvmgr process receives it
Test CaseID:CT_NM_29
Test Type: Positive</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>To broadcast network manager auto switch to private enabled event and check if netsrvmgr process receives it</test_objective>
...
IARM_Bus_Connect()
IARM_Bus_BroadcastEvent(IARM_BUS_NM_SRV_MGR_NAME,IARM_BUS_NETWORK_MANAGER_EVENT_AUTO_SWITCH_TO_PRIVATE_ENABLED,(void*)&amp;eventData,sizeof(eventData))
IARM_Bus_Disconnect()
...
9. IARMBUS_Agent deregisters from the IARM Bus Daemon.</automation_approch>
    ...
    <test_script>NM_WifiMgr_networkMgrrEvent_switchToPrivate</test_script>
    <skipped>No</skipped>
