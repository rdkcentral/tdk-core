...
<xml>
  ...
  <name>NM_WifiMgr_cancelWPSPairing</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Cancel WPS pairing</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Cancel WPS pairing</test_objective>
...
2.NetSrvMgr_Agent should enable WPS pairing
3.NetSrvMgr_Agent should cancel WPS pairing</automation_approch>
    <expected_output>WPS pairing should be cancelled</expected_output>
...
iarmObj.configureTestCase(ip,port,'NM_WifiMgr_cancelWPSPairing');
#Get the result of connection with test component and STB
iarmLoadStatus = iarmObj.getLoadModuleResult();
print(("Iarmbus module loading status : %s\n" %iarmLoadStatus));
...
if "SUCCESS" in iarmLoadStatus.upper():
    ...
    if "SUCCESS" in result:
        ...
        if "SUCCESS" in result:
            ...
            netsrvObj.configureTestCase(ip,port,'NM_WifiMgr_cancelWPSPairing');
            #Get the result of connection with test component and STB
            ...
            if "SUCCESS" in netsrvLoadStatus.upper():
                ...
                tdkTestObj.addParameter("method_name", "initiateWPSPairing");
                ...
                if expectedresult in actualresult:
                    ...
                    #Execute the test case in STB
                    tdkTestObj.addParameter("method_name", "cancelWPSPairing");
                    expectedresult="SUCCESS"
                    tdkTestObj.executeTestCase(expectedresult);
                    #Get the result of execution
                    actualresult = tdkTestObj.getResult();
