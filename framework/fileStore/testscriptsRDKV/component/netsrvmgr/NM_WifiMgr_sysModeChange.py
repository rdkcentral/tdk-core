...
<xml>
  ...
  <name>NM_WifiMgr_sysModeChange</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective:To change sysmode of wifi manager
Test CaseID:CT_NM_25
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_NM_42</test_case_id>
    <test_objective>To change mode of wifi manager</test_objective>
...
2.NetSrvMgr_Agent should change the mode of wifi manager
3.NetSrvMgr_Agent will return SUCCESS or FAILURE based on the result from the above step</automation_approch>
    <except_output>Checkpoint 1.Mode of wifi manager should be changed successfully</except_output>
    <priority>High</priority>
    <test_stub_interface>libnetsrvmgrstub.so</test_stub_interface>
    <test_script>NM_WifiMgr_sysModeChange</test_script>
    <skipped>No</skipped>
    ...
    if "SUCCESS" in result:
        ...
        if "SUCCESS" in result:
            ...
            if "SUCCESS" in netsrvLoadStatus.upper():
                ...
                tdkTestObj.addParameter("new_mode",0);
                ...
                print("SysModeChange returned as : %s" %actualresult)
