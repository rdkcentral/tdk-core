...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoDefaultmuted</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>Media_120</test_case_id>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-defaultmuted.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_Media_VideoDefaultmuted</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoDefaultmuted');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-defaultmuted.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing video-defaultmuted.html file")
            grep_line = "video-defaultmuted | tail -3 | tr -d '\\n'"
            log_filename = "video-defaultmuted"
...
if "video-defaultmuted" in status_dict:
    print(f"video-defaultmuted: {status_dict['video-defaultmuted']}")
