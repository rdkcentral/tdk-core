...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoSeek</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify correct behavior of seeking in various video states including end, paused and after fastSeek</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_149</test_case_id>
    <test_objective>To ensure that seeking updates currentTime correctly, multiple seeks collapse into a single event, and video remains paused or resumes appropriately depending on state</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-seek-after-end.html, video-seek-double.html, video-seek-have-nothing.html, video-seek-multiple.html, video-seek-past-end-paused.html, video-seek-to-current-time.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Video currentTime updates as expected, only one seeked event fires for simultaneous seeks, paused state is preserved when seeking past the end, and fastSeek followed by currentTime assignment sets the correct time</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_VideoSeek</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoSeek');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-after-end.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-double.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-have-nothing.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-multiple.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-past-end-paused.html'
webkit_test_url6 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-seek-to-current-time.html'
