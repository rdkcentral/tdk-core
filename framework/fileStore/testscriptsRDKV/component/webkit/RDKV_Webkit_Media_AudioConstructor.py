...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_AudioConstructor</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate resource loading and preload behavior of the Audio object.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_46</test_case_id>
    <test_objective>Verify that Audio loads resources correctly when src is set or passed in constructor, and that the preload attribute defaults to auto.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audio-constructor.html, audio-constructor-preload.html, audio-constructor-src.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The Audio element should correctly initialize, trigger loadstart and canplaythrough events, set currentSrc to the given file.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_AudioConstructor</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_AudioConstructor');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/audio-constructor.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/audio-constructor-preload.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/audio-constructor-src.html'
