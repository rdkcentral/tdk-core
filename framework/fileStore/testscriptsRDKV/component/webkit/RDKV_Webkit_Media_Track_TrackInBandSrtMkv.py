...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackInBandSrtMkv</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify in-band and out-of-band text tracks from an MKV file are correctly handled, including addtrack events, cue duplication, kind and language attributes, and track order.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_49</test_case_id>
    <test_objective>Ensure that:
1. Text track "addtrack" events are triggered for MKV in-band tracks.
2. No duplicate cues appear after seeking backwards.
3. In-band text tracks' kind attributes match expected values.
4. In-band text tracks' language attributes match expected values.
5. Text track order is preserved when mixing in-band and out-of-band tracks.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-in-band-srt-mkv-addtrack.html, track-in-band-srt-mkv-cues-added-once.html, track-in-band-srt-mkv-kind.html, track-in-band-srt-mkv-language.html, track-in-band-srt-mkv-track-order.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Console logs should show:
- PASS for all addtrack events.
- No duplicate cues after seek operations.
- Correct kind and language attributes for in-band tracks.
- Track order as expected.
- "END OF TEST" for each HTML test.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackInBandSrtMkv</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackInBandSrtMkv');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-srt-mkv-addtrack.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-srt-mkv-cues-added-once.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-srt-mkv-kind.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-srt-mkv-language.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-srt-mkv-track-order.html'
