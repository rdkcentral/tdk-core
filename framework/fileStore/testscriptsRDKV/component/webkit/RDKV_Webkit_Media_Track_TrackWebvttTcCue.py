...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackWebvttTcCue</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests that cues recognize any text as an optional identifier and handle missing or duplicate identifiers correctly.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_44</test_case_id>
    <test_objective>To verify that cues with optional or empty identifiers, including those with special characters, are parsed correctly and maintain proper timing, text, size, and alignment settings.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-webvtt-tc006-cue-identifiers.html, track-webvtt-tc007-cue-no-id.html, track-webvtt-tc019-cue-size.html, track-webvtt-tc020-cue-size-align.html, track-webvtt-tc031-cue-recovery.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Cues have the correct length, identifiers, start and end times, text, size, and alignment, and cues are recovered properly when missing blank line separators are encountered.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackWebvttTcCue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackWebvttTcCue');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc006-cue-identifiers.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc007-cue-no-id.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc019-cue-size.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc020-cue-size-align.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc031-cue-recovery.html'
