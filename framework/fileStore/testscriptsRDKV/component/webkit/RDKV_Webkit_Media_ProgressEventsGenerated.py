...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_ProgressEventsGenerated</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate generation of progress events during media loading</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_107</test_case_id>
    <test_objective>To verify that the media element emits multiple progress events while loading and playing</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>progress-events-generated-correctly.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The progress event count should be greater than one, indicating proper event generation during playback</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_ProgressEventsGenerated</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_ProgressEventsGenerated');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/progress-events-generated-correctly.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing progress-events-generated-correctly.html file")
            grep_line = "progress-events-generated-correctly | tail -3 | tr -d '\\n'"
            log_filename = "progress-events-generated-correctly"
...
if "progress-events-generated-correctly" in status_dict:
    print(f"progress-events-generated-correctly: {status_dict['progress-events-generated-correctly']}")
