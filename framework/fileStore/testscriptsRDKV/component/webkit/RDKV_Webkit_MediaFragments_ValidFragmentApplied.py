...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_ValidFragmentApplied</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0053: To verify that a media fragment with invalid and valid parameters (e.g., 't=foo:7ampersandt=npt:3') is correctly interpreted, with only the valid t=npt:3 fragment being applied.
    TC0054: To verify that a media fragment with multiple name-value pairs is correctly processed, with only the valid t=3 fragment being applied.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_14</test_case_id>
    <test_objective>
      TC0053: To ensure that when the media fragment 't=foo:7ampersandt=npt:3' is provided, only the valid fragment #t=npt:3 is processed, and the video starts playing from 3 seconds while ignoring the invalid t=foo:7 fragment.
      TC0054: To ensure that when the media fragment provided, only the valid fragment #t=3 is processed, and the video starts playing from 3 seconds, ignoring the invalid fragments.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0053.html, TC0054.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_ValidFragmentApplied</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_ValidFragmentApplied');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0053.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0054.html'
