...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_AudioTrack</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Tests detection and configuration of in-band audio tracks and their state changes when loaded and unloaded.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_01</test_case_id>
    <test_objective>To verify that in-band audio tracks are exposed with correct codec details and are removed when the source is cleared.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audio-track-configuration.html, audio-track.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Audio track detected with codec mp4a.40.2, sample rate 44100, 2 channels, valid bitrate, and track count updated from 1 to 0 after unloading.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_AudioTrack</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_AudioTrack');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/audio-track-configuration.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/audio-track.html'
