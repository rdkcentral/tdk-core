...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_SpecifiedRange</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0004: To ensure that media playback honors a valid fragment request from the beginning to a specified end time.
    TC0005: To ensure that media playback starts and ends correctly within the specified range of a valid media fragment.
    TC0006: To ensure that media playback starts and ends correctly within the specified range of a valid media fragment spanning from a defined start time to the end of the requested range.
    TC0009: To verify that when a media fragment exceeds the media's duration, the user agent seeks to the end or handles the out-of-range request correctly.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_09</test_case_id>
    <test_objective>
      TC0004: To verify that a media fragment with the format 't=0,9.97' correctly plays from the start (0) to the specified end time (9.97), and playback pauses as expected near the end of the requested fragment.
      TC0005: To verify that a media fragment with the format 't=3,7' correctly initiates playback from the specified start time (3) to the specified end time (7), and playback pauses as expected near the end of the requested fragment.
      TC0006: Ensure playback begins at the specified start time and ends within 0.75 seconds of the fragment end time.
      TC0009: To ensure the user agent seeks to the end of the media or processes the out-of-range request for the fragment.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0004.html, TC0005.html, TC0006.html, TC0009.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_SpecifiedRange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_SpecifiedRange');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0004.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0005.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0006.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0009.html'
