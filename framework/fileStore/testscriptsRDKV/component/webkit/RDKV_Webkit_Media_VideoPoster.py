...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoPoster</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test verifies the behavior of the video element when using the poster attribute, including valid, invalid, empty, and missing poster images</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_144</test_case_id>
    <test_objective>To ensure the video element displays the correct poster, respects width and height attributes, and handles blocked or missing poster images correctly</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-poster.html, video-poster-blocked-by-willsendrequest.html, video-poster-delayed.html, video-poster-not-found.html, video-poster-scale.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Video dimensions match the poster size when available or default size when missing or invalid, and the poster attribute reflects the assigned value</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_VideoPoster</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoPoster');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-poster.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-poster-blocked-by-willsendrequest.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-poster-delayed.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-poster-not-found.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-poster-scale.html'
