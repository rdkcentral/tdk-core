...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_VideoTrack</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests audio and video tracks in media elements, including alternate groups, fallback tracks, and in-band video tracks.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_46</test_case_id>
    <test_objective>To verify correct counting, configuration, and properties of audio and video tracks under various scenarios.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-track-alternate-groups.html, video-track-configuration.html, video-track.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Audio tracks counted correctly, video track properties correct for AVC and HEVC, in-band video tracks handled properly.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_VideoTrack</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_VideoTrack');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/video-track-alternate-groups.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/video-track-configuration.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/video-track.html'
