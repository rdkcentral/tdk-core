...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_ValidRangePlayback</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0085: To verify that when multiple fragments are provided (t=3,7ampersandt=foo), the last valid fragment t=foo is ignored, and the video plays from t=3 to t=7 as requested.
    TC0086: To ensure that the rubbish fragment (foo) before the valid fragment (t=3,7) is ignored, and the video plays from 3 to 7 seconds as requested.
    TC0087: To ensure that the rubbish fragment (foo) after the valid fragment (t=3,7) is ignored, and the video plays from 3 to 7 seconds as requested.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_15</test_case_id>
    <test_objective>
      TC0085: To confirm that the video plays the segment from 3 to 7 seconds, ignoring the invalid fragment (t=foo).
      TC0086: To confirm that the fragment foo is ignored, and the video correctly plays from t=3 to t=7 based on the valid t=3,7 fragment.
      TC0087: To confirm that the fragment foo after the valid fragment t=3,7 is ignored, and the video correctly plays from t=3 to t=7 based on the valid t=3,7 fragment.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0085.html, TC0086.html, TC0087.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_ValidRangePlayback</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_ValidRangePlayback');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0085.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0086.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0087.html'
