...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_SprinkleAmpersands</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0088: To verify that additional ampersand characters, even if sprinkled at the end of a valid fragment like t=3,7, do not affect the expected behavior of the media playback.
    TC0089: To verify that additional ampersand characters at the start of a fragment, like ampersandt=3,7, are ignored, and the video playback proceeds as expected from t=3 to t=7.
    TC0090: To verify that multiple ampersand characters before a valid fragment (like ampersandampersandt=3,7) are ignored, and the video playback proceeds as expected from t=3 to t=7.
    TC0091: To verify that trailing ampersand characters after a valid fragment (like ampersandt=3,7ampersand) are ignored, and the video playback proceeds as expected from t=3 to t=7.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_11</test_case_id>
    <test_objective>
      TC0088: To ensure that extra ampersand characters after the valid fragment t=3,7 are ignored, and the video plays as expected from t=3 to t=7 without interference from the redundant ampersand characters.
      TC0089: To ensure that an extra ampersand at the beginning of a valid fragment t=3,7 does not affect the media playback, and the video starts at currentTime == 3 and ends at currentTime == 7 as expected.
      TC0090: To ensure that multiple ampersand characters before a valid fragment do not interfere with the media fragment. The test should confirm that the video starts at currentTime == 3 and ends at currentTime == 7 as expected, and the extra ampersand characters are ignored.
      TC0091: To ensure that trailing ampersand characters after a valid fragment do not interfere with the media fragment. The test should confirm that the video starts at currentTime == 3 and ends at currentTime == 7 as expected, with the trailing ampersand characters being ignored.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0088.html, TC0089.html, TC0090.html, TC0091.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_SprinkleAmpersands</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_SprinkleAmpersands');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0088.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0089.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0090.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0091.html'
