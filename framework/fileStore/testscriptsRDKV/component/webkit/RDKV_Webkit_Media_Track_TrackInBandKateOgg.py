...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackInBandKateOgg</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that the device browser correctly detects and handles in-band Kate OGG text tracks</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_48</test_case_id>
    <test_objective>Ensure addtrack events, cue management, kind attributes, language, and track order are properly validated for in-band Kate OGG streams</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-in-band-kate-ogg-addtrack.html, track-in-band-kate-ogg-cues-added-once.html, track-in-band-kate-ogg-kind.html, track-in-band-kate-ogg-language.html, track-in-band-kate-ogg-track-order.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Console should show PASS logs for addtrack events, cue validation, correct kind/language/order attributes, followed by “END OF TEST” and “TEST COMPLETE</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackInBandKateOgg</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackInBandKateOgg');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-kate-ogg-addtrack.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-kate-ogg-cues-added-once.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-kate-ogg-kind.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-kate-ogg-language.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/in-band/track-in-band-kate-ogg-track-order.html'
