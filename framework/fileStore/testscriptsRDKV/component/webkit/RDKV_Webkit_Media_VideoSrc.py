...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoSrc</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>These tests validate video element behavior when handling valid, empty, missing, bogus, and blob URLs, as well as when the source attribute is removed.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_156</test_case_id>
    <test_objective>To ensure correct load events, error handling, state changes, and no unintended reloads when src is altered or removed.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-src.html, video-src-blob-perf.html, video-src-empty.html, video-src-invalid-poster.html, video-src-invalid-remove.html, video-src-none.html, video-src-plus-source.html, video-src-remove.html, video-src-set.html, video-src-source.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Valid sources load normally with correct dimensions, bogus or empty ones trigger error code 4, missing src keeps state empty, and blob URLs load within expected time.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_VideoSrc</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoSrc');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-blob-perf.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-empty.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-invalid-poster.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-invalid-remove.html'
webkit_test_url6 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-none.html'
webkit_test_url7 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-plus-source.html'
webkit_test_url8 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-remove.html'
webkit_test_url9 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-set.html'
webkit_test_url10 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-src-source.html'
