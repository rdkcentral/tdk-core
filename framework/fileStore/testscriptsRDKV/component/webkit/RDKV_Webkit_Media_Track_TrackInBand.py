...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackInBand</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests in-band and added text tracks for multiple languages and kinds, verifying cues, active cues, and track visibility behavior</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_16</test_case_id>
    <test_objective>To verify that in-band text tracks and added text tracks have correct length, cues, language, kind, and that enabling or showing tracks displays cues immediately while unloading or hiding tracks flushes them</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-in-band-chapters.html, track-in-band-duplicate-tracks-when-source-changes.html, track-in-band-legacy-api.html, track-in-band-mode.html, track-in-band.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>TextTracks have correct length, language, kind, cues and active cues, showing a track displays cues immediately, disabling or unloading tracks flushes cues, adding tracks preserves proper sort order and avoids duplicates</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackInBand</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackInBand');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-in-band-chapters.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-in-band-duplicate-tracks-when-source-changes.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-in-band-legacy-api.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-in-band-mode.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-in-band.html'
