...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_InvalidFragmentFullPlayback</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0073: To verify that the media fragment t=0:0:0 is recognized as invalid and the entire media resource is played.
    TC0074: To verify that the media fragment t=0:00:60 is recognized as invalid and the entire media resource is played.
    TC0075: To verify that the media fragment t=0:01:60 is recognized as invalid and the entire media resource is played.
    TC0076: To verify that the media fragment t=0:60:00 is recognized as invalid and the entire media resource is played.
    TC0077: To verify that the media fragment t=0:000:000 is recognized as invalid and the entire media resource is played.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_01</test_case_id>
    <test_objective>
      TC0073: To ensure that the user agent recognizes the fragment t=0:0:0 as invalid and plays the entire media resource from the beginning.
      TC0074: To ensure that the user agent identifies t=0:00:60 as an invalid media fragment and plays the entire media resource from the beginning.
      TC0075: To ensure that the user agent identifies t=0:01:60 as an invalid media fragment and plays the entire media resource from the beginning.
      TC0076: To ensure that the user agent identifies t=0:60:00 as an invalid media fragment and plays the entire media resource from the beginning.
      TC0077: To ensure that the user agent identifies t=0:000:000 as an invalid media fragment and plays the entire media resource from the beginning.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0073.html, TC0074.html, TC0075.html, TC0076.html, TC0077.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_InvalidFragmentFullPlayback</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_InvalidFragmentFullPlayback');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0073.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0074.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0075.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0076.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0077.html'
