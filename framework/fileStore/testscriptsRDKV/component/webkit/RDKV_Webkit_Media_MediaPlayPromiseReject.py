...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_MediaPlayPromiseReject</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate media playback error handling and promise rejection scenarios.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_97</test_case_id>
    <test_objective>To verify that mediaElement play correctly rejects with appropriate errors such as AbortError NotAllowedError and NotSupportedError under invalid operations restrictions or invalid sources</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>media-play-promise-reject-load-abort.html, media-play-promise-reject-pause-abort.html, media-play-promise-reject-play-notallowed-audio.html, media-play-promise-reject-play-notallowed.html, media-play-promise-reject-play-notsupported.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The play promise should reject with the expected error type matching the scenario AbortError NotAllowedError or NotSupportedError</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_MediaPlayPromiseReject</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_MediaPlayPromiseReject');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-play-promise-reject-load-abort.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-play-promise-reject-pause-abort.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-play-promise-reject-play-notallowed-audio.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-play-promise-reject-play-notallowed.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-play-promise-reject-play-notsupported.html'
