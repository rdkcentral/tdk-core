...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_URLEncodedFragment</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0034: To verify that a URL-encoded fragment ('t%3D3') is not recognized as a valid media fragment and the user agent plays the entire media resource from the start.
    TC0035: To verify that a URL-encoded fragment ('%74=3') is correctly interpreted as a valid media fragment and that the media plays from 3 seconds to the end.
    TC0036: To verify that a URL-encoded fragment ('t=%33') is correctly interpreted as a valid media fragment and that the media plays from 3 seconds to the end.
    TC0037: To verify that a URL-encoded fragment ('t=3%2C7') is correctly interpreted as a valid media fragment requesting playback from 3 to 7 seconds.
    TC0038: To verify that a URL-encoded fragment ('t=%6Ept:3') is correctly interpreted and the media is requested from 3 seconds to the end, where %6E is equivalent to n.
    TC0039: To verify that a URL-encoded fragment ('t=npt%3A3') is correctly interpreted and the media is requested from 3 seconds to the end.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_13</test_case_id>
    <test_objective>
      TC0034: To ensure that when a media fragment is URL-encoded ('t%3D3'), the user agent does not treat it as a valid fragment and instead plays the entire media resource starting from the beginning (currentTime == 0).
      TC0035: To ensure that when a URL-encoded fragment ('%74=3', which is equivalent to 't=3') is used, the media is requested to play starting from 3 seconds and ending at the end of the media resource.
      TC0036: To ensure that when a URL-encoded fragment ('t=%33', which is equivalent to 't=3') is used, the media is requested to play starting from 3 seconds and ending at the end of the media resource.
      TC0037: To ensure that when a URL-encoded fragment ('t=3%2C7', which is equivalent to 't=3,7') is used, the media plays from 3 seconds to 7 seconds.
      TC0038: To ensure that the URL-encoded fragment 't=%6Ept:3', which translates to 't=npt:3', correctly requests playback starting from 3 seconds to the end of the media resource.
      TC0039: To ensure that the URL-encoded fragment 't=npt%3A3', which translates to 't=npt:3', correctly requests playback starting from 3 seconds to the end of the media resource.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0034.html, TC0035.html, TC0036.html, TC0037.html, TC0038.html, TC0039.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_URLEncodedFragment</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_URLEncodedFragment');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0034.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0035.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0036.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0037.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0038.html'
webkit_test_url6 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0039.html'
