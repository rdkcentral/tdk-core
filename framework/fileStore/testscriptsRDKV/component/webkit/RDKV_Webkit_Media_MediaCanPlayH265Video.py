...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_MediaCanPlayH265Video</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate canPlayType support for MPEG4 video with H265 codecs.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_77</test_case_id>
    <test_objective>Verify that the video element correctly reports playback capability for MP4 containers with H265 codec strings.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>media-can-play-h265-video.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The method should return maybe for generic MP4 and probably for valid H265 codec MIME types, regardless of case formatting.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_MediaCanPlayH265Video</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_MediaCanPlayH265Video');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-can-play-h265-video.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing media-can-play-h265-video.html file")
            grep_line = "media-can-play-h265-video | tail -3 | tr -d '\\n'"
            log_filename = "media-can-play-h265-video"
...
if "media-can-play-h265-video" in status_dict:
    print(f"media-can-play-h265-video: {status_dict['media-can-play-h265-video']}")
