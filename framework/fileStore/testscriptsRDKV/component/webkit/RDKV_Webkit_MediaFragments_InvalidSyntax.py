...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_InvalidSyntax</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0001: To validate that an invalid media fragment syntax is ignored and playback begins at the default start time.
    TC0044: To verify that an invalid media fragment ('t=-1,3') with incorrect syntax (a - character at an invalid position) is handled by playing the entire media resource.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_06</test_case_id>
    <test_objective>
      TC0001: To ensure that when an invalid media fragment is provided, the player starts playback from 0 seconds as per specification.
      TC0044: To ensure that when an invalid media fragment 't=-1,3' is provided, the user agent recognizes it as invalid and plays the entire media resource starting from the beginning.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0001.html, TC0044.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_InvalidSyntax</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_InvalidSyntax');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0001.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0044.html'
