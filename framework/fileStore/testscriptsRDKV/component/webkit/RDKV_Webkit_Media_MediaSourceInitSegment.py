...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To get the Media Source Init Segment details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To get the Media Source Init Segment details from the device browser</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>media-source-init-segment-swap-track-ids.html,media-source-init-segment-duration.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to get the Media Source Init Segment details</expected_output>
