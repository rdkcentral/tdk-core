...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackWebvttTcAlign</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests that cue text, position, alignment, line, and snap-to-lines settings are correctly applied for all text tracks.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_43</test_case_id>
    <test_objective>To verify that each cue in multiple text tracks reflects the expected alignment, position, line, and snap-to-lines configuration.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-webvtt-tc016-align-positioning.html, track-webvtt-tc018-align-text-line-position.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Cues in all text tracks have the correct number, alignment, position, line values, and snap-to-lines settings as defined.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackWebvttTcAlign</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackWebvttTcAlign');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc016-align-positioning.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc018-align-text-line-position.html'
