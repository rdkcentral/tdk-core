...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_AudioTrackMkvVorbis</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that the WebKit browser correctly detects and handles MKV Vorbis audio tracks.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_47</test_case_id>
    <test_objective>Ensure that audio track addtrack events, enabled/disabled state changes, and language details are validated for MKV Vorbis streams</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audio-track-mkv-vorbis-addtrack.html, audio-track-mkv-vorbis-enabled.html, audio-track-mkv-vorbis-language.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Browser console should show PASS logs for addtrack events, correct enabled/disabled attribute toggling, and audio track details followed by “END OF TEST” and “TEST COMPLETE”</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_AudioTrackMkvVorbis</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_AudioTrackMkvVorbis');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/audio/audio-track-mkv-vorbis-addtrack.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/audio/audio-track-mkv-vorbis-enabled.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/audio/audio-track-mkv-vorbis-language.html'
