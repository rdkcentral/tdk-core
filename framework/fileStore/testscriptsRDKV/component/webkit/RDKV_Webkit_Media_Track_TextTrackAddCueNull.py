...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TextTrackAddCueNull</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests that adding or removing a cue with a null value is not allowed.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_03</test_case_id>
    <test_objective>To verify that passing a null cue when adding or removing triggers an error.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>texttrack-addCue-null.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Exceptions are thrown for both invalid calls, confirming non-nullable cue parameter enforcement.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TextTrackAddCueNull</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TextTrackAddCueNull');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/texttrack-addCue-null.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing texttrack-addCue-null.html file")
            grep_line = "texttrack-addCue-null | tail -3 | tr -d '\\n'"
            log_filename = "texttrack-addCue-null"
...
if "texttrack-addCue-null" in status_dict:
    print(f"texttrack-addCue-null: {status_dict['texttrack-addCue-null']}")
