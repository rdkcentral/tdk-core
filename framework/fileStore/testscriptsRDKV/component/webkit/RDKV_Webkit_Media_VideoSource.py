...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoSource</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate video with source elements during load, error, and re-selection.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_155</test_case_id>
    <test_objective>To check error events fire on source, video error stays null, load restarts source selection, moving sources handled correctly, and no valid source sets no-source state.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-source.html, video-source-error.html, video-source-error-no-candidate.html, video-source-load.html, video-source-media.html, video-source-moved.html, video-source-none-supported.html, video-source-type.html, video-source-type-params.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Errors fire only on source, video error remains null, load re-evaluates sources, valid source loads and plays, no valid source leaves network state as no source.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_VideoSource</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoSource');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-error.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-error-no-candidate.html'
webkit_test_url4 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-load.html'
webkit_test_url5 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-media.html'
webkit_test_url6 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-moved.html'
webkit_test_url7 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-none-supported.html'
webkit_test_url8 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-type.html'
webkit_test_url9 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-source-type-params.html'
