...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_MediaFragments_TimeRangePlayback</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>
    TC0078: To verify that the media is requested from 3 seconds to 7 seconds using the fragment t=00:00:03,00:00:07.
    TC0079: To verify that the media is requested from 3 seconds to 7 seconds using the fragment t=3,00:00:07.
  </synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Mediafragments_12</test_case_id>
    <test_objective>
      TC0078: To ensure that the media plays from 3 seconds to 7 seconds, and pauses within a tolerance of 0.75 seconds after reaching the end of the fragment.
      TC0079: To ensure that the media plays from 3 seconds to 7 seconds, and pauses within a tolerance of 0.75 seconds after reaching the end of the fragment.
    </test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>TC0078.html, TC0079.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_Webkit_MediaFragments_TimeRangePlayback</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_MediaFragments_TimeRangePlayback');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0078.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/media-fragments/TC0079.html'
