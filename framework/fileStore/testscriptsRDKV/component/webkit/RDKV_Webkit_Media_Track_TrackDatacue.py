...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackDatacue</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests the DataCue interface including value and data properties, constructor behavior, and track assignment</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_10</test_case_id>
    <test_objective>To verify that DataCue correctly handles string, object, and array values, maintains an immutable ArrayBuffer for data, throws exceptions for invalid assignments, and enforces track kind restrictions</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-datacue-value.html, track-datacue.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>DataCue properties match initialized values, value and data behave as specified, exceptions are thrown for invalid data or track assignments, and cues are correctly added only to metadata tracks</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackDatacue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackDatacue');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-datacue-value.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-datacue.html'
