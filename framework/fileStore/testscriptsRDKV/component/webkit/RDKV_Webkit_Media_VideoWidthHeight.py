...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_VideoWidthHeight</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate video element resizing through attributes and properties.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_160</test_case_id>
    <test_objective>To ensure video width, height, offsetWidth, and offsetHeight correctly reflect property updates and attribute changes.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>video-width-height.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Video starts at 100x50, scales to 200x100 via properties, and finally matches attribute-driven size of 400x200.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_VideoWidthHeight</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_VideoWidthHeight');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/video-width-height.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing video-width-height.html file")
            grep_line = "video-width-height | tail -3 | tr -d '\\n'"
            log_filename = "video-width-height"
...
if "video-width-height" in status_dict:
    print(f"video-width-height: {status_dict['video-width-height']}")
