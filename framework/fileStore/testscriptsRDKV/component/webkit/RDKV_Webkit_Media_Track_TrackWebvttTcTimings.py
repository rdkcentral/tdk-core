...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Track_TrackWebvttTcTimings</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To tests validate cue timing parsing in WebVTT, covering cases without hours, with hours, syntax errors, and handling of whitespace around the cue-timings separator.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Track_45</test_case_id>
    <test_objective>To validate correct cue parsing, rejection of invalid timings, and proper handling of whitespace near separators.</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>track-webvtt-tc008-timings-no-hours.html, track-webvtt-tc009-timings-hour.html, track-webvtt-tc029-timings-whitespace.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>Valid cues are parsed with correct IDs, times and text. Invalid cues are ignored. Whitespace variations do not affect parsing.</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Track_TrackWebvttTcTimings</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Track_TrackWebvttTcTimings');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc008-timings-no-hours.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc009-timings-hour.html'
webkit_test_url3 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/track/track-webvtt-tc029-timings-whitespace.html'
