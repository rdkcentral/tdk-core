...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_Webkit_Media_Unsupported</name>
  <primitive_test_id/>
  <primitive_test_name>webkit_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate error handling for unsupported or invalid QuickTime media</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>Media_112</test_case_id>
    <test_objective>To verify that QuickTime files with RTSP URLs or unsupported track types trigger appropriate load errors</test_objective>
...
All the variables in WebkitVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>unsupported-rtsp.html, unsupported-tracks.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The media element should report a non-null error with correct error code and networkState when applicable, and any unsupported tracks should generate an error</expected_output>
    <priority>High</priority>
    <test_stub_interface>webkit</test_stub_interface>
    <test_script>RDKV_Webkit_Media_Unsupported</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Webkit_Media_Unsupported');
...
webkit_test_url = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/unsupported-rtsp.html'
webkit_test_url2 = obj.url+WebkitVariables.wpe_webkit_testcases_path+'/media/unsupported-tracks.html'
