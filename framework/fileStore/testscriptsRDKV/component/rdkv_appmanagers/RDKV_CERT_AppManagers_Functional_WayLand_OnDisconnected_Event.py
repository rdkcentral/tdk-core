...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AppManagers_Functional_WayLand_OnDisconnected_Event')
...
if "SUCCESS" in result.upper():
    ...
    if "SUCCESS" in result[1]:
        ...
        if "SUCCESS" in result:
            ...
            events = ['{"org.rdk.RDKWindowManager": "onDisconnected"}']
            for item in events:
                        ...
                        if "SUCCESS" in result:
                            ...
                            if wayland_mp4_md5sum_value in result:
                                ...
                                if "SUCCESS" in result:
                                    ...
                                    # Wait for the onDisconnected event
                                    ...
                                    if len(event_log) > 0:
                                        ...
                                        if event_status == "TRUE":
                                            # Step 8 : Check created display should not present in the list of apps after receiving onDisconnected event
                                            print("\n")
                                            time.sleep(5)
                                            method = "org.rdk.RDKWindowManager.1.getApps"
                                            tdkTestObj = obj.createTestStep('appmanagers_getvalue')
