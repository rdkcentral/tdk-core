...
if "SUCCESS" in result.upper():
    ...
    if "SUCCESS" in result[1]:
        ...
        if "SUCCESS" in result:
            ...
            events = ['{"org.rdk.DownloadManager": "onAppDownloadStatus"}','{"org.rdk.AppPackageManager": "onAppInstallationStatus"}','{"org.rdk.RDKWindowManager": "onFocus"}']
            for item in events:
                            ...
                            if "error" not in result and "result" in result and result["result"] in (None, '', 'NONE'):
                                ...
                                if len(event_log) > 0:
                                    for entry in event_log:
                                        ...
                                        inner = outer["params"]
                                        #print("\nParsed Event : ", inner)
                                        focus_appInstanceId = inner["clientId"]
