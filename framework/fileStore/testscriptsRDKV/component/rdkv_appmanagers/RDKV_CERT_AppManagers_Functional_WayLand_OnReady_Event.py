                                    ...
                                    if len(event_log) > 0:
                                        for entry in event_log:
                                            ...
                                            if clientId == wayland_display_name:
                                                print("SUCCESS : Received onReady event for the created display : ", clientId)
                                                tdkTestObj.setResultStatus("SUCCESS")
                                                event_status = "TRUE"
                                                break
                                        ...
                                        if event_status == "TRUE":
                                            ...
                                            print("FAILURE : onReady event received but for different display or not received at all : ", clientId)
                                            tdkTestObj.setResultStatus("FAILURE")
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE")
                                else:
