...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>XUPNP_GetUsesdaylighttimeFromOutFile</name>
  <primitive_test_id/>
  <primitive_test_name>XUPNP_ReadXDiscOutputFile</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the Uses daylight time value from xdiscovery output file.
Testcase ID: CT_XUPNP_59</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_59</test_case_id>
    <test_objective>To get the Uses daylight time value from xdiscovery output file.
</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetUsesdaylighttimeFromOutFile</test_script>
    <skipped>No</skipped>
...
xUpnpObj.configureTestCase(ip,port,'XUPNP_GetUsesdaylighttimeFromOutFile');
