...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>XUPNP_GetBaseStreamingUrl</name>
  <primitive_test_id/>
  <primitive_test_name>XUPNP_GetUpnpResult</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get base streaming url value from xdiscovery process.
Testcase ID: CT_XUPNP_19</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_19</test_case_id>
    <test_objective>To get base streaming url value from xdiscovery process.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetBaseStreamingUrl</test_script>
    <skipped>No</skipped>
