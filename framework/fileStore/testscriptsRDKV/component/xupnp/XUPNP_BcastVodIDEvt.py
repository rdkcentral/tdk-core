...
Testcase ID: CT_XUPNP_41</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_41</test_case_id>
    <test_objective>To broadcast vod ID event and check if xcal-device process receives it.</test_objective>
...
6. The stub will invokes the RPC method for checking the vod ID event is registered and send the results.
...
9. IARMBUS_Agent deregisters from the IARM Bus Daemon.</automation_approch>
    ...
    <test_script>XUPNP_BcastVodIDEvt</test_script>
    <skipped>No</skipped>
