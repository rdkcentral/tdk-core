...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>XUPNP_GetVODServerId</name>
  <primitive_test_id/>
  <primitive_test_name>XUPNP_GetUpnpResult</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>XUPNP_GetVODServerId</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_45</test_case_id>
    <test_objective>To get VODSeverID from systemids value from xdiscovery process.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetVODServerId</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'XUPNP_GetVODServerId');
        ...
        if "SUCCESS" in result:
            ...
            if "SUCCESS" in xupnpLoadStatus.upper():
                ...
                for subList in details.split(","):
                    ...
                    print("VOD Server ID - %s "  %d["vodServerId"]);
