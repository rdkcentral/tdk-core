...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_AudioBufferSourceNodeLegacyApi</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the AudioBufferSourceNodeLegacyApi details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_65</test_case_id>
    <test_objective>To get the AudioBufferSourceNodeLegacyApi details from the device browser</test_objective>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to get the AudioBufferSAudioBufferSourceNodeLegacyApiourceNotGcedUntilEnded details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_WebAudio_AudioBufferSourceNodeLegacyApi</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_AudioBufferSourceNodeLegacyApi');
...
webaudio_test_url = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audiobuffersourcenode-legacy-api.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing audiobuffersourcenode-legacy-api.html file")
            grep_line = "audiobuffersourcenode-legacy-api.html | tail -25 | tr -d '\\n'"
            log_filename = "audiobuffersourcenode-legacy-api"
...
if "audiobuffersourcenode-legacy-api" in status_dict:
    print(f"audiobuffersourcenode-legacy-api: {status_dict['audiobuffersourcenode-legacy-api']}")
