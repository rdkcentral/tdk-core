...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_AudioparamSetTargetTimeConstant</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the audioparam setTarget timeConstant details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_93</test_case_id>
    <test_objective>To get the audioparam setTarget timeConstant details from the device browser</test_objective>
...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audioparam-setTarget-timeConstant-0.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to get the audioparam setTarget timeConstant details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_WebAudio_AudioparamSetTargetTimeConstant</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_AudioparamSetTargetTimeConstant');
...
webaudio_test_url = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-setTarget-timeConstant-0.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            print("Processing audioparam-setTarget-timeConstant-0.html file")
            grep_line = "audioparam-setTarget-timeConstant-0 | tail -3 | tr -d '\\n'"
            log_filename = "audioparam-setTarget-timeConstant-0"
...
if "audioparam-setTarget-timeConstant-0" in status_dict:
    print(f"audioparam-setTarget-timeConstant-0: {status_dict['audioparam-setTarget-timeConstant-0']}")
