...
stream_url= WebAudioVariables.aac_audio_url
...
if expectedResult in result.upper():
    ...
    tdkTestObj.addParameter("VariableList","browser_instance,webinspect_port,chromedriver_path,log_check_method,aac_audio_url")
