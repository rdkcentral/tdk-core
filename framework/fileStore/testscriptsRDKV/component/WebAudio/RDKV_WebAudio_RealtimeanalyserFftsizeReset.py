...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_RealtimeanalyserFftsizeReset</name>
  <primitive_test_id/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_RealtimeanalyserFftsizeReset');
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            grep_line = "realtimeanalyser-fftsize-reset | tail -3 | tr -d '\\n'"
            log_filename = "realtimeanalyser-fftsize-reset"
...
if "realtimeanalyser-fftsize-reset" in status_dict:
    print(f"realtimeanalyser-fftsize-reset: {status_dict['realtimeanalyser-fftsize-reset']}")
