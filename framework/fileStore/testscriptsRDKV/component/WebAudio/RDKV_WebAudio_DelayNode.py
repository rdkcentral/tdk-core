...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_DelayNode</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the DelayNode details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_36</test_case_id>
    <test_objective>To get the DelayNode details from the device browser</test_objective>
...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>delaynode.html,delaynode-maxdelay.html,delaynode-scheduling.html,delaynode-max-default-delay.html,delaynode-max-nondefault-delay.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to get the DelayNode details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_WebAudio_DelayNode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_DelayNode');
...
webaudio_test_url = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode.html'
webaudio_test_url2 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode-maxdelay.html'
webaudio_test_url3 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode-scheduling.html'
webaudio_test_url4 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode-maxdelaylimit.html'
webaudio_test_url5 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode-max-default-delay.html'
webaudio_test_url6 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/delaynode-max-nondefault-delay.html'
