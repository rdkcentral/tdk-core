...
stream_url= WebAudioVariables.eac3_audio_url
...
if expectedResult in result.upper():
    ...
    tdkTestObj.addParameter("VariableList","browser_instance,webinspect_port,chromedriver_path,log_check_method,eac3_audio_url")
