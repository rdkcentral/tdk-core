...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_GetStreamInfo_M4A</name>
  <primitive_test_id/>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_WebAudio_GetStreamInfo_M4A</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_GetStreamInfo_M4A');
    ...
    if expectedResult in pre_req_status:
        ...
        if status == "SUCCESS" :
            if log_check_method == "WebinspectPageLogs":
                ...
                webinspect_logs=WebAudiolib.webaudio_getLogs_webinspectpage(obj,app_name, [["9","9","9","9","13"],[]])
                ...
                webinspect_logs = WebAudiolib.webaudio_getLogs_fromDevicelogs(obj,app_name,grep_line,[["9","9","9","9","13"],[]])
            if webinspect_logs != "":
