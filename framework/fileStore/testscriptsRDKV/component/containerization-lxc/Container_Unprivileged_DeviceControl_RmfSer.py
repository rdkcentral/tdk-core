...
<xml>
  ...
  <name>Container_Unprivileged_DeviceControl_RmfSer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check unprivileged containers devices control restrictions for rmfserv</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Container_11</test_case_id>
    <test_objective>Check unprivileged containers devices control restrictions for rmfserv</test_objective>
...
4. TM unloads the SystemUtilAgent</automation_approch>
    <except_output>Checkpoint 1.Check the file "/containers/rmfserv/base.conf" contains an entry as "lxc.cgroup.devices.deny = a"</except_output>
    <priority>High</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>Container_Unprivileged_DeviceControl_RmfSer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Container_Unprivileged_DeviceControl_RmfSer');
