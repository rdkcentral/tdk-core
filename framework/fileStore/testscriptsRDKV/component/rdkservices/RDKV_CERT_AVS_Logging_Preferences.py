...
<xml>
  ...
  <name>RDKV_CERT_AVS_Logging_Preferences</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Logging preferences rdk service api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Logging_Preferences');
...
tdkTestObj.addParameter("xml_name","LoggingPreferences");
