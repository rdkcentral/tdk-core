...
<xml>
  ...
  <name>RDKV_CERT_AVS_Messenger</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Messenger api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Messenger');
...
tdkTestObj.addParameter("xml_name","Messenger");
