...
<xml>
  ...
  <name>RDKV_CERT_AVS_NetworkManager</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Test RDKService NetworkManager APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_NetworkManager');
...
tdkTestObj.addParameter("xml_name","NetworkManager");
