...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service DTV api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_DTV');
...
tdkTestObj.addParameter("xml_name","DTV");
