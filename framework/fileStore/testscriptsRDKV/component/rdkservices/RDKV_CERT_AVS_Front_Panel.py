...
<xml>
  ...
  <name>RDKV_CERT_AVS_Front_Panel</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Front Panel api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Front_Panel');
...
tdkTestObj.addParameter("xml_name","FrontPanel");
