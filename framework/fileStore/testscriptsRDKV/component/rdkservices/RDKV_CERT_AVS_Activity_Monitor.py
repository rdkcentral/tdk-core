...
<xml>
  ...
  <name>RDKV_CERT_AVS_Activity_Monitor</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Activity monitor api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Activity_Monitor');
...
tdkTestObj.addParameter("xml_name","ActivityMonitor");
