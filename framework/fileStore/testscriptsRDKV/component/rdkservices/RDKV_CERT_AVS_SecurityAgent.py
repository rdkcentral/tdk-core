...
<xml>
  ...
  <name>RDKV_CERT_AVS_SecurityAgent</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate RDK service SecurityAgent api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_SecurityAgent');
...
tdkTestObj.addParameter("xml_name","SecurityAgent");
