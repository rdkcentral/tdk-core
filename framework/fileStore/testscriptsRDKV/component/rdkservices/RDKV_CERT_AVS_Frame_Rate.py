...
<xml>
  ...
  <name>RDKV_CERT_AVS_Frame_Rate</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Frame rate api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Frame_Rate');
...
tdkTestObj.addParameter("xml_name","FrameRate");
