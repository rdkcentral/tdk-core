...
<xml>
  ...
  <name>RDKV_CERT_AVS_System</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service System api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_System');
...
tdkTestObj.addParameter("xml_name","System");
