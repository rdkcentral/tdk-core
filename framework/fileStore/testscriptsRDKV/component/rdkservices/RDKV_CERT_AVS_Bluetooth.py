...
<xml>
  ...
  <name>RDKV_CERT_AVS_Bluetooth</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Bluetooth api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Bluetooth');
...
tdkTestObj.addParameter("xml_name","Bluetooth");
