...
<xml>
  ...
  <name>RDKV_CERT_AVS_Network</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Network api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Network');
...
if expectedResult in result.upper():
    ...
    tdkTestObj.addParameter("xml_name","Network");
