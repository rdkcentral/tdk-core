...
<xml>
  ...
  <name>RDKV_CERT_AVS_Display_Settings</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Display settings rdk service api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Display_Settings');
...
tdkTestObj.addParameter("xml_name","DisplaySettings");
