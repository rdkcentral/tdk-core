...
<xml>
  ...
  <name>RDKV_CERT_AVS_HDCP_Profile</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service HDCP Profile api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_HDCP_Profile');
...
tdkTestObj.addParameter("xml_name","HDCPProfile");
