...
<xml>
  ...
  <name>RDKV_CERT_AVS_State_Observer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service State Observer api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_State_Observer');
...
tdkTestObj.addParameter("xml_name","StateObserver");
