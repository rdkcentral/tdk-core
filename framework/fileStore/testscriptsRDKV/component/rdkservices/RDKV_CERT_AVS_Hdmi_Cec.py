...
<xml>
  ...
  <name>RDKV_CERT_AVS_Hdmi_Cec</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service HDMI CEC api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Hdmi_Cec');
...
tdkTestObj.addParameter("xml_name","HdmiCec");
