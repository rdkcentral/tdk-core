...
<xml>
  ...
  <name>RDKV_CERT_AVS_Device_Info</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Device info rdk service api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Device_Info');
...
tdkTestObj.addParameter("xml_name","DeviceInfo");
