...
<xml>
  ...
  <name>RDKV_CERT_AVS_RemoteControl</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Test RDKService RemoteControl APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_RemoteControl');
...
tdkTestObj.addParameter("xml_name","RemoteControl");
