...
<xml>
  ...
  <name>RDKV_CERT_AVS_PersistentStore</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service PersistentStore api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_PersistentStore');
...
tdkTestObj.addParameter("xml_name","PersistentStore");
