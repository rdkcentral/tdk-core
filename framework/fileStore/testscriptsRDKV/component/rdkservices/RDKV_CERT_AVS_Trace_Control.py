...
<xml>
  ...
  <name>RDKV_CERT_AVS_Trace_Control</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To run rdk service trace control tests</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Trace_Control');
...
tdkTestObj.addParameter("xml_name","TraceControl");
