...
<xml>
  ...
  <name>RDKV_CERT_AVS_CompositeInput</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Composite Input api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_CompositeInput');
...
tdkTestObj.addParameter("xml_name","CompositeInput");
