...
<xml>
  ...
  <name>RDKV_CERT_AVS_Display_Settings_VA</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Display Settings rdk service APIs applicable for Video Accelerator</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Display_Settings_VA');
...
tdkTestObj.addParameter("xml_name","DisplaySettings_VA_");
