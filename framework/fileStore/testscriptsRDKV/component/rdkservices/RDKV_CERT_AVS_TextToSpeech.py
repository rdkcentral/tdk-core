...
<xml>
  ...
  <name>RDKV_CERT_AVS_TextToSpeech</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK serviceTextToSpeech api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_TextToSpeech');
...
tdkTestObj.addParameter("xml_name","TextToSpeech");
