...
<xml>
  ...
  <name>RDKV_CERT_AVS_MaintenanceManager</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Test RDKService MaintenanceManager APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_MaintenanceManager');
...
tdkTestObj.addParameter("xml_name","MaintenanceManager");
