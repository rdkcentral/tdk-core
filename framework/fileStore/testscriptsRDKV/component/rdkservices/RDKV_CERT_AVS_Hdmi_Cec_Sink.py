...
<xml>
  ...
  <name>RDKV_CERT_AVS_Hdmi_Cec_Sink</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate RDK service HDMI CEC Sink Api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Hdmi_Cec_Sink');
...
tdkTestObj.addParameter("xml_name","HdmiCecSink");
