...
<xml>
  ...
  <name>BluetoothHAL_Pair_UnPair_Discovered_Device</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To pair and unpair a discovered device</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_HAL_27</test_case_id>
    <test_objective>To pair and unpair a discovered device</test_objective>
...
Checkpoint 3. Verify that the bluetooth client device  is not present  in the paired devices list after BTRCore_UnPairDevice api is executed successfully</expected_output>
    <priority>High</priority>
    <test_stub_interface>libbluetoothhalstub.so.0</test_stub_interface>
    <test_script>BluetoothHAL_Pair_UnPair_Discovered_Device</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
bluetoothhalObj.configureTestCase(ip,port,'BluetoothHAL_Pair_UnPair_Discovered_Device');
