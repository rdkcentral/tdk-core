...
<xml>
  ...
  <name>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Speakers</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether discoverable devices are listed in the discovered devices list when the device type is Speakers</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_HAL_20</test_case_id>
    <test_objective>To check whether discoverable devices are listed in the discovered devices list when the device type is Speakers</test_objective>
...
Checkpoint 2. Verify that the bluetooth client device  is present in the discovered devices list</expected_output>
    ...
    <test_script>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Speakers</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
bluetoothhalObj.configureTestCase(ip,port,'BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Speakers');
