...
<xml>
  ...
  <name>BluetoothHAL_Set_Get_AdapterName_With_SpecialCharacters</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get the Bluetooth adapter name with number and special characters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_HAL_13</test_case_id>
...
2. adapter_name - the name string with numbers and special characters</input_parameters>
...
4. BluetoothHal agent will invoke the api BTRCore_SetAdapterName to set the  bluetooth adapter name to a string containing numbers and special characters.
...
Checkpoint 2. Verify that the adapter name is updated correctly.</expected_output>
    ...
    <test_script>BluetoothHAL_Set_Get_AdapterName_With_SpecialCharacters</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
bluetoothhalObj.configureTestCase(ip,port,'BluetoothHAL_Set_Get_AdapterName_With_SpecialCharacters');
