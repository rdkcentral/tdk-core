...
<xml>
  ...
  <name>RDKV_Container_Cobalt_Launch_AfterReboot</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Launch Cobalt after Reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_49</test_case_id>
    <test_objective>Launch  Cobalt after Reboot</test_objective>
...
7. Verify that Cobalt is running in container mode
    ...
    <expected_output>Cobalt should launch fine after reboot</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Cobalt_Launch_AfterReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Cobalt_Launch_AfterReboot');
