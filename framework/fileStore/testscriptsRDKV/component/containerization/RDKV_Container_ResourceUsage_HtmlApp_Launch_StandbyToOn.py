...
<xml>
  ...
  <name>RDKV_Container_ResourceUsage_HtmlApp_Launch_StandbyToOn</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to calculate the resource usage during HtmlApp launch in container mode in standby mode to ON</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_47</test_case_id>
    <test_objective>The objective of this test is to calculate the resource usage during HtmlApp launch in container mode in standby mode to ON</test_objective>
...
10. Calculate resource usage</automation_approch>
    ...
    <test_script>RDKV_Container_ResourceUsage_HtmlApp_Launch_StandbyToOn</test_script>
    <skipped>No</skipped>
