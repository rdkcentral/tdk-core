...
<xml>
  ...
  <name>RDKV_Container_Launch_HtmlApp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To launch HtmlApp in container mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_08</test_case_id>
    <test_objective>To launch HtmlApp in container mode</test_objective>
...
7. Check wpeframework.log</automation_approch>
    <expected_output>HtmlApp should be launched in container mode</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Launch_HtmlApp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Launch_HtmlApp');
