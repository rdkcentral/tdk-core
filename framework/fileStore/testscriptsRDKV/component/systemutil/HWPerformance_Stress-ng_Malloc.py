...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>HWPerformance_Stress-ng_Malloc</name>
  <primitive_test_id/>
  <primitive_test_name>ExecuteCommand</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Execute Stress-ng opensource performance tool to perform malloc, calloc, realloc, free etc., to stress the system</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_05</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool to perform malloc, calloc, realloc, free etc., to stress the system</test_objective>
    ...
    <input_parameters>sh TDK_HWPerfTools_Executor.sh Stress-ng_Malloc</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_Malloc</test_script>
    <skipped>No</skipped>
...
sysUtilObj.configureTestCase(ip,port,'HWPerformance_Stress-ng_Malloc');
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    command = "sh TDK_HWPerfTools_Executor.sh Stress-ng_Malloc"
