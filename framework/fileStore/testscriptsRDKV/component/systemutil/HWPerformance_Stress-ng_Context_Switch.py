...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <input_parameters>sh TDK_HWPerfTools_Executor.sh Stress-ng_Context_Switch</input_parameters>
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    command = "sh TDK_HWPerfTools_Executor.sh Stress-ng_Context_Switch"
