...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>HWPerformance_Sysbench_Memory</name>
  <primitive_test_id/>
  <primitive_test_name>ExecuteCommand</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Execute Sysbench opensource performance tool and capture the memory metrics by reading and writing data from memory buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_08</test_case_id>
    ...
    <test_script>HWPerformance_Sysbench_Memory</test_script>
    <skipped>No</skipped>
...
sysUtilObj.configureTestCase(ip,port,'HWPerformance_Sysbench_Memory');
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    if expectedresult in actualresult:
        if details:
            ...
            result=hardwarePerformanceThresholdComparison(sysUtilObj,details,unit="s",reverserscheck="false")
