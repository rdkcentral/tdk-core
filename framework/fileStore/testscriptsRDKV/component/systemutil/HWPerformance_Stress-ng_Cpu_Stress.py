...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>HWPerformance_Stress-ng_Cpu_Stress</name>
  <primitive_test_id/>
  <primitive_test_name>ExecuteCommand</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Execute Stress-ng opensource performance tool to stress cpu by starting N workers exercising the CPU by sequentially working through all the different CPU stress methods</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_04</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool to stress cpu by starting N workers exercising the CPU by sequentially working through all the different CPU stress methods</test_objective>
    ...
    <input_parameters>sh TDK_HWPerfTools_Executor.sh Stress-ng_Cpu_Stress</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_Cpu_Stress</test_script>
    <skipped>No</skipped>
...
sysUtilObj.configureTestCase(ip,port,'HWPerformance_Stress-ng_Cpu_Stress');
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    command = "sh TDK_HWPerfTools_Executor.sh Stress-ng_Cpu_Stress"
    ...
    if expectedresult in actualresult:
        if details:
            ...
            result=hardwarePerformanceThresholdComparison(sysUtilObj,details,unit=" ops/s",reverserscheck="false")
