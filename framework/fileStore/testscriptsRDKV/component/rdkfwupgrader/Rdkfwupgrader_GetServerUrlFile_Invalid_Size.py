...
<xml>
  ...
  <name>Rdkfwupgrader_GetServerUrlFile_Invalid_Size</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To pass Invalid string buffer size with control characters and spaces to rdkfwupgrader API GetServerUrlFile and verify output</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_32</test_case_id>
    <test_objective>To pass Invalid string buffer size with control characters and spaces to rdkfwupgrader API GetServerUrlFile and verify output</test_objective>
    ...
    3. RDK_fwupgradeAgent will invoke GetServerUrlFile API with testurl data along with invalid buffer size.
    ...
    <test_script>Rdkfwupgrader_GetServerUrlFile_Invalid_Size</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetServerUrlFile_Invalid_Size');
sysUtilObj.configureTestCase(ip,port,'Rdkfwupgrader_GetServerUrlFile_Invalid_Size');
