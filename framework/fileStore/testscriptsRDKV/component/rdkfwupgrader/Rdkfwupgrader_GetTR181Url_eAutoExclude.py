...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eAutoExclude</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type AutoExclude</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_104</test_case_id>
    <test_objective>To get a URL from tr181 for the query type AutoExclude</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_eAutoExclude</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eAutoExclude');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 1); #with eAutoExclude URL type
