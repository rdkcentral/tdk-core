...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eBootstrap</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type Bootstrap</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_105</test_case_id>
    <test_objective>To get a URL from tr181 for the query type Bootstrap</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_eBootstrap</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eBootstrap');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 2); #with eBootstrap URL type
