...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eXconf</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type Xconf</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get a URL from tr181 for the query type Xconf</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_eXconf</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eXconf');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 5); #with eXconf URL type
