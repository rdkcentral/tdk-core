...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_RVS_WebKitBrowser_LaunchAndDestroy</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_launchAndDestroy</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to do continuous launch and kill WebKitBrowser and validate the stability of app and resource usage for a minimum of 1000 iterations.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_45</test_case_id>
    <test_objective>The objective of this test is to do continuous launch and kill WebKitBrowser and validate the stability of app and resource usage for a minimum of 1000 iterations.</test_objective>
...
1. Launch WebKitBrowser using RDKShell
2. Check the status of plugin using Controller
3. Destroy the plugin using RDKShell
4. Check the status of plugin using Controller
5. Validate the resource usage by DeviceInfo.1.systemInfo method
</automation_approch>
    <expected_output>DUT should be stable after each iteration.</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_stability</test_stub_interface>
    <test_script>RDKV_CERT_RVS_WebKitBrowser_LaunchAndDestroy</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_WebKitBrowser_LaunchAndDestroy');
