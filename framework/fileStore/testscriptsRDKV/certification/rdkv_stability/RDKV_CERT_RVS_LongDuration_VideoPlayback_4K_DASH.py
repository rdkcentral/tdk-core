...
<xml>
  ...
  <name>RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_DASH</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate the resource usage while playing a 4k dash video in video player Lightning application for a minimum of 10 hours.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to validate the resource usage while playing a 4k dash video in video player Lightning application for a minimum of 10 hours.</test_objective>
...
4. Validate resource usage in every minute.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_DASH');
        ...
        #rdkv_performancelib.setPS_value(video_test_urls[0])
            ...
            if status == "SUCCESS":
                ...
                if result_dict_list != []:
                    ...
                    print("\n No CPU and Memory info collected")
            ...
            tdkTestObj.setResultStatus("FAILURE");
            print("\n Unable to set the URL in PersistantStore")
    else:
