...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_CERT_RVS_DisplayPlugins_ActivateDeactivate</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_validateCPULoad</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to activate and deactivate display plugins for given number of times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_23</test_case_id>
    <test_objective>The objective of this test is to activate and deactivate display plugins for given number of times.</test_objective>
...
4. Revert the plugins status after loop.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_DisplayPlugins_ActivateDeactivate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_DisplayPlugins_ActivateDeactivate');
...
if expectedResult in (result.upper() and pre_condition_status):
    ...
    plugins = "org.rdk.DisplaySettings,org.rdk.FrontPanel,org.rdk.HdmiCec"
    status = "SUCCESS"
