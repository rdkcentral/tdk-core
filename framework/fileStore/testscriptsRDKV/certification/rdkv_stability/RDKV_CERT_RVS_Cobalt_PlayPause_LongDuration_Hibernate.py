...
<xml>
  ...
  <name>RDKV_CERT_RVS_Cobalt_PlayPause_LongDuration_Hibernate</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test validates the play Pause functionality of cobalt after long duration Hibernate restore</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_70</test_case_id>
    <test_objective>This test validates the play Pause functionality of cobalt after long duration Hibernate restore</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI,Accelerator</test_setup>
    <pre_requisite>1. Wpeframework process should be up and running in the device.
</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>1. Time upto which cobalt should be in hibernated state
...
2.put cobalt in hibernated state for given amount of time
3.restore and resume the app
4. Set the URL of video to be played.
5. Validate if the video is playing using proc entries
6. Validate CPU load
7. Validate memory usage
8. Revert all values</automation_approch>
    <expected_output>The video should play without interruption after cobalt is restored from long duration hibernated state</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_stability</test_stub_interface>
    <test_script>RDKV_CERT_RVS_Cobalt_PlayPause_LongDuration_Hibernate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_Cobalt_PlayPause_LongDuration_Hibernate');
