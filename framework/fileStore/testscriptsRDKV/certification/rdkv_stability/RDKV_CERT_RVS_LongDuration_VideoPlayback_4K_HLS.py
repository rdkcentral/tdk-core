...
<xml>
  ...
  <name>RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_HLS</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate the resource usage while playing a 4k hls video in video player Lightning application for a minimum of 10 hours.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to validate the resource usage while playing a 4k hls video in video player Lightning application for a minimum of 10 hours.</test_objective>
...
4. Validate resource usage in every minute.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_HLS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_LongDuration_VideoPlayback_4K_HLS');
