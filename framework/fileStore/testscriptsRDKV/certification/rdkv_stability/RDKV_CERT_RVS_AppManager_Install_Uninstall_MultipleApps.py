...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_AppManager_Install_UnInstall_MultipleApps');
...
if expectedResult in (result.upper() and pre_condition_status):
    ...
    if curr_plugins_status_dict != plugin_status_needed:
        ...
        time.sleep(10)
    if status == "SUCCESS":
        test_count = StabilityTestVariables.install_uninstall_count
        app_bundle_list = StabilityTestVariables.appmanager_test_apps
        download_url = PerformanceTestVariables.app_download_url
       ...
       # for app_bundle in app_bundle_list:
           ...
           # for i in range(test_count):
            for app_bundle in app_bundle_list:
                ...
                app_download_url = download_url + "/" + app_bundle
