...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_AppManager_Launch_Kill');
...
if expectedResult in (result.upper() and pre_condition_status):
    ...
    if curr_plugins_status_dict != plugin_status_needed:
        ...
        time.sleep(10)
    if status == "SUCCESS":
        test_count = StabilityTestVariables.launch_kill_count
            ...
            for i in range(test_count):
                ...
                if status == "SUCCESS":
                    ...
                    if app_name in loaded_apps:
                        ...
                        tdkTestObj.addParameter("value",param)
                        tdkTestObj.executeTestCase(expectedResult)
