...
<xml>
  ...
  <name>RDKV_CERT_RVS_SecondaryPlugins_ActivateDeactivate</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to activate and deactivate secondary plugins(HTMLApp, lightningApp, DataCapture,User preference, ,av input,messenger, logging prefernce,timer, hdcp profile,warehouse) for given number of times.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_21</test_case_id>
    <test_objective>The objective of this test is to activate and deactivate secondary plugins(HTMLApp, lightningApp, DataCapture,User preference, ,av input,messenger, logging prefernce,timer, hdcp profile,warehouse) for given number of times.</test_objective>
...
4. Revert the plugins status after loop.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_SecondaryPlugins_ActivateDeactivate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_SecondaryPlugins_ActivateDeactivate');
...
if expectedResult in (result.upper() and pre_condition_status):
    ...
    plugins = "org.rdk.AVInput,org.rdk.HdcpProfile,org.rdk.Timer,org.rdk.Warehouse,org.rdk.UserPreferences,HtmlApp,LightningApp,Messenger,org.rdk.LoggingPreferences"
    status = "SUCCESS"
