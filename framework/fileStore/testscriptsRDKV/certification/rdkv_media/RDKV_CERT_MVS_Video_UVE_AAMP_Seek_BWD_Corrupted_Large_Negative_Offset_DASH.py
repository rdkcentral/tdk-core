...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Seek_BWD_Corrupted_Large_Negative_Offset_DASH')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_corrupted_large_negative_dash
        ...
        # Video seeked backward after 55 seconds, then close the player after 70 seconds
        setOperation("seekbwd","55")
        setOperation("close",70)
