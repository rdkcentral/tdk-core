...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Complete_Video_Audio_Segment_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_640</test_case_id>
...
10. Streaming server should be stopped</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Complete_Video_Audio_Segment_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Complete_Video_Audio_Segment_DASH')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        if "SUCCESS" in launch_status:
            ...
            tdkTestObj.executeTestCase(expectedResult)
            if "FAILURE" in test_result:
                print("EXPECTED BEHAVIOR IN DELAY TEST")
