...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Crypt_Skip_Byte_Block_HLS_H264_AAC')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_widevine_crypt_skip_block_hls_h264_aac
        ...
        setURLArgument("drmconfigs",MediaValidationVariables.video_src_url_widevine_crypt_skip_block_hls_h264_aac_drmconfigs)
        ...
        #url=<video_hls_aac_url>.mpd&drmconfigs=com.widevine(<license_url>)&operations=close(60)&autotest=true&type=dash
