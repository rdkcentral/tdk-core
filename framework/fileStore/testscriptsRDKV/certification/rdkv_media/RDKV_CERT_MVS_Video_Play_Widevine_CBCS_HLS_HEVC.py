...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_CBCS_HLS_HEVC')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_widevine_cbcs_hls_hevc_aac
        ...
        setURLArgument("drmconfigs",MediaValidationVariables.video_src_url_widevine_cbcs_hls_hevc_aac_drmconfigs)
        ...
        #url=<video_src_url_widevine_cbcs_hls>.mpd&drmconfigs=com.widevine(license_url)&operations=close(60)&autotest=true&type=hls
