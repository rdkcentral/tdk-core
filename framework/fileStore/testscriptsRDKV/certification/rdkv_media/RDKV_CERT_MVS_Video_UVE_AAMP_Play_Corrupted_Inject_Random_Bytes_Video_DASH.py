...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Inject_Random_Bytes_Video_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_inject_random_bytes_video_dash
    if pre_requisite_status == "SUCCESS":
            print("The content is corrupted with INJECT_RANDOM_BYTES_VIDEO of the video")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing wrong elementary stream with random bytes DASH video to verify AAMP player's stability and error recovery behavior ************\n")                
