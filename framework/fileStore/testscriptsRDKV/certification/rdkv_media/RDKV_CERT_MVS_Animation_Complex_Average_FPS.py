...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Animation application to render Rectangles, Texts and images and check whether the average FPS calculated for 60 sec duration value is as expected</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_43</test_case_id>
    <test_objective>Test Script to launch a lightning Animation application to render Rectangles, Texts and images and check whether the average FPS calculated for 60 sec duration value is as expected</test_objective>
...
4. App performs animation to render Rectangles, Texts and Images for 60 seconds.
...
7. Revert all values</automation_approch>
    <expected_output>Animation of Rect, Text and Image should happen for 60 sec and average FPS should be grater than or equal to expected fps value.</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_media</test_stub_interface>
    <test_script>RDKV_CERT_MVS_Animation_Complex_Average_FPS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Animation_Complex_Average_FPS')
