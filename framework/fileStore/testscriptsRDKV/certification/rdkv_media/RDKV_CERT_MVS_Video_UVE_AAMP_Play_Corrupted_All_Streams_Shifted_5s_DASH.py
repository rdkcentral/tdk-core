...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_All_Streams_Shifted_5s_DASH')
...
if expectedResult in result.upper():
    ...
    # Setting the pre_requisites for media test. Launching the webkit instance via RDKShell and
