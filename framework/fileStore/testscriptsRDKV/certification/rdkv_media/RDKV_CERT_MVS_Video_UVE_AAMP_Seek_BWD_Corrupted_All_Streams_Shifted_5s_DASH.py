...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Seek_BWD_Corrupted_All_Streams_Shifted_5s_DASH')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_corrupt_all_streams_shifted_5s_dash
        ...
        # Video seeked backward after 55 seconds, then close the player after 85 seconds
        setOperation("seekbwd","55")
        setOperation("close",85)
