...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_I_Frames_Of_Middle_Video_Segment_VP9')
...
if expectedResult in result.upper():
    ...
    videoURL = MediaValidationVariables.video_src_url_corrupt_i_middle_vp9
    if pre_requisite_status == "SUCCESS":
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Corruption occurs in the I frames during the middle segment of the video from 32 to 42 seconds *************\n")
