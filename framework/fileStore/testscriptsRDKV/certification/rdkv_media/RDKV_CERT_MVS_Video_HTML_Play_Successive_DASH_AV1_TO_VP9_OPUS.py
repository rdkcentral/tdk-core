...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Play_Successive_DASH_AV1_TO_VP9_OPUS')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL1  = MediaValidationVariables.video_src_url_av1
        ...
        videoURL2  = MediaValidationVariables.video_src_url_opus
