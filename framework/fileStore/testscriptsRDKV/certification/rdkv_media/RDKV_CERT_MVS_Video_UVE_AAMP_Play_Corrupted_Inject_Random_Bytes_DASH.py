...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Inject_Random_Bytes_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_inject_random_bytes_audio_dash
    if pre_requisite_status == "SUCCESS":
            print("The audio content is corrupted with INJECT_RANDOM_BYTES_DASH.")
            ...
            #url=<video_url>.mpd&operations=close(90)&autotest=true
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing DASH audio with WRONG_ELEMENTRY_STREAM_inject_random_byte corruption to verify AAMP player's stability and error recovery behavior ************\n")
