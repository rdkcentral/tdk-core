...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_same_H264_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_737</test_case_id>
...
webinspect_port: string  video_src_url_same_dash: string</input_parameters>
...
5.App should play the live DASH content, an Ad segment should be inserted during playback, and playback should resume to the main content after the Ad
...
8.Revert all values.</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_same_H264_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_same_H264_DASH')
