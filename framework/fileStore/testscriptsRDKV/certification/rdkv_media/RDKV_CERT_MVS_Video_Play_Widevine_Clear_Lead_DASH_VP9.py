...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Clear_Lead_DASH_VP9')
...
videoURL = MediaValidationVariables.video_src_url_widevine_clear_lead_dash_vp9_opus
...
setURLArgument("drmconfigs", MediaValidationVariables.video_src_url_widevine_clear_lead_dash_vp9_opus_drmconfigs)
...
#url=<video_vp9_opus_url>.mpd&drmconfigs=com.widevine(<license_url>)&operations=close(60)&autotest=true&type=dash
...
for video_test_url in video_test_urls:
    ...
    # ==========================================================
    # ��� ADDED PRINTS □~@~S DRM OBSERVATION (NO VALIDATION) ���
    # ==========================================================
    print("\n================ DRM OBSERVATION =================")
    print("NOTE:")
