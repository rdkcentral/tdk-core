...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Seek_Pos_DASH_H264')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        appURL    = MediaValidationVariables.html_dash_test_app_url
        ...
        #url=<video_dash_h264_url>&operations=seekfwd(30),seekbwd(30),close(30)
