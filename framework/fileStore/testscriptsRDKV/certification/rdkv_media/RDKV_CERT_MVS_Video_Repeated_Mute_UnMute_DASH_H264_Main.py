...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Repeated_Mute_UnMute_DASH_H264_Main')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        #url=<video_src_url_dash_h264_main>.mpd&operations=mute(5),unmute(5),repeat(15)&autotest=true&type=dash
