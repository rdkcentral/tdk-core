...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Truncate_Early_Segment_HLS')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_truncate_an_early_media_segment_hls
    if pre_requisite_status == "SUCCESS":
            print("The content is corrupted with TRUNCATE_EARLY_SEGMENT of the video")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing truncated early segment hls video to verify AAMP player's stability and error recovery behavior ************\n")
