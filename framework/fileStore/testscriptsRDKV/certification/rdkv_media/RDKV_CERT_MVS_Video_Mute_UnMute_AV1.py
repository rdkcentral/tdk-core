...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Mute_UnMute_AV1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit instance to play av1 video codec content and perform mute and unmute operations</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_229</test_case_id>
    <test_objective>Test Script to launch a lightning Video player application via Webkit instance to play av1 video codec content and perform mute and unmute operations</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Mute_UnMute_AV1</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Mute_UnMute_AV1')
