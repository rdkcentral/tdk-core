...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Seek_BWD_Corrupted_Audio_Shifted_10s_HLS')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_corrupted_audio_10s_hls
        ...
        #url=<video_url>.m3u8&operations=seekbwd(90),close(10)&autotest=true&options=checkInterval(5),seekInterval(10)
