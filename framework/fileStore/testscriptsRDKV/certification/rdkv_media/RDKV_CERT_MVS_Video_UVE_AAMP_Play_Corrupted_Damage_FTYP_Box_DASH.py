...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Damage_FTYP_Box_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_damage_the_ftyp_box_dash
    if pre_requisite_status == "SUCCESS":
            print("The video content is corrupted with DAMAGE_THE_FTYP_BOX.")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing DASH video with DAMAGE_THE_FTYP_BOX corruption to verify AAMP player's stability and error recovery behavior ************\n")
