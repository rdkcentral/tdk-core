...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_FF3X_Play_DASH_H264_Main')
...
if expectedResult in result.upper() and FFEnabledStatus.lower() != "no" and config_status != "FAILURE":
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        #url=<video_src_url_dash_h264_main>.mpd&operations=fastfwd3x(30),playnow(10),close(30)&options=checkInterval(5)&autotest=true&type=dash
