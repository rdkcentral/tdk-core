...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Clear_Lead_DASH_AC3')
...
videoURL = MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_ac3
...
setURLArgument("drmconfigs", MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_ac3_drmconfigs)
...
#url=<video_ac3_url>.mpd&drmconfigs=com.widevine(<license_url>)&operations=close(150)&autotest=true&type=dash
