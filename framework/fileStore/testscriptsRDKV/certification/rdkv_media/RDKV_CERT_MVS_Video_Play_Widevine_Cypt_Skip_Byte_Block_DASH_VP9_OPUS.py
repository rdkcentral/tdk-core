...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_widevine_crypt_skip_block_dash_vp9_opus
        ...
        setURLArgument("drmconfigs",MediaValidationVariables.video_src_url_widevine_crypt_skip_block_dash_vp9_opus_drmconfigs)
