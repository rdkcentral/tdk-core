...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Play_Successive_DASH_H264_TO_AV1_TO_HEVC')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        appURL2   = MediaValidationVariables.html_dash_test_app_url
        videoURL2  = MediaValidationVariables.video_src_url_av1
        ...
        # Construct stream 3 URL
        appURL3   = MediaValidationVariables.html_dash_test_app_url
        videoURL3  = MediaValidationVariables.video_src_url_hevc
        # Setting VideoPlayer Operations for Stream 3
        operations3 = getOperations()
        # Setting VideoPlayer test app URL arguments
        setURLArgument("url",videoURL3)
        setURLArgument("operations",operations3)
        setURLArgument("autotest","true")
        appArguments3 = getURLArguments()
        # Getting the complete test app URL for stream 3
        video_test_url3 = getTestURL(appURL3,appArguments3)
        ...
        setPS_value([video_test_url1,video_test_url2,video_test_url3])
