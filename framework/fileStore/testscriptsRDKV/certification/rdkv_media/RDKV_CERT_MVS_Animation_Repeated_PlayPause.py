...
<xml>
  ...
  <name>RDKV_CERT_MVS_Animation_Repeated_PlayPause</name>
...
3. Launch LightningApp webkit instance with animation test app url with the operations play, pause and repeat info.
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Animation_Repeated_PlayPause</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Animation_Repeated_PlayPause')
