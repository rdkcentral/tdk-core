...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Play_Successive_DASH_H264_AC3_TO_H264_EC3')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL1  = MediaValidationVariables.video_src_url_ac3
        ...
        videoURL2  = MediaValidationVariables.video_src_url_ec3
