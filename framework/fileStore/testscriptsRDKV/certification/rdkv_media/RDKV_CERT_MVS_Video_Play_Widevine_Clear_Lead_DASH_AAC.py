...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Clear_Lead_DASH_AAC')
...
videoURL = MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_aac
...
setURLArgument("drmconfigs", MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_aac_drmconfigs)
