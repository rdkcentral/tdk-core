...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Play_Successive_4K_HLS_HEVC_TO_H264')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        appURL1    = MediaValidationVariables.html_hls_test_app_url
        videoURL1  = MediaValidationVariables.video_src_url_4k_hls
        ...
        appURL2   = MediaValidationVariables.html_hls_test_app_url
        videoURL2  = MediaValidationVariables.video_src_url_hls
