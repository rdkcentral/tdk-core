...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Initial_Video_Audio_Segment_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_642</test_case_id>
...
10. Streaming server should be stopped</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Initial_Video_Audio_Segment_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_Initial_Video_Audio_Segment_DASH')
...
if expectedResult in result.upper():
    ...
    video_chunk_pattern = "chunk-stream0-00001"   # Example video chunk pattern
    audio_chunk_pattern = "chunk-stream1-00001"   # Example audio chunk pattern  
