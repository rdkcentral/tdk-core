...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_Diff_H264_HEVC_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_736</test_case_id>
...
webinspect_port: string  video_src_url_ad_diff_dash: string</input_parameters>
...
8.Revert all values.</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_Diff_H264_HEVC_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Ad_insertion_Diff_H264_HEVC_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables. video_src_url_ad_diff_dash
