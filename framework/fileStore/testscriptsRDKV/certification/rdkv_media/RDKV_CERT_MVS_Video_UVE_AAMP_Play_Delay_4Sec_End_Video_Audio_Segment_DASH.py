...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_End_Video_Audio_Segment_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_646</test_case_id>
...
10. Streaming server should be stopped</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_End_Video_Audio_Segment_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Delay_4Sec_End_Video_Audio_Segment_DASH')
...
if expectedResult in result.upper():
    ...
    generate_nginx_config(template_path, local_destination, remote_destination, nginx_container_ip, combined_chunk_pattern, delay4sec_value )
    ...
    delay = MediaValidationVariables.delay4sec_value 
