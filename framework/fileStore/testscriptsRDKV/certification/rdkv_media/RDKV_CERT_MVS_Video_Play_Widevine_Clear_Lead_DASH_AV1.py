...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Clear_Lead_DASH_AV1')
...
videoURL = MediaValidationVariables.video_src_url_widevine_clear_lead_dash_av1_aac
...
setURLArgument("drmconfigs", MediaValidationVariables.video_src_url_widevine_clear_lead_dash_av1_aac_drmconfigs)
