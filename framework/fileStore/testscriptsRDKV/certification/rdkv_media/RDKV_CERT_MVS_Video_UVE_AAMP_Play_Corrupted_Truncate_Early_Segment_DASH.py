...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Truncate_Early_Segment_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_truncate_an_early_media_segment_dash
    if pre_requisite_status == "SUCCESS":
            print("The video content is corrupted with TRUNCATE_EARLY_SEGMENT")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing truncated early segment DASH video to verify AAMP player's stability and error recovery behavior ************\n")
