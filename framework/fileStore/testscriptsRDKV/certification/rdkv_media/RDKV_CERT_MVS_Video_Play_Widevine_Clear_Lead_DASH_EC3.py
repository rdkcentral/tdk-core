...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_Clear_Lead_DASH_EC3')
...
videoURL = MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_ec3
...
setURLArgument("drmconfigs", MediaValidationVariables.video_src_url_widevine_clear_lead_dash_h264_ec3_drmconfigs)
...
#url=<video_dash_ec3_url>.mpd&drmconfigs=com.widevine(<license_url>)&operations=close(60)&autotest=true&type=dash
