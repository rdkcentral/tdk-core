...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_I_P_Frames_Of_Initial_Video_Segment_VP9')
...
if expectedResult in result.upper():
    ...
    videoURL = MediaValidationVariables.video_src_url_corrupt_i_p_initial_vp9
    if pre_requisite_status == "SUCCESS":
            ...
            #url=<video_url_vp9>&operations=close(60)&autotest=true&type=webm
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Corruption occurs in the I and P frames during the initial segment of the video from 0-12 seconds *************\n")
