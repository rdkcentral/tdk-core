...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_AV1_AAC_I_End_DASH</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_766</test_case_id>
...
webinspect_port: string  video_src_url_corrupted_av1_aac_I_end_dash: string</input_parameters>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_AV1_AAC_I_End_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupted_av1_aac_I_end_dash
