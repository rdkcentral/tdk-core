...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_HTML_Play_Successive_DASH_HEVC_TO_4K_HLS_HEVC')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL1  = MediaValidationVariables.video_src_url_hevc
        ...
        videoURL2  = MediaValidationVariables.video_src_url_4k_hls
