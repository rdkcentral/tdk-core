...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Seek_BWD_Corrupted_Non_Monotonic_Jump_Backward_Mid_Stream_DASH')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_corrupted_bwd_jump_mid_dash
        ...
        # Video seeked backward after 60 seconds, then close the player after 80 seconds
        setOperation("seekbwd","60")
        setOperation("close",80)
