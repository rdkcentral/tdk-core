...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Wrong_Codec_Header_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_wrong_codec_header_dash
    if pre_requisite_status == "SUCCESS":
            print("The content is corrupted with WRONG_CODEC_HEADER of the video")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing corrupted DASH video with incorrect codec headers to verify AAMP player's stability and error recovery behavior ************\n")
