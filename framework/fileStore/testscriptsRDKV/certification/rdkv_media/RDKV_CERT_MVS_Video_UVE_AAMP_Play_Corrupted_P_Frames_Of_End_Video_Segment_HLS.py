...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_P_Frames_Of_End_Video_Segment_HLS</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_404</test_case_id>
...
webinspect_port: string  video_src_url_corrupt_P_end_hls: string</input_parameters>
...
8. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_P_Frames_Of_End_Video_Segment_HLS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_P_Frames_Of_End_Video_Segment_HLS')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_P_end_hls
