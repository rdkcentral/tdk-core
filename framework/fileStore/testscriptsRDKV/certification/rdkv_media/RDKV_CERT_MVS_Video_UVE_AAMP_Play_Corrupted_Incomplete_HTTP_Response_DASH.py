...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Incomplete_HTTP_Response_DASH')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_incomplete_http_responce_dash
    if pre_requisite_status == "SUCCESS":
            print("The video content is corrupted with INCOMPLETE_HTTP_RESPONCE_ASSET.")
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing DASH video with INCOMPLETE_HTTP_RESPONCE_ASSET corruption to verify AAMP player's stability and error recovery behavior ************\n")
