...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_CBCS_DASH_VP9')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_widevine_cbcs_dash_vp9_opus
        ...
        setURLArgument("drmconfigs",MediaValidationVariables.video_src_url_widevine_cbcs_dash_vp9_opus_drmconfigs)
        ...
        #url=<video_src_url_widevine_cbcs_dash_vp9>.mpd&drmconfigs=com.widevine(license_url)&operations=close(60)&autotest=true&type=dash
