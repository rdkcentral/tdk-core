...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_Corrupted_Duplicate_TFHD_TFDT_Boxes_HLS')
...
if expectedResult in result.upper():
    ...
    videoURL  = MediaValidationVariables.video_src_url_corrupt_duplicate_tfhd_tfdt_boxes_hls
    if pre_requisite_status == "SUCCESS":
            ...
            if "SUCCESS" in launch_status:
                ...
                test_counter += 1
                print("\n************ Playing HLS video with DUPLICATE_tfhd_tfdt_BOXES_INSIDE_MOOF corruption to validate AAMP player's error resilience ************\n")
