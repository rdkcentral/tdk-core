...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_AppManager_TimeTo_Launch_App');
        ...
        if status == "SUCCESS":
            ...
            if status == "SUCCESS":
                ...
                if  "APP_STATE_ACTIVE" in event:
                    ...
                    Summ_list.append('App launched at :{}'.format(launch_time))
                    ...
                    print("\n Time taken to launch the app : {}(ms)".format(time_taken_for_launch))
                    Summ_list.append('Time taken to launch app :{}ms'.format(time_taken_for_launch))
                    print("\n Threshold value for time taken to launch the app: {} ms".format(launch_threshold))
                    print("\n Validate the time:")
