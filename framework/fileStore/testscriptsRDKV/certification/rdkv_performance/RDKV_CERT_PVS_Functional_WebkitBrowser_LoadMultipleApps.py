...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_WebkitBrowser_LoadMultipleApps');
            ...
            if webKitbrowser_status == 'resumed' and expectedResult in result:
                ...
                if expectedResult in result:
                    ...
                    if browser_test_url in new_url and expectedResult in result:
                        ...
                        #Launch Cobalt and validate if the WebKitBrowser is still running or not
                                                            ...
                                                            if launch_status == expectedResult:
                                                                ...
                                                                if lightningapp_status == 'resumed' and expectedResult in result:
                                                                    ...
                                                                    if expectedResult in result:
                                                                            ...
                                                                            if result == "SUCCESS":
                                                                                ...
                                                                                if status == "SUCCESS"  and ssh_param_dict != {} :   
                                                                                    ...
                                                                                    if ("crash" or "CRASH" or "Crash") in output:
                                                                                        print("Crash log observed while launching multiple apps with WebKitBrowser in the background")
                                                                                        ...
                                                                                        if output != 'deactivated':
                                                                                            ...
                                                                                            print("Crash is observed while launching multiple apps with WebKitBrowser in the backgroundd")
                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                    else:
                                                                                        print("No crash logs found in the log file")
                                                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                                                    #Check the status of WebKitBrowser
                                                                                    print("Check the status of WebKitBrowser")
                                                                                    tdkTestObj = obj.createTestStep('rdkservice_getPluginStatus')
                                                                                    tdkTestObj.addParameter("plugin","WebKitBrowser")
                                                                                    tdkTestObj.executeTestCase(expectedResult)
                                                                                    webKitbrowser_status = tdkTestObj.getResultDetails()
                                                                                    result = tdkTestObj.getResult()
                                                                                    if webKitbrowser_status != 'deactivated' and expectedResult in result:
                                                                                        print("WebKitBrowser is still activated and didnt crash")
                                                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                                                        ...
                                                                                        if result == "SUCCESS":
                                                                                            ...
                                                                                            print("\n Unable to deactivate WebKitBrowser")
                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                    else:
                                                                                        print("WebKitBrowser is deactivated in between the validation")
                                                                                        tdkTestObj.setResultStatus("FAILURE")
                                                                                else:
                                                                        ...
                                                                        print("Unable to set the URL in LightningApp")
                                                                        tdkTestObj.setResultStatus("FAILURE")
                                                                else:
                        ...
                        print("Failed to load the URL in WebKitBrowser")
                        tdkTestObj.setResultStatus("FAILURE");                
                else:
                    print("Unable to set the URL in WebKitBrowser")
                    tdkTestObj.setResultStatus("FAILURE");       
            else:
                print("Unable to get the status of WebKitBrowser")
                tdkTestObj.setResultStatus("FAILURE");
        else:
