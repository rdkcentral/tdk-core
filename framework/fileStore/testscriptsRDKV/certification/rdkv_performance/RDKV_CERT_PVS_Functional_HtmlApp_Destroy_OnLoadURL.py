...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_PVS_Functional_HtmlApp_Destroy_OnLoadURL</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_setValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to load URL in HtmlApp, destroy the plugin, check whether HtmlApp is stable and able to load URL again in it after launching the plugin again.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_88</test_case_id>
    <test_objective>The objective of this test is to load URL in HtmlApp, destroy the plugin, check whether HtmlApp is stable and able to load URL again in it after launching the plugin again.</test_objective>
...
10. Destroy the plugin</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Functional_HtmlApp_Destroy_OnLoadURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_HtmlApp_Destroy_OnLoadURL')
