...
<xml>
  ...
  <name>RDKV_CERT_PVS_Apps_TimeTo_Video_PlayPause_Direct_WEBM</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script is to get the performance of the Lightning application by calculating the time taken for play and pause operations of direct webm video.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_116</test_case_id>
    <test_objective>This script is to get the performance of the Lightning application by calculating the time taken for play and pause operations of direct webm video.</test_objective>
...
3. Get the time taken to play/pause the video</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Apps_TimeTo_Video_PlayPause_Direct_WEBM</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Apps_TimeTo_Video_PlayPause_Direct_WEBM');
