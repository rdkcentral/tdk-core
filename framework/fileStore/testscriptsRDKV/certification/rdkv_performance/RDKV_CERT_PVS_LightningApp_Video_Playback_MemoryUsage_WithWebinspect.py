...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>25</version>
  <name>RDKV_CERT_PVS_LightningApp_Video_Playback_MemoryUsage_WithWebinspect</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_getValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test is to calculate memory usage of the Lightning application by keeping the 
 web inspect port open for play and pause operations of mp4 video</synopsis>
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_158</test_case_id>
    <test_objective>The Objective of the test is to calculate memory usage of the Lightning application by keeping the 
 web inspect port open for play and pause operations of mp4 video</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI,Accelerator</test_setup>
    <pre_requisite>1. As a prerequisite disable all other plugins and enable LightningApp.
</pre_requisite>
...
4.Calcute the Memory usage </automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_LightningApp_Video_Playback_MemoryUsage_WithWebinspect</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_LightningApp_Video_Playback_MemoryUsage_WithWebinspect');
deviceIP =str(ip)
