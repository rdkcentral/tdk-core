...
6. Find the time taken to launch UI by finding the difference between splash finished log time stamp and time saved before reboot.
                            ...
                            if ssh_param_dict != {} and expectedResult in result:
                                ...
                                if output != "EXCEPTION" and expectedResult in result:
                                    ...
                                    if splash_line != "":
                                        ...
                                        print("\n UI load finished at :{} (UTC)".format(splash_line_time))
                                        Summ_list.append('UI load finished at :{}'.format(splash_line_time))
                                        ...
                                        Summ_list.append('UI_LAUNCH_TIME_THRESHOLD_VALUE :{}ms'.format(ui_launch_threshold_value))
    ...
    if deviceAvailability == "Yes":
        ...
        if revert_if == "YES" and status == "SUCCESS":
            ...
            if all(status == "SUCCESS" for status in (activate_status,url_status,lauch_app_status)):
                interface_status = set_default_interface(obj,"eth0")
