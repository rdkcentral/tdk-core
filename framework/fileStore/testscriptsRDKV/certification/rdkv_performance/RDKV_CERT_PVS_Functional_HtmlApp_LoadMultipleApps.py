...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_HtmlApp_LoadMultipleApps');
            ...
            if htmlapp_status == 'resumed' and expectedResult in result:
                ...
                if expectedResult in result:
                    ...
                    if browser_test_url in new_url and expectedResult in result:
                        ...
                        #Launch Cobalt and validate if the HtmlApp is still running or not
                                                                                ...
                                                                                if result == "SUCCESS":
                                                                                    ...
                                                                                    if status == "SUCCESS"  and ssh_param_dict != {} :   
                                                                                        ...
                                                                                        if ("crash" or "CRASH" or "Crash") in output:
                                                                                            print("Crash log observed while launching multiple apps with HtmlApp in the background")
                                                                                            print("\n Validate the status of HtmlApp plugin to confirm the crash:\n")
                                                                                            tdkTestObj = obj.createTestStep('rdkservice_getPluginStatus')
                                                                                            tdkTestObj.addParameter("plugin","HtmlApp")
                                                                                            tdkTestObj.executeTestCase(expectedResult);
                                                                                            output = tdkTestObj.getResultDetails()
                                                                                            if output != 'deactivated':
                                                                                                ...
                                                                                                print("Crash is observed while launching multiple apps with HtmlApp in the backgroundd")
                                                                                                tdkTestObj.setResultStatus("FAILURE")
                                                                                        else:
                                                                                            print("No crash logs found in the log file")
                                                                                            tdkTestObj.setResultStatus("SUCCESS")
                                                                                        #Check the status of HtmlApp
                                                                                        print("Check the status of HtmlApp")
                                                                                        tdkTestObj = obj.createTestStep('rdkservice_getPluginStatus')
                                                                                        tdkTestObj.addParameter("plugin","HtmlApp")
                                                                                        tdkTestObj.executeTestCase(expectedResult)
                                                                                        htmlapp_status = tdkTestObj.getResultDetails()
                                                                                        ...
                                                                                        if htmlapp_status != 'deactivated' and expectedResult in result:
                                                                                            print("HtmlApp is still activated and didnt crash")
                                                                                            tdkTestObj.setResultStatus("SUCCESS")
                    ...
                    print("Unable to set the URL in HtmlApp")
                    tdkTestObj.setResultStatus("FAILURE");
            else:
                print("Unable to get the status of HtmlApp")
                tdkTestObj.setResultStatus("FAILURE");
        else:
