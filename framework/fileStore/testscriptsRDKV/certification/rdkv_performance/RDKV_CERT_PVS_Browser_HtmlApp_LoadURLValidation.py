...
<xml>
  ...
  <name>RDKV_CERT_PVS_Browser_HtmlApp_LoadURLValidation</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this script is to validate if the URL is getting loaded correctly in Html App using API response and webinspect page.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_137</test_case_id>
    <test_objective>The objective of this script is to validate if the URL is getting loaded correctly in HTML App using API response and webinspect page.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI, Accelerator</test_setup>
    <pre_requisite>None</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. Launch HTML app
2. Load any url through HtmlApp.1.url
3. Validate whether the url launched is same as the url displayed in webinspect page</automation_approch>
    <expected_output>The url displayed in webinspect page should be same as the url launched in html app</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_performance</test_stub_interface>
    <test_script>RDKV_CERT_PVS_Browser_HtmlApp_LoadURLValidation</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Browser_HtmlApp_LoadURLValidation')
