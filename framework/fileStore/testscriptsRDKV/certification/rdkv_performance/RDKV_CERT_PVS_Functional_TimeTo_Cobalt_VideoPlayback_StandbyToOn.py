...
3. Launch Cobalt using RDKShell and load a video URL using deeplink method.
4. Click OK using generatekey method.
5. Verify video playback using wpeframework log
6. Set the power state to STANDBY
7. Set the power state to ON after storing the current system time
8. Get the event logs from wpeframework log and parse the time stamp
9. Calculate the result by finding the difference between system time stored and time stamp of event
10. Revert values</automation_approch>
                                                    ...
                                                    if power_state == power_states[i]:
                                                        ...
                                                        if power_state == "ON":
                                                            ...
                                                            if cobalt_status == 'hibernated' and expectedResult in result:
                                                                print("\nCobalt is in hibernated state. Restoring Cobalt\n")
                                                                tdkTestObj.setResultStatus("SUCCESS")
                                                                restore_status, restore_time = restore_plugin(obj,"Cobalt")
                                                                if restore_status == expectedResult:
                                                                    time.sleep(5)
                                                                    resume_status, resume_time = launch_plugin(obj, "Cobalt")
                                                                    if resume_status == expectedResult:
                                                                        ...
                                                                        if cobalt_status == 'resumed':
                                                                             print("\n Cobalt resumed successfully after power-on")
                                                                        else:                                                                                   
                                                                             print("\n Cobalt did not enter resumed state, current:", cobalt_status)  
                                                                             tdkTestObj.setResultStatus("FAILURE")
                                                                    else:
                                                                         print("\n Error in launching Cobalt")
                                                                         tdkTestObj.setResultStatus("FAILURE")
                                                                else:
                                                                     print("\n Error while restoring Cobalt")
                                                                     tdkTestObj.setResultStatus("FAILURE")
                                                            else:
