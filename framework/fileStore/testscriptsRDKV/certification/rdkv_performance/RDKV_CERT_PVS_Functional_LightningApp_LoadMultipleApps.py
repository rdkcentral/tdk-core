...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_LightningApp_LoadMultipleApps');
            ...
            if lightningapp_status == 'resumed' and expectedResult in result:
                ...
                if expectedResult in result:
                    ...
                    if browser_test_url in new_url and expectedResult in result:
                        ...
                        #Launch Cobalt and validate if the LightningApp is still running or not
                                                                            ...
                                                                            if result == "SUCCESS":
                                                                                ...
                                                                                if status == "SUCCESS"  and ssh_param_dict != {} :   
                                                                                    ...
                                                                                    if ("crash" or "CRASH" or "Crash") in output:
                                                                                        print("Crash log observed while launching multiple apps with LightningApp in the background")
                                                                                        ...
                                                                                        if output != 'deactivated':
                                                                                            ...
                                                                                            print("Crash is observed while launching multiple apps with LightningApp in the backgroundd")
                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                    else:
                                                                                        print("No crash logs found in the log file")
                                                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                                                    #Check the status of LightningApp
                                                                                    print("Check the status of LightningApp")
                                                                                    tdkTestObj = obj.createTestStep('rdkservice_getPluginStatus')
                                                                                    tdkTestObj.addParameter("plugin","LightningApp")
                                                                                    tdkTestObj.executeTestCase(expectedResult)
                                                                                    lightningapp_status = tdkTestObj.getResultDetails()
                                                                                    ...
                                                                                    if lightningapp_status != 'deactivated' and expectedResult in result:
                                                                                        print("LightningApp is still activated and didnt crash")
                                                                                        tdkTestObj.setResultStatus("SUCCESS")
                                                                                        ...
                                                                                        if result == "SUCCESS":
                                                                                            ...
                                                                                            print("\n Unable to deactivate LightningApp")
                                                                                            tdkTestObj.setResultStatus("FAILURE")
                                                                                    else:
                                                                                        print("LightningApp is deactivated in between the validation")
                                                                                        tdkTestObj.setResultStatus("FAILURE")
                                                                                else:
                ...
                print("Unable to get the status of LightningApp")
                tdkTestObj.setResultStatus("FAILURE");
        else:
