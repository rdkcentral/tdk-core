...
<xml>
  ...
  <name>RDKV_CERT_PVS_Functional_Vimeo_ResourceUsage_SwitchTo_MainUI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this script is to get the Resource usage while going back from Vimeo to home screen</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
2. Set the Vimeo URL.
3. Get the Resource Usage from Vimeo to MainUI</automation_approch>
    <expected_output>To get the Resource usage while going back from vimeo to home screen</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_performance</test_stub_interface>
    <test_script>RDKV_CERT_PVS_Functional_Vimeo_ResourceUsage_SwitchTo_MainUI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_Vimeo_ResourceUsage_SwitchTo_MainUI');
