...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_PACS_Cobalt_ResourceUsage_Launch</name>
  <primitive_test_id/>
...
3. Validate CPU load and memory usage.</automation_approch>
    ...
    <test_script>RDKV_CERT_PACS_Cobalt_ResourceUsage_Launch</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PACS_Cobalt_ResourceUsage_Launch');
