...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_PVS_Apps_ResourceUsage_Launch</name>
  <primitive_test_id/>
...
4. Revert the status of plugins</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Apps_ResourceUsage_Launch</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Apps_ResourceUsage_Launch');
...
if expectedResult in result.upper():
    ...
    if status == "SUCCESS":
        ...
        if result == "SUCCESS":
            ...
            print("\n Video test URL is set successfully in PersistanceStorage");
