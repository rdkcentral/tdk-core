...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_DisconnectWiFi_GetAssociatedDeviceNumberOfEntries</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that on disconnecting a Wireless Client through 2.4 GHz radio value of parameter (Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries) should be decremented accordingly</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_167</test_case_id>
    <test_objective>Verify that on disconnecting a Wireless Client through 2.4 GHz radio value of parameter (Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries) should be decremented accordingly</test_objective>
...
Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries</input_parameters>
...
8.Unload tdkb_e2e module</automation_approch>
    <except_output>Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries should be decremented by one after successfully disconnected from wifi</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_DisconnectWiFi_GetAssociatedDeviceNumberOfEntries</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_DisconnectWiFi_GetAssociatedDeviceNumberOfEntries');
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    param = "Device.WiFi.AccessPoint.%s.AssociatedDeviceNumberOfEntries" %tdkbE2EUtility.ssid_2ghz_index
