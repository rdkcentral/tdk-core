...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithPTRuleDisabled</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_584</test_case_id>
...
15. Unload the modules.</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithPTRuleDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithPTRuleDisabled');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithPTRuleDisabled');
            ...
            if lanIP != "":
                ...
                if expectedresult in status and curIPAddress:
                    ...
                    if expectedresult in status:
                        ...
                        #Set the Port Triggering rule and disable it:- Trigger Port(start:end) - 12345:12345, TargetPort(start:end) - 54321:54321 (for NETCAT), Trigger Protocol - UDP, Target Protocol - UDP, Description - MyPTRule
                        step = step + 1
                        triggerStart = "12345"
                        triggerEnd = "12345"
                        targetStart = "54321"
