...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_OpenSecurity_SSIDDisabled_HTTPTraffic</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that http traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 5GHZ and SSID interface parameter for 5GHZ [Device.WiFi.SSID.2.Enable] is disabled.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_250</test_case_id>
    <test_objective>Verify that http traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 5GHZ and SSID interface parameter for 5GHZ [Device.WiFi.SSID.2.Enable] is disabled.</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_OpenSecurity_SSIDDisabled_HTTPTraffic</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_OpenSecurity_SSIDDisabled_HTTPTraffic');
