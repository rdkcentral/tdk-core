...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedServices_Block_HTTP_TrustedLANClient</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of HTTP service through Parental control (managed services) while allowing HTTP connectivity for trusted clients</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_473</test_case_id>
    <test_objective>Verify that WG supports blocking of HTTP service through Parental control (managed services) while allowing HTTP connectivity for trusted clients</test_objective>
...
"Device.X_Comcast_com_ParentalControl.ManagedServices.Service."
 Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.</input_parameters>
...
5. Set values to all fields in new rule to block HTTP service
6. Add new rule to Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.
7.Set values to the new rule for adding the LAN client as trusted user
8.Check whether the LAN client is able to establish http connection
9.Delete the added rules and revert all params values
10.Unload tdkb_e2e module</automation_approch>
    <except_output>LAN client should  be able to establish http connection as it is a trusted user</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_Block_HTTP_TrustedLANClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_HTTP_TrustedLANClient');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_HTTP_TrustedLANClient');
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
                ...
                if expectedresult in status and setValuesList == newValues:
                    ...
                    if expectedresult in actualresult:
                        ...
                        if (int(serviceInstance) > 0):
                            ...
                            startport = "Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort" %serviceInstance
                            endPort = "Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort" %serviceInstance
                            alwaysBlock = "Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock" %serviceInstance

                            setValuesList = ['http','BOTH','80','80','true'];
                            print("Parameter values that are set: %s" %setValuesList)

                            list1 = [description,'http','string']
                            list2 = [protocol,'BOTH','string']
                            list3 = [startport,'80','unsignedInt']
                            list4 = [endPort,'80','unsignedInt']
                            ...
                            if expectedresult in actualresult:
                                ...
                                if expectedresult in status and setValuesList == newValues:
                                    ...
                                    if lanIP:
                                        ...
                                        tdkTestObj = obj1.createTestStep("AdvancedConfig_AddObject");
                                        tdkTestObj.addParameter("paramName","Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.");
                                        tdkTestObj.executeTestCase(expectedresult);
                                        actualresult = tdkTestObj.getResult();
                                        details = tdkTestObj.getResultDetails();
                                        if expectedresult in actualresult:
                                            ...
                                            if (int(trustedInstance) > 0):
                                                ...
                                                ipaddress = "Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.%s.IPAddress" %trustedInstance
                                                trusted = "Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.%s.Trusted" %trustedInstance
                                                            ...
                                                            if expectedresult in status and curIPAddress:
                                                                ...
                                                                if expectedresult in status:
                                                                    ...
                                                                    if expectedresult in status:
                                                                        ...
                                                                        print("TEST STEP 15:Check the HTTP connectivity from LAN to WAN")

                                                                        status = wgetToWAN("WGET_HTTP", lanIP, curIPAddress, "LAN")

                                                                        if expectedresult in status:
                                                                            tdkTestObj.setResultStatus("SUCCESS");
                                                                            print("The blocked service 'HTTP' can be reached by trusted client")
                                                                            print("[TEST EXECUTION RESULT] : SUCCESS");
                                                                        else:
                                                                            tdkTestObj.setResultStatus("FAILURE");
                                                                            print("The blocked service 'HTTP' cannot be reached by trusted client also")
                                                ...
                                                tdkTestObj.addParameter("paramName","Device.X_Comcast_com_ParentalControl.ManagedServices.TrustedUser.%s." %trustedInstance);
                                                expectedresult = "SUCCESS";
                                                tdkTestObj.executeTestCase(expectedresult);
                                                actualresult = tdkTestObj.getResult();
                                            ...
                                            tdkTestObj.setResultStatus("FAILURE");
                                            print("TEST STEP 8: Adding new rule for service blocking");
                                            print("EXPECTED RESULT 8: Should add new rule");
                                            print("ACTUAL RESULT 8: added new rule %s" %details);
                                            print("[TEST EXECUTION RESULT] : FAILURE");
                                    else:
                            ...
                            #Delete the created table entry
                            tdkTestObj = obj1.createTestStep("AdvancedConfig_DelObject");
                            tdkTestObj.addParameter("paramName","Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s." %serviceInstance);
                            expectedresult = "SUCCESS";
                            tdkTestObj.executeTestCase(expectedresult);
                            actualresult = tdkTestObj.getResult();
                            print("[TEST EXECUTION RESULT] : %s" %actualresult) ;
            ...
            if expectedresult in actualresult and expectedresult in finalStatus:
                tdkTestObj.setResultStatus("SUCCESS");
                print("EXPECTED RESULT 17: Should set the original managedServiceEnable status");
                print("ACTUAL RESULT 17: %s" %details);
                print("[TEST EXECUTION RESULT] : SUCCESS");
            else:
                tdkTestObj.setResultStatus("FAILURE");
                details = tdkTestObj.getResultDetails();
                print("EXPECTED RESULT 17: Should set the original managedServiceEnable ");
                print("ACTUAL RESULT 17: %s" %details);
                print("[TEST EXECUTION RESULT] : FAILURE");
        else:
            tdkTestObj.setResultStatus("FAILURE");
