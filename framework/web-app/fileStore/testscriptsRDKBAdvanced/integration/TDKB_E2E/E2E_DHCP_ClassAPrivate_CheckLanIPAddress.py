...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_DHCP_ClassAPrivate_CheckLanIPAddress</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that DHCPv4 server pool can be set with Class A private IP address range 10.x.x.x -10.255.255.255.  Ensure that ethernet client obtains IP within the range</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_192</test_case_id>
    <test_objective>Verify that DHCPv4 server pool can be set with Class A private IP address range 10.x.x.x -10.255.255.255.  Ensure that ethernet client obtains IP within the range</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    <except_output>The IP obtained by the lan client should be in Class A private range</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_DHCP_ClassAPrivate_CheckLanIPAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_ClassAPrivate_CheckLanIPAddress');
