...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_AutoGuardInterval_20MHzBW</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether Wireless client can connect to WG when Guard interval is auto and Channel BW is 20MHZ for frequency band 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_09</test_case_id>
    <test_objective>Verify whether Wireless client can connect to WG when Guard interval is auto and Channel BW is 20MHZ for frequency band 2.4GHz</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband,Emulator,RPI</test_setup>
    <pre_requisite>1.Ccsp Components in DUT should be in a running state that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>Device.WiFi.Radio.1.GuardInterval : Auto
...
3. Set Guardinterval and channelBW to Auto and 20MHz using tdkb_e2e_SetMultipleParams
...
4. Revert the values of guardinterval and channelBW
    ...
    <test_script>E2E_WIFI_2.4GHZ_AutoGuardInterval_20MHzBW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_AutoGuardInterval_20MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the Guard interval as "Auto" and ChannelBW as "20MHz"
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'Auto','20MHz'];
