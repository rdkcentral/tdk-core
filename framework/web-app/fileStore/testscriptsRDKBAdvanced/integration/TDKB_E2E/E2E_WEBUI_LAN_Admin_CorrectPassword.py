...
<xml>
  ...
  <name>E2E_WEBUI_LAN_Admin_CorrectPassword</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Good_PWD when logged in with correct password</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_509</test_case_id>
    <test_objective>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Good_PWD when logged in with correct password</test_objective>
...
8. Check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Good_PWD when logged in with correct password
9. Kill selenium hub and node
10. unload module</automation_approch>
    <except_output>Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword should give Good_PWD when logged in with correct password</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_Admin_CorrectPassword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_Admin_CorrectPassword');
                        ...
                        if expectedresult in status:
                            ...
                            if status == "SUCCESS":
                                try:
                                    ...
                                    if expectedresult in status and password == "Good_PWD":
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("TEST STEP 7: Check if compare password gives Good_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Good_PWD")
                                        ...
                                        print("TEST STEP 7: Check if compare password gives Good_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Good_PWD")
                                        print("ACTUAL RESULT 7: Failed to get compare password value as Good_PWD");
