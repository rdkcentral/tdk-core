...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            print(f"ACTUAL RESULT {step}: Retrived current ssid, keypassphrase and securityModel. Current values:{orgValue}")
            print("[TEST EXECUTION RESULT] : SUCCESS")
                            ...
                            if wlanIP:
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        print(f"TEST STEP {step}: Get the AssociatedDevice's MAC from WG")
                                        ...
                                        if expectedresult in status and MAC1:
                                            ...
                                            if MAC2:
                                                ...
                                                step += 1
                                                print(f"TEST STEP {step}: Check if the MAC address from client is same as the one from WG")
