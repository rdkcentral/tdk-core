...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPAWPA2PSK</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in wpawpa2-psk authentication for 5GHZ.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_376</test_case_id>
    <test_objective>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in wpawpa2-psk authentication for 5GHZ.</test_objective>
...
3. Set security mode to WPA-WPA2-Personal,radio enable and ssid enable to true using tdkb_e2e_SetMultipleParams
3. Try to connect to 5GHZ from WIFI client and Lan Client
4.  send telnet request to lan client from wifi client
4. Revert the values</automation_approch>
    <except_output>Telnet  request should be success</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPAWPA2PSK</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_LANtoWLAN_Telnet_WPAWPA2PSK');
