...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecuritymode')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecuritymode')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            print(f"ACTUAL RESULT {step}: Retrived current ssid and securityMode. Current values: {orgValue}")
            print("[TEST EXECUTION RESULT] : SUCCESS")
            ...
            if expectedresult in actualresult:
                ...
                # Set ssid and securityMode for 6ghz
                setValuesList = [tdkbE2EUtility.ssid_6ghz_name,'Enhanced-Open']
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in status and setValuesList == newValues:
                        tdkTestObj.setResultStatus("SUCCESS")
                        print(f"ACTUAL RESULT {step}: Parameter values after SET . Values: {newValues}")
                        print("[TEST EXECUTION RESULT] : SUCCESS")
                            ...
                            if wlanIP:
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        step += 1
                                        print(f"TEST STEP {step}: Check whether wlan client connected with Open security mode")
                                        print(f"EXPECTED RESULT {step}: Wlan client should connect with Open security mode")
                                        security_mode = tdkbE2EUtility.getSecurityMode(tdkbE2EUtility.ssid_6ghz_name)
                                        if "Enhanced-Open" in security_mode:
                                            tdkTestObj.setResultStatus("SUCCESS")
                                            print(f"ACTUAL RESULT {step}: Wlan client connected with Open security mode")
                                            print("[TEST EXECUTION RESULT] : SUCCESS")
                                            # Disconnect wlan
                                            step += 1
                                            ...
                                            tdkTestObj.setResultStatus("FAILURE")
                                            print(f"ACTUAL RESULT {step}: Wlan client did not connect with Open security mode")
                                            print("[TEST EXECUTION RESULT] : FAILURE")
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE")
                        ...
                        tdkTestObj.setResultStatus("FAILURE")
                        print(f"ACTUAL RESULT {step}: GET operation failed or parameter values are not updated with new values")
                        print("[TEST EXECUTION RESULT] : FAILURE")
                else:
                    tdkTestObj.setResultStatus("FAILURE")
                    print(f"ACTUAL RESULT {step}: SET operartion failed. Details: {details}")
                    print("[TEST EXECUTION RESULT] : FAILURE")
            ...
            tdkTestObj.setResultStatus("FAILURE")
            print(f"ACTUAL RESULT {step}: Failed to retrive current ssid and security mode")
            print("[TEST EXECUTION RESULT] : FAILURE")
    else:
