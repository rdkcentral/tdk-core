...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_Firewall_Custom_HttpFromLanToWan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_SetMultipleParams</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that when Firewall Config is set to Custom HTTP access from LAN to WAN should not be blocked</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_300</test_case_id>
    <test_objective>Verify that when Firewall Config is set to Custom HTTP access from LAN to WAN should not be blocked</test_objective>
...
5. From the lan client, do HTTP to the WAN client and check whether http is success when the firewall level is set to Custom
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_Firewall_Custom_HttpFromLanToWan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Firewall_Custom_HttpFromLanToWan');
