...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_OpenSecurity_RadioDisabled_HTTPTraffic</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that http traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_360</test_case_id>
    <test_objective>Verify that http traffic between WLan to LAN should be denied when wifi client assocation in open authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_OpenSecurity_RadioDisabled_HTTPTraffic</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_OpenSecurity_RadioDisabled_HTTPTraffic');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            list3 = [securityMode,orgValue[1],'string']
            list4 = [radioEnable,orgValue[2],'bool']
            list5 = [ssidEnable,orgValue[3],'bool']
