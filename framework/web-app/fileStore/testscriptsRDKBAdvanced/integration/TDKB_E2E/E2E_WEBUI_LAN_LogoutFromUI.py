...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_WEBUI_LAN_LogoutFromUI</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if we can logout from the UI page connected from LAN client</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check if we can logout from the UI page connected from LAN client</test_objective>
...
8. Try to logout from the page
9. Kill selenium hub and node
10. unload module</automation_approch>
    <except_output>The UI page of gateway should be accessible from LAN cleint and should be able to logout from the page</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_LogoutFromUI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_LogoutFromUI');
