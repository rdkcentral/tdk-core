...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_802.11anac_OperatingStandard</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that 802.11n 802.11a 802.11ac clients should be able to connect to WG when mode is a/n/ac for frequency band 5GHZ</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_21</test_case_id>
    <test_objective>Verify that 802.11n 802.11a 802.11ac clients should be able to connect to WG when mode is a/n/ac for frequency band 5GHZ</test_objective>
...
3. Set operating standard "a,ac,n" using tdkb_e2e_SetMultipleParams
3. Try to connect to Wifi client and check whether the wifi client is connected to the DUT using operating standard "a,ac,n"
4. Revert the values of operating standard</automation_approch>
    <except_output>WIFI client should be able to connect to the DUT with the using operating standard "a,ac,n"</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_802.11anac_OperatingStandard</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_802.11anac_OperatingStandard');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the operating standard as "a,n,ac"
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'a,n,ac'];
            ...
            list3 = [operatingStandard,'a,n,ac','string']
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 8: Check whether wlan client connected with 802.11 a/n/ac operating standard")
                                    operating_standard = getOperatingStandard(tdkbE2EUtility.ssid_5ghz_name);
                                    operating_standard_list = ['802.11a','802.11n','802.11ac']
