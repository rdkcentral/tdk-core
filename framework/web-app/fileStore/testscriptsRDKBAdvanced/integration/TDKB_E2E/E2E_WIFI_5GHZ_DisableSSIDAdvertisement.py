...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_5GHZ_DisableSSIDAdvertisement</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that Network name broadcast (SSID advertisement) can be disabled in WG for 5GHz radio</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_137</test_case_id>
    <test_objective>Verify that Network name broadcast (SSID advertisement) can be disabled in WG for 5GHz radio</test_objective>
...
4. Disable ssid advertisement
5.  Connect to the WIFI client and check whether the ssid is getting listed
6.Unload tdkb_e2e module</automation_approch>
    <except_output>The SSID should not get listed when SSIDAdvertisement is disabled</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_DisableSSIDAdvertisement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_DisableSSIDAdvertisement');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'false'];
            ...
            if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print("TEST STEP 2: Set the ssid,keypassphrase and SSIDAdvertisement")
                print("EXPECTED RESULT 2: Should set the ssid,keypassphrase and SSIDAdvertisement");
                print("ACTUAL RESULT 2: %s" %details);
                print("[TEST EXECUTION RESULT] : SUCCESS");

                #Retrieve the values after set and compare
                newParamList=[ssidName,keyPassPhrase,SSIDAdvert]
            ...
            list3 = [SSIDAdvert,orgValue[2],'bool']
