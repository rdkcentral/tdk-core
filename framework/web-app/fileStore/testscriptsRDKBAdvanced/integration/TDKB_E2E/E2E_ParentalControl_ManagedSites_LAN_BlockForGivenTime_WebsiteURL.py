...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedSites_LAN_BlockForGivenTime_WebsiteURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of websites using url only during specific day and time period through Parental control (managed sites)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_390</test_case_id>
    <test_objective>Verify that WG supports blocking of websites using url only during specific day and time period through Parental control (managed sites)</test_objective>
...
6.Check whether the LAN client is able to access the url  using wget
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedSites_LAN_BlockForGivenTime_WebsiteURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_LAN_BlockForGivenTime_WebsiteURL');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_LAN_BlockForGivenTime_WebsiteURL');
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    if expectedresult not in status:
                                                        tdkTestObj.setResultStatus("SUCCESS");
                                                        print("Http connection from LAN to the URL is blocked")
                                                        finalStatus = "SUCCESS";
                                                    else:
                                                        tdkTestObj.setResultStatus("FAILURE");
                                                        print("Http connection from LAN to the URL is success")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE");
