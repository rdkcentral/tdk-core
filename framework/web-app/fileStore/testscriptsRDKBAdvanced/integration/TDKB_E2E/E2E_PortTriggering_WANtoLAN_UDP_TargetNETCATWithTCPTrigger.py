...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithTCPTrigger</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_572</test_case_id>
...
10. Send an outbound packet to trigger the port 12345 with a TCP packet which is not the trigger protocol configured in the rule.
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithTCPTrigger</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithTCPTrigger');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetNETCATWithTCPTrigger');
