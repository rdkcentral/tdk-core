...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_DHCP_2.4GHZ_SetSubnetMask_255.0.0.0</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that after configuring DHCP Server Subnet mask to 255.0.0.0 it gets reflected successfully on the Wi-Fi Client</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_174</test_case_id>
    <test_objective>Verify that after configuring DHCP Server Subnet mask to 255.0.0.0 it gets reflected successfully on the Wi-Fi Client</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_DHCP_2.4GHZ_SetSubnetMask_255.0.0.0</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_2.4GHZ_SetSubnetMask_255.0.0.0');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'10.0.0.1','255.0.0.0','10.0.0.2','10.0.0.253'];
