...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_5GHZ_GetWiFiConnectivityRate</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the successful Wi-Fi connectivity rate of 5GHz radio band by connecting/disconnecting 10 times in Wireless Gateway</synopsis>
  <groups_id/>
...
3. Set the security mode for 5GHz to WPA2PSK , ssid name and password using tdkb_e2e_SetMultipleParams
...
6.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_GetWiFiConnectivityRate</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_GetWiFiConnectivityRate');
