...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_ConnectWiFi_GetAssociatedDeviceNumberOfEntries</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that on connecting a Wireless Client through 2.4 GHz radio value of parameter (Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries) should be incremented accordingly</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_166</test_case_id>
    <test_objective>Verify that on connecting a Wireless Client through 2.4 GHz radio value of parameter (Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries) should be incremented accordingly</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    <except_output>Device.WiFi.AccessPoint.1.AssociatedDeviceNumberOfEntries should be incremented by one after successfully connected to wifi.</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_ConnectWiFi_GetAssociatedDeviceNumberOfEntries</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_ConnectWiFi_GetAssociatedDeviceNumberOfEntries');
