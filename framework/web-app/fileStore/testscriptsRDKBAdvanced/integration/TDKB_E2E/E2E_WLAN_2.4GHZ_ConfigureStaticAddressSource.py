...
<xml>
  ...
  <name>E2E_WLAN_2.4GHZ_ConfigureStaticAddressSource</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if configuring a Static IP is successful for the WLAN client(2.4ghz) connected as reflected in the value of Address Source, and upon deleting the Static IP config, the Address Source changes back to DHCP.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Verify if configuring a Static IP is successful for the WLAN client(2.4ghz) connected as reflected in the value of Address Source, and upon deleting the Static IP config, the Address Source changes back to DHCP.</test_objective>
...
10.Unload the e2e module.</automation_approch>
    ...
    <test_script>E2E_WLAN_2.4GHZ_ConfigureStaticAddressSource</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WLAN_2.4GHZ_ConfigureStaticAddressSource')
obj1.configureTestCase(ip,port, 'E2E_WLAN_2.4GHZ_ConfigureStaticAddressSource')
...
if "SUCCESS" in loadmodulestatus.upper() and loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,'true', tdkbE2EUtility.ssid_2ghz_pwd]
            ...
            list3 = [keyPassPhrase,tdkbE2EUtility.ssid_2ghz_pwd,'string']
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    param = f"Device.WiFi.AccessPoint.{tdkbE2EUtility.ssid_2ghz_index}.AssociatedDeviceNumberOfEntries"
