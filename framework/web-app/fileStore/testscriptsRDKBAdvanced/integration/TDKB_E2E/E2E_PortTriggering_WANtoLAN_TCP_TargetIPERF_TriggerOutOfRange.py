...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>E2E_PortTriggering_WANtoLAN_TCP_TargetIPERF_TriggerOutOfRange</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_618</test_case_id>
...
6. To the added instance, configure the rule: Trigger Port(start:end) - 12340:12346, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
...
15. Unload the modules</automation_approch>
    <expected_output>Port Triggering rule in GW should take effect so that inbound packet with target port 5001 is not forwarded to the LAN machine (which is running an IPERF server) after it sends an outbound packet through the GW that triggers the out of range port 12350 which is not configured in the rule.</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_PortTriggering_WANtoLAN_TCP_TargetIPERF_TriggerOutOfRange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetIPERF_TriggerOutOfRange');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetIPERF_TriggerOutOfRange');
