...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>E2E_WIFI_5GHZ_WPA2PSK_AES_ValidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using valid key for 5GHZ SSID. Ensure that client should be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_15</test_case_id>
    <test_objective>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using valid key for 5GHZ SSID. Ensure that client should not be able to connect to WG</test_objective>
...
3. Try to connect to Wifi client and check whether the wifi client is connected to the DUT using AES and WPA2-Personal and valid wifi password
4. Revert the values of encryption method and security mode</automation_approch>
    <except_output>WIFI client should be able to connect to the DUT with the using AES  encryption method and WPA2-Personal security mode and valid wifi password</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_WPA2PSK_AES_ValidKey</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPA2PSK_AES_ValidKey');
