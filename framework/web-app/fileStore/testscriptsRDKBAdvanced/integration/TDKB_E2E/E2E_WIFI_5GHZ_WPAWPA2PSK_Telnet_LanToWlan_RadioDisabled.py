...
<xml>
  ...
  <status>FREE</status>
  <synopsis>Verify that telnet traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_224</test_case_id>
    <test_objective>Verify that telnet traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled.</test_objective>
