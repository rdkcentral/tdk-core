...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWlanToLan_GetThroughput</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Configure the GW in 802.11n mode with autochannel enabled, HT20(BW:20MHz), guard interval 400ns. Using iperf check throughput from 2.4GHZWLAN to LAN. The average speed of transfer will be 170mbps and minimum 140mbps should be met.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Configure the GW in 802.11n mode with autochannel enabled, HT20(BW:20MHz), guard interval 400ns. Using iperf check throughput from 2.4GHZWLAN to LAN. The average speed of transfer will be 170mbps and minimum 140mbps should be met.</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWlanToLan_GetThroughput</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWlanToLan_GetThroughput');
