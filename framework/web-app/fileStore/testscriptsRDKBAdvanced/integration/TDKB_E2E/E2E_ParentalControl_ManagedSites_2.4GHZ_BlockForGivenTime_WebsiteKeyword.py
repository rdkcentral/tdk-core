...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedSites_2.4GHZ_BlockForGivenTime_WebsiteKeyword</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of webistes using keyword for Wi-Fi Client associated using 2.4GHZ radio only during specific day and time period through parental control (managed sites)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_104</test_case_id>
    <test_objective>Verify that WG supports blocking of webistes using keyword for Wi-Fi Client associated using 2.4GHZ radio only during specific day and time period through parental control (managed sites)</test_objective>
...
5. Set values to all fields in new rule including start time and end time of blocking
6.Check whether the WLAN client is able to access the url keyword using wget
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedSites_2.4GHZ_BlockForGivenTime_WebsiteKeyword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_2.4GHZ_BlockForGivenTime_WebsiteKeyword');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_2.4GHZ_BlockForGivenTime_WebsiteKeyword');
                        ...
                        if (instance > 0):
                            ...
                            if expectedresult in actualresult:
                                ...
                                if expectedresult in status and setValuesList == newValues:
                                    ...
                                    print("EXPECTED RESULT 6: Should retrieve the current values of all fields of new rule")
