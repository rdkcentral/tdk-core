...
<xml>
  <id/>
  <version>5</version>
  <name>E2E_ParentalControl_ManagedDevices_2.4GHZ_Block_WLAN</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG supports blocking of specific Wi-Fi clients associated using 2.4GHZ radio based on MACaddress through parental control (managed devices)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_115</test_case_id>
    <test_objective>Verify that WG supports blocking of specific Wi-Fi clients associated using 2.4GHZ radio based on MACaddress through parental control (managed devices)</test_objective>
...
10.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedDevices_2.4GHZ_Block_WLAN</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_Block_WLAN');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_Block_WLAN');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() :
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'true','false','WPA2-Personal'];
