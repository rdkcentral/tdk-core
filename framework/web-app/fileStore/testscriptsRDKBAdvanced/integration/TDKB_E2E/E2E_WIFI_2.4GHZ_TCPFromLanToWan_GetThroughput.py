...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_TCPFromLanToWan_GetThroughput</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the throughput using iperf tool from the LAN to the WAN. The max speed of transfer will be 10 Mbps</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the throughput using iperf tool from the LAN to the WAN. The max speed of transfer will be 10 Mbps</test_objective>
...
5. Check the TCP connection from LAN to WAN
6.Unload tdkb_e2e module</automation_approch>
    <except_output>The throughput should be less than 10Mbps</except_output>
    <priority>High</priority>
    <test_stub_interface>TDKB_E2E</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_TCPFromLanToWan_GetThroughput</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_TCPFromLanToWan_GetThroughput');
                        ...
                        if lanIP:
                            ...
                            if expectedresult in status:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 7:Check TCP from LAN to WAN");
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if throughput < 10:
                                            tdkTestObj.setResultStatus("SUCCESS");
                                            print("Throughtput is less than 10Mbps")
                                            finalStatus = "SUCCESS"
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
                                            print("Throughtput is more than 10Mbps")
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("TEST STEP 7:TCP from LAN to WAN failed")
