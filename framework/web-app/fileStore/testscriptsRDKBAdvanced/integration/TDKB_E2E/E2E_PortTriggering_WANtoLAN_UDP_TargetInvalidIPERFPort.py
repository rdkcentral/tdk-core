...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_UDP_TargetInvalidIPERFPort</name>
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_UDP_TargetInvalidIPERFPort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetInvalidIPERFPort');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetInvalidIPERFPort');
                            ...
                            if expectedresult in status:
                                ...
                                if expectedresult in status:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        print("EXPECTED RESULT %d: IPERF client runing in WAN machine should NOT connect to the server running in LAN with the GW WAN IP of DUT using invalid port %s" %(step, invalidPort))
