...
<xml>
  <id/>
  <version>4</version>
  <name>E2E_WIFI_2.4GHZ_AccessInternet_2GHZRadioOnlyEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that wireless client is able to connect to WG and access internet when 2.4GHz radio is enabled and 5GHZ radio is disabled in WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_34</test_case_id>
    <test_objective>Verify that wireless client is able to connect to WG and access internet when 2.4GHz radio is enabled and 5GHZ radio is disabled in WG</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband,Emulator,RPI</test_setup>
    <pre_requisite>1.Ccsp Components in DUT should be in a running state that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>Device.WiFi.Radio.1.Enable : true
...
3. Set Radio.1.Enable to true and Radio.2.Enable to false using tdkb_e2e_SetMultipleParams
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_AccessInternet_2GHZRadioOnlyEnabled');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            radioDisable = "%s|false|bool" %RadioEnable_5ghz
            ...
            radioRevert = "%s|%s|bool" %(RadioEnable_5ghz,orgValue[3])
