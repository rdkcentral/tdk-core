...
<xml>
  ...
  <name>E2E_WEBUI_WLAN_2.4GHZ_LoginToUI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if we can login to the UI page of gateway from the WLAN Client after connecting 2.4GHZ SSID</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check if we can login to the UI page of gateway from the WLAN Client after connecting 2.4GHZ SSID</test_objective>
...
12.  unload module</automation_approch>
    ...
    <test_script>E2E_WEBUI_WLAN_2.4GHZ_LoginToUI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WLAN_2.4GHZ_LoginToUI');
