...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_WPAPSK_RadioDisabled_FTPTraffic</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that ftp traffic between WLan to LAN should be denied when wifi client assocation in wpa-psk authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_387</test_case_id>
    <test_objective>Verify that ftp traffic between WLan to LAN should be denied when wifi client assocation in wpa-psk authentication for 2.4GHZ and Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.</test_objective>
...
3. Set security mode to WPA-Personal,radio enable and ssid enable to true using tdkb_e2e_SetMultipleParams
3. Try to connect to 2.4GHZ from WIFI client and Lan Client
4. Disable radio and send ftp request to wlan client from lan client
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WPAPSK_RadioDisabled_FTPTraffic</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPAPSK_RadioDisabled_FTPTraffic');
