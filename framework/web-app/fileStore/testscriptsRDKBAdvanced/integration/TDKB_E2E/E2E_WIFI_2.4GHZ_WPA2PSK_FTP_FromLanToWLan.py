...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_FTP_FromLanToWLan</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_142</test_case_id>
...
5. From the wlan client, try to connect to the LAN client via ftp and check whether ftp connection and file transfer is success when the security mode for 2.4GHz is set to WPA2PSK
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WPA2PSK_FTP_FromLanToWLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_FTP_FromLanToWLan');
