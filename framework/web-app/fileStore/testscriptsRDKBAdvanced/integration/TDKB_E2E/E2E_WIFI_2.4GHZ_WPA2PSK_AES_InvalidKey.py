...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_AES_InvalidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using invalid key for 2.4GHZ SSID. Ensure that client should not be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_02</test_case_id>
    <test_objective>Verify whether WG supports WPA2-PSK with AES encryption security mechanism using invalid key for 2.4GHZ SSID. Ensure that client should not be able to connect to WG</test_objective>
...
3. Try to connect to Wifi client and check whether the wifi client is not connected to the DUT using AES and WPA2-Personal and invalid wifi password
4. Revert the values of encryption method and security mode</automation_approch>
    <except_output>WIFI client should not be able to connect to the DUT with the using AES  encryption method and WPA2-Personal security mode and invalid wifi password</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_WPA2PSK_AES_InvalidKey</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_AES_InvalidKey');
