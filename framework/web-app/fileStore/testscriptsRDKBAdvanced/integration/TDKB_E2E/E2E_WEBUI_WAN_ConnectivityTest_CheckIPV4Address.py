...
<xml>
  ...
  <name>E2E_WEBUI_WAN_ConnectivityTest_CheckIPV4Address</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the connectivity of IPV4 address when public IPV4 is given</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check the connectivity of IPV4 address when public IPV4 is given</test_objective>
...
8.Enter public IPv4 address in IPV4 connectivity test column
9.Check if OK is displayed
10. Kill selenium hub and node
11. unload module</automation_approch>
    <expected_output>The connectivity status of IPV4 address should be displayed as OK.</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_WAN_ConnectivityTest_CheckIPV4Address</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WAN_ConnectivityTest_CheckIPV4Address');
            ...
            if orgValue == "router":
                ...
                if status == "SUCCESS":
                    try:
                        ...
                        #To give IPV4 address as input
                        ipv4_1 = publicIPV4.split(".")[0];
                        ipv4_2 = publicIPV4.split(".")[1];
                        ipv4_3 = publicIPV4.split(".")[2];
                        ipv4_4 = publicIPV4.split(".")[3];
                        driver.find_element_by_id("ipv4_address_1").send_keys(ipv4_1)
                        driver.find_element_by_id("ipv4_address_2").send_keys(ipv4_2)
                        driver.find_element_by_id("ipv4_address_3").send_keys(ipv4_3)
                        driver.find_element_by_id("ipv4_address_4").send_keys(ipv4_4)
                        ...
                        if value == "OK":
                            tdkTestObj.setResultStatus("SUCCESS");
                            print("Connectivity status of IPV4 address is displayed as OK")
                        else:
                            tdkTestObj.setResultStatus("FAILURE");
                            print("Failed to get the connectivity status as OK")
