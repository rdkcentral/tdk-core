...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerUDP</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_608</test_case_id>
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerUDP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerUDP');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_BOTH_TargetIPERF_TriggerUDP');
                            ...
                            if expectedresult in status:
                                ...
                                if expectedresult in status:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        serverStatus = serverStatus = checkFileContents("LAN", tdkbE2EUtility.server_logfile)
