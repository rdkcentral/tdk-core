...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_WPAWPA2PSK_High_UDPFromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that UDP Traffic should be successfull with destination as wired client and source as wireless client  where client association in wpawpa2-psk security wlan on 5ghz band with firewall set to High.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_439</test_case_id>
    <test_objective>Verify that UDP Traffic should be successfull with destination as wired client and source as wireless client  where client association in wpawpa2-psk security wlan on 5ghz band with firewall set to High.</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPAWPA2PSK_High_UDPFromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPAWPA2PSK_High_UDPFromWlanToLan');
