...
<xml>
  ...
  <name>E2E_XDNS_DisableXDNS_AccessLevel1Site</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To disable xDNS and test leve1 (low) websites work as expected</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To disable xDNS and test leve1 (low) websites work as expected</test_objective>
...
6. From lan client do nslookup of a level1 site
...
9. Unload tdkb_e2e module</automation_approch>
    <except_output>nslookup of level1 site from Lan client should be success</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_XDNS_DisableXDNS_AccessLevel1Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_DisableXDNS_AccessLevel1Site');
                    ...
                    if lanIP:
                        ...
                        if expectedresult in status and curIPAddress:
                            ...
                            if expectedresult in status:
                                tdkTestObj.setResultStatus("SUCCESS");
                                finalStatus = "SUCCESS";
                                print("TEST STEP 6:Check if the level1 site accessible with xdns disbaled")
                                print("EXPECTED RESULT 6:The level1 site should be accessible with xdns disabled")
                                print("[TEST EXECUTION RESULT] : SUCCESS");
                            else:
