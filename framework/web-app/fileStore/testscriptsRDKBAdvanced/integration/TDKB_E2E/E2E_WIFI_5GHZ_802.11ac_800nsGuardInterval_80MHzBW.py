...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_5GHZ_802.11ac_800nsGuardInterval_80MHzBW</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether Wireless client can connect to WG when Guard interval is 800ns and Channel BW is 80MHZ for frequency band 5GHZ (802.11ac clients only)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_31</test_case_id>
    <test_objective>Verify whether Wireless client can connect to WG when Guard interval is 800ns and Channel BW is 80MHZ for frequency band 5GHZ (802.11ac clients only)</test_objective>
...
Device.WiFi.Radio.1.OperatingChannelBandwidth : 80MHz</input_parameters>
    <automation_approch>1. Load tdkb_e2e module
2. Using tdkb_e2e_Get, get and save GuardInterval and channelBW
3. Set Guardinterval and channelBW to 800nsec and 80MHz using tdkb_e2e_SetMultipleParams
3. Try to connect to Wifi client
4. Revert the values of guardinterval and channelBW</automation_approch>
    <except_output>The DUT should connect to its wifi client successfully</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_802.11ac_800nsGuardInterval_80MHzBW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_802.11ac_800nsGuardInterval_80MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the Guard interval as "800ns" and ChannelBW as "80MHz"
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'800nsec','80MHz'];
