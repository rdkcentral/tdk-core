...
<xml>
  ...
  <name>E2E_WEBUI_WAN_CheckConnectivityTest_DestinationAddress</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the default destination address used for the connectivity test for mso page</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_493</test_case_id>
    <test_objective>To check the default destination address used for the connectivity test for mso page</test_objective>
...
8.Check the default destination address used for the connectivity test is displayed
9. Kill selenium hub and node
10. unload module</automation_approch>
    <except_output>For mso page,destination address used for connectivity test should be displayed</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_WAN_CheckConnectivityTest_DestinationAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WAN_CheckConnectivityTest_DestinationAddress');
                ...
                if status == "SUCCESS":
                    try:
                        ...
                        if destination_details1 == destination_details2:
                            tdkTestObj.setResultStatus("SUCCESS");
                            print("TEST STEP 3: Get the default destination address used for the connectivity test")
                            print("EXPECTED RESULT 3: Should display the default destination address used for the connectivity test")
                            print("ACTUAL RESULT 3: Default destination address used for the connectivity test is displayed");
                            print("[TEST EXECUTION RESULT] : SUCCESS");
                        else:
                            tdkTestObj.setResultStatus("FAILURE");
                            print("TEST STEP 3: Failed to get the destination address")
