...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_OpenSecurity_HttpToRouterPrivateIP</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that http connection from 2.4 WLAN client to router's private ip is success with open security mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_555</test_case_id>
    <test_objective>Verify that http connection from 2.4 WLAN client to router's private ip is success with open security mode</test_objective>
...
3.Connect the WiFi client to the 2.4SSID  of gateway with open security mode
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_OpenSecurity_HttpToRouterPrivateIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_OpenSecurity_HttpToRouterPrivateIP');
