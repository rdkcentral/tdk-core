...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_WPAWPA2PSK_PingRouterPublicIP</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that ping from 2.4 WLAN client to router's public ip is success with WPA-WPA2-PSK security mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_544</test_case_id>
    <test_objective>Verify that http connection from 2.4 WLAN client to router's private ip is success with security mode WPA-WPA2-PSK</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    <expected_output>Http connection from 2.4 WLAN client to router's private ip is success with security mode WPA-WPA2-PSK</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_WPAWPA2PSK_PingRouterPublicIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPAWPA2PSK_PingRouterPublicIP');
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 10:Check the PING from 2.4 WLAN to router's public ip")
                                    ...
                                    if expectedresult in status:
                                        ...
                                        print("Ping successful from 2.4 WLAN to router's public ip")
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("Ping not successful from 2.4 WLAN to router's public ip")
