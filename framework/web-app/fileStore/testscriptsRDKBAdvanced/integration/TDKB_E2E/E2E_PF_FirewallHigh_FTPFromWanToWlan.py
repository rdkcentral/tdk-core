...
<xml>
  ...
  <name>E2E_PF_FirewallHigh_FTPFromWanToWlan</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify Port Forwarding with FTP service running on Wi-Fi Client and Firewall mode set to High FTP access should be successful from WAN to WLAN</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_81</test_case_id>
    <test_objective>Verify Port Forwarding with FTP service running on Wi-Fi Client and Firewall mode set to High FTP access should be successful from WAN to WLAN</test_objective>
...
10. Check if the http connection is success or not
...
13.Unload tdkb_e2e and advancedconfig modules</automation_approch>
    ...
    <test_script>E2E_PF_FirewallHigh_FTPFromWanToWlan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PF_FirewallHigh_FTPFromWanToWlan');
obj1.configureTestCase(ip,port,'E2E_PF_FirewallHigh_FTPFromWanToWlan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if expectedresult in actualresult:
                                        ...
                                        if expectedresult in actualresult:
                                                ...
                                                if (instance1 > 0):
                                                    ...
                                                    if expectedresult in actualresult:
                                                        ...
                                                        if expectedresult in status:
                                                            ...
                                                            print("TEST STEP 11:FTP from WAN to GW failed")
                                            ...
                                            tdkTestObj.setResultStatus("FAILURE");
                                            details = tdkTestObj.getResultDetails();
                                            print("[TEST STEP ]: Enabling Port Mapping");
                                            print("[EXPECTED RESULT ]: Should enable Port Mapping");
                                            print("[ACTUAL RESULT ]: %s" %details);
                                            print("[TEST EXECUTION RESULT] : %s" %actualresult);
