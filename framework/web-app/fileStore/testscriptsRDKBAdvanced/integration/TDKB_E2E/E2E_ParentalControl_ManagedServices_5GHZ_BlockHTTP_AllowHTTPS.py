...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTP_AllowHTTPS</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG allows other services for Wi-Fi Client associated using 5GHZ radio when only HTTP service is blocked through parental control( managed services)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_125</test_case_id>
...
6.Check whether the WLAN client is able to access internet using https
7.Delete the added rule and revert all params values
8.Unload tdkb_e2e module</automation_approch>
    <except_output>The WLAN client should be able to access the internet using the unblocked service HTTPS</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTP_AllowHTTPS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTP_AllowHTTPS');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTP_AllowHTTPS');
