...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerOutOfRange</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_619</test_case_id>
...
8. To the added instance, configure the rule: Trigger Port(start:end) - 12340:12346, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
...
12. Send an outbound packet to trigger the out of range port 12350 with TCP packet
...
17. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerOutOfRange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerOutOfRange');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerOutOfRange');
                            ...
                            if wlanIP != "":
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        #Set the Port Triggering rule and enable it:- Trigger Port(start:end) - 12340:12346, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
                                        step = step + 1
                                        triggerStart = "12340"
                                        triggerEnd = "12346"
                                        targetStart = "5001"
