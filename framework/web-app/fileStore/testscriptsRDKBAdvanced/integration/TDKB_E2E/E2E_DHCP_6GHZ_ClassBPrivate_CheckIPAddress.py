...
<xml>
  ...
  <name>E2E_DHCP_6GHZ_ClassBPrivate_CheckIPAddress</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that on configuring DHCP Server to Class B Private IP range (172.16.x.x - 172.31.255.255) Wi-Fi Client connected via 6GHz radio successfully receives IP address
</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_680</test_case_id>
    <test_objective>Verify that on configuring DHCP Server to Class B Private IP range (172.16.x.x - 172.31.255.255) Wi-Fi Client connected via 6GHz radio successfully receives IP address
</test_objective>
...
3. Set LanIP,SubnetMask,Maximum and minimum Address range as ClassB using tdkb_e2e_SetMultipleParams
...
6. Unload tdkb_e2e module</automation_approch>
    <expected_output>The IP obtained by the wifi client should be in Class B private range</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_DHCP_6GHZ_ClassBPrivate_CheckIPAddress</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,"E2E_DHCP_6GHZ_ClassBPrivate_CheckIPAddress")
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_6ghz_name,tdkbE2EUtility.ssid_6ghz_pwd,"172.16.0.1","255.255.0.0","172.16.0.2","172.16.0.253"]
            ...
            list3 = [lanIPAddress, "172.16.0.1", "string"]
            list4 = [lanSubnetMask, "255.255.0.0", "string"]
            list5 = [minAddress, "172.16.0.2", "string"]
            list6 = [maxAddress, "172.16.0.253", "string"]
