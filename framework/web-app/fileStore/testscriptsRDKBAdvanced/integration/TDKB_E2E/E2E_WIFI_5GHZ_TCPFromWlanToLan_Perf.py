...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_TCPFromWlanToLan_Perf</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to monitor the data transfer rate from 2.4WLAN client to LAN client over long duration</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test to monitor the data transfer rate from 5GHZ WLAN client to LAN client over long duration</test_objective>
...
5. From the wlan client, do iperf data transfer to LAN client .Monitor the throughput and save its values to an output file
6.Check if the average throughput is within the expected range or not and transfer the output log filr to TM
7. Revert the security mode to original value
8.Unload tdkb_e2e module</automation_approch>
    <except_output>Tthe average throughput value during data transfer from WLAN to LAN should be within the expected range</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_5GHZ_TCPFromWlanToLan_Perf</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_TCPFromWlanToLan_Perf');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            status,clientOutput,clientOutput_avg = getThroughput("WLAN","LAN",lanIP,wlanIP,tdkbE2EUtility.wlan_5ghz_throughput_outfile,tdkbE2EUtility.wlan_5ghz_throughput_to_lan,tdkTestObj);
