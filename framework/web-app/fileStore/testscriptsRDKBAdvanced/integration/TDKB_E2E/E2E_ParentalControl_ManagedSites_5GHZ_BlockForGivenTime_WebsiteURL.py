...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedSites_5GHZ_BlockForGivenTime_WebsiteURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of websites using url for Wi-Fi client associated using 5GHZ radio only during specific day and time period through Parental control (managed sites)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_118</test_case_id>
    <test_objective>Verify that WG supports blocking of websites using url for Wi-Fi client associated using 5GHZ radio only during specific day and time period through Parental control (managed sites)</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedSites_5GHZ_BlockForGivenTime_WebsiteURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_5GHZ_BlockForGivenTime_WebsiteURL');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_5GHZ_BlockForGivenTime_WebsiteURL');
