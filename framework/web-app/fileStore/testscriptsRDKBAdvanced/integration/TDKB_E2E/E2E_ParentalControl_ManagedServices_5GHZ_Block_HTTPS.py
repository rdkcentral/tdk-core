...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTPS</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG supports blocking of HTTPS service for Wi-Fi Client associated using 5GHZ radio through Parental control (managed services)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_126</test_case_id>
    <test_objective>Verify that WG supports blocking of HTTPS service for Wi-Fi Client associated using 5GHZ radio through Parental control (managed services)</test_objective>
...
9.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTPS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTPS');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTPS');
