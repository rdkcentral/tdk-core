...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_Low_UDPFromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_Low_UDPFromWlanToLan')
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                setValuesList = [tdkbE2EUtility.ssid_6ghz_name, 'Enhanced-Open', 'Low']
