...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerInRange</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_599</test_case_id>
...
8. To the added instance, configure the rule: Trigger Port(start:end) - 1234:1244, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
...
18. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerInRange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerInRange');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoWLAN_TCP_TargetIPERF_TriggerInRange');
                            ...
                            if wlanIP != "":
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        #Set the Port Triggering rule and enable it:- Trigger Port(start:end) - 1234:1244, TargetPort(start:end) - 5001:5001 (for IPERF), Trigger Protocol - TCP, Target Protocol - TCP, Description - MyPTRule
                                        step = step + 1
                                        triggerStart = "1234"
                                        triggerEnd = "1244"
                                        targetStart = "5001"
                                        ...
                                        if expectedresult in status:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    #Trigger the port
                                                    step = step + 1
                                                    #Select a random port in range triggerStart:triggerEnd
