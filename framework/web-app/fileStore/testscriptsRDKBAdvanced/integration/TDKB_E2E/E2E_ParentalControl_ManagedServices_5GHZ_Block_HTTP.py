...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of HTTP service for Wi-Fi Client associated using 5GHZ radio through Parental control (managed services)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_123</test_case_id>
    <test_objective>Verify that WG supports blocking of HTTP service for Wi-Fi Client associated using 5GHZ radio through Parental control (managed services)</test_objective>
...
7.Check whether the WLAN client is able to access internet using http
8.Delete the added rule and revert all params values
9.Unload tdkb_e2e module</automation_approch>
    <expected_output>The WLAN client should not access the internet using HTTP</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTP');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_Block_HTTP');
