...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTPS_AllowHTTP</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG allows other services for Wi-Fi Client associated using 5GHZ radio when only HTTPS service is blocked through parental control (managed Services)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_128</test_case_id>
    <test_objective>Verify that WG allows other services for Wi-Fi Client associated using 5GHZ radio when only HTTP service is blocked through parental control (managed Services)</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTPS_AllowHTTP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTPS_AllowHTTP');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_5GHZ_BlockHTTPS_AllowHTTP');
                                            ...
                                            if expectedresult in status and curIPAddress:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        print("TEST STEP 12:Check the Http connectivity from WLAN to LAN")
