...
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_DisconnectWiFi_GetAssociatedDeviceNumberOfEntries')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_DisconnectWiFi_GetAssociatedDeviceNumberOfEntries')
                        ...
                        if expectedresult in status:
                            ...
                            if expectedresult in status:
                                ...
                                if wlanIP:
                                    ...
                                    if expectedresult in status:
                                        tdkTestObj.setResultStatus("SUCCESS")
                                        print(f"ACTUAL RESULT {step}: Current Associated number of entries after connecting wlan client: {associatedNumberOfEntriesAfterWiFiConnect}")
                                        print(f"[TEST EXECUTION RESULT] : SUCCESS")
                                        ...
                                        if expectedresult in status and (int(associatedNumberOfEntries) + 1) == int(associatedNumberOfEntriesAfterWiFiConnect):
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    tdkTestObj.setResultStatus("SUCCESS")
                                                    print(f"ACTUAL RESULT {step}: Current Associated number of entries after disconnecting wlan client: {associatedNumberOfEntriesAfterWiFidisConnect}")
                                                    print(f"[TEST EXECUTION RESULT] : SUCCESS")
                                                    step += 1
                                                    ...
                                                    if expectedresult in status and (int(associatedNumberOfEntriesAfterWiFiConnect) - 1) == int(associatedNumberOfEntriesAfterWiFidisConnect):
                                                        ...
                                                        tdkTestObj.setResultStatus("FAILURE")
                                                        print(f"ACTUAL RESULT {step}: Associated number of entries not decremented / Failed to verify")
