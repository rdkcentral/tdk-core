...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWanToWlan_GetThroughput</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Configure the GW in 802.11n mode with autochannel enabled, HT20(BW:20MHz), guard interval 400ns. Using iperf check throughput from WAN to 2.4GHZWLAN. The average speed of transfer will be 110mbps depending on class of service constraints</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Configure the GW in 802.11n mode with autochannel enabled, HT20(BW:20MHz), guard interval 400ns. Using iperf check throughput from WAN to 2.4GHZWLAN. The average speed of transfer will be 110mbps depending on class of service constraints</test_objective>
...
5. Check the TCP connection from WAN to WLAN and get the throughput
6.Unload tdkb_e2e module</automation_approch>
    <except_output>The average speed of transfer will be 110mbps depending on class of service constraints</except_output>
    <priority>High</priority>
    <test_stub_interface>TDKB_E2E</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWanToWlan_GetThroughput</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_802.11n_20MHzBW_FromWanToWlan_GetThroughput');
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 10:Check TCP from WAN to WLAN");
                                    status,serverOutput,clientOutput = tcp_udpInClients("WAN","WLAN",wlanIP,tdkbE2EUtility.wan_ip,"TCP_Throughput");
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if int(throughput) <= 110:
                                            tdkTestObj.setResultStatus("SUCCESS");
                                            print("Throughtput is 110Mbps")
