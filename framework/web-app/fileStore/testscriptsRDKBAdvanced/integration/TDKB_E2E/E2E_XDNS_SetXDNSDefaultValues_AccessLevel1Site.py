...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>E2E_XDNS_SetXDNSDefaultValues_AccessLevel1Site</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Enable xDNS and try to access the level1 wesbites with DNSIPV4 as 75.75.75.75 and DNS IPv6 as 2001:558:feed::1</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Enable xDNS and try to access the level1 wesbites with DNSIPV4 as 75.75.75.75 and DNS IPv6 as 2001:558:feed::1</test_objective>
...
12. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_XDNS_SetXDNSDefaultValues_AccessLevel1Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_SetXDNSDefaultValues_AccessLevel1Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_SetXDNSDefaultValues_AccessLevel1Site');
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in  actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level1 site accessible with default values")
                                                print("EXPECTED RESULT 9:The level1 site should be accessible with default values")
                                                print("[TEST EXECUTION RESULT] : SUCCESS");
                                                finalStatus = "SUCCESS"
                                            else:
