...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedServices_Block_LAN_FTP</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG supports blocking of FTP service through Parental control (managed services)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Verify that WG supports blocking of FTP service through Parental control (managed services)</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    <except_output>LAN client should not be able to establish FTP connection</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_Block_LAN_FTP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_FTP');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_FTP');
