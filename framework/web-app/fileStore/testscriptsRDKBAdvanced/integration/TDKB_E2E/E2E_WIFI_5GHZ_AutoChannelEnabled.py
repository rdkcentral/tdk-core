...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_AutoChannelEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify whether automatic channel selection can be enabled for 5GHZ radio band and client should be able to connect to one of the non interference channel</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_38</test_case_id>
    <test_objective>Verify whether automatic channel selection can be enabled for 5GHZ radio band and client should be able to connect to one of the non interference channel</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband,Emulator</test_setup>
    <pre_requisite>1.Ccsp Components in DUT should be in a running state that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>Device.WiFi.Radio.2.AutoChannelEnable : true</input_parameters>
    <automation_approch>1. Load tdkb_e2e module
2. Using tdkb_e2e_Get, get and save AutoChannel enable status for 5GHZ
...
4. Revert the values of Radio enable</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_AutoChannelEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_AutoChannelEnabled');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        autoChannelEnable = "Device.WiFi.Radio.%s.AutoChannelEnable" %tdkbE2EUtility.radio_5ghz_index
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    param = "Device.WiFi.Radio.2.ChannelsInUse"
