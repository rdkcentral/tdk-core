...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedServices_Block_LAN_FTP_ForGivenTime</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that WG supports blocking of FTP service only during specific day and time period through parental control (managed services)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Verify that WG supports blocking of FTP service only during specific day and time period through parental control (managed services)</test_objective>
...
6.Check whether the LAN client is able to establish ftp connection
7.Delete the added rule and revert all params values
8.Unload tdkb_e2e module</automation_approch>
    <expected_output>LAN client should not be able to establish FTP connection during the specified time period</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdbb_e2e</test_stub_interface>
    <test_script>E2E_ParentalControl_ManagedServices_Block_LAN_FTP_ForGivenTime</test_script>
    <skipped>No</skipped>
    <release_version>M57</release_version>
    <remarks>WAN,LAN</remarks>
  </test_cases>
  <script_tags />
</xml>
'''
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_FTP_ForGivenTime');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedServices_Block_LAN_FTP_ForGivenTime');
                                        ...
                                        if expectedresult in status and curIPAddress:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print("TEST STEP 11:Check the FTP connectivity from LAN to WAN")
