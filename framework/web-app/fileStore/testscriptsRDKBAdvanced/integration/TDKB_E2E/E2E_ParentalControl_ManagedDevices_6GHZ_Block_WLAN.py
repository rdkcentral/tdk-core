...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Block_WLAN')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Block_WLAN')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Block_WLAN')
                                                                    ...
                                                                    if wlanIP:
                                                                        ...
                                                                        if expectedresult in status:
                                                                            ...
                                                                            if expectedresult in status:
                                                                                ...
                                                                                step += 1
                                                                                print(f"TEST STEP {step}: Verify if HTTP connection from WLAN to WAN is blocked using wget")
