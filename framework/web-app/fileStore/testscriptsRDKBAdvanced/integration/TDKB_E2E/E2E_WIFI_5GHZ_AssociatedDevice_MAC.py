...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_AssociatedDevice_MAC</name>
...
(Device.WiFi.AccessPoint.$si2.AssociatedDevice.1.MACAddress)</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>Verify that MAC address of 5 GHz radio band obtained through parameter (Device.WiFi.AccessPoint.10101.AssociatedDevice.1.MACAddress) matches with the address obtained from Wireless Client.</test_objective>
...
4. Get the client MAC from WG by querying Device.WiFi.AccessPoint.2.AssociatedDevice.1.MACAddress
...
6. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_AssociatedDevice_MAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_AssociatedDevice_MAC');
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    getMAC = "Device.WiFi.AccessPoint.%s.AssociatedDevice.1.MACAddress" %tdkbE2EUtility.ssid_5ghz_index
                                    ...
                                    if expectedresult in status and MAC1:
                                        ...
                                        MAC2 = getWlanMACAddress(tdkbE2EUtility.wlan_5ghz_interface);
