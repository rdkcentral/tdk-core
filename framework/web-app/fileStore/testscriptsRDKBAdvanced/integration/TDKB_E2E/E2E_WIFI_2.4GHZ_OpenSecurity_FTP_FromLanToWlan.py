...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromLanToWlan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that largersize file can be downloaded sucessfuly from ftpserver when wifi client assocation in open security wlan on 2.4ghz band.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_140</test_case_id>
    <test_objective>Verify that largersize file can be downloaded sucessfuly from ftpserver when wifi client assocation in open security wlan on 2.4ghz band.</test_objective>
...
5. From the wlan client, try to connect to the LAN client via ftp and check whether ftp connection and file transfer is success when the security mode for 2.4GHz is set to None
6. Revert the security mode to original value
7.Unload tdkb_e2e module</automation_approch>
    <except_output>ftp connection from WLAN client to LAN client should be success file transfer is completed</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromLanToWlan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromLanToWlan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            #Send FTP request from LAN client to WLAN client
