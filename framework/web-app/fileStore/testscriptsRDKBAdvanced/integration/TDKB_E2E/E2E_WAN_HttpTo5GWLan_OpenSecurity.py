...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>E2E_WAN_HttpTo5GWLan_OpenSecurity</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that http connection from WAN to 5GHZ WLAN client with open security mode is not success</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_554</test_case_id>
    <test_objective>Verify that http connection from WAN to 5GHZ WLAN client with open security mode is not success</test_objective>
...
3.Connect the WiFi client to the 5GSSID  of gateway with open security mode
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WAN_HttpTo5GWLan_OpenSecurity</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WAN_HttpTo5GWLan_OpenSecurity');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'None'];
