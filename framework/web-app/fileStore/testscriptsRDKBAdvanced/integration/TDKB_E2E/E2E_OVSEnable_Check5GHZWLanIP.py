...
<xml>
  ...
  <name>E2E_OVSEnable_Check5GHZWLanIP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if the 5GHZ WLan client gets proper IP when OVS is enabled in gateway</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_551</test_case_id>
    <test_objective>Check if the 5GHZ WLan client gets proper IP when OVS is enabled in gateway</test_objective>
...
4. Connect wlan client to DUT's 5G SSID
...
7. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_OVSEnable_Check5GHZWLanIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_OVSEnable_Check5GHZWLanIP');
