...
<xml>
  ...
  <name>E2E_XDNS_DualMask_SecondaryDNS_Level1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Enable dual DNS mask with secondary DNS server and check if a Level 1 site is accessible from client</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_496</test_case_id>
    <test_objective>Enable dual DNS mask with secondary DNS server and check if a Level 1 site is accessible from client</test_objective>
...
5. Add new rule in this table with LAN client MAC, level 1 DNS ipv4 and ipv6 secondary dns ips and a tag name for rule
...
9. Ping should fail as XDNS blocks the DNS resolution of level1 site
...
12. Unload tdkb_e2e module</automation_approch>
    <except_output>Level1 site shouldn't be reachable from the client configured in XDNS rule</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_XDNS_DualMask_SecondaryDNS_Level1</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_DualMask_SecondaryDNS_Level1');
obj1.configureTestCase(ip,port,'E2E_XDNS_DualMask_SecondaryDNS_Level1');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = [lanMAC,tdkbE2EUtility.xdns_level1_secondary_dns_server,tdkbE2EUtility.xdns_level1_ipv6_secondary_dns_server,"Default"];
                                ...
                                list3 = [dnsipv6,tdkbE2EUtility.xdns_level1_ipv6_secondary_dns_server,'string']
                                    ...
                                    if expectedresult in actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult not in status:
                                                ...
                                                print("EXPECTED RESULT 9:The level1 site should not be accessible from the blocked device")
                                                print("[TEST EXECUTION RESULT] : SUCCESS");
                                                finalStatus = "SUCCESS"
                                            else:
