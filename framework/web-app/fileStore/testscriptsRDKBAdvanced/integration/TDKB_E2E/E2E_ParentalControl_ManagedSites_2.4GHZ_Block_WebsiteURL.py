...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_ParentalControl_ManagedSites_2.4GHZ_Block_WebsiteURL</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that WG supports blocking of websites using url (www.google.com) for Wi-Fi client associated using 2.4GHZ radio through Parental control (managed sites)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_100</test_case_id>
    <test_objective>Verify that WG supports blocking of websites using url (www.google.com) for Wi-Fi client associated using 2.4GHZ radio through Parental control (managed sites)</test_objective>
...
4. Enable managed sites and set WPA2PSK as security mode
5.Add new rule to Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.
6. Set values to all fields in new rule
8.Check whether the WLAN client is able to access the url using wget
...
10.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedSites_2.4GHZ_Block_WebsiteURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_2.4GHZ_Block_WebsiteURL');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedSites_2.4GHZ_Block_WebsiteURL');
                                        ...
                                        if wlanIP:
                                            ...
                                            if expectedresult in status and curIPAddress:
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print("TEST STEP 11: Refreshed wifi network")
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        print("TEST STEP 12:Check the Http connectivity from WLAN to blocked URL")
