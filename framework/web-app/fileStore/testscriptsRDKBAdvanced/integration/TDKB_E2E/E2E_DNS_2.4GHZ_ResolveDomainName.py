...
<xml>
  ...
  <name>E2E_DNS_2.4GHZ_ResolveDomainName</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that the DNS server of WG successfully resolves the DNS queries in 2.4WLAN client</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_454</test_case_id>
    <test_objective>Verify that the DNS server of WG successfully resolves the DNS queries in 2.4WLAN client</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_DNS_2.4GHZ_ResolveDomainName</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DNS_2.4GHZ_ResolveDomainName');
                        ...
                        if wlanIP:
                            ...
                            if expectedresult in status and curIPAddress:
                                ...
                                if expectedresult in status:
                                    ...
                                    print("TEST STEP 8:Connect to 2.4WLAN Client and do NSLookup")
