...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Allow_WLAN')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Allow_WLAN')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_Allow_WLAN')
