...
<xml>
  ...
  <name>E2E_WEBUI_WLAN_2.4GHZ_GetFirewallLevel</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the firewall level from the UI page after connecting to 2.4GHZ WLAN client and verify it.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the firewall level from the UI page after connecting to 2.4GHZ WLAN client and verify it.</test_objective>
...
5. Start Node in wlan client machine
...
12. unload module</automation_approch>
    ...
    <test_script>E2E_WEBUI_WLAN_2.4GHZ_GetFirewallLevel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WLAN_2.4GHZ_GetFirewallLevel');
