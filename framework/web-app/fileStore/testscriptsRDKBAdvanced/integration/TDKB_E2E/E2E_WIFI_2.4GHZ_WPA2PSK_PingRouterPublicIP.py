...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_PingRouterPublicIP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that ping from 2.4 WLAN client to router's public ip is success with WPA2-PSK security mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_533</test_case_id>
    <test_objective>Verify that ping from 2.4G WLAN client to router's public ip is success</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    <expected_output>ping from 2.4G WLAN client to router's public ip is success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_PingRouterPublicIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_PingRouterPublicIP');
