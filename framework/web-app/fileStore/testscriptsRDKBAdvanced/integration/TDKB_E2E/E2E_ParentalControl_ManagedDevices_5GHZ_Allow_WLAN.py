...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_ParentalControl_ManagedDevices_5GHZ_Allow_WLAN</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_133</test_case_id>
...
9.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedDevices_5GHZ_Allow_WLAN</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_5GHZ_Allow_WLAN');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_5GHZ_Allow_WLAN');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() :
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'true','true','WPA2-Personal'];
