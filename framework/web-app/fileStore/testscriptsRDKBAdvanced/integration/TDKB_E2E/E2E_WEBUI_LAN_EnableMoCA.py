...
<xml>
  ...
  <name>E2E_WEBUI_LAN_EnableMoCA</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Enable moca via UI and verify verbiage on pop up window</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_492</test_case_id>
    <test_objective>Enable moca via UI and verify verbiage on pop up window</test_objective>
...
9. Navigate to Connection option and navigate to Moca
10. Enable MoCa and save the settings and verify verbiage on pop up window
...
12. unload module</automation_approch>
    ...
    <test_script>E2E_WEBUI_LAN_EnableMoCA</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_EnableMoCA');
                            ...
                            if status == "SUCCESS":
                                try:
                                    ...
                                    if value == "Waiting for backend to be fully executed, please be patient...":
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("TEST STEP 6: verify verbiage on pop up window")
                                        print("EXPECTED RESULT 6: Should get verbiage on pop up window as Waiting for backend to be fully executed, please be patient...")
                                        print("ACTUAL RESULT 6: %s" %value);
                                        print("[TEST EXECUTION RESULT] : SUCCESS");
                                    else:
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print("TEST STEP 6: Failed to get the output as Waiting for backend to be fully executed, please be patient...")
