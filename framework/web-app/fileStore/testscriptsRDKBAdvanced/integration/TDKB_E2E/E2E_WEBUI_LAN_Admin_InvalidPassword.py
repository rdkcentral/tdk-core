...
<xml>
  ...
  <name>E2E_WEBUI_LAN_Admin_InvalidPassword</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Invalid_PWD when logged in with incorrect password </synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
   <test_case_id>TC_TDKB_E2E_511</test_case_id>
    <test_objective>To check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Invalid_PWD when logged in with incorrect password </test_objective>
...
7. Get value of Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword
8. Check if Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword gives Invalid_PWD
9. Kill selenium hub and node
10. unload module</automation_approch>
    <except_output>Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword should give Invalid_PWD</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_LAN_Admin_InvalidPassword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_LAN_Admin_InvalidPassword');
                        ...
                        if expectedresult in status:
                            ...
                            if status == "SUCCESS":
                                try:
                                    ...
                                    alert_obj.accept()
                                    time.sleep(10);
                                    print("TEST STEP 6: Get the value of Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword")
                                    param = "Device.Users.User.3.X_RDKCENTRAL-COM_ComparePassword"
                                    tdkTestObj,status,password = getParameterValue(obj,param)
                                    if expectedresult in status and password == "Invalid_PWD":
                                        tdkTestObj.setResultStatus("SUCCESS");
                                        print("TEST STEP 7: Check if compare password gives Invalid_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Invalid_PWD")
                                        ...
                                        print("TEST STEP 7: Check if compare password gives Invalid_PWD")
                                        print("EXPECTED RESULT 7: Should get the compare password value as Invalid_PWD")
                                        print("ACTUAL RESULT 7: Failed to get compare password value as Invalid_PWD %s" %password);
