...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_400nsGuardInterval_40MHzBW</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether Wireless client can connect to WG when Guard interval is 400ns and Channel BW is 40MHZ for frequency band 5GHZ</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_26</test_case_id>
    <test_objective>Verify whether Wireless client can connect to WG when Guard interval is 400ns and Channel BW is 40MHZ for frequency band 5GHZ</test_objective>
...
4. Revert the values of guardinterval and channelBW
    ...
    <test_script>E2E_WIFI_5GHZ_400nsGuardInterval_40MHzBW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_400nsGuardInterval_40MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'400nsec','40MHz'];
