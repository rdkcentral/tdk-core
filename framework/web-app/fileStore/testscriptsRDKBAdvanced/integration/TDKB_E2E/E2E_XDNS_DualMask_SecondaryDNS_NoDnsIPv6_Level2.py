...
<xml>
  ...
  <name>E2E_XDNS_DualMask_SecondaryDNS_NoDnsIPv6_Level2</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set dual dns masq with level2 secondary xdns server, but skip adding ipv6 xdns server config. Check if default dns is used instead of xdns and level2 site is accessible from client.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_503</test_case_id>
    <test_objective>Set dual dns masq with level2 secondary xdns server, but skip adding ipv6 xdns server config. Check if default dns is used instead of xdns and level2 site is accessible from client.</test_objective>
...
5. Add new rule in this table with LAN client MAC, level 2 DNS ipv4 secondary dns ips and a tag name for rule
...
12. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_XDNS_DualMask_SecondaryDNS_NoDnsIPv6_Level2</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_DualMask_SecondaryDNS_NoDnsIPv6_Level2');
obj1.configureTestCase(ip,port,'E2E_XDNS_DualMask_SecondaryDNS_NoDnsIPv6_Level2');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = [lanMAC,tdkbE2EUtility.xdns_level2_secondary_dns_server,"Default"];
                                print("Parameter values that are set: %s" %setValuesList)

                                list1 = [macAddress,lanMAC,'string']
                                list2 = [dnsipv4,tdkbE2EUtility.xdns_level2_secondary_dns_server,'string']
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level2 site is accessible from the blocked device")
