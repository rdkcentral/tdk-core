...
<xml>
  <id/>
  <version>2</version>
  <name>E2E_WIFI_2.4GHZ_OpenSecurity_HttpFromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_SetMultipleParams</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that http traffic between WLAN to LAN should be succesfull when wifi client assocation in open authentication for 2.4GHZ.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_239</test_case_id>
    <test_objective>Verify that http traffic between WLAN to LAN should be succesfull when wifi client assocation in open authentication for 2.4GHZ.</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_OpenSecurity_HttpFromWlanToLan</test_script>
    <skipped>No</skipped>
