...
<xml>
  ...
  <name>E2E_ParentalControl_ManagedDevices_2.4GHZ_BlockAll_Allow_WLAN</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that when managed devices state is set as Block All, WG supports allowing of a specific 2.4GHZ Wi-Fi client</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Verify that when managed devices state is set as Block All, WG supports allowing of a specific 2.4GHZ Wi-Fi client</test_objective>
...
3. Enable managed device, set False to Allowall and set WPA2PSK as security mode
4.  Connect to the WIFI client and get the MAC address of the WLAN client
5.Add new rule to Device.X_Comcast_com_ParentalControl.ManagedDevices.Device. and give the MAC of 2.4GHZ client to allow it
6. Set values to all fields in new rule
7.Check whether the WLAN client's internet access is allowed using wget
...
9.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_ParentalControl_ManagedDevices_2.4GHZ_BlockAll_Allow_WLAN</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_BlockAll_Allow_WLAN');
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_2.4GHZ_BlockAll_Allow_WLAN');
