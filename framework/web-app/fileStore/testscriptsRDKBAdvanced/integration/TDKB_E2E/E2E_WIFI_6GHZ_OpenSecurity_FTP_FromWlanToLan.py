...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_FTP_FromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_FTP_FromWlanToLan')
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if lanIP:
                                            ...
                                            if expectedresult in status:
                                                ...
                                                step += 1
                                                # Send FTP request to LAN client from WLAN client
                                                print(f"\nTEST STEP {step}: Check FTP from WLAN to LAN")
                                                ...
                                                if expectedresult in status:
                                                    ...
                                                    print(f"\nTEST STEP {step}: From wlan client, disconnect from wifi ssid")
