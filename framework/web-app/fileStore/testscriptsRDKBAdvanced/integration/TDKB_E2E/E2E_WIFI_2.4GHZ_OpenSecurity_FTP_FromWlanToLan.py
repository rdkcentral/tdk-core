...
<xml>
  <id/>
  <version>3</version>
  <name>E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromWlanToLan</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that largersize file can be uploaded sucessfuly to ftpserver when wifi client assocation in open security wlan on 2.4ghz band.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_146</test_case_id>
    <test_objective>Verify that largersize file can be uploaded sucessfuly to ftpserver when wifi client assocation in open security wlan on 2.4ghz band.</test_objective>
...
5. From the Wlan client, do ftp to the LAN client and desired File downloaded via ftp is success when the security mode for 2.4GHz is set to None
6. Revert the security mode to original value
7.Unload tdkb_e2e module</automation_approch>
    <except_output>From the wlan client, do ftp to the LAN client and check whether ftp is success and desired File should be downloaded when the security mode for 2.4GHz is set to None</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_OpenSecurity_FTP_FromWlanToLan');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            #Send ftp request and do file transfer to LAN client from WLAN client
                                            ...
                                            if expectedresult in status:
                                                ...
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print("TEST STEP 10:FTP from WLAN to LAN failed")
                                        else:
                                            tdkTestObj.setResultStatus("FAILURE");
