...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_UDP_TargetIPERFWithPTRuleDisabled</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_588</test_case_id>
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_UDP_TargetIPERFWithPTRuleDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetIPERFWithPTRuleDisabled');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_UDP_TargetIPERFWithPTRuleDisabled');
