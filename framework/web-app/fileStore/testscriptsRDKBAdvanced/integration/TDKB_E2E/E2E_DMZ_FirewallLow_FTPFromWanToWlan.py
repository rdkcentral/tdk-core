...
<xml>
  ...
  <name>E2E_DMZ_FirewallLow_FTPFromWanToWlan</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify DMZ with FTP service running on Wi-Fi Client and Firewall mode set to Low FTP access should be successful from WAN to WLAN</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_93</test_case_id>
    <test_objective>Verify DMZ with FTP service running on Wi-Fi Client and Firewall mode set to Low FTP access should be successful from WAN to WLAN</test_objective>
...
13.Unload tdkb_e2e and advancedconfig modules</automation_approch>
    ...
    <test_script>E2E_DMZ_FirewallLow_FTPFromWanToWlan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DMZ_FirewallLow_FTPFromWanToWlan');
obj1.configureTestCase(ip,port,'E2E_DMZ_FirewallLow_FTPFromWanToWlan');
