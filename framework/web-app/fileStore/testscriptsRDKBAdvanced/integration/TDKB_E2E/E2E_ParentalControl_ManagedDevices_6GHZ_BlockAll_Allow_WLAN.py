...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_BlockAll_Allow_WLAN')
obj1.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_BlockAll_Allow_WLAN')
wifi_obj.configureTestCase(ip,port,'E2E_ParentalControl_ManagedDevices_6GHZ_BlockAll_Allow_WLAN')
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            if exit_flag != 1:
                ...
                setValuesList = [tdkbE2EUtility.ssid_6ghz_name,tdkbE2EUtility.ssid_6ghz_pwd,'true','false']
                ...
                step += 1
                print(f"TEST STEP {step}: Set the ssid,keypassphrase,managedDeviceEnable and allowAll")
                            ...
                            if wlanIP:
                                ...
                                if expectedresult in status and curIPAddress:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        step += 1
                                        print(f"TEST STEP {step}: Get the MAC address of the wlan client")
                                        ...
                                        if expectedresult in status:
                                            ...
                                            if MAC:
                                                ...
                                                # add new rule
                                                step += 1
                                                print(f"TEST STEP {step}: Adding new rule for device blocking")
                                                ...
                                                if expectedresult in actualresult:
                                                    ...
                                                    if (int(instance) > 0):
                                                        ...
                                                        setValuesList = ['Allow','rootNAT',MAC,'true']
                                                        print(f"Parameter values that are set: {setValuesList}")
                                                        ...
                                                        step += 1
                                                        print(f"TEST STEP {step}: Set the blockType,description,mac and alwaysBlock")
                                                        ...
                                                        if expectedresult in actualresult:
                                                            ...
                                                            step += 1
                                                            print(f"TEST STEP {step}: Get the current blockType,description,mac and alwaysBlock")
                                                                ...
                                                                if expectedresult in status:
                                                                    ...
                                                                    if wlanIP:
                                                                        ...
                                                                        if expectedresult in status:
                                                                            ...
                                                                            #add static route
                                                                            step += 1
                                                                            print(f"TEST STEP {step}: Add static route to reach WAN from WLAN client")
                                                                            ...
                                                                            if expectedresult in status:
                                                                                ...
                                                                                # verify HTTP connection from WLAN to WAN
                                                                                step += 1
                                                                                print(f"TEST STEP {step}: Verify if HTTP connection from WLAN to WAN using wget")
                                                                            ...
                                                                            step += 1
                                                                            print(f"TEST STEP {step}: Delete the static route")
                                                        ...
                                                        details = tdkTestObj.getResultDetails()
                                                        step += 1
                                                        print(f"TEST STEP {step}: Deleting the added rule")
