...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_2.4GHZ_800nsGuardInterval_20MHzBW</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether Wireless client can connect to WG when Guard interval is 800ns and Channel BW is 40MHZ for frequency band 2.4GHZ</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_13</test_case_id>
    <test_objective>Verify whether Wireless client can connect to WG when Guard interval is 800ns and Channel BW is 40MHZ for frequency band 2.4GHZ</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.WiFi.Radio.1.GuardInterval : 800nsec
...
3. Set Guardinterval and channelBW to 800nsec and 20MHz using tdkb_e2e_SetMultipleParams
...
4. Revert the values of guardinterval and channelBW
    ...
    <test_script>E2E_WIFI_2.4GHZ_800nsGuardInterval_20MHzBW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_800nsGuardInterval_20MHzBW');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            # Set the Guard interval as "800ns" and ChannelBW as "20MHz"
            setValuesList = [tdkbE2EUtility.ssid_2ghz_name,tdkbE2EUtility.ssid_2ghz_pwd,'800nsec','20MHz'];
            ...
            list3 = [GuardInterval,'800nsec','string']
