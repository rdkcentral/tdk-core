...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_DHCP_5GHZ_SetSubnetMask_255.255.255.128</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that on configuring DHCP Server Subnet mask to 255.255.255.128, it gets reflected successfully on the Wi-Fi Client connected via 5GHz radio</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_182</test_case_id>
    <test_objective>Verify that on configuring DHCP Server Subnet mask to 255.255.255.128, it gets reflected successfully on the Wi-Fi Client connected via 5GHz radio</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_DHCP_5GHZ_SetSubnetMask_255.255.255.128</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_5GHZ_SetSubnetMask_255.255.255.128');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            setValuesList = [tdkbE2EUtility.ssid_5ghz_name,tdkbE2EUtility.ssid_5ghz_pwd,'10.0.0.1','255.255.255.128','10.0.0.2','10.0.0.126'];
