...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_Low_UDPFromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_WPA3PSK_Low_UDPFromWlanToLan')
    ...
    if expectedresult in status:
        ...
        if expectedresult in status:
            ...
            if exit_flag != 1:
                ...
                setValuesList = [tdkbE2EUtility.ssid_6ghz_name, tdkbE2EUtility.ssid_6ghz_pwd, 'Low']
                ...
                firewallParam = f"{firewallLevel}|Low|string"
