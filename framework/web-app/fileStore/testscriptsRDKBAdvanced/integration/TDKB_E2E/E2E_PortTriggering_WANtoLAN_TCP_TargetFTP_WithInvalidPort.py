...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_TCP_TargetFTP_WithInvalidPort</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_628</test_case_id>
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_TCP_TargetFTP_WithInvalidPort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetFTP_WithInvalidPort');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetFTP_WithInvalidPort');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in status:
                            ...
                            if expectedresult in status:
                                ...
                                invalidPort = "12343"
                                step = step + 1
                                print("\nTEST STEP %d: Trigger with invalid Port %s through an outbound packet from LAN client" %(step, invalidPort))
