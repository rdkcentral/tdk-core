...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>E2E_XDNS_SetInvalidMAC_AccessLevel3Site</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set Invalid MAC address of the client and try to access the level3 site</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Set Invalid MAC address of the client and try to access the level3 site</test_objective>
...
5. Add new rule in this table with invalid MAC, DNS ipv4 and valid ipv6 ips and a tag name for rule
...
12. Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_XDNS_SetInvalidMAC_AccessLevel3Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_SetInvalidMAC_AccessLevel3Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_SetInvalidMAC_AccessLevel3Site');
                    ...
                    if expectedresult in status:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if (instance > 0):
                                ...
                                setValuesList = ["A:B:C:D",tdkbE2EUtility.xdns_level3_dns_server,tdkbE2EUtility.xdns_level3_ipv6_dns_server,"Default"];
                                print("Parameter values that are set: %s" %setValuesList)

                                list1 = [macAddress,"A:B:C:D",'string']
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level3 site accessible with invalid MAC Address")
                                                print("EXPECTED RESULT 9:The level3 site should be accessible with invalid MAC Address")
                                                print("[TEST EXECUTION RESULT] : SUCCESS");
                                                finalStatus = "SUCCESS"
                                            else:
