...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_LANtoWLAN_Telnet_OpenSecurity</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in open authentication for 2.4GHZ</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_372</test_case_id>
    <test_objective>Verify that telnet traffic between WLan to LAN should be succesfull when wifi client assocation in open authentication for 2.4GHZ</test_objective>
...
4. Revert the values</automation_approch>
    <except_output>Telnet connection request should be success</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WIFI_2.4GHZ_LANtoWLAN_Telnet_OpenSecurity</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_LANtoWLAN_Telnet_OpenSecurity');
