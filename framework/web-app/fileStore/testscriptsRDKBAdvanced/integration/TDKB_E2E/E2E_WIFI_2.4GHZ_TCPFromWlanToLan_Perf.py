...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_TCPFromWlanToLan_Perf</name>
  ...
  <test_cases>
    ...
    <test_objective>Test to monitor the data transfer rate from 2.4GHZ WLAN client to LAN client over long duration</test_objective>
...
8.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_TCPFromWlanToLan_Perf</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_TCPFromWlanToLan_Perf');
                                ...
                                if expectedresult in status:
                                    ...
                                    if lanIP:
                                        ...
                                        if expectedresult in status:
                                            ...
                                            status,clientOutput,clientOutput_avg = getThroughput("WLAN","LAN",lanIP,wlanIP,tdkbE2EUtility.wlan_2ghz_throughput_outfile,tdkbE2EUtility.wlan_2ghz_throughput_to_lan,tdkTestObj);
