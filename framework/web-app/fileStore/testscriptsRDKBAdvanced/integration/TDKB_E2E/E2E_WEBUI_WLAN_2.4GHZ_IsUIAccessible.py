...
<xml>
  ...
  <name>E2E_WEBUI_WLAN_2.4GHZ_IsUIAccessible</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if the UI page of gateway is accessible from wlan client after connecting to 2.4GHZ SSID.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check if the UI page of gateway is accessible from wlan client after connecting to 2.4GHZ SSID.</test_objective>
...
10.  unload module</automation_approch>
    <except_output>The UI page of gateway should be accessible from WLAN cleint</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_WLAN_2.4GHZ_IsUIAccessible</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WLAN_2.4GHZ_IsUIAccessible');
