...
<xml>
  ...
  <name>E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_UDPFromWlanToLan</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that udp traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_221</test_case_id>
    <test_objective>Verify that udp traffic between wireless and wired clients should be denied when Radio interface parameter for 5GHZ [Device.WiFi.Radio.2.Enable] is disabled</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_UDPFromWlanToLan</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPA2PSK_RadioDisabled_UDPFromWlanToLan');
                                            ...
                                            if expectedresult in actualresult:
                                                ...
                                                if expectedresult in status and setValuesList == newValues:
                                                    ...
                                                    if "SUCCESS" in status and lossPercentage=="0%":
                                                        ...
                                                        tdkTestObj.setResultStatus("SUCCESS");
                                                        print("TEST STEP 10:SUCCESS :UDP from WLAN to LAN failed")
                                                        finalStatus = "SUCCESS"
                                                    ...
                                                    if expectedresult in status:
                                                        ...
                                                        tdkTestObj.setResultStatus("FAILURE");
                                                        print("TEST STEP 13:Disconnect from WIFI SSID: FAILED")
                                                else:
                                                    tdkTestObj.setResultStatus("FAILURE");
                                                    print("TEST STEP 11: Get the current radioEnable")
                                                    print("EXPECTED RESULT 11: Should retrieve the current radioEnable")
