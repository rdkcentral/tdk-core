...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_WIFI_5GHZ_WPAWPA2PSK_HTTPS_LanToWlan_SSIDDisabled</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that https traffic between wireless and wired clients should be denied when SSID parameter for 5GHZ [Device.WiFi.SSID.2.Enable] is disabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_237</test_case_id>
    <test_objective>Verify that https traffic between wireless and wired clients should be denied when SSID parameter for 5GHZ [Device.WiFi.SSID.2.Enable] is disabled.</test_objective>
...
4. Revert the values</automation_approch>
    ...
    <test_script>E2E_WIFI_5GHZ_WPAWPA2PSK_HTTPS_LanToWlan_SSIDDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_5GHZ_WPAWPA2PSK_HTTPS_LanToWlan_SSIDDisabled');
