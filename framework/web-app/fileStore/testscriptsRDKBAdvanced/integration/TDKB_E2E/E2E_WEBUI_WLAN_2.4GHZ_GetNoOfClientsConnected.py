...
<xml>
  <id/>
  <version>25</version>
  <name>E2E_WEBUI_WLAN_2.4GHZ_GetNoOfClientsConnected</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check if the number of clients connected to WLAN using 2.4GHZ is successfully updated .</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_476</test_case_id>
    <test_objective>Check if the number of clients connected to WLAN using 2.4GHZ is successfully updated .</test_objective>
...
11.Check if the number of clients connected to 2.4GHZ WiFi network is updated or not.
12. Kill selenium hub and node
13.  unload module</automation_approch>
    <except_output>Number of clients connected to 2.4GHZ WiFi network should to updated successfully.</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_WEBUI_WLAN_2.4GHZ_GetNoOfClientsConnected</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WEBUI_WLAN_2.4GHZ_GetNoOfClientsConnected');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        noOfClientsConnected = "Device.WiFi.AccessPoint.%s.AssociatedDeviceNumberOfEntries" %tdkbE2EUtility.ssid_2ghz_index
        ...
        if expectedresult in status:
            ...
            print("TEST STEP 1: Get the current ssid and keypassphrase and number of clients connected to WLAN 2.4GHZ")
                                    ...
                                    if expectedresult in status:
                                        ...
                                        if status == "SUCCESS":
                                            try:
                                                ...
                                                num = driver.find_element_by_xpath("/html/body/div[1]/div[3]/div[3]/div[3]/div[1]/div[4]/span[2]").text
                                                print("number of clients connected to WiFi network :%s"%num);
