...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_PingDefaultGWIp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that ping from 2.4WLAN client to Default GW ip (like,10.0.0.1) is success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_456</test_case_id>
    <test_objective>Verify that ping from 2.4WLAN client to Default GW ip (like,10.0.0.1) is success</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_PingDefaultGWIp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_PingDefaultGWIp');
