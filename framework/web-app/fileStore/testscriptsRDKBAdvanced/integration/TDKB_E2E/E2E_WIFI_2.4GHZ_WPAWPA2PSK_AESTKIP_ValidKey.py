...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>E2E_WIFI_2.4GHZ_WPAWPA2PSK_AESTKIP_ValidKey</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify whether WG supports WPAWPA2-PSK (TKIP/AES)á encryption security mechanism using valid key for 2.4GHZ SSID. Ensure that client should be able to connect to WG</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_03</test_case_id>
    <test_objective>Verify whether WG supports WPAWPA2-PSK (TKIP/AES)Ã&#131;Â¡ encryption security mechanism using valid key for 2.4GHZ SSID. Ensure that client should be able to connect to WG</test_objective>
...
4. Revert the values of encryption method and security mode</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_WPAWPA2PSK_AESTKIP_ValidKey</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPAWPA2PSK_AESTKIP_ValidKey');
