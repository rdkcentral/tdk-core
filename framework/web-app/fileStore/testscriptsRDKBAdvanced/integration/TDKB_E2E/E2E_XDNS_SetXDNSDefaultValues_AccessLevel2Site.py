...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>E2E_XDNS_SetXDNSDefaultValues_AccessLevel2Site</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Enable xDNS and try to access the level2 wesbites with DNSIPV4 as 75.75.75.75 and DNS IPv6 as 2001:558:feed::1</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_419</test_case_id>
    <test_objective>Enable xDNS and try to access the level2 wesbites with DNSIPV4 as 75.75.75.75 and DNS IPv6 as 2001:558:feed::1</test_objective>
...
8. From LAN client do a nslookup to any level2 site via default dns server
...
12. Unload tdkb_e2e module</automation_approch>
    <except_output>nslookup should resolve the level2 site successfully</except_output>
    <priority>High</priority>
    <test_stub_interface>tdkb_e2e</test_stub_interface>
    <test_script>E2E_XDNS_SetXDNSDefaultValues_AccessLevel2Site</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_XDNS_SetXDNSDefaultValues_AccessLevel2Site');
obj1.configureTestCase(ip,port,'E2E_XDNS_SetXDNSDefaultValues_AccessLevel2Site');
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if expectedresult in  actualresult1:
                                        ...
                                        if expectedresult in status and setValuesList == newValues:
                                            ...
                                            if expectedresult in status:
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print("TEST STEP 9:Check if the level2 site accessible with default values")
                                                print("EXPECTED RESULT 9:The level2 site should be accessible with default values")
                                                print("[TEST EXECUTION RESULT] : SUCCESS");
                                                finalStatus = "SUCCESS"
                                            else:
