...
<xml>
  ...
  <name>E2E_WIFI_2.4GHZ_WPA2PSK_HttpToRouterPrivateIP</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that http connection from 2.4 WLAN client to router's private ip is success with WPA2-PSK security mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_541</test_case_id>
    <test_objective>Verify that http connection from 2.4 WLAN client to router's private ip is success</test_objective>
...
7.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_WIFI_2.4GHZ_HttpToRouterPrivateIP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_2.4GHZ_WPA2PSK_HttpToRouterPrivateIP');
