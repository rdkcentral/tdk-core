...
<xml>
  ...
  <name>E2E_PortTriggering_WANtoLAN_TCP_TargetIPERFWithUDPTrigger</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_574</test_case_id>
...
11. From WAN client, send an inbound packet to the target port 5001 via the DUT GW WAN IP. The packet should NOT be successfully forwarded to the LAN client.
...
15. Unload the modules</automation_approch>
    ...
    <test_script>E2E_PortTriggering_WANtoLAN_TCP_TargetIPERFWithUDPTrigger</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetIPERFWithUDPTrigger');
obj1.configureTestCase(ip,port,'E2E_PortTriggering_WANtoLAN_TCP_TargetIPERFWithUDPTrigger');
                            ...
                            if expectedresult in status:
                                ...
                                if expectedresult in status:
                                    ...
                                    if expectedresult in status:
                                        ...
                                        print("EXPECTED RESULT %d: IPERF client running in WAN machine should be failed to the server running in LAN with the GW WAN IP of DUT" %step)
