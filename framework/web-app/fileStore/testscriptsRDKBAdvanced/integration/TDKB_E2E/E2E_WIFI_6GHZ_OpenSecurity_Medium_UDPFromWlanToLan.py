...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_Medium_UDPFromWlanToLan')
wifi_obj.configureTestCase(ip,port,'E2E_WIFI_6GHZ_OpenSecurity_Medium_UDPFromWlanToLan')
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in status:
        ...
        print(f"TEST STEP {step}: Get the current ssid, securityMode and firewallLevel")
        ...
        if expectedresult in status:
            ...
            if expectedresult in actualresult:
                ...
                setValuesList = [tdkbE2EUtility.ssid_6ghz_name, 'Enhanced-Open', 'Medium']
                ...
                step += 1
                print(f"TEST STEP {step}: Set the ssid, security mode and firewallLevel")
                ...
                if expectedresult in actualresult and expectedresult in firewallResult:
                    ...
                    step += 1
                    print(f"TEST STEP {step}: Get the current ssid, security mode and firewallLevel after setting new values")
                ...
                print(f"TEST STEP {step}: Revert ssid and firewall to original values")
