...
<xml>
  <id/>
  <version>1</version>
  <name>E2E_DHCP_5GHZ_ClassAPrivate_CheckIPAddress</name>
  <primitive_test_id/>
  <primitive_test_name>tdkb_e2e_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that on configuring DHCP Server Class A Private IP range (10.x.x.x - 10.255.255.255) Wi-Fi Client connected via 5GHz radio successfully receives IP address</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_E2E_95</test_case_id>
    <test_objective>Verify that on configuring DHCP Server Class A Private IP range (10.x.x.x - 10.255.255.255) Wi-Fi Client connected via 5GHz radio successfully receives IP address</test_objective>
...
6.Unload tdkb_e2e module</automation_approch>
    ...
    <test_script>E2E_DHCP_5GHZ_ClassAPrivate_CheckIPAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_DHCP_5GHZ_ClassAPrivate_CheckIPAddress');
