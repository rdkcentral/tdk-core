...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RDKLogger_36</test_case_id>
    <test_objective>To add a log message for a module with empty log level confguration in debug.ini file</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. RDK debug manager module should be intialized     2. Module TEST6 should have empty log configurations in debug.ini file</pre_requisite>
    <api_or_interface_used>rdk_dbg_MsgRaw()</api_or_interface_used>
    <input_parameters>rdk_dbg_MsgRaw: 
string – level (e.g., ERROR)
string – module (e.g., TEST6)
...
5. RDKLoggerStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1..Check that log message is logged by the API.
...
TestMgr_RDKLogger_Log</test_stub_interface>
    <test_script>RDKLogger_Log_DefaultLevel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
