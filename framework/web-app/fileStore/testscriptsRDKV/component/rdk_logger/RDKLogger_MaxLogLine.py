...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1370</id>
  <version>2</version>
  <name>RDKLogger_MaxLogLine</name>
  <primitive_test_id>591</primitive_test_id>
  <primitive_test_name>RDKLogger_Log_Msg</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check the maximum message size that can be logged using RDK_LOG.
Test Case ID: CT_RDKLogger_33
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RDKLogger_33</test_case_id>
    <test_objective>To check the maximum message size (2 lines of msg) that can be logged using RDK_LOG</test_objective>
