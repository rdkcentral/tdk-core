...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1364</id>
  <version>2</version>
  <name>RDKLogger_Log_All</name>
  <primitive_test_id>586</primitive_test_id>
  <primitive_test_name>RDKLogger_Log_All</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To log 5 different messages of INFO, NOTICE, WARNING, ERROR, FATAL levels .
Test Case ID: CT_RDKLogger_23
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RDKLogger_23</test_case_id>
    <test_objective>To log 5 different messages of INFO, NOTICE, WARNING, ERROR, FATAL levels from a module with meta log level “ALL” enabled in debug.ini file.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>1. RDK debug manager module should be intialized 
2. Module should have ALL threshold level configured in debug.ini file</pre_requisite>
    <api_or_interface_used>rdk_dbg_MsgRaw()</api_or_interface_used>
    <input_parameters>rdk_dbg_MsgRaw:
string – module (e.g., TEST1)</input_parameters>
...
4. On success of rdk_logger_init() API, RDKLoggerStub_agent will call RDK_LOG() API of the component 5 times each with DEBUG, INFO, NOTICE, WARNING, ERROR and FATAL levels of TEST1 module.
...
TestMgr_RDKLogger_Log_All</test_stub_interface>
    <test_script>RDKLogger_Log_All</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'RDKLogger_Log_All');
