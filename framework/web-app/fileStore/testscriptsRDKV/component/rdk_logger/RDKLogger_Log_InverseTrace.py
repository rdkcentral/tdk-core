...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RDKLogger_26</test_case_id>
    <test_objective>To add 9 log messages of TRACE1 through TRACE9 levels from a module with meta log level “!TRACE” enabled in debug.ini file.</test_objective>
...
string – module (e.g., TEST5)</input_parameters>
    <automation_approch>1. TM loads RDKLoggerStub_agent via the test agent.
2. TM will invoke “TestMgr_RDKLogger_Log_InverseTrace” in RDKLoggerStub_agent.
3. RDKLoggerStub_agent will call rdk_logger_init() API of the component and get the result.
4. On success of rdk_logger_init() API, RDKLoggerStub_agent will call RDK_LOG() API of the component 9 times each with TRACE1... TRACE9 levels of TEST5 module.
5. RDKLoggerStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1. Check that none of the 9 trace log messages is logged by the API.
Checkpoint 2.Check the return value of API for success status.</except_output>
    <priority>High</priority>
    <test_stub_interface>librdkloggerstub.so
TestMgr_RDKLogger_Log_InverseTrace</test_stub_interface>
    <test_script>RDKLogger_Log_InverseTrace</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
