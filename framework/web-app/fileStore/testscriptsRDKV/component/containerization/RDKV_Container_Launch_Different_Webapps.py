...
<xml>
  ...
  <name>RDKV_Container_Launch_Different_Webapps</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To launch two  different webapps parallelly in container</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_09</test_case_id>
    <test_objective>Launch two different webapps parallelly in container</test_objective>
...
LIGHTNINGAPP_DETAILS=</input_parameters>
...
8. Launch LightningApp
9. Verify that LightningApp is running in container mode
10. Check wpeframework.log</automation_approch>
    <expected_output>Both the webapps must be running parallely in container mode</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Launch_Different_Webapps</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Launch_Different_Webapps');
...
if expectedResult in result.upper():
    ...
    configKeyList = ["SSH_METHOD", "SSH_USERNAME", "SSH_PASSWORD", "HTMLAPP_DETAILS","LIGHTNINGAPP_DETAILS"]
    configValues = {}
            ...
            if expectedResult in actualresult.upper():
                ...
                if expectedResult in actualresult.upper():
                    ...
                    if "launching HtmlApp in container mode" in output:
                        print "Html launched successfully in container mode"
