...
<xml>
  ...
  <name>RDKV_Container_Thunder_Restart_LightningApp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>LightningApp should play video in container mode and launch after thunder restart</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_29</test_case_id>
    <test_objective>LightningApp should play video in container mode and launch after thunder restart</test_objective>
...
11. Verify that LightningApp is running in container mode.</automation_approch>
    <expected_output>LightningApp should play video in container mode and launch after thunder restart</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Thunder_Restart_LightningApp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Thunder_Restart_LightningApp');
                            ...
                            if "SUCCESS" == result1:
                                ...
                                if expectedResult in result:
                                    ...
                                    if expectedResult not in actualresult.upper():
                                        print "LightningApp is not running after Thunder Restart"
                                        print "Launch LightningApp"
                                        time.sleep(10)
                                        tdkTestObj = obj.createTestStep('containerization_launchApplication')
                                        tdkTestObj.addParameter("launch",lightningapp_details)
                                        ...
                                        print "LightningApp is running even after Thunder Restart"
                                        tdkTestObj.setResultStatus("FAILURE")
                                else:
