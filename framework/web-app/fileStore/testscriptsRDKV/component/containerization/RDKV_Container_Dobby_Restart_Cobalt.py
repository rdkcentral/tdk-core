...
<xml>
  ...
  <name>RDKV_Container_Dobby_Restart_Cobalt</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Cobalt should play video in container mode and launch after dobby restart</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_32</test_case_id>
    <test_objective>Cobalt should play video in container mode and launch after dobby restart</test_objective>
...
11. Verify that youtube is running in container mode.</automation_approch>
    <expected_output>Cobalt should play video in container mode and launch after dobby restart</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Dobby_Restart_Cobalt</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Dobby_Restart_Cobalt');
                                ...
                                if output != "EXCEPTION" and expectedResult in result and "old: PAUSED" in output:
                                    ...
                                    if expectedResult in result:
                                        ...
                                        if expectedResult not in actualresult.upper():
                                            print("Cobalt is not running after Dobby Restart")
                                            print("Launch Cobalt")
                                            tdkTestObj = obj.createTestStep('containerization_launchApplication')
                                            tdkTestObj.addParameter("launch",cobalt_details)
                                            tdkTestObj.executeTestCase(expectedResult)
                                            ...
                                            if expectedResult in actualresult.upper():
                                                ...
                                                if expectedResult in actualresult.upper():
                                                    ...
                                                    if "launching cobalt in container mode" in output:
                                                        ...
                                                        print("Unable to get Container Launch logs")
                                            ...
                                            print("Cobalt is still running after Dobby Restart")
                                            tdkTestObj.setResultStatus("FAILURE")
                                    else:
