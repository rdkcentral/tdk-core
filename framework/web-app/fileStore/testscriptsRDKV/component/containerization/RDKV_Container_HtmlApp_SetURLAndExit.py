...
<xml>
  ...
  <name>RDKV_Container_HtmlApp_SetURLAndExit</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Launch HtmlApp in container mode, set url and exit</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_52</test_case_id>
    <test_objective>Launch Html App in container mode, set url and exit</test_objective>
...
9.Exit from HtmlApp
    ...
    <expected_output>Should be able to set URL and exit from HtmlApp </expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_HtmlApp_SetURLAndExit</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_HtmlApp_SetURLAndExit');
