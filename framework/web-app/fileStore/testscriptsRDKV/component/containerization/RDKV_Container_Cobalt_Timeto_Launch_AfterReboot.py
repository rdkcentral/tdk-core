...
<xml>
  ...
  <name>RDKV_Container_Cobalt_Timeto_Launch_AfterReboot</name>
...
5. Reboot the device
6. Register for onLaunch event of RDKShell.
7. Save current system time and launch Cobalt using RDKShell.
8. Get the time from triggered event
9. Validate the output with threshold value</automation_approch>
    <expected_output>Cobalt should be launched in container mode and time taken to launch Cobalt should be within the expected limit.</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Cobalt_Timeto_Launch_AfterReboot</test_script>
    <skipped>No</skipped>
