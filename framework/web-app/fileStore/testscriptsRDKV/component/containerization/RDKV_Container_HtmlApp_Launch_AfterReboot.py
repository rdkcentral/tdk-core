...
<xml>
  ...
  <name>RDKV_Container_HtmlApp_Launch_AfterReboot</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>HtmlApp should play video in container mode and launch after reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_25</test_case_id>
    <test_objective>HtmlApp should play video in container mode and launch after reboot</test_objective>
...
11. Verify that HtmlApp is running in container mode.</automation_approch>
    <expected_output>HtmlApp should play video in container mode and launch after reboot</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_HtmlApp_Launch_AfterReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_HtmlApp_Launch_AfterReboot');
