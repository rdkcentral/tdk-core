...
<xml>
  ...
  <name>RDKV_Container_HtmlApp_TimeTo_Launch</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate the time taken to launch HtmlApp plugin in container mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_21</test_case_id>
    <test_objective>The objective of this test is to validate the time taken to launch HtmlApp plugin in container mode</test_objective>
...
2. HTMLAPP_LAUNCH_THRESHOLD_VALUE_IN_CONTAINER
...
5. Save current system time and launch HtmlApp using RDKShell.
...
7. Validate the output with threshold value</automation_approch>
    ...
    <test_script>RDKV_Container_HtmlApp_TimeTo_Launch</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_HtmlApp_TimeTo_Launch');
