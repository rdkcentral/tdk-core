...
<xml>
  ...
  <name>RDKV_Container_Cobalt_ResourceUsage_AfterReboot_StressTest</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate resource usage for Cobalt after Reboot for 5 times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_65</test_case_id>
    <test_objective>In a loop of 5 times, Validate Resource Usage for Cobalt after Reboot</test_objective>
...
8. Validate resource usage</automation_approch>
    ...
    <test_script>RDKV_Container_Cobalt_ResourceUsage_AfterReboot_StressTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Cobalt_ResourceUsage_AfterReboot_StressTest');
