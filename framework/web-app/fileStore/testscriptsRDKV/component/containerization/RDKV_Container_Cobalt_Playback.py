...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Cobalt should play video in container mode and launch after reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_04</test_case_id>
    <test_objective>Cobalt should play video in container mode and launch after reboot</test_objective>
...
11. Verify that youtube is running in container mode.</automation_approch>
    <expected_output>Cobalt should play video in container mode and launch after reboot</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Cobalt_Playback</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Cobalt_Playback');
