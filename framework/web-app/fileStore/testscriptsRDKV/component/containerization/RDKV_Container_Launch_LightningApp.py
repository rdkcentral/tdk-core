...
<xml>
  ...
  <name>RDKV_Container_Launch_LightningApp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To launch LightningApp in container mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_02</test_case_id>
    <test_objective>To launch LightningApp in container mode</test_objective>
...
7. Check wpeframework.log</automation_approch>
    <expected_output>LightningApp should be launched in container mode</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Launch_LightningApp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Launch_LightningApp');
