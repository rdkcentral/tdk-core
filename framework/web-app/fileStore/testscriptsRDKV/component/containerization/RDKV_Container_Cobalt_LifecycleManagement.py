...
5. Launch plugin using launch method of RDKShell.
6. Set given video URL using deeplink method of Cobalt
7.  Validate whether video is playing using proc entries
8. Suspend the plugin using suspend method of RDKShell
9. Resume the plugin using resume method of RDKShell
10. Move the plugin to back using moveToBack method of RDKShell
11. Move the plugin to front using moveToFront method of RDKShell
12. Deactivate the plugin using destroy method of RDKShell</automation_approch>
