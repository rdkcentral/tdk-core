...
<xml>
  ...
  <name>RDKV_Container_HtmlApp_LifecycleManagement</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to do lifecycle management of HtmlApp plugin in container mode.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_19</test_case_id>
    <test_objective>The objective of this test is to do lifecycle management of HtmlApp plugin in container mode.</test_objective>
...
9.  Validate whether URL is set using above method itself.
...
14. Deactivate the plugin using destroy method of RDKShell.</automation_approch>
    ...
    <test_script>RDKV_Container_HtmlApp_LifecycleManagement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_HtmlApp_LifecycleManagement');
