...
<xml>
  ...
  <name>RDKV_Container_LightningApp_ResourceUsage_AfterReboot</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate resource usage for LightningApp after Reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_44</test_case_id>
    <test_objective>Validate Resource Usage for LightningApp after Reboot</test_objective>
...
8. Validate resource usage</automation_approch>
    ...
    <test_script>RDKV_Container_LightningApp_ResourceUsage_AfterReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_LightningApp_ResourceUsage_AfterReboot');
