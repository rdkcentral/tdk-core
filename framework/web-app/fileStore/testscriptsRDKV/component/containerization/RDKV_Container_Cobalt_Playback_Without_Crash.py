...
8. Start playback
9.Check wpeframework.log for crash</automation_approch>
    <expected_output>Cobalt should play video without crashing in container mode</expected_output>
    <priority>High</priority>
    <test_stub_interface>containerization</test_stub_interface>
    <test_script>RDKV_Container_Cobalt_Playback_Without_Crash</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Cobalt_Playback_Without_Crash');
