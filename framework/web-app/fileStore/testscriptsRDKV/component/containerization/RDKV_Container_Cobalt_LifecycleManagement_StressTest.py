...
<xml>
  ...
  <name>RDKV_Container_Cobalt_LifecycleManagement_StressTest</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to do lifecycle management of Cobalt plugin in container mode for 5 times and validate the resource usage.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>Containerization_64</test_case_id>
    <test_objective>The objective of this test is to do lifecycle management of Cobalt plugin in container mode for 5 times and validate the resource usage.</test_objective>
...
8. Set given URL using Cobalt.1.url method.
...
15. Validate the resource usage</automation_approch>
    ...
    <test_script>RDKV_Container_Cobalt_LifecycleManagement_StressTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Container_Cobalt_LifecycleManagement_StressTest');
...
if expectedResult in result.upper():
    ...
    configKeyList = ["SSH_METHOD", "SSH_USERNAME", "SSH_PASSWORD", "COBALT_DETAILS","PROC_VALIDATION", "VIDEO_VALIDATION_SCRIPT_FILE","COBALT_PLAYBACK_URL_CONTAINER"]
    configValues = {}
    max_iterations =  5
    ...
    if "FAILURE" != result:
        if "directSSH" == configValues["SSH_METHOD"]:
            ...
            cobalt_test_url = configValues["COBALT_PLAYBACK_URL_CONTAINER"]
