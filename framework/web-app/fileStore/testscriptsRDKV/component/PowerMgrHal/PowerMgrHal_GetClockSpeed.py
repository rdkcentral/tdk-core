...
<xml>
  ...
  <name>PowerMgrHal_GetClockSpeed</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>PowerMgrHal_GetClockSpeed</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to get the current clock speed of the CPU using PLAT_API_GetClockSpeed API</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PowerMgrHal_07</test_case_id>
    <test_objective>Test Script to get the current clock speed of the CPU using PLAT_API_GetClockSpeed API</test_objective>
...
3.Invoke PLAT_API_GetClockSpeed API to get the current CPU clock speed
4.Based on the API return value update the test status as SUCCESS/FAILURE
5.Unload the module</automation_approch>
    <expected_output>API should give current clock speed of the CPU</expected_output>
    <priority>High</priority>
    <test_stub_interface>libpwrmgrhalstub.so.0.0.0</test_stub_interface>
    <test_script>PowerMgrHal_GetClockSpeed</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'PowerMgrHal_GetClockSpeed');
...
if "SUCCESS" in loadModuleStatus.upper():
    ...
    print("EXEPECTED OUTPUT : Should get the clock speed of CPU")
