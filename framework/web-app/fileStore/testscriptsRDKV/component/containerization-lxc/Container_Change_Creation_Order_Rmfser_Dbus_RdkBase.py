...
<xml>
  ...
  <name>Container_Change_Creation_Order_Rmfser_Dbus_RdkBase</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify container creation order is correct for the sequence ["rmfserv", "dbus", "rdk-base"]</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Container_17</test_case_id>
    <test_objective>Verify container creation order is correct for the sequence ["rmfserv", "dbus", "rdk-base"]</test_objective>
...
2. SystemUtilAgent will change the contents of the file '/etc/containers_order.conf' to "rmfserv dbus rdk-base"
...
6. TM unloads the SystemUtilAgent</automation_approch>
    ...
    <test_script>Container_Change_Creation_Order_Rmfser_Dbus_RdkBase</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Container_Change_Creation_Order_Rmfser_Dbus_RdkBase');
