...
<xml>
  ...
  <name>Container_Access_Shell_DBus</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify Dbus container shell is accessible when the container is running</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Container_19</test_case_id>
    <test_objective>Verify Dbus container shell is accessible when the container is running</test_objective>
...
5. TM unloads the SystemUtilAgent</automation_approch>
    <except_output>Checkpoint 1.Check the Dbus container state is "RUNNING"
Checkpoint 2.Check if the Dbus container shell is accessible</except_output>
    <priority>High</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>Container_Access_Shell_DBus</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Container_Access_Shell_DBus');
