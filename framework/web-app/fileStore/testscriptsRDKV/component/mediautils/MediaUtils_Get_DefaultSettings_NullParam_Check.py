...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>MediaUtils_Get_DefaultSettings_NullParam_Check</name>
  <primitive_test_id/>
  ...
  <test_cases>
    ...
    <test_objective>To verify the default settings API by passing null param</test_objective>
...
Checkpoint 4:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Get_DefaultSettings_NullParam_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'MediaUtils_Get_DefaultSettings_NullParam_Check');
...
if "SUCCESS" in loadStatus.upper():
    ...
    if result:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                print("MediaUtils_Get_DefaultSettings call getting failed due to null param being passed");
                print(details);
                tdkTestObj.setResultStatus("SUCCESS");
            else:
                print("MediaUtils_Get_DefaultSettings call getting succeeded eventhough with the null param");
                details = tdkTestObj.getResultDetails();
                print("DEFAULT SETTINGS: " , details);
