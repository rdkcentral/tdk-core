...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>MediaUtils_Get_Status_NullParam_Check</name>
  <primitive_test_id/>
  <primitive_test_name>MediaUtils_Get_Status</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a test to validate the get status API with the null param</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MediaUtils_12</test_case_id>
    <test_objective>To validate with the null param</test_objective>
...
Checkpoint 6:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Get_Status_NullParam_Check</test_script>
    <skipped>No</skipped>
