...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>MediaUtils_Get_Status_InvalidHandle_Check</name>
  <primitive_test_id/>
  <primitive_test_name>MediaUtils_Get_Status</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a test to validate the get status API with the invalid handle</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MediaUtils_11</test_case_id>
...
Checkpoint 6:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Get_Status_InvalidHandle_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'MediaUtils_Get_Status_InvalidHandle_Check');
...
def getStatus():
    ...
    GetStatus_Details = tdkTestObj.getResultDetails();
    if expectedresult in actualresult:
        print("MediaUtils_Get_status call : FAILURE due to ", GetStatus_Details);
        tdkTestObj.setResultStatus("SUCCESS");
    else:
        print("MediaUtils_Get_status call : SUCCESS");
        tdkTestObj.setResultStatus("FAILURE");
        print("RMF_AudioCapture_Status: " , GetStatus_Details);
