...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>MediaUtils_Start_AudioCapture_BufferNotReady</name>
  <primitive_test_id/>
  <primitive_test_name>MediaUtils_AudioCaptureStart</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a negative test to check if audio capturing occurs when buffer is not set.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MediaUtils_07</test_case_id>
    <test_objective>This is a negative test to check if audio capturing occurs when buffer is not ready</test_objective>
...
MediaUtils_AudioCaptureStart - string "VALID", "NOTREADY"
...
Checkpoint 5:MediaUtils_AudioCapture_Close should close successfully</except_output>
    ...
    <test_script>MediaUtils_Start_AudioCapture_BufferNotReady</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'MediaUtils_Start_AudioCapture_BufferNotReady');
