...
<xml>
  ...
  <name>HdmicecHal_TxAsync_Send_Abort_Msg</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to send abort message to the target device (TV) asynchronously. This message is reserved for testing purpose.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HdmicecHal_15</test_case_id>
    <test_objective>Test Script to send abort message to the target device (TV) asynchronously. This message is reserved for testing purpose.</test_objective>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'HdmicecHal_TxAsync_Send_Abort_Msg');
