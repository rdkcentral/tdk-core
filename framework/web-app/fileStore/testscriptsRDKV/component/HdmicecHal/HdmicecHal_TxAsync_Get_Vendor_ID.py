...
<xml>
  ...
  <name>HdmicecHal_TxAsync_Get_Vendor_ID</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to request the Vendor ID from a device  using asynchronous transmission</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HdmicecHal_11</test_case_id>
    <test_objective>Test Script to request the Vendor ID from a device  using asynchronous transmission</test_objective>
...
6. Unload the module</automation_approch>
    ...
    <test_script>HdmicecHal_TxAsync_Get_Vendor_ID</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'HdmicecHal_TxAsync_Get_Vendor_ID');
