...
<xml>
  ...
  <name>HdmicecHal_Tx_Get_CEC_Version</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to enquire which version of CEC the target (TV) supports</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HdmicecHal_04</test_case_id>
    <test_objective>Test Script to enquire which version of CEC the target (TV) supports</test_objective>
...
6. Unload the module</automation_approch>
    ...
    <test_script>HdmicecHal_Tx_Get_CEC_Version</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'HdmicecHal_Tx_Get_CEC_Version');
