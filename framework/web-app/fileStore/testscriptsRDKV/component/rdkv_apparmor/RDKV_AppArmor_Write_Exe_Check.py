...
<xml>
  ...
  <name>RDKV_AppArmor_Write_Exe_Check</name>
...
lighttpd</synopsis>
  ...
  <test_cases>
    ...
    <test_objective> To check write execute permissions are present together</test_objective>
...
3. Pass if files are present.</automation_approch>
    ...
    <test_script>RDKV_AppArmor_Write_Exe_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_AppArmor_Write_Exe_Check');
