...
<xml>
  ...
  <name>RDKV_AppArmor_Dac_Override_Lighttpd</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check Dac_Override is present in lighttpd profile</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_APPARMOR_17</test_case_id>
    <test_objective>To check Dac_Override is present in lighttpd profile</test_objective>
...
2. Validate Dac_Override is present lighttpd profile
3. Pass if dac_override is removed</automation_approch>
    <expected_output>Dac_Override is present in lighttpd profile</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_apparmor</test_stub_interface>
    <test_script>RDKV_AppArmor_Dac_Override_Lighttpd</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_AppArmor_Dac_Override_Lighttpd');
