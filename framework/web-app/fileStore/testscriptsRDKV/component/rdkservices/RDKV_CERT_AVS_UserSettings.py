...
<xml>
  ...
  <name>RDKV_CERT_AVS_UserSettings</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To perform tests on RDKService's UserSettings APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_UserSettings');
...
tdkTestObj.addParameter("xml_name","UserSettings");
