...
<xml>
  ...
  <name>RDKV_CERT_AVS_PlayerInfo</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service PlayerInfo api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_PlayerInfo');
...
tdkTestObj.addParameter("xml_name","PlayerInfo");
