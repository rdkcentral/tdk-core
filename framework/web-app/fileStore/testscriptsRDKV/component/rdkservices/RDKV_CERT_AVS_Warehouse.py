...
<xml>
  ...
  <name>RDKV_CERT_AVS_Warehouse</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Warehouse api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Warehouse');
...
tdkTestObj.addParameter("xml_name","Warehouse");
