...
<xml>
  ...
  <name>RDKV_CERT_AVS_TV_Control_Settings</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Tv control settings api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_TV_Control_Settings');
...
tdkTestObj.addParameter("xml_name","TV_Control_Settings");
