...
<xml>
  ...
  <name>RDKV_CERT_AVS_DeviceIdentification</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service DeviceIdentification api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_DeviceIdentification');
...
tdkTestObj.addParameter("xml_name","DeviceIdentification");
