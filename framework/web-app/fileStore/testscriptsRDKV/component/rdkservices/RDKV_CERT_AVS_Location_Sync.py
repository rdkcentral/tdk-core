...
<xml>
  ...
  <name>RDKV_CERT_AVS_Location_Sync</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK Service Location Sync API's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Location_Sync');
...
tdkTestObj.addParameter("xml_name","LocationSync");
