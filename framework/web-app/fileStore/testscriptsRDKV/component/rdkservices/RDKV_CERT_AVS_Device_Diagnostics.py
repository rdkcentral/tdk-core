...
<xml>
  ...
  <name>RDKV_CERT_AVS_Device_Diagnostics</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Device Diagnostics api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Device_Diagnostics');
...
tdkTestObj.addParameter("xml_name","DeviceDiagnostics");
