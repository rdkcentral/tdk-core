...
<xml>
  ...
  <name>RDKV_CERT_AVS_Cobalt</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Cobalt api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Cobalt');
...
tdkTestObj.addParameter("xml_name","Cobalt");
