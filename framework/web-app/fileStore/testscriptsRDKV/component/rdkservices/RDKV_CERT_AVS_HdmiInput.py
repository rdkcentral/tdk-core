...
<xml>
  ...
  <name>RDKV_CERT_AVS_HdmiInput</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service HdmiInput api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_HdmiInput');
...
tdkTestObj.addParameter("xml_name","HdmiInput");
