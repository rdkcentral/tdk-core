...
<xml>
  ...
  <name>RDKV_CERT_AVS_MiracastService</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Basic API validation related to the miracast plugin</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_MiracastService');
...
tdkTestObj.addParameter("xml_name","MiracastService");
