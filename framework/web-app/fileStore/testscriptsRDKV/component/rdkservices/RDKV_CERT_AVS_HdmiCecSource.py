...
<xml>
  ...
  <name>RDKV_CERT_AVS_HdmiCecSource</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Test RDKService HdmiCecSource APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_HdmiCecSource');
...
tdkTestObj.addParameter("xml_name","HdmiCecSource");
