...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service OCDM api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_OCDM');
...
tdkTestObj.addParameter("xml_name","OCDM");
