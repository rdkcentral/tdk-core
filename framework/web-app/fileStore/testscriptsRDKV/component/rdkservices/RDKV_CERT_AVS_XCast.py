...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service XCast api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_XCast');
...
tdkTestObj.addParameter("xml_name","XCast");
