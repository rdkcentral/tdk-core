...
<xml>
  ...
  <name>RDKV_CERT_AVS_Display_Settings_TV</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Display Settings rdk service APIs applicable for TV platform</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Display_Settings_TV');
...
tdkTestObj.addParameter("xml_name","DisplaySettings_TV_");
