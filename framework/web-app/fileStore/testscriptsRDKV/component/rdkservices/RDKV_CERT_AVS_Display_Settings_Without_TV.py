...
<xml>
  ...
  <name>RDKV_CERT_AVS_Display_Settings_Without_TV</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test Display Settings rdk service APIs for which TV needs to be disconnected</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Display_Settings_Without_TV');
...
tdkTestObj.addParameter("xml_name","DisplaySettingsWithoutTV");
