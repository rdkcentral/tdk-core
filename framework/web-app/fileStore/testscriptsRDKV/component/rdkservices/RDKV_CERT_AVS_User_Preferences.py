...
<xml>
  ...
  <name>RDKV_CERT_AVS_User_Preferences</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test User Preferences rdk service api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_User_Preferences');
...
tdkTestObj.addParameter("xml_name","UserPreferences");
