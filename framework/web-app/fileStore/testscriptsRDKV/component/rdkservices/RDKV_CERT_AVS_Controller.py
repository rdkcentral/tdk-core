...
<xml>
  ...
  <name>RDKV_CERT_AVS_Controller</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service Controller api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Controller');
...
tdkTestObj.addParameter("xml_name","Controller");
