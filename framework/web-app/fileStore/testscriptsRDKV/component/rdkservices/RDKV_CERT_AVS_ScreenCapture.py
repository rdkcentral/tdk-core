...
<xml>
  ...
  <name>RDKV_CERT_AVS_ScreenCapture</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service ScreenCapture api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_ScreenCapture');
...
tdkTestObj.addParameter("xml_name","ScreenCapture");
