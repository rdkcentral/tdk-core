...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service LISA api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_LISA');
...
tdkTestObj.addParameter("xml_name","LISA");
