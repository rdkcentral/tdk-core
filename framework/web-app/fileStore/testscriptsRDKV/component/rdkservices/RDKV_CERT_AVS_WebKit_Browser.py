...
<xml>
  ...
  <name>RDKV_CERT_AVS_WebKit_Browser</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service WebKit_Browser api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_WebKit_Browser');
...
tdkTestObj.addParameter("xml_name","WebKitBrowser");
