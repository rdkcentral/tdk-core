...
<xml>
  ...
  <name>RDKV_CERT_AVS_AV_Input</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service AV Input api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_AV_Input');
...
tdkTestObj.addParameter("xml_name","AVInput");
