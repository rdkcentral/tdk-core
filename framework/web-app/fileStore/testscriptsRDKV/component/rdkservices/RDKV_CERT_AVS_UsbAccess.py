...
<xml>
  ...
  <name>RDKV_CERT_AVS_UsbAccess</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service UsbAccess api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_UsbAccess');
...
tdkTestObj.addParameter("xml_name","UsbAccess");
