...
<xml>
  ...
  <name>RDKV_CERT_AVS_Display_Info</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK Service Display info api's</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_Display_Info');
...
tdkTestObj.addParameter("xml_name","DisplayInfo");
