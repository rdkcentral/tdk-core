...
<xml>
  ...
  <name>RDKV_CERT_AVS_OCIContainer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test RDK service OCIContainer APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_AVS_OCIContainer');
...
tdkTestObj.addParameter("xml_name","OCIContainer");
