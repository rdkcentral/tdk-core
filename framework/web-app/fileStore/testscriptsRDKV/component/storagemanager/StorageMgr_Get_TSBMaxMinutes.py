...
<xml>
  ...
  <name>StorageMgr_Get_TSBMaxMinutes</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to get the number of minutes allowed for TSB storage</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_StorageMgr_13</test_case_id>
    <test_objective>Test Script to get the number of minutes allowed for TSB storage</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Video_Accelerator, RDKTV</test_setup>
    <pre_requisite></pre_requisite>
    <api_or_interface_used>getTSBMaxMinutes</api_or_interface_used>
...
3.Should return the minutes allowed for TSB storage.
    ...
    <expected_output>Should return the minutes allowed for TSB storage</expected_output>
    <priority>High</priority>
    <test_stub_interface>libstoragemanagerstub.so.0.0.0</test_stub_interface>
    <test_script>StorageMgr_Get_TSBMaxMinutes</test_script>
    <skipped>No</skipped>
