...
<xml>
  ...
  <name>StorageMgr_Get_TSBPartitionMountPath</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the mount path of TSB</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_StorageMgr_16</test_case_id>
    <test_objective>Test script to get the mount path of TSB</test_objective>
...
3.It should return the path TSB is mounted.
</automation_approch>
    <expected_output>Should return the path TSB is mounted</expected_output>
    <priority>High</priority>
    <test_stub_interface>libstoragemanagerstub.so.0.0.0</test_stub_interface>
    <test_script>StorageMgr_Get_TSBPartitionMountPath</test_script>
    <skipped>No</skipped>
