...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_Basic_Sanity_System_Sanity_Check</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_Basic_Sanity_05</test_case_id>
    <test_objective>To Initiate the shell scripts which perform various system sanity checks</test_objective>
    ...
    <automation_approch>1.Perform various system sanity checks</automation_approch>
    <expected_output>Validation of various Sanity senarious and reported if there are any failures</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_basic_sanity</test_stub_interface>
    <test_script>RDKV_Basic_Sanity_System_Sanity_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Basic_Sanity_System_Sanity_Check');
...
if expectedResult in result.upper():
    ...
    if "FAILURE" != result:
        if "directSSH" == configValues["SSH_METHOD"] :
            ...
            command = "sh " + configValues["SANITY_SCRIPT_PATH"] + "/system_sanity_check.sh 1 2 3 4 5 6 7 8 12 13"
