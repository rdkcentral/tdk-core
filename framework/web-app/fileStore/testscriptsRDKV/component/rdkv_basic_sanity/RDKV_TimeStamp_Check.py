...
<xml>
  ...
  <name>RDKV_TimeStamp_Check</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Script to test the time stamp of the files present in the device</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Basic_Sanity_17</test_case_id>
    <test_objective>Script to test the time stamp of the files present in the device</test_objective>
    ...
    <automation_approch>List the files which is lesser than the build time stamp</automation_approch>
    <expected_output>All files should have the biuld time stamp</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_basic_sanity</test_stub_interface>
    <test_script>RDKV_TimeStamp_Check</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RDKV_TimeStamp_Check');
...
if ("SUCCESS" in LoadStatus.upper()):
    ...
    command = "cd /opt/TDK; sh system_file_check.sh check_file_dates"
