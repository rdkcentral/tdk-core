...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_Basic_Sanity_Check_Eth_Wifi_Toggle_Functionality</name>
  <primitive_test_id/>
  <primitive_test_name>rdkv_basic_sanity_executeInDUT</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Validate Ethernet_Wifi Toggle functionality</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_Basic_Sanity_07</test_case_id>
    <test_objective>To Initiate the shell scripts which perform eth to wifi toggle functionality check</test_objective>
    ...
    <automation_approch>1.Validate eth to wifi toggle functionality</automation_approch>
    <expected_output>Validation of toggle functionality.When network interface is altered the test case expects ping response to be success within the given timeout</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_basic_sanity</test_stub_interface>
    <test_script>RDKV_Basic_Sanity_Check_Eth_Wifi_Toggle_Functionality</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Basic_Sanity_Check_Eth_Wifi_Toggle_Functionality');
...
if expectedResult in result.upper():
    ...
    if "FAILURE" != result:
        if "directSSH" == configValues["SSH_METHOD"] :
            ...
            command = "sh " + configValues["SANITY_SCRIPT_PATH"] + "/system_sanity_check_eth_wifi_toggle_functionality.sh"
