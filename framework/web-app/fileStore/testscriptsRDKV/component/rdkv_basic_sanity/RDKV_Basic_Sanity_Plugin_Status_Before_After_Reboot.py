...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_Basic_Sanity_Plugin_Status_Before_After_Reboot</name>
  <primitive_test_id/>
  <primitive_test_name>rdkv_basic_sanity_executeInDUT</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate Status of Plugins before and after reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_script>RDKV_Basic_Sanity_Plugin_Status_Before_After_Reboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Basic_Sanity_Plugin_Status_Before_After_Reboot');
