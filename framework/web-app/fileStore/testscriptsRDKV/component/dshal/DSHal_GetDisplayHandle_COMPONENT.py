...
<xml>
  ...
  <name>DSHal_GetDisplayHandle_COMPONENT</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if display handle is retrieved for COMPONENT</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetDisplayHandle_COMPONENT');
