...
<xml>
  ...
  <name>DSHal_GetVideoPortHandle_HDMI_Invalid_PortIndex</name>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_19</test_case_id>
...
2 . DSHAL agent will invoke the api dsGetVideoPort for invalid port index with port type as HDMI
...
Checkpoint 2 Verify that handle is not retrieved</expected_output>
    ...
    <test_script>DSHal_GetVideoPortHandle_HDMI_Invalid_PortIndex</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetVideoPortHandle_HDMI_Invalid_PortIndex');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
        ...
        if expectedResult in actualResult:
            ...
            print details;
            print "VideoPort handle not retrieved for invalid port index for HDMI";
        else:
            tdkTestObj.setResultStatus("FAILURE");
            print "VideoPort handle retrieved for invalid port index for HDMI";
