...
<xml>
  ...
  <name>DSHal_SetandGet_DialogEnhancement_level12</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set dialogenhancement level to 12</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_125</test_case_id>
    <test_objective>To set dialogenhancement level to 12</test_objective>
...
2 . DSHAL agent will invoke the api dsSetDialogEnhancement to set the level to 12
...
Checkpoint 2 Verify that the level is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_DialogEnhancement_level12</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_DialogEnhancement_level12');
