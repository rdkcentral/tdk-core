...
<xml>
  ...
  <name>DSHal_IsOutputHDR_HDMI</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>DSHal_IsOutputHDR</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the HDR status of output HDMI</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the HDR status of output HDMI</test_objective>
...
dsIsOutputHDR(int handle, bool *hdr)</api_or_interface_used>
...
Checkpoint 2 Verify that the HDR status is valid</expected_output>
    ...
    <test_script>DSHal_IsOutputHDR_HDMI</test_script>
    <skipped>No</skipped>
