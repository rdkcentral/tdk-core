...
<xml>
  ...
  <name>DSHal_SetandGet_AudioCompression_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set HDMI port Audio compression</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To set HDMI port Audio compression</test_objective>
...
dsSetAudioCompression(int handle, int audioCompression)
dsGetAudioCompression(int handle, int *audioCompression)</api_or_interface_used>
...
Checkpoint 2 Verify that the audio compression is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_AudioCompression_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_AudioCompression_HDMI');
