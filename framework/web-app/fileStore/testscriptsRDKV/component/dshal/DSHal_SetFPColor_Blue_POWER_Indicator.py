...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DSHal_SetFPColor_Blue_POWER_Indicator</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_70</test_case_id>
...
2.DSHAL agent will invoke the API dsSetFPColor with parameter LED indicator 1 [POWER LED] and color Blue
...
5.Unload the module</automation_approch>
    ...
    <test_script>DSHal_SetFPColor_Blue_POWER_Indicator</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_SetFPColor_Blue_POWER_Indicator');
...
if "SUCCESS" in loadModuleStatus.upper() and capable:
    ...
    print("\nTEST STEP1 : To set color of Power indicator in Front Panel to Blue")
    print("EXEPECTED RESULT : Should set the power led colour to Blue")
