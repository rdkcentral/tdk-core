...
<xml>
  ...
  <name>DSHal_SetSurroundVirtualizer_AutoMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the Surround Virtualizer in Auto mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_159</test_case_id>
    <test_objective>To set the surround virtualizer in auto mode and check whether it is set properly.</test_objective>
...
4. TM checks if the virtualizer mode and boost are returned as expected and return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>DSHal_SetSurroundVirtualizer_AutoMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_SetSurroundVirtualizer_AutoMode');
