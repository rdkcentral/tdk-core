...
<xml>
  ...
  <name>DSHal_SetandGet_HDMIPreference_1X</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get HDMI preference to HDCP Protocol version 1.x</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To set and get HDMI preference to HDCP Protocol version 1.x</test_objective>
...
3 . DSHAL agent will invoke the api dsSetHdmiPreference to set the HDCP protocol version to 1.x
...
Checkpoint 2 Verify that the HDCP protocol version is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_HDMIPreference_1X</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_HDMIPreference_1X');
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            ...
            if details == "true":
                ...
                tdkTestObj.addParameter("hdcpProtocol", hdcpProtocolVersion["VERSION_1X"]);
                #Execute the test case in STB
                tdkTestObj.executeTestCase(expectedResult);
                actualResult = tdkTestObj.getResult();
