...
<xml>
  ...
  <name>DSHal_GetAndSetResolution_HDMI_InvalidAspectRatio</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if the resolution is set for InvalidAspectRatio</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_113</test_case_id>
    <test_objective>To check if the resolution is set for InvalidAspectRatio</test_objective>
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            ...
            if details == "true":
                ...
                tdkTestObj.addParameter("aspectRatio",7); #Invalid Aspect Ratio
