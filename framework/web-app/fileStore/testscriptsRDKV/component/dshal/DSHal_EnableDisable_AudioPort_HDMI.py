...
<xml>
  ...
  <name>DSHal_EnableDisable_AudioPort_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To enable and disable HDMI audio port</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_13</test_case_id>
    <test_objective>To enable and disable HDMI audio port</test_objective>
...
2 . DSHAL agent will invoke the api dsEnableAudioPort to enable/disable the HDMI audio port status
...
Checkpoint 2 Verify that the status is set</expected_output>
    ...
    <test_script>DSHal_EnableDisable_AudioPort_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_EnableDisable_AudioPort_HDMI');
