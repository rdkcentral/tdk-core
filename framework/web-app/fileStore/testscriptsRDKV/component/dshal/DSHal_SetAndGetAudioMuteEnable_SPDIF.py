...
<xml>
  ...
  <name>DSHal_SetAndGetAudioMuteEnable_SPDIF</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set AudioMute status to true for SPDIF audio port</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To set AudioMute status to true for SPDIF audio port</test_objective>
...
Checkpoint 2 Verify that the mute is set</expected_output>
    ...
    <test_script>DSHal_SetAndGetAudioMuteEnable_SPDIF</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetAndGetAudioMuteEnable_SPDIF');
