...
<xml>
  ...
  <name>DSHal_SetandGet_StereoMode_Invalid_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if HDMI audio port stereo mode can be set to invalid mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_7</test_case_id>
    <test_objective>To check if HDMI audio port stereo mode can be set to invalid mode</test_objective>
...
Checkpoint 2 Verify that invalid stereo mode is not set</expected_output>
    ...
    <test_script>DSHal_SetandGet_StereoMode_Invalid_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_StereoMode_Invalid_HDMI');
