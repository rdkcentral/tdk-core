...
<xml>
  ...
  <name>DSHal_SetBassEnhancer_Invalid</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Bass Enhancer is set to invalid value</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check if Bass Enhancer is set to invalid value</test_objective>
...
2 . DSHAL agent will invoke the api dsSetBassEnhancer to set invalid boost value
3 . TM checks if the boost value is same as that set and return SUCCESS/FAILURE status.</automation_approch>
    <expected_output>Checkpoint 1.Verify the API call is failure</expected_output>
    <priority>High</priority>
    <test_stub_interface>libdshalstub.so.0.0.0</test_stub_interface>
    <test_script>DSHal_SetBassEnhancer_Invalid</test_script>
    <skipped>No</skipped>
