...
<xml>
  ...
  <name>DSHal_SetandGet_StereoMode_Surround_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set HDMI audio port stereo mode to "SURROUND"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_6</test_case_id>
    <test_objective>To set HDMI audio port stereo mode to "SURROUND"</test_objective>
...
Checkpoint 2 Verify that the stereo mode is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_StereoMode_Surround_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_StereoMode_Surround_HDMI');
