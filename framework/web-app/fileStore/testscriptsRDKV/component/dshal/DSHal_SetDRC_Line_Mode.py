...
<xml>
  ...
  <name>DSHal_SetDRC_Line_Mode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to set DRC mode to line mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_171</test_case_id>
    <test_objective>Test to set DRC mode to line mode</test_objective>
...
Checkpoint 2 Verify that the mode is set</expected_output>
    ...
    <test_script>DSHal_SetDRC_Line_Mode</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetDRC_Line_Mode');
