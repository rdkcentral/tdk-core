...
<xml>
  ...
  <name>DSHal_SetandGet_HDMIPreference_2X</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get HDMI preference to HDCP Protocol version 2.x</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To set and get HDMI preference to HDCP Protocol version 2.x</test_objective>
...
Checkpoint 2 Verify that the HDCP protocol version is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_HDMIPreference_2X</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_HDMIPreference_2X');
