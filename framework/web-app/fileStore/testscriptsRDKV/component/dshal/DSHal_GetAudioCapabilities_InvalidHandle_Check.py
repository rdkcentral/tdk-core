...
<xml>
  ...
  <name>DSHal_GetAudioCapabilities_InvalidHandle_Check</name>
  ...
  <test_cases>
    ...
    <test_objective>Test script to validate the Getaudiocapabilities API by passing an invalid handle</test_objective>
...
2. Invoke the dsGetAudioCapabilities api by passing an invalid handle.
3. TM checks if the dsGetAudioCapabilities returned a corresponding error code and return SUCCESS/FAILURE status.</automation_approch>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_GetAudioCapabilities_InvalidHandle_Check');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
    ...
    if expectedResult in actualResult:
        print(details);
        print("ACTUAL RESULT : dsGetAudioCapabilities call is failed due to invalid handle");
        tdkTestObj.setResultStatus("SUCCESS");
        print("[TEST EXECUTION RESULT] : SUCCESS");
    else:
        print("Value returned : ", details);
        print("ACTUAL RESULT : dsGetAudioCapabilities call is success eventhough with an invalid handle");
