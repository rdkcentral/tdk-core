...
<xml>
  ...
  <name>DSHal_IsSurroundDecoderEnabled_NullParam_Check</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the surround decoder enabled API with the null param being passed</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_184</test_case_id>
    <test_objective>To validate SurroundDecoder enabled API with the null param being passed</test_objective>
...
Checkpoint 2 Verify that the status is correct</expected_output>
    ...
    <test_script>DSHal_IsSurroundDecoderEnabled_NullParam_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_IsSurroundDecoderEnabled_NullParam_Check');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            print(details);
            print("ACTUAL RESULT : dsIsSurroundDecoderEnabled call is failed due to null param being passed");
            tdkTestObj.setResultStatus("SUCCESS");
            print("[TEST EXECUTION RESULT] : SUCCESS");
        else:
            print("Value returned : ", details);
            print("ACTUAL RESULT : dsIsSurroundDecoderEnabled call is success eventhough null param being passed");
