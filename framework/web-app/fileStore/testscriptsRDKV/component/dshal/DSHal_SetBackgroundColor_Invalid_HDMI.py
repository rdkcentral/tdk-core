...
<xml>
  ...
  <name>DSHal_SetBackgroundColor_Invalid_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set video device background color to none for Invalid color id</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_55</test_case_id>
    <test_objective>To set video device background color to none for Invalid color id</test_objective>
...
2 . DSHAL agent will invoke the api dsSetBackgroundColor to set the BG color to none
3. TM checks if the color is set and return SUCCESS/FAILURE status.</automation_approch>
    <expected_output>Checkpoint 1.Verify the API call is success
Checkpoint 2 Verify that the BG color is set to none for Invalid color id</expected_output>
    <priority>High</priority>
    <test_stub_interface>libdshalstub.so.0.0.0</test_stub_interface>
    <test_script>DSHal_SetBackgroundColor_Invalid_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetBackgroundColor_Invalid_HDMI');
sysObj.configureTestCase(ip,port,'DSHal_SetBackgroundColor_Invalid_HDMI');
