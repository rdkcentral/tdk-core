...
<xml>
  ...
  <name>DSHal_GetColorSpace_HDMI</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>DSHal_GetColorSpace</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the color space of the video device connected to HDMI port</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_26</test_case_id>
    <test_objective>To check the color space of the video device connected to HDMI port</test_objective>
...
dsGetColorSpace(int handle, dsDisplayColorSpace_t* color_space)</api_or_interface_used>
    <input_parameters>type - Video port type
index- Video port index
handle - Video port handle
color_space - Color space</input_parameters>
...
Checkpoint 2 Verify that the color space value is correct</expected_output>
    ...
    <test_script>DSHal_GetColorSpace_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetColorSpace_HDMI');
