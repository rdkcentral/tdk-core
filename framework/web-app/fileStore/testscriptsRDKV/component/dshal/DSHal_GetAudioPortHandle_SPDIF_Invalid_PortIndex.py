...
<xml>
  ...
  <name>DSHal_GetAudioPortHandle_SPDIF_Invalid_PortIndex</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if audio port handle is retrieved for invalid port index for SPDIF</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_29</test_case_id>
    <test_objective>To check if audio port handle is retrieved for invalid port index for SPDIF</test_objective>
...
Checkpoint 2 Verify that the handle is not retrieved</expected_output>
    ...
    <test_script>DSHal_GetAudioPortHandle_SPDIF_Invalid_PortIndex</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetAudioPortHandle_SPDIF_Invalid_PortIndex');
