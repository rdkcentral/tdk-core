...
<xml>
  ...
  <name>DSHal_Disable_DolbyVolumeMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To disable dolby volume mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_127</test_case_id>
    <test_objective>To disable dolby volume mode</test_objective>
...
Checkpoint 2 Verify that the mode is set</expected_output>
    ...
    <test_script>DSHal_Disable_DolbyVolumeMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_Disable_DolbyVolumeMode');
