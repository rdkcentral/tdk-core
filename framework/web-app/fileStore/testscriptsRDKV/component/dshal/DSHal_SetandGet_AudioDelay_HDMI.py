...
<xml>
  ...
  <name>DSHal_SetandGet_AudioDelay_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set HDMI port Audio delay</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_46</test_case_id>
    <test_objective>To set HDMI port Audio delay</test_objective>
...
Checkpoint 2 Verify that the audio delay is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_AudioDelay_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_AudioDelay_HDMI');
