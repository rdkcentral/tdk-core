...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DSHal_SetFPBlink_RECORD_Indicator</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_67</test_case_id>
...
4. Initialize DSHAL subsystems</pre_requisite>
    ...
    <input_parameters>eIndicator - FP LED indicator (RECORD)
...
5.Unload the module</automation_approch>
    ...
    <test_script>DSHal_SetFPBlink_RECORD_Indicator</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_SetFPBlink_RECORD_Indicator');
