...
<xml>
  ...
  <name>DSHal_SetandGet_AudioDelayOffset_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set HDMI port Audio delay offset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_48</test_case_id>
    <test_objective>To set HDMI port Audio delay offset</test_objective>
...
Checkpoint 2 Verify that the audio delay offset is set</expected_output>
    ...
    <test_script>DSHal_SetandGet_AudioDelayOffsetOffset_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_AudioDelayOffset_HDMI');
