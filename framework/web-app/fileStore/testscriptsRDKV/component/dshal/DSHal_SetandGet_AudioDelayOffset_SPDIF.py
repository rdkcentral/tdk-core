...
<xml>
  ...
  <name>DSHal_SetandGet_AudioDelayOffset_SPDIF</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set SPDIF port Audio delay offset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_49</test_case_id>
    <test_objective>To set SPDIF port Audio delay offset</test_objective>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetandGet_AudioDelayOffset_SPDIF');
