...
<xml>
  ...
  <name>DSHal_GetHDCPCurrentProtocol_HDMI</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>DSHal_GetHDCPCurrentProtocol</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the currently used HDCP protocol version</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_40</test_case_id>
    <test_objective>To get the currently used HDCP protocol version</test_objective>
...
dsGetHDCPCurrentProtocol (int handle, dsHdcpProtocolVersion_t *protocolVersion)</api_or_interface_used>
...
2 . DSHAL agent will invoke the api dsGetHDCPCurrentProtocol to get the currently used HDCP protocol version
...
Checkpoint 2 Verify that the HDCP protocol is valid</expected_output>
    ...
    <test_script>DSHal_GetHDCPCurrentProtocol_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetHDCPCurrentProtocol_HDMI');
