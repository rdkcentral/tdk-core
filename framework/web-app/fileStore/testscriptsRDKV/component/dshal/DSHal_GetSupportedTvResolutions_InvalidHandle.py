...
<xml>
  ...
  <name>DSHal_GetSupportedTvResolutions_InvalidHandle</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if supported tv resolutions is retrieved for invalid handle</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_101</test_case_id>
    <test_objective>To check if supported tv resolutions is retrieved for invalid handle</test_objective>
...
Checkpoint 2 Verify that the resolutions is not retrieved</expected_output>
    ...
    <test_script>DSHal_GetSupportedTvResolutions_InvalidHandle</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetSupportedTvResolutions_InvalidHandle');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
    ...
    #Getting audio port handle instead of video port handle
