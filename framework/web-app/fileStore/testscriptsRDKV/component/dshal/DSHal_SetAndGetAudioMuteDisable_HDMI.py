...
<xml>
  ...
  <name>DSHal_SetAndGetAudioMuteDisable_HDMI</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set AudioMute status to false for HDMI audio port</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_42</test_case_id>
    <test_objective>To set AudioMute status to false for HDMI audio port</test_objective>
...
Checkpoint 2 Verify that the mute status is set</expected_output>
    ...
    <test_script>DSHal_SetAndGetAudioMuteDisable_HDMI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_SetAndGetAudioMuteDisable_HDMI');
