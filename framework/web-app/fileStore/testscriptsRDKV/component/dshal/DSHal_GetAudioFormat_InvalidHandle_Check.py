...
<xml>
  ...
  <name>DSHal_GetAudioFormat_InvalidHandle_Check</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to check Getaudioformat HAL api with the invalid handle.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
2. Invoke the dsGetAudioFormat api by passing an invalid handle.
3. TM checks if the dsGetAudioFormat returned a corresponding error code and return SUCCESS/FAILURE status based on that.</automation_approch>
    ...
    <test_script>DSHal_GetAudioFormat_InvalidHandle_Check</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DSHal_GetAudioFormat_InvalidHandle_Check');
...
if "SUCCESS" in dshalloadModuleStatus.upper():
    ...
    if result:
        ...
        print("Test Step: Passing invalid handle to the GetAudioFormat API");
        ...
        if expectedResult in actualResult:
            print(details);
            print("ACTUAL RESULT : dsGetAudioFormat call is failed due to invalid handle being passed");
            tdkTestObj.setResultStatus("SUCCESS");
            print("[TEST EXECUTION RESULT] : SUCCESS");
        else:
            print("Value returned : ",details);
            print("ACTUAL RESULT : dsGetAudioFormat call is success eventhough by passing an invalid handle");
