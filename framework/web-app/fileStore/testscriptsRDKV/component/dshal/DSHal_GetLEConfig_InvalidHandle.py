...
<xml>
  ...
  <name>DSHal_GetLEConfig_InvalidHandle</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>DSHal_GetLEConfig</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if LEConfig status is retrieved for invalid handle</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_DS_HAL_94</test_case_id>
    <test_objective>To check if LEConfig status is retrieved for invalid handle</test_objective>
...
Checkpoint 2 Verify that the status is not retrieved</expected_output>
    ...
    <test_script>DSHal_GetLEConfig_InvalidHandle</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
dshalObj.configureTestCase(ip,port,'DSHal_GetLEConfig_InvalidHandle');
