...
<xml>
  ...
  <name>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Unknown</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether discoverable devices are listed in the discovered devices list when the device type is Unknown</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_HAL_26</test_case_id>
    <test_objective>To check whether discoverable devices are listed in the discovered devices list when the device type is Unknown</test_objective>
...
Checkpoint 2. Verify that the bluetooth client device  is present in the discovered devices list</expected_output>
    ...
    <test_script>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Unknown</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
bluetoothhalObj.configureTestCase(ip,port,'BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_Unknown');
