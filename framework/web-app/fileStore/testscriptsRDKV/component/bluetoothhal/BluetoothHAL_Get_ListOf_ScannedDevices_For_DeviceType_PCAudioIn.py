...
<xml>
  ...
  <name>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_PCAudioIn</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether discoverable devices are listed in the discovered devices list when the device type is PCAudioIn</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
Checkpoint 2. Verify that the bluetooth client device  is present in the discovered devices list</expected_output>
    ...
    <test_script>BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_PCAudioIn</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
bluetoothhalObj.configureTestCase(ip,port,'BluetoothHAL_Get_ListOf_ScannedDevices_For_DeviceType_PCAudioIn');
