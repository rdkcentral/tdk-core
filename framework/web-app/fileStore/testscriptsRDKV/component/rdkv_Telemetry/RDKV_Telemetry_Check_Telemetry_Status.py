...
<xml>
  ...
  <name>RDKV_Telemetry_Check_Telemetry_Status</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify the telemetry2_0 process and service is running in DUT</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkv_Telemetry_01</test_case_id>
    <test_objective>To verify the telemetry2_0 process and service is running in DUT</test_objective>
    ...
    <automation_approch>1. Fetch telemetry2_0 systemd service status.
    2. Verify if telemetry2_0 process is running using pidof command</automation_approch>
    <expected_output>1. telemetry2_0 service must be running without any errors.
    2. telemetry2_0 process must be running in device.</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_Telemetry_Check_Telemetry_Status</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Telemetry_Check_Telemetry_Status');
