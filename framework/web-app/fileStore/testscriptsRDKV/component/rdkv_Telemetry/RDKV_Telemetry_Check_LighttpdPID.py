...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify the lighttpd process is running in DUT</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkv_Telemetry_02</test_case_id>
    <test_objective>To verify the lighttpd process is running in DUT</test_objective>
    ...
    <automation_approch>1. Verify if lighttpd process is running using pidof command</automation_approch>
    <expected_output>1. lighttpd process must be running in device.</expected_output>
