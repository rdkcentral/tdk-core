...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_NULL_param</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify the behavior when a NULL parameter is passed in the GetTR181Url function.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_111</test_case_id>
    <test_objective>To verify the behavior when a NULL parameter is passed in the GetTR181Url function.</test_objective>
    ...
    2. RDK_fwupgradeAgent will invoke GetTR181Url API with the NULL param being passed to pUrlOut param.
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_NULL_param</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_NULL_param');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 1);
    ...
    if result == "FAILURE" and "crash" not in details:
        print("SUCCESS : GetTR181Url failed as expected for null param")
        tdkTestObj.setResultStatus("SUCCESS")
    elif "crash" in details:
        print("FAILURE : GetTR181Url crashes when called with null param")
        tdkTestObj.setResultStatus("FAILURE")
        obj.initiateReboot();
    else:
        print("FAILURE : GetTR181Url is success for null param which is not expected")
        tdkTestObj.setResultStatus("FAILURE")
