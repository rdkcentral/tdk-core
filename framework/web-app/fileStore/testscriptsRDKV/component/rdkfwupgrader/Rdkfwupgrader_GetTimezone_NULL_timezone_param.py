...
<xml>
  ...
  <name>Rdkfwupgrader_GetTimezone_NULL_timezone_param</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To pass NULL timezone param to rdkfwupgrader API GetTimezone and verify output</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_38</test_case_id>
    <test_objective>To pass NULL timezone param to rdkfwupgrader API GetTimezone and verify output</test_objective>
    ...
    2. RDK_fwupgradeAgent will invoke GetTimezone API with the NULL param being passed to pTimezone param.
    ...
    <test_script>Rdkfwupgrader_GetTimezone_NULL_timezone_param</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTimezone_NULL_timezone_param');
...
if "SUCCESS" in result.upper():
    if True:
        ...
        if result == "FAILURE" and "crash" not in details:
            print("SUCCESS : GetTimezone failed as expected for the pointer pTimezone param as null")
            tdkTestObj.setResultStatus("SUCCESS")
        elif "crash" in details:
            print("FAILURE : GetTimezone crashes when called with pTimezone param as null")
