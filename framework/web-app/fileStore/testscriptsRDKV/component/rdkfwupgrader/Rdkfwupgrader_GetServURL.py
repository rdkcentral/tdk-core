...
<xml>
  ...
  <name>Rdkfwupgrader_GetServURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>verify output whether it got scanned properly the URL from the test file or not.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_92</test_case_id>
    <test_objective>verify output whether it got scanned properly the URL from the test file or not.</test_objective>
    ...
    3. RDK_fwupgradeAgent will invoke GetServURL API with testurl data.
    ...
    <test_script>Rdkfwupgrader_GetServURL</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetServURL');
sysUtilObj.configureTestCase(ip,port,'Rdkfwupgrader_GetServURL');
