...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eCIXconf</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type CIXconf</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_107</test_case_id>
    <test_objective>To get a URL from tr181 for the query type CIXconf</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_eCIXconf</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eCIXconf');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 4); #with eCIXconf URL type
