...
<xml>
  ...
  <name>Rdkfwupgrader_mergeLists</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To merge two metaDataList via rdkfwupgrader API mergeLists and verify output</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_21</test_case_id>
    <test_objective>To merge two metaDataList via rdkfwupgrader API mergeLists and verify output</test_objective>
    ...
    <test_script>Rdkfwupgrader_mergeLists</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_mergeLists');
...
if "SUCCESS" in result.upper():
    ...
    #list1 and list2 obtained from RdkfwupgraderTestVariables
