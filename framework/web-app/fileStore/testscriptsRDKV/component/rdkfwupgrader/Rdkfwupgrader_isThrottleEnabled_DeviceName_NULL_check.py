...
<xml>
  ...
  <name>Rdkfwupgrader_isThrottleEnabled_DeviceName_NULL_check</name>
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_135</test_case_id>
    ...
    2. RDK_fwupgradeAgent will invoke isThrottleEnabled API with the NULL param being passed to device_name param.
    ...
    <test_script>Rdkfwupgrader_isThrottleEnabled_DeviceName_NULL_check</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_isThrottleEnabled_DeviceName_NULL_check');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("devname_null_param", 1);
