...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eRecovery</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type recovery</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_103</test_case_id>
    <test_objective>To get a URL from tr181 for the query type recovery</test_objective>
    ...
    <expected_output>API must return the number of characters which copied to th buffer</expected_output>
    <priority>High</priority>
    <test_stub_interface>librdkfwupgraderstub.so.0.0.0</test_stub_interface>
    <test_script>Rdkfwupgrader_GetTR181Url_eRecovery</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eRecovery');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 0); #with eRecovery URL type
