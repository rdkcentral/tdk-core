...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_Unknown_URLType</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 and verfiy with the invalid query type</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_110</test_case_id>
    <test_objective>To get a URL from tr181 and verfiy with the invalid query type</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_Unknown_URLType</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_Unknown_URLType');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", -1); #with unknown URL type
