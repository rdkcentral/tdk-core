...
<xml>
  ...
  <name>Rdkfwupgrader_GetTR181Url_eDac15</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get a URL from tr181 for the query type Dac15</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_109</test_case_id>
    <test_objective>To get a URL from tr181 for the query type Dac15</test_objective>
    ...
    <test_script>Rdkfwupgrader_GetTR181Url_eDac15</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetTR181Url_eDac15');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("eURL_enum", 6); #with eDac15 URL type
