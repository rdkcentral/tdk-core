...
<xml>
  ...
  <name>Rdkfwupgrader_GetFileContents_NULL_filename_param</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To pass NULL filename param to rdkfwupgrader API GetFileContents and verify output</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_85</test_case_id>
    <test_objective>To pass NULL filename param to rdkfwupgrader API GetFileContents and verify output</test_objective>
    ...
    2. RDK_fwupgradeAgent will invoke GetFileContents API with the NULL param being passed to pFileName param.
    ...
    <test_script>Rdkfwupgrader_GetFileContents_NULL_filename_param</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetFileContents_NULL_filename_param');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj.addParameter("filename_null_check", 1);
