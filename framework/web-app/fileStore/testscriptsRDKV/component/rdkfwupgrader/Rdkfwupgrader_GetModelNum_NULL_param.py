...
<xml>
  ...
  <name>Rdkfwupgrader_GetModelNum_NULL_param</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify the behavior when a NULL parameter is passed in the GetModelNum function.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_65</test_case_id>
    <test_objective>To verify the behavior when a NULL parameter is passed in the GetModelNum function.</test_objective>
    ...
    2. RDK_fwupgradeAgent will invoke GetModelNum API with the NULL param being passed to pModelNum param.
    ...
    <test_script>Rdkfwupgrader_GetModelNum_NULL_param</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_GetModelNum_NULL_param');
...
if "SUCCESS" in result.upper():
    ...
    if result == "FAILURE" and "crash" not in details:
        print("SUCCESS : GetModelNum failed as expected for null param")
        tdkTestObj.setResultStatus("SUCCESS")
    elif "crash" in details:
        print("FAILURE : GetModelNum crashes when called with null param")
        tdkTestObj.setResultStatus("FAILURE")
        obj.initiateReboot();
    else:
        print("FAILURE : GetModelNum is success for null param which is not expected")
        tdkTestObj.setResultStatus("FAILURE")
