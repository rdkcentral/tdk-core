...
<xml>
  ...
  <name>Rdkfwupgrader_getJRPCTokenData</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To obtain token from testString via rdkfwupgrader API getJRPCTokenData and verify output</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKFWUPGRADE_14</test_case_id>
    <test_objective>To obtain token from testString via rdkfwupgrader API getJRPCTokenData and verify output</test_objective>
    ...
    <expected_output>API must return the token</expected_output>
    <priority>High</priority>
    <test_stub_interface>librdkfwupgraderstub.so.0.0.0</test_stub_interface>
    <test_script>Rdkfwupgrader_getJRPCTokenData</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Rdkfwupgrader_getJRPCTokenData');
