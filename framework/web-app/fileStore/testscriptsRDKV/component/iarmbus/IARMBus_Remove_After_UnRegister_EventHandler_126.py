...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>IARMBus_Remove_After_UnRegister_EventHandler_126</name>
  <primitive_test_id/>
  <primitive_test_name>IARMBUS_RemoveEventHandler</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS – IARM_Bus_RemoveEventHandler() remove a unreigstered handler shoud return INVALID_PARAM.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_126</test_case_id>
    <test_objective>IARMBUS – IARM_Bus_RemoveEventHandler() remove a unreigstered handler shoud return INVALID_PARAM.</test_objective>
...
9.TestMgr_IARMBUS_RemoveEventHandler</priority>
    <test_stub_interface>IARMBus_Remove_After_UnRegister_EventHandler_126.py</test_stub_interface>
    <test_script>IARMBus_Remove_After_UnRegister_EventHandler_126</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks>M35</remarks>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBus_Remove_After_UnRegister_EventHandler_126');
                                ...
                                if expectedresult in actualresult:
                                        ...
                                        if expectedresult in actualresult:
                                            if "INVALID_PARAM" in details.upper():
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print "SUCCESS :Event Handler not Removed  %s" %details;
                                            else:
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print "FAILURE: IARM_Bus_RemoveEventHandler failed with %s ERROR code. " %details;
                                        else:
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print "FAILURE: IARM_Bus_RemoveEventHandler success. %s" %details;
                                else:
                                        tdkTestObj.setResultStatus("FAILURE");
