...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>801</id>
  <version>1</version>
  <name>IARMBUS_IsConnected_Invalid_Membername_54</name>
  <primitive_test_id>25</primitive_test_id>
  <primitive_test_name>IARMBUS_IsConnected</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script tests Checking process registration status with invalid member name, with IARMDaemon Manager
TEST CASE ID:CT_IARMBUS_54</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_54</test_case_id>
    <test_objective>IARMBUS – Checking process registration status with invalid member name, with IARMDaemon Manager</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XI3-1 / XG1-1</test_setup>
    <pre_requisite>“IARMDaemonMain” process should be running.</pre_requisite>
    <api_or_interface_used>IARM_Bus_Init(char *) 
IARM_Bus_Connect()
IARM_Bus_IsConnected(const char *, int *)
IARM_Bus_Disconnect()
...
5.TestMgr_IARMBUS_IsConnected</test_stub_interface>
    <test_script>IARMBUS_IsConnected_Invalid_Membername_54</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                                tdkTestObj.setResultStatus("SUCCESS");
                                print "SUCCESS: IARM_Bus_Isconnected failed. %s " %details;

                        else:
                                tdkTestObj.setResultStatus("FAILURE");
                                print "FAILURE: API-Is_Connected success for invalid name";                                
