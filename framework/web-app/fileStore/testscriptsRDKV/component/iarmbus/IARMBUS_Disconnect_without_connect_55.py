...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>797</id>
  <version>1</version>
  <name>IARMBUS_Disconnect_without_connect_55</name>
  <primitive_test_id>7</primitive_test_id>
  <primitive_test_name>IARMBUS_DisConnect</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script tests Checking Iarmbus disconnect without connecting.
TEST CASE ID:	CT_IARMBUS_55</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_55</test_case_id>
    <test_objective>IARMBUS – Checking Iarmbus disconnect without connecting.</test_objective>
...
5.TestMgr_IARMBUS_IsConnected</test_stub_interface>
    <test_script>IARMBUS_Disconnect_without_connect_55</test_script>
    <skipped>No</skipped>
