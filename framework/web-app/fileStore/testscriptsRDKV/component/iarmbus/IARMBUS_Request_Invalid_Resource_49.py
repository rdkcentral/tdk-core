...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>807</id>
  <version>1</version>
  <name>IARMBUS_Request_Invalid_Resource_49</name>
  <primitive_test_id>11</primitive_test_id>
  <primitive_test_name>IARMBUS_RequestResource</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script tests Request for Invalid resource type
TEST CASE ID:CT_IARMBUS_49</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_49</test_case_id>
    <test_objective>IARMBUS -Request for Invalid resource type</test_objective>
...
IARM_BusDaemon_RequestOwnership : IARM_Bus_ResrcType_t – IARM_BUS_RESOURCE_DECODER_10
IARM_BusDaemon_ReleaseOwnership : IARM_Bus_ResrcType_t - IARM_BUS_RESOURCE_DECODER_0
...
3.IARMBUS_Agent will request for an invalid resource. 
4.IARMBUS_Agent will fails to release invalid resource 
...
6.TestMgr_IARMBUS_ReleaseResource</test_stub_interface>
    <test_script>IARMBUS_Request_Invalid_Resource_49</test_script>
    <skipped>No</skipped>
