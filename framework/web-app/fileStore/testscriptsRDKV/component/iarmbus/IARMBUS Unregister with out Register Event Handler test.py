...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>68</id>
  <version>1</version>
  <name>IARMBUS Unregister with out Register Event Handler test</name>
  ...
  <synopsis>This test script tests the failure scenario when an unregister event handler is called without registering a event handler. Test case ID:CT_IARMBUS_5</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_5</test_case_id>
    <test_objective>IARMBUS – deregister event handler without registering event handler.</test_objective>
...
4.IARMBUS_Agent deregister the event handler.
...
7.TestMgr_IARMBUS_UnRegisterEventHandler</test_stub_interface>
    <test_script>IARMBUS Unregister with out Register Event Handler test</test_script>
    <skipped>No</skipped>
