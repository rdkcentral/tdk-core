...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1338</id>
  <version>2</version>
  <name>IARM_BUS_SysMgr_Event_Card_FwDNLD_73</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_CARD_FWDNLD” event.
Test case Id - CT_IARMBUS_73</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_74</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_HDCP_PROFILE_UPDATE” event.</test_objective>
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_Card_FwDNLD_73</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_IARMBUS_73');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        #passing parameter for CARD FW download event to Receiver - Valid on Cisco CA
