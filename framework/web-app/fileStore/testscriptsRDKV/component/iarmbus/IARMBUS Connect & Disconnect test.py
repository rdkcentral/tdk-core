...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>31</id>
  <version>2</version>
  <name>IARMBUS Connect &amp; Disconnect test</name>
  <primitive_test_id>6</primitive_test_id>
  <primitive_test_name>IARMBUS_Connect</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script tests the successful joining of the Agent application with the IARM Bus.
Test Case ID : CT_IARMBUS_1</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_1</test_case_id>
    <test_objective>IARMBUS – Joining application with IARMBUS</test_objective>
...
4.TestMgr_IARMBUS_Disconnect</test_stub_interface>
    <test_script>IARMBUS Connect &amp; Disconnect test</test_script>
    <skipped>No</skipped>
