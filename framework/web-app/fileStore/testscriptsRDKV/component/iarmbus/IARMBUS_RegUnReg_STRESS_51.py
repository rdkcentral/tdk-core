...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>952</id>
  <version>1</version>
  <name>IARMBUS_RegUnReg_STRESS_51</name>
  ...
  <synopsis>This test script tests Register and deregistering event handler for every 100milli seconds for ''n''  times.
TEST CASE ID: CT_IARMBUS_51</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_51</test_case_id>
    <test_objective>IARMBUS – Register and deregistering event handler for every 100 milli seconds for multiple times.</test_objective>
...
9.Above steps 3 to 7 will repeat for  “x” number of  times and sends the result to TM.</automation_approch>
...
8.TestMgr_IARMBUS_UnRegisterEventHandler</test_stub_interface>
    <test_script>IARMBUS_RegUnReg_STRESS_51</test_script>
    <skipped>No</skipped>
