...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>75</id>
  <version>1</version>
  <name>IARMBUS Request graphics plane-1 test</name>
  <primitive_test_id>11</primitive_test_id>
  <primitive_test_name>IARMBUS_RequestResource</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script verifies the successful obtaining of graphics plane - 1 resource
Test Case ID : CT_IARMBUS_12</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_12</test_case_id>
    <test_objective>IARMBUS -Request for Graphics plane-1 resource.</test_objective>
...
IARM_BusDaemon_RequestOwnership : IARM_Bus_ResrcType_t - IARM_BUS_RESOURCE_PLANE_1
IARM_BusDaemon_ReleaseOwnership : IARM_Bus_ResrcType_t - IARM_BUS_RESOURCE_PLANE_1
...
3.IARMBUS_Agent will request for resource IARM_BUS_RESOURCE_PLANE_1.
4.IARMBUS_Agent will release resource IARM_BUS_RESOURCE_PLANE_1.
...
6.TestMgr_IARMBUS_ReleaseResource</test_stub_interface>
    <test_script>IARMBUS Request graphics plane-1 test</test_script>
    <skipped>No</skipped>
