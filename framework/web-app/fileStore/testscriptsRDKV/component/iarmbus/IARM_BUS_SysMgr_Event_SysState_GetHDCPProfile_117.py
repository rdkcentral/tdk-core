...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>IARM_BUS_SysMgr_Event_SysState_GetHDCPProfile_117</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS –Get HDCP profile using  IARM_BUS_SYSMGR_API_GetHDCPProfile RPC call.
Test case Id - CT_IARMBUS_117</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_117</test_case_id>
    <test_objective>IARMBUS – Get the HDCP profile using  IARM_BUS_SYSMGR_API_GetHDCPProfile RPC call.</test_objective>
...
Checkpoint 2. Check for the HDCP profile get value using the RPC call</except_output>
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_SysState_GetHDCPProfile_117</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARM_BUS_SysMgr_Event_SysState_GetHDCPProfile_117');
