...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_127</test_case_id>
    <test_objective>IARMBUS – IARM_Bus_RemoveEventHandler() remove a NULL event handler should fail</test_objective>
...
3.IARMBUS_Agent will broadcast the dummy event to the bus using IARM_Bus_BroadcastEvent api.
...
9.TestMgr_IARMBUS_RemoveEventHandler</priority>
    <test_stub_interface>IARMBus_Remove_NULL_EventHandler_127.py</test_stub_interface>
    <test_script>IARMBus_Remove_NULL_EventHandler_127</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks>M35</remarks>
  </test_cases>
