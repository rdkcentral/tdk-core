...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>100</id>
  <version>1</version>
  <name>IARMBUS BusCall MFR-Board Product Class test</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script queries the MFR Board Product Class
Test Case ID : CT_IARMBUS_35</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_34</test_case_id>
    <test_objective>IARMBUS – Querying board (STB) product class.</test_objective>
...
Void * - IARM_BUS_MFR_SERIALIZED_TYPE_PRODUCTCLASS,
size_t sizeof(param)
...
3.IARMBUS_Agent invokes the RPC method for querying board product class. 
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS BusCall MFR-Board Product Class test</test_script>
    <skipped>No</skipped>
