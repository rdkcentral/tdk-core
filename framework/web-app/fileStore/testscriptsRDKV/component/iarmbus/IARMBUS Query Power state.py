...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>90</id>
  <version>1</version>
  <name>IARMBUS Query Power state</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script queries the Current Power state of the STB
Test Case ID : CT_IARMBUS_26</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_25</test_case_id>
    <test_objective>IARMBUS – Querying the   Power state of STB from the process.</test_objective>
...
Checkpoint 2.Check the Power state before and after pressing the power key</except_output>
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS Query Power state</test_script>
    <skipped>No</skipped>
