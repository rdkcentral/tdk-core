...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1331</id>
  <version>1</version>
  <name>IARM_BUS_DiskMgr_Event_ExtHDD_Off_22</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type DISKMGR_EVENT_EXTHDD_OFF.
Test case Id - CT_IARMBUS_22</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_22</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type DISKMGR_EVENT_EXTHDD_OFF.</test_objective>
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_DiskMgr_Event_ExtHDD_Off_22</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #passing parameter for receiving Ext HDD event State Off for disk manager
            ...
            if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("argv1","OFF");
                expectedresult="SUCCESS"
                tdkTestObj.executeTestCase(expectedresult);
                actualresult = tdkTestObj.getResult();
