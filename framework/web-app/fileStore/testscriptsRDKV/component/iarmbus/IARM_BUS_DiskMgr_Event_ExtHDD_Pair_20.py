...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1332</id>
  <version>1</version>
  <name>IARM_BUS_DiskMgr_Event_ExtHDD_Pair_20</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type DISKMGR_EVENT_EXTHDD_PAIR.
Test case Id - CT_IARMBUS_20</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_20</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_DISKMGR_EVENT_EXTHDD” event with event type DISKMGR_EVENT_EXTHDD_PAIR.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1 / XG1-1</test_setup>
    <pre_requisite>“IARMDaemonMain” and "diskMgrMain" process should be running.</pre_requisite>
...
const char * - IARM_BUS_DISKMGR_NAME , IARM_EventId_t - IARM_BUS_DISKMGR_EVENT_EXTHDD, IARM_EventHandler_t - _evthandler
IARM_Bus_BroadcastEvent :
Const char* - IARM_BUS_DISKMGR_NAME,
IARM_EventId_t – IARM_BUS_DISKMGR_EVENT_EXTHDD ,
Void * - eventdata, size_t – sizeof (eventdata)
IARM_Bus_UnRegisterEventHandler :
const char* – IARM_BUS_DISKMGR_NAME , IARM_EventId_t – IARM_BUS_DISKMGR_EVENT_EXTHDD
...
4.IARMBUS_Agent will register for “IARM_BUS_DISKMGR_EVENT_EXTHDD” event and waits on event.
...
8.TestMgr_IARMBUS_InvokeSecondApplication</test_stub_interface>
    <test_script>IARM_BUS_DiskMgr_Event_ExtHDD_Pair_20</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #passing parameter for receiving Ext HDD event State Pairing for disk manager
            tdkTestObj.addParameter("owner_name","DISKMgr");
            ...
            if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("argv1","PAIR");
                expectedresult="SUCCESS"
                tdkTestObj.executeTestCase(expectedresult);
                actualresult = tdkTestObj.getResult();
