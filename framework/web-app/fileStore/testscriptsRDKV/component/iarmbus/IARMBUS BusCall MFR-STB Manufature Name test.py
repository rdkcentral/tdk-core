...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>96</id>
  <version>1</version>
  <name>IARMBUS BusCall MFR-STB Manufature Name test</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script queries the STB Manufacturer Name
Test Case ID :CT_IARMBUS_31</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_30</test_case_id>
    <test_objective>IARMBUS – Querying board (STB) manufacture name.</test_objective>
...
Void * - IARM_BUS_MFR_SERIALIZED_TYPE_MANUFACTURER,
size_t sizeof(param)
...
3.IARMBUS_Agent invokes the RPC method for querying board manufacture name. 
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS BusCall MFR-STB Manufature Name test</test_script>
    <skipped>No</skipped>
