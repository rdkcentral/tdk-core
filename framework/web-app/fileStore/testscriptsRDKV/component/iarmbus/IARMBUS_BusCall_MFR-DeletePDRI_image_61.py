...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1311</id>
  <version>2</version>
  <name>IARMBUS_BusCall_MFR-DeletePDRI_image_61</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS ? Deleting PDRI image from box using IARM_BUS_MFRLIB_API_DeletePDRI RPC call
Test case Id - CT_IARMBUS_61</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_61</test_case_id>
    <test_objective>IARMBUS – Deleting PDRI image from box using IARM_BUS_MFRLIB_API_DeletePDRI RPC call</test_objective>
...
3.IARMBUS_Agent invokes the RPC method for deleting PDRI image using IARM_BUS_MFRLIB_API_DeletePDRI.
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS_BusCall_MFR-DeletePDRI_image_61</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_IARMBUS_61');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        # parameter for deleting PDRI image from the box
                        tdkTestObj.addParameter("owner_name","MFRLib");
                        tdkTestObj.addParameter("method_name","mfrDeletePDRI");
                        expectedresult="SUCCESS"
                        tdkTestObj.executeTestCase(expectedresult);
                        actualresult = tdkTestObj.getResult();
                        details=tdkTestObj.getResultDetails();
                        ...
                        if expectedresult in actualresult:
                                ...
                                print "Delete PDRI image from the box:" ;
                                print details;
                        else:
