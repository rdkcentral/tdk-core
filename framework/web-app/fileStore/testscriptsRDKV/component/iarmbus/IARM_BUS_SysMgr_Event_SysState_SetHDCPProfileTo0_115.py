...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>IARM_BUS_SysMgr_Event_SysState_SetHDCPProfileTo0_115</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS – Set HDCP profile 0 using  IARM_BUS_SYSMGR_API_GetHDCPProfile RPC call.IARM_BUS_SYSMGR_API_SetHDCPProfile RPC call
Test case Id - CT_IARMBUS_115</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_115</test_case_id>
    <test_objective>IARMBUS – Set HDCP profile0 using IARM_BUS_SYSMGR_API_GetHDCPProfile RPC call and verify using IARM_BUS_SYSMGR_API_GetHDCPProfile RPC call.</test_objective>
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_SysState_SetHDCPProfileTo0_115</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARM_BUS_SysMgr_Event_SysState_SetHDCPProfileTo0_115');
