...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>77</id>
  <version>2</version>
  <name>IARMBUS Request power  test</name>
  <primitive_test_id>11</primitive_test_id>
  <primitive_test_name>IARMBUS_RequestResource</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script verifies the successful obtaining of power resource
Test Case ID : CT_IARMBUS_14</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_14</test_case_id>
    <test_objective>IARMBUS - Request for power resource.</test_objective>
...
IARM_BusDaemon_ReleaseOwnership : IARM_Bus_ResrcType_t - IARM_BUS_RESOURCE_POWER
...
3.IARMBUS_Agent will request for resource IARM_BUS_RESOURCE_POWER.
4.IARMBUS_Agent will release resource IARM_BUS_RESOURCE_POWER.
...
6.TestMgr_IARMBUS_ReleaseResource</test_stub_interface>
    <test_script>IARMBUS Request power  test</test_script>
    <skipped>No</skipped>
