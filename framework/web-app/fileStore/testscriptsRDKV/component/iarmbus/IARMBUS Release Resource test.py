...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>69</id>
  <version>1</version>
  <name>IARMBUS Release Resource test</name>
  <primitive_test_id>12</primitive_test_id>
  <primitive_test_name>IARMBUS_ReleaseResource</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script tests the successful release of an acquired resource
Test Case ID : CT_IARMBUS_6.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_6</test_case_id>
    <test_objective>IARMBUS – Releasing acquired resource by a process.</test_objective>
...
5.IARMBUS_Agent deregister the event handler.
...
8.TestMgr_IARMBUS_UnRegisterEventHandler</test_stub_interface>
    <test_script>IARMBUS Release Resource test</test_script>
    <skipped>No</skipped>
