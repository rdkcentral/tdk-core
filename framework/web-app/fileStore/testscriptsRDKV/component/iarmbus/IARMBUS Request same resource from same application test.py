...
<?xml version="1.0" encoding="UTF-8"?><xml>
 ...
 application already acquires the same resource.TestCase ID:CT_IARMBUS_8</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_8</test_case_id>
    <test_objective>IARMBUS – Requesting a resource from the application for which, the same resource  is already allocated .</test_objective>
...
6.TestMgr_IARMBUS_ReleaseResource</test_stub_interface>
    <test_script>IARMBUS Request same resource from same application test</test_script>
    <skipped>No</skipped>
