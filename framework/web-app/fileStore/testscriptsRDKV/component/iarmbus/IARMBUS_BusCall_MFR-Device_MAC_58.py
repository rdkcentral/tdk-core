...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1416</id>
  <version>2</version>
  <name>IARMBUS_BusCall_MFR-Device_MAC_58</name>
  <primitive_test_id>8</primitive_test_id>
  <primitive_test_name>IARMBUS_BusCall</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>IARMBUS ? Querying board (STB) Device MAC
Test case Id - CT_IARMBUS_58</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_58</test_case_id>
    <test_objective>IARMBUS – Querying board (STB) Device MAC</test_objective>
...
Void * - IARM_BUS_MFR_SERIALIZED_TYPE_DEVICEMAC,
Size_t sizeof(param)
...
3.IARMBUS_Agent invokes the RPC method for querying Device Mac. 
...
5.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARMBUS_BusCall_MFR-Device_MAC_58</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_IARMBUS_58');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        #parameter for getting STB Device MAC
                        tdkTestObj.addParameter("owner_name","MFRLib");
                        tdkTestObj.addParameter("mfr_param_type",10);
                        tdkTestObj.addParameter("method_name","mfrGetManufacturerData");
                        expectedresult="SUCCESS"
                        tdkTestObj.executeTestCase(expectedresult);
                        actualresult = tdkTestObj.getResult();
                        actualresult = tdkTestObj.getResult();
