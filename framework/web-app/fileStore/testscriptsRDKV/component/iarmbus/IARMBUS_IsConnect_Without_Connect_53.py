...
TEST CASE ID:CT_IARMBUS_53</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_53</test_case_id>
    <test_objective>IARMBUS – Checking process registration status without registering it with IARMDaemon Manager</test_objective>
...
3.IARMBUS_Agent checks for Registration of process with UI Manager. 
...
5.TestMgr_IARMBUS_IsConnected</test_stub_interface>
    <test_script>IARMBUS_IsConnect_Without_Connect_53</test_script>
    <skipped>No</skipped>
