...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>57</id>
  <version>1</version>
  <name>IARMBUS unregisterEvt Handler test</name>
  <primitive_test_id>23</primitive_test_id>
  <primitive_test_name>IARMBUS_UnRegisterEventHandler</primitive_test_name>
  <primitive_test_version>14</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script tests the successful de-registration of an Event handler
Test Case ID : CT_IARMBUS_4</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_4</test_case_id>
    <test_objective>IARMBUS – deregister event handler for removing listener for an event.</test_objective>
...
3.IARMBUS_Agent will register for “IARM_BUS_IRMGR_EVENT_IRKEY” event and waits on event.
...
8.TestMgr_IARMBUS_UnRegisterEventHandler</test_stub_interface>
    <test_script>IARMBUS unregisterEvt Handler test</test_script>
    <skipped>No</skipped>
