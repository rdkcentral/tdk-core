...
<xml>
  ...
  <name>IARMBUs_Multiple_Sender_Single_Receiver_Performance_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Multiple event transmitter and Single event receiver.
Contributed by TWC
Test Case ID : IARMBUS_PERF_1</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUs_Multiple_Sender_Single_Receiver_Performance_Test');
	...
	tdkTestObj = obj.createTestStep('IARMBUS_Init');
        ...
        if ("SUCCESS" in actualresult):
			...
			expectedresult="SUCCESS"
				...
				tdkTestObj.addParameter("owner_name","IRMgr");
				tdkTestObj.addParameter("event_id",0);
				tdkTestObj.addParameter("evttxappname","gen_multiple_events");
				tdkTestObj.addParameter("keyType",128);
				tdkTestObj.addParameter("keyCode",33024);
				expectedresult="SUCCESS"
                                tdkTestObj.executeTestCase(expectedresult);
                                actualresult = tdkTestObj.getResult();
                                #details=tdkTestObj.getResultDetails();
