...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>811</id>
  <version>1</version>
  <name>IARMBUS_unregisterEvtHandler_With_PosId_45</name>
  ...
  <synopsis>This test script tests Unregister event handler for removing listener for a positive event ID.
TEST CASE ID:CT_IARMBUS_45</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_45</test_case_id>
    <test_objective>IARMBUS – Unregister event handler for removing listener for a positive event ID.</test_objective>
...
8.TestMgr_IARMBUS_UnRegisterEventHandler</test_stub_interface>
    <test_script>IARMBUS_unregisterEvtHandler_With_PosId_45</test_script>
    <skipped>No</skipped>
