...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>33</id>
  <version>2</version>
  <name>IARMBUS IsConnected test</name>
  <primitive_test_id>25</primitive_test_id>
  <primitive_test_name>IARMBUS_IsConnected</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script tests the registration status of the Agent with the IARM Bus
Test Case ID :CT_IARMBUS_3</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_3</test_case_id>
    <test_objective>IARMBUS – Checking process registration status with IARMDaemon Manager</test_objective>
...
5.TestMgr_IARMBUS_IsConnected</test_stub_interface>
    <test_script>IARMBUS IsConnected test</test_script>
    <skipped>No</skipped>
