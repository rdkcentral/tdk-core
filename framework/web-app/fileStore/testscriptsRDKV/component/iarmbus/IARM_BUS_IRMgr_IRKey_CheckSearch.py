...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1605</id>
  <version>1</version>
  <name>IARM_BUS_IRMgr_IRKey_CheckSearch</name>
...
Testcase ID: CT_IARMBUS_111</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_111</test_case_id>
    <test_objective>Check if multiple IR event notification is received for repeated key press/release for Search key</test_objective>
...
5.IARMBUS_Agent will broadcast SEARCH key press and key release event 50 times to the bus.
...
8.TestMgr_IARMBUS_GetLastReceivedEventDetails</test_stub_interface>
    <test_script>IARM_BUS_IRMgr_IRKey_CheckSearch</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARM_BUS_IRMgr_IRKey_CheckSearch');
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                                ...
                                #Broadcast IR Key event SEARCH from IR Mgr
                                keyCode=0x000000CF
				keyCodeStr="SEARCH"
