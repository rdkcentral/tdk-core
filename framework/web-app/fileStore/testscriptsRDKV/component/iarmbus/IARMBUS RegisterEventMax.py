...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>92</id>
  <version>1</version>
  <name>IARMBUS RegisterEventMax</name>
  <primitive_test_id>27</primitive_test_id>
  <primitive_test_name>IARMBUS_RegisterEvent</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script registers for all possible events .
Test Case ID : CT_IARMBUS_28</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_27</test_case_id>
    <test_objective>IARMBUS – Registering all the Events before publishing and receiving events.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1 / XG1-1</test_setup>
    <pre_requisite>“IARMDaemonMain” process should be running.</pre_requisite>
    <api_or_interface_used>IARM_Bus_Init(char *)
IARM_Bus_Connect()
IARM_Bus_RegisterEvent(int )
IARM_Bus_Disconnect()
...
4.IARMBUS_Agent will register all the events ie maximum number of events that any manager can have.
...
5.TestMgr_IARMBUS_RegisterEvent</test_stub_interface>
    <test_script>IARMBUS RegisterEventMax</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if ("SUCCESS" in actualresult):
        ...
        if expectedresult in actualresult:
            ...
            #This should be called in the IARM Manager perspective like irmgr,pwrmgr.
