...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1411</id>
  <version>1</version>
  <name>IARM_BUS_SysMgr_Event_SysState_StbSerialNo_65</name>
  ...
  <status>FREE</status>
  <synopsis>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_SYSTEMSTATE” event and setting data for IARM_BUS_SYSMGR_SYSSTATE_STB_SERIAL_NO and getting back using IARM_BUS_SYSMGR_API_GetSystemStates RPC call.
Test case Id -  CT_IARMBUS_65</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_IARMBUS_65</test_case_id>
    <test_objective>IARMBUS – Broadcasting and Receiving “IARM_BUS_SYSMGR_EVENT_SYSTEMSTATE” event and setting data for IARM_BUS_SYSMGR_SYSSTATE_STB_SERIAL_NO and getting back using IARM_BUS_SYSMGR_API_GetSystemStates RPC call.</test_objective>
...
Void * - eventdata(IARM_BUS_SYSMGR_SYSSTATE_STB_SERIAL_NO), size_t – sizeof (eventdata)
...
6.TestMgr_IARMBUS_BusCall</test_stub_interface>
    <test_script>IARM_BUS_SysMgr_Event_SysState_StbSerialNo_65</test_script>
    <skipped>No</skipped>
