...
<xml>
  ...
  <name>Aamp_GetPlaybackPosition_MPD_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current playback position for MPD stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_58</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetPlaybackPosition_MPD_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetPlaybackPosition_MPD_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetPlaybackPosition_MPD_URL');
                        ...
                        if expectedResult in actualResult:
                                ...
                                if expectedResult in actualResult:
                                        ...
                                        if diff >= 5.0:
                                                #Set the result status of execution
                                                tdkTestObj.setResultStatus("SUCCESS");
                                                print "Playback position retrieved is valid for MPD stream";
                                        else:
                                                #Set the result status of execution
                                                tdkTestObj.setResultStatus("FAILURE");
                                                print "Playback position retrieved is not valid for MPD stream";
                                else:
                                        #Set the result status of execution
                                        tdkTestObj.setResultStatus("FAILURE");
                                ...
                                #Set the result status of execution
                                tdkTestObj.setResultStatus("FAILURE");
                                print "Playback position not retrieved correctly for MPD stream";
		else:
