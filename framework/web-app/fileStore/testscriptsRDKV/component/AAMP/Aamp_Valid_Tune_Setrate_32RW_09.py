...
<xml>
  ...
  <name>Aamp_Valid_Tune_Setrate_32RW_09</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tune_Setrate_32RW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_09</test_case_id>
    <test_objective>Tune_Setrate_32RW</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Valid_Tune_Setrate_32RW_09</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_32RW_09');
sysobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_32RW_09');
