...
<xml>
  ...
  <name>Aamp_Live_URL_Tune_Test_17</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if event is received for live URL tune</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_17</test_case_id>
    <test_objective>Check if event is received for live URL tune</test_objective>
...
3. TM checks if the corresponding event is received and returns SUCCESS/FAILURE
4. TM unloads the Aamp Agent and systemutil Agent.</automation_approch>
    <except_output>Checkpoint 1. Event is received for live URL tune</except_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Live_URL_Tune_Test_17</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Live_URL_Tune_Test_17');
sysObj.configureTestCase(ip,port,'Aamp_Live_URL_Tune_Test_17');
