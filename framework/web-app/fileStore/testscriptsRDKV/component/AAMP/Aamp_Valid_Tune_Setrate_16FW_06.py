...
<xml>
  ...
  <name>Aamp_Valid_Tune_Setrate_16FW_06</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tune_Setrate_16FW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_06</test_case_id>
    <test_objective>Tune_Setrate_16FW</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Valid_Tune_Setrate_16FW_06</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_16FW_06');
sysobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_16FW_06');
