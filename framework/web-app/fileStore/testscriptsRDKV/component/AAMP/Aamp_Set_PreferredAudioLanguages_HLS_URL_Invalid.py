...
<xml>
  ...
  <name>Aamp_Set_PreferredAudioLanguages_HLS_URL_Invalid</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_46</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Set_PreferredAudioLanguages_HLS_URL_Invalid</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Set_PreferredAudioLanguages_HLS_URL_Invalid');
sysObj.configureTestCase(ip,port,'Aamp_Set_PreferredAudioLanguages_HLS_URL_Invalid');
                    ...
                    if "SUCCESS" in tuneStatus:
                        ...
                        if expectedResult in actualResult and lang_list in str(details):
                            ...
                            if expectedResult in actualResult and new_lang != lang_list.split(",")[0] and new_lang == lang_list.split(",")[1]:
                                ...
                                tdkTestObj.setResultStatus("FAILURE");
                                print details;
                                print "Current Audio language is not same as second preferred language"
                                print "[TEST EXECUTION RESULT] : FAILURE\n"
                        else:
                            tdkTestObj.setResultStatus("FAILURE");
                            print details;
