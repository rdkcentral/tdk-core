...
<xml>
  ...
  <name>Aamp_Tune_Setrate_64FW_07</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Setrate_test with rate 64FW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_07</test_case_id>
    <test_objective>Test aamp setrate API</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Tune_Setrate_64FW_07</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Tune_Setrate_64FW_07');
sysobj.configureTestCase(ip,port,'Aamp_Tune_Setrate_64FW_07');
