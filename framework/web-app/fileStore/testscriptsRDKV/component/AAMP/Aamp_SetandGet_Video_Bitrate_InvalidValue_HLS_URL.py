...
<xml>
  ...
  <name>Aamp_SetandGet_Video_Bitrate_InvalidValue_HLS_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_64</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_SetandGet_Video_Bitrate_InvalidValue_HLS_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_SetandGet_Video_Bitrate_InvalidValue_HLS_URL');
sysObj.configureTestCase(ip,port,'Aamp_SetandGet_Video_Bitrate_InvalidValue_HLS_URL');
