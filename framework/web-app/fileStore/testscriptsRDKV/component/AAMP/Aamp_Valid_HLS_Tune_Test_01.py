...
<xml>
  ...
  <name>Aamp_Valid_HLS_Tune_Test_01</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Valid_HLS_Tune_Testt</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Valid_HLS_Tune_Test</test_objective>
...
6.Set the script status as per the Log comparison</automation_approch>
    <except_output>Aamp tune should be success</except_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Valid_HLS_Tune_Test_01</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Valid_HLS_Tune_Test_01');
sysobj.configureTestCase(ip,port,'Aamp_Valid_HLS_Tune_Test_01');
