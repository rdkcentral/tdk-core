...
<xml>
  ...
  <name>Aamp_IsLive_Check_Live_Stream_14</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if IsLive API returns true for a live stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_14</test_case_id>
    <test_objective>Check if IsLive API returns true for a live stream</test_objective>
...
5. TM checks if the value returned is True and returns SUCCESS/FAILURE
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_IsLive_Check_Live_Stream_14</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_IsLive_Check_Live_Stream_14');
sysObj.configureTestCase(ip,port,'Aamp_IsLive_Check_Live_Stream_14');
