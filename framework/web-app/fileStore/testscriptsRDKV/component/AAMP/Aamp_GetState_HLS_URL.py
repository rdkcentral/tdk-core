...
<xml>
  ...
  <name>Aamp_GetState_HLS_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current State value for HLS stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_55</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetState_HLS_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetState_HLS_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetState_HLS_URL');
	...
	if expectedResult in actualResult:
		...
		if expectedResult in actualResult:
			...
			print "Result :", details;
				...
				print "State retrieved is valid for HLS stream";
			else:
        		        #Set the result status of execution
                		tdkTestObj.setResultStatus("FAILURE");
				print "State not retrievd correctly for HLS stream";
		else:
