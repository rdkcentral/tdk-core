...
<xml>
  ...
  <name>Aamp_Get_Audio_Bitrates_MPD_URL</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>Aamp_AampGetAudioBitrates</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to get the available audio bitrates</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_35</test_case_id>
    <test_objective>Test Script to get the available audio bitrates</test_objective>
...
AampStop
AampGetAudioBitrates</api_or_interface_used>
...
5. TM unloads the Aamp Agent and systemutil Agent.</automation_approch>
    <expected_output>Should get the available audio bitrates</expected_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Get_Audio_Bitrates_MPD_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Get_Audio_Bitrates_MPD_URL');
sysObj.configureTestCase(ip,port,'Aamp_Get_Audio_Bitrates_MPD_URL');
