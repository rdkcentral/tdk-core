...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Aamp_Seek_ToLive_21</name>
  <primitive_test_id/>
  <primitive_test_name>Aamp_AampSeekLive</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To seek the stream to live</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_21</test_case_id>
    <test_objective>To see the stream to live</test_objective>
...
2. Parse the live stream from Aamp_Tune_Config.ini
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Seek_ToLive_21</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
aampObj.configureTestCase(ip,port,'Aamp_Seek_ToLive_21');
sysObj.configureTestCase(ip,port,'Aamp_Seek_ToLive_21');
