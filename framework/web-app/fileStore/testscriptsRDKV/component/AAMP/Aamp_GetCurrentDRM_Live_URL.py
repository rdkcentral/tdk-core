...
<xml>
  ...
  <name>Aamp_GetCurrentDRM_Live_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current DRM value for live stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_50</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetCurrentDRM_Live_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetCurrentDRM_Live_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetCurrentDRM_Live_URL');
		...
		if expectedResult in actualResult:
			...
			print "Result :", details;
	        	...
	        	if expectedResult in actualResult and details in drmNames:
        		        #Set the result status of execution
                		tdkTestObj.setResultStatus("SUCCESS");
				print "DRM retrieved is validi for Live stream";
			else:
        		        #Set the result status of execution
                		tdkTestObj.setResultStatus("FAILURE");
				print "DRM not retrievd correctly for Live stream";
		else:
