...
<xml>
  ...
  <name>Aamp_GetCurrentDRM_HLS_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current DRM value for HLS stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_52</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetCurrentDRM_HLS_URL</test_script>
    <skipped>No</skipped>
    ...
    if expectedResult in actualResult:
        ...
        if expectedResult in actualResult:
            ...
            if expectedResult in actualResult and details in drmNames:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print("DRM retrieved is valid for HLS stream");
            else:
                #Set the result status of execution
                tdkTestObj.setResultStatus("FAILURE");
                print("DRM not retrievd correctly for HLS stream");
        else:
