...
<xml>
  ...
  <name>Aamp_Get_Current_Audio_Language_18</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_18</test_case_id>
    <test_objective>Check if GetCurrentAudioLanguage API invocation is success for HLS stream</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Get_Current_Audio_Language_18</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Get_Current_Audio_Language_18');
sysObj.configureTestCase(ip,port,'Aamp_Get_Current_Audio_Language_18');
