...
<xml>
  ...
  <name>Aamp_Set_AudioTracks_HLS_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_75</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Set_AudioTracks_HLS_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Set_AudioTracks_HLS_URL');
