...
<xml>
  ...
  <name>Aamp_Get_Video_Bitrates_HLS_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_31</test_case_id>
    <test_objective>Test Script to get the available video bitrates for hls stream</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Get_Video_Bitrates_HLS_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Get_Video_Bitrates_HLS_URL');
sysObj.configureTestCase(ip,port,'Aamp_Get_Video_Bitrates_HLS_URL');
