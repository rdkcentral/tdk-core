...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Aamp_Tune_Setrate_Seek_4RW_09</name>
  <primitive_test_id/>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Tune_Setrate_Seek_4RW_09</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Tune_Setrate_Seek_4RW_09');
sysobj.configureTestCase(ip,port,'Aamp_Tune_Setrate_Seek_4RW_09');
...
if ("SUCCESS" in aamp_status.upper()) and ("SUCCESS" in sysutil_status.upper()):
	...
	if Expected_Result in result:
		...
		if Expected_Result in result:
			...
			tdkTestObj.addParameter("seconds",7.0);
		        #Execute the test case in STB
		        tdkTestObj.executeTestCase(Expected_Result);
		        #Get the result of execution
		        result = tdkTestObj.getResult();
