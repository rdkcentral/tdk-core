...
<xml>
  ...
  <name>Aamp_SetAndGet_Video_Rectangle</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_48</test_case_id>
    <test_objective>Test script to get and set video display rectangle co-ordinates</test_objective>
...
3. Aamp Agent invokes SetVideoRectangle API with valid co-ordinates
4. Checks if GetVideoRectangle API  returns the co-ordinates set and set SUCCESS/FAILURE
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetAndSet_Video_Rectangle</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_SetAndGet_Video_Rectangle');
sysObj.configureTestCase(ip,port,'Aamp_SetAndGet_Video_Rectangle');
