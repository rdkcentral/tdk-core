...
<xml>
  ...
  <name>Aamp_HLS_Tune_Stop_Test_03</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_03</test_case_id>
    <test_objective>Test Aamp stop while HLS tuning</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_HLS_Tune_Stop_Test_03</test_script>
    <skipped>No</skipped>
...
sysutil_obj = tdklib.TDKScriptingLibrary("systemutil","2.0");
...
aamp_obj.configureTestCase(ip,port,'Aamp_HLS_Tune_Stop_Test_03');
sysutil_obj.configureTestCase(ip,port,'Aamp_HLS_Tune_Stop_Test_03');

#Get the result of connection with test component and STB
aamp_status  =aamp_obj.getLoadModuleResult();
sysutil_status = sysutil_obj.getLoadModuleResult();
...
if ("SUCCESS" in aamp_status.upper()) and ("SUCCESS" in sysutil_status.upper()):
        ...
        sysutil_obj.setLoadModuleStatus("SUCCESS");
        ...
        if Expected_Result in result:
                ...
                result=aampUtilitylib.searchAampEvents(sysutil_obj, pattern);
                if Expected_Result in result:
