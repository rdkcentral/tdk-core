...
<xml>
  ...
  <name>Aamp_SetandGet_Audio_Bitrate_MPD_URL</name>
  ...
  <remarks>SetAudioBitrate API is not implemented in Aamp</remarks>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_SetandGet_Audio_Bitrate_MPD_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_SetandGet_Audio_Bitrate_MPD_URL');
sysObj.configureTestCase(ip,port,'Aamp_SetandGet_Audio_Bitrate_MPD_URL');
