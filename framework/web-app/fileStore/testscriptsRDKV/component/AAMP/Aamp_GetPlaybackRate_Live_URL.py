...
<xml>
  ...
  <name>Aamp_GetPlaybackRate_Live_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to get the current playback rate for Live stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_69</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetPlaybackRate_Live_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetPlaybackRate_Live_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetPlaybackRate_Live_URL');
			...
			if expectedResult in actualResult:
				...
				if expectedResult in actualResult:
					...
					if rate != 0 and "PLAYING" in state or rate ==0 and "PAUSED":
						#Set the result status of execution
						tdkTestObj.setResultStatus("SUCCESS");
						print "Playback rate retrieved is valid for Live stream";
					else:
						#Set the result status of execution
						tdkTestObj.setResultStatus("FAILURE");
						print "Playback rate not retrieved correctly for Live stream";
				else:
					#Set the result status of execution
	                                tdkTestObj.setResultStatus("FAILURE");
