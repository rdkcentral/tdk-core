...
<xml>
  ...
  <name>Aamp_Set_AudioTracks_MPD_URL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to set to desired audio track</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_76</test_case_id>
    <test_objective>Test script to set to desired audio track</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1V3,XI3</test_setup>
    <pre_requisite>configure Aamp_Tune_Config.ini with proper MPD tuning URL</pre_requisite>
    <api_or_interface_used>MPD URL</api_or_interface_used>
    <input_parameters>AampTune
AampStop
AampGetAvailableAudioTracks
AampGetAudioTrack
AampSetAudioTrack</input_parameters>
...
4. Aamp Agent invokes GetAudioTrack to get the current audio playing
5. Aamp Agent invokes SetAudioTrack to set to desired audio track
6. Aamp Agent invokes GetAudioTrack to verify if desired audio track is set
7. TM checks if API returns a non empty value and returns SUCCESS/FAILURE
8. TM unloads the Aamp Agent and systemutil Agent.</automation_approch>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Set_AudioTracks_MPD_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Set_AudioTracks_MPD_URL');
sysObj.configureTestCase(ip,port,'Aamp_Set_AudioTracks_MPD_URL');
