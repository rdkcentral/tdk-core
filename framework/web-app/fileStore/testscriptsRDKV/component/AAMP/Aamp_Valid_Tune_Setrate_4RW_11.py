...
<xml>
  ...
  <name>Aamp_Valid_Tune_Setrate_4RW_11</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tune_Setrate_4RW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_11</test_case_id>
    <test_objective>Tune_Setrate_4RW</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Valid_Tune_Setrate_4RW_11</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_4RW_11');
sysobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_4RW_11');
		...
		if Expected_Result in result:
			...
			tdkTestObj.addParameter("rate",-4.0);
				...
				if Expected_Result in result:
					...
					print "AampSetRate failed to Pause the stream"
