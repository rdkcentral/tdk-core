...
<xml>
  ...
  <name>Aamp_SetandGet_Video_Bitrate_HLS_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_61</test_case_id>
...
6. Aamp Agent invokes Tune API with HLS URL
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_SetandGet_Video_Bitrate_HLS_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_SetandGet_Video_Bitrate_HLS_URL');
