...
<xml>
  ...
  <name>Aamp_SetandGet_Video_Bitrate_MPD_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_59</test_case_id>
...
5. Aamp Agent invokes SetVideoBitrates API with a supported bitrates
6. Aamp Agent invokes Tune API with MPD URL
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_SetandGet_Video_Bitrate_MPD_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_SetandGet_Video_Bitrate_MPD_URL');
sysObj.configureTestCase(ip,port,'Aamp_SetandGet_Video_Bitrate_MPD_URL');
