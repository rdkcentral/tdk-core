...
<xml>
  ...
  <name>Aamp_Valid_Tune_Setrate_16RW_08</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tune_Setrate_16RW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_08</test_case_id>
    <test_objective>Tune_Setrate_16RW</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Valid_Tune_Setrate_16RW_08</test_script>
    <skipped>No</skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_16RW_08');
sysobj.configureTestCase(ip,port,'Aamp_Valid_Tune_Setrate_16RW_08');
