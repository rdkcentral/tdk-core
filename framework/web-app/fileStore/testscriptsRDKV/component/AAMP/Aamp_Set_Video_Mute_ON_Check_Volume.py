...
<xml>
  ...
  <name>Aamp_Set_Video_Mute_ON_Check_Volume</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id> </primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>Aamp_AampSetVideoMute</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>Test script to mute the video and verify the audio volume is not changed</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_49</test_case_id>
    <test_objective>Test script to mute the video and verify the audio volume is not changed</test_objective>
...
AampStop
AampGetAudioVolume
AampSetVideoMute</api_or_interface_used>
...
3. Aamp Agent invokes GetAudioVolume API
4. Aamp Agent invokes SetVideoMute API to mute the video
5. Aamp Agent invokes GetAudioVolume API
4. TM checks if audio volume before and after video mute is same or not and returns SUCCESS/FAILURE
5. TM unloads the Aamp Agent and systemutil Agent.</automation_approch>
    <expected_output>audio volume before and after video mute  should be same</expected_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_Set_Video_Mute_Check_Volume</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_Set_Video_Mute_ON_Check_Volume');
