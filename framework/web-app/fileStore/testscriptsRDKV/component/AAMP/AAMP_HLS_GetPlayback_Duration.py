...
<xml>
  ...
  <name>AAMP_HLS_GetPlayback_Duration</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get the playback duration for the HLS stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Get Playback duration for the HLS stream</test_objective>
...
7.Check if the API returned a non-zero value and set result as SUCCESS/FAILURE</automation_approch>
    <expected_output>Tune event should be received and Playback Duration must be received</expected_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_HLS_GetPlayback_Duration</test_script>
    <skipped>No</skipped>
