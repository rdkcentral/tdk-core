...
<xml>
  ...
  <name>Aamp_MPD_Stream_Tune_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check tuning for mpd stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Check tuning for mpd stream</test_objective>
...
5.Set the script status as per the Log comparison</automation_approch>
    <except_output>Tune event should be received</except_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_MPD_Stream_Tune_Test</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_MPD_Stream_Tune_Test');
sysObj.configureTestCase(ip,port,'Aamp_MPD_Stream_Tune_Test');
