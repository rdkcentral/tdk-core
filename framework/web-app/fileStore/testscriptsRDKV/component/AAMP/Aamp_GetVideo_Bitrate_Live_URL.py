...
<xml>
  ...
  <name>Aamp_GetVideo_Bitrate_Live_URL</name>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_70</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_GetVideo_Bitrate_Live_URL</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_GetVideo_Bitrate_Live_URL');
sysObj.configureTestCase(ip,port,'Aamp_GetVideo_Bitrate_Live_URL');
