...
<xml>
  ...
  <name>Aamp_MPD_Tune_Setrate_16RW</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check setrate 16RW for mpd stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_25</test_case_id>
    <test_objective>Check setrate 16RW for mpd stream</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_MPD_Tune_Setrate_16RW</test_script>
    <skipped>No</skipped>
...
aampObj.configureTestCase(ip,port,'Aamp_MPD_Tune_Setrate_16RW');
sysObj.configureTestCase(ip,port,'Aamp_MPD_Tune_Setrate_16RW');
