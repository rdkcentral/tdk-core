...
<xml>
  ...
  <test_cases>
    <test_case_id>CT_Aamp_78</test_case_id>
    ...
    <automation_approch>1.Invoke Tune API with MPD url.
...
8. Invoke Aamp Stop to exit gracefully from the player.</automation_approch>
    ...
    <test_script>Aamp_SetSlowMotionRate_Seek_MPD</test_script>
    <skipped></skipped>
...
aampobj.configureTestCase(ip,port,'Aamp_SetSlowMotionRate_Seek_MPD.py');
sysobj.configureTestCase(ip,port,'\Aamp_SetSlowMotionRate_Seek_MPD');
