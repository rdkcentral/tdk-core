...
<xml>
  ...
  <name>Aamp_InValid_URL_Tune_Test_02</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>InValid_URL_Tune_Test</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Aamp_02</test_case_id>
    <test_objective>InValid_URL_Tune_Test</test_objective>
...
6.Set the script status as per the Log comparison</automation_approch>
    <except_output>Aamp tune should be failed</except_output>
    <priority>High</priority>
    <test_stub_interface>libaampstub.so.0.0.0
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>Aamp_InValid_URL_Tune_Test_02</test_script>
    <skipped>No</skipped>
...
pattern="AAMP_EVENT_TUNE_FAILED"
...
aampobj.configureTestCase(ip,port,'Aamp_InValid_URL_Tune_Test_02');
