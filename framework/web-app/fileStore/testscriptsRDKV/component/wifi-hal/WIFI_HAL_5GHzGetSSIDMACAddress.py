...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_5GHzGetSSIDMACAddress</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_25</test_case_id>
...
7.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHzGetSSIDMACAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_5GHzGetSSIDMACAddress');
