...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_5GHzGetSSIDTrafficStats</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetSSIDTrafficStats</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the basic SSID traffic statistics info for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_18</test_case_id>
    <test_objective>To get the basic SSID traffic statistics info for 5GHz.</test_objective>
...
5.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHzGetSSIDTrafficStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_5GHzGetSSIDTrafficStats');
