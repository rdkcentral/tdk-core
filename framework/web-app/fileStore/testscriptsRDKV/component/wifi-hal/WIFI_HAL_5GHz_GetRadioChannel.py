...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_5GHz_GetRadioChannel</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the current radio channel for 5GHz</synopsis>
  <groups_id/>
...
3.Using WIFI_HAL_GetOrSetParamStringValue, invoke wifi_getRadioPossibleChannels() api and get the list of radio possible channels for radio 1.
4.Using WIFI_HAL_GetOrSetParamULongValue, invoke wifi_getRadioChannel() api and get the list of radio channels in use for radio 1
...
6.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHz_GetRadioChannel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_5GHz_GetRadioChannel');
