...
<xml>
  <id/>
  <version>7</version>
  <name>WIFI_HAL_5GHzGetRadioSupportedStandards</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke wifi_getRadioSupportedStandards() api for 5GHz and check whether it returns the radio supported standards list as ['n','ac'].</synopsis>
  <groups_id/>
...
4.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHzGetRadioSupportedStandards</test_script>
    <skipped>No</skipped>
