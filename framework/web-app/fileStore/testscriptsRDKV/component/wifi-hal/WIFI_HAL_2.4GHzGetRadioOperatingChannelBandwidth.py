...
<xml>
  <id/>
  <version>4</version>
  <name>WIFI_HAL_2.4GHzGetRadioOperatingChannelBandwidth</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_3</test_case_id>
...
2.Get the operating channel bandwidth by invoking wifi_getRadioOperatingChannelBandwidth() api.
3.If the operating channel bandwidth is within the valid range,return SUCCESS,else FAILURE.
4.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_2.4GHzGetRadioOperatingChannelBandwidth</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_2.4GHzGetRadioOperatingChannelBandwidth');
