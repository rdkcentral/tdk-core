...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_5GHzClearSSIDInfo</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_ClearSSIDInfo</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke wifi_clearSSIDInfo() api with radioIndex 1 to clear the last connected AP info from wpa_supplicant.conf</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_41</test_case_id>
    <test_objective>To invoke wifi_clearSSIDInfo() api with radioIndex 1 to clear the last connected AP info from wpa_supplicant.conf</test_objective>
...
6.Unload the module.</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHzClearSSIDInfo</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_5GHzClearSSIDInfo');
