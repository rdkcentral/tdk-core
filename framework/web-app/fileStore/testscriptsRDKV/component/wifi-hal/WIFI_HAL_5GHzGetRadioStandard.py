...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_5GHzGetRadioStandard</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetOrSetRadioStandard</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the radio standard and see if the output is among the supported standard list for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_32</test_case_id>
    <test_objective>To get the radio standard for 5GHz and check if the values are present in supported radio standards</test_objective>
...
7.Unload the module,</automation_approch>
    ...
    <test_script>WIFI_HAL_5GHzGetRadioStandard</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_5GHzGetRadioStandard');
