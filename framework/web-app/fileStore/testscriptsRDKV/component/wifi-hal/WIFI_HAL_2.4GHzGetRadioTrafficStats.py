...
<xml>
  <id/>
  <version>1</version>
  <name>WIFI_HAL_2.4GHzGetRadioTrafficStats</name>
  <primitive_test_id/>
  <primitive_test_name>WIFI_HAL_GetRadioTrafficStats</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get detailed radio traffic statistics information for 2.4GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFI_HAL_19</test_case_id>
    <test_objective>To get detailed radio traffic statistics information for 2.4GHz</test_objective>
...
5.Unload the module.</automation_approch>
    <except_output>Get detailed radio traffic statistics information for 2.4GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFI_HAL</test_stub_interface>
    <test_script>WIFI_HAL_2.4GHzGetRadioTrafficStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'WIFI_HAL_2.4GHzGetRadioTrafficStats');
