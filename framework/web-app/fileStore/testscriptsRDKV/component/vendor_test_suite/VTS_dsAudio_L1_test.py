...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsAudio L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_04</test_case_id>
    <test_objective>Execute VTS dsAudio L1 testcases</test_objective>
    ...
    <input_parameters>dsAudio config yaml</input_parameters>
    ...
    <test_script>VTS_dsAudio_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsAudio_L1_test');
