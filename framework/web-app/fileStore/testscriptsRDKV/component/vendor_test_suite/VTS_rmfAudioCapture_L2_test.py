...
<xml>
  ...
  <name>VTS_rmfAudioCapture_L2_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS rmfAudioCapture L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_10</test_case_id>
    <test_objective>Execute VTS rmfAudioCapture L2 testcases</test_objective>
    ...
    <input_parameters>rmfAudioCapture config yaml</input_parameters>
    ...
    <test_script>VTS_rmfAudioCapture_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_rmfAudioCapture_L2_test');
...
if "SUCCESS" in result.upper():
    ...
    #Set module
    module = "L2 rmfAudioCapture"
    #Set binary name
    binaryName = rmfAudioCapture_binaryName
    #Set Custom List of TestCases
    testCaseList = rmfAudioCapture_L2_List
    #Set basepath of test
    basePath = VTS_Binary_basePath + rmfAudioCapture_basePath
