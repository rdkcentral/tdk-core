...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS HDMICEC L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_11</test_case_id>
    <test_objective>Execute VTS HDMICEC L1 testcases</test_objective>
    ...
    <test_script>VTS_HDMICEC_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_HDMICEC_L1_test');
