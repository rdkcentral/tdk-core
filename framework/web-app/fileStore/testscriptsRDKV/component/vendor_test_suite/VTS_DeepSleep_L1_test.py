...
<xml>
  ...
  <name>VTS_DeepSleep_L1_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS DeepSleep L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_15</test_case_id>
    <test_objective>Execute VTS DeepSleep L1 testcases</test_objective>
    ...
    <input_parameters>DeepSleep config yaml</input_parameters>
    ...
    <test_script>VTS_DeepSleep_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_DeepSleep_L1_test');
...
if "SUCCESS" in result.upper():
    ...
    try:
        if testList:
            ...
            executionSummary = runTest(binaryPath, module, plugin_name, testList, testCaseList, DeepSleep_L1_SkipTestCaseList)
