...
<xml>
  ...
  <name>VTS_dsDisplay_L2_test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsDisplay L2 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_18</test_case_id>
    <test_objective>Execute VTS dsDisplay L2 testcases</test_objective>
    ...
    <input_parameters>dsDisplay config yaml</input_parameters>
    ...
    <test_script>VTS_dsDisplay_L2_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsDisplay_L2_test');
