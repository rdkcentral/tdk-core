...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute VTS dsHost L1 testcases</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>VTS_Test_03</test_case_id>
    <test_objective>Execute VTS dsHost L1 testcases</test_objective>
    ...
    <input_parameters>dsHost config yaml</input_parameters>
    ...
    <test_script>VTS_dsHost_L1_test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'VTS_dsHost_L1_test');
...
if "SUCCESS" in result.upper():
    ...
    for module in modules:
        if module == "L1 dsHost":
            testCaseList = Host_L1_List
            plugin_name = "dsHost L1"
            testCaseID = plugin_name
        else:
            testCaseList = Host_L1_advanced_List
            plugin_name = "dsHost L1 -- advanced"
            testCaseID = plugin_name
