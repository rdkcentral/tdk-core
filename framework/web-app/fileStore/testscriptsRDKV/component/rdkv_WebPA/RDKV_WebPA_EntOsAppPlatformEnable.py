...
<xml>
  ...
  <name>RDKV_WebPA_EntOsAppPlatformEnable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the distributed platform enable flag for EntOsAppPlatform using the WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_16</test_case_id>
    <test_objective>To validate the distributed platform enable flag for EntOsAppPlatform using the WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.EntOsAppPlatform.EnableDistPlatform will fetch the WebPA server url from the device.
...
2.RFC parameter should return distributed platform enable flag for EntOsAppPlatform</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_EntOsAppPlatformEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_EntOsAppPlatformEnable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.EntOsAppPlatform.EnableDistPlatform"
    testValue = "1"
