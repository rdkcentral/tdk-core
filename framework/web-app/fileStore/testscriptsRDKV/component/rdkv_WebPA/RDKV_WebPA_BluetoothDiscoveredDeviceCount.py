...
<xml>
  ...
  <name>RDKV_WebPA_BluetoothDiscoveredDeviceCount</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the number of discovered Bluetooth devices using the WebPA interface</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_28</test_case_id>
    <test_objective>To validate the number of discovered Bluetooth devices using the WebPA interface</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_xBlueTooth.DiscoveredDeviceCnt will fetch the WebPA server url from the device.
...
2. API must return the number of Bluetooth devices discovered</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_BluetoothDiscoveredDeviceCount</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_BluetoothDiscoveredDeviceCount')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_xBlueTooth.DiscoveredDeviceCnt"
