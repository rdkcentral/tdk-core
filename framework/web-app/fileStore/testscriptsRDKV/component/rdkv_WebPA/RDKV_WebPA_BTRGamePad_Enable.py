...
<xml>
  ...
  <name>RDKV_WebPA_BTRGamePad_Enable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to validate the BTRGamePad is enabled or not</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_BTRGamePad_Enable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BTR.GamePad.Enable"
    testValue = "1"
