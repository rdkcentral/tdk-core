...
<xml>
  ...
  <test_cases>
    ...
    <automation_approch>1. Device.DeviceInfo.Migration.MigrationStatus will fetch the WebPA server url from the device.
...
2.API via Webpa server should return and set the Migration status</expected_output>
