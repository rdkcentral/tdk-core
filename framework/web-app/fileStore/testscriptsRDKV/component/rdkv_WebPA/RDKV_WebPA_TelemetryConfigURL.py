...
<xml>
  ...
  <name>RDKV_WebPA_TelemetryConfigURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to verify the Telemetry URL is configured or not using the WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_17</test_case_id>
    <test_objective>Test to verify the Telemetry URL is configured or not using the WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.ConfigURL will fetch the WebPA server url from the device.
...
2.API via Webpa server should return the Temetry URL</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_TelemetryConfigURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_TelemetryConfigURL')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.ConfigURL"
    testValue = "1"
