...
<xml>
  ...
  <name>RDKV_WebPA_StandbyReboot_Enable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to validate the StandbyReboot parameter enabled or not using WebPA server</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>rdkvWebPA_05</test_case_id>
    <test_objective>Test to validate the StandbyReboot parameter enabled or not using WebPA server</test_objective>
    ...
    <automation_approch>1. Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.StandbyReboot.Enable will fetch the WebPA server url from the device.
...
3. TM will return SUCCESS or FAILURE based on the result from the above step.</automation_approch>
    <expected_output>Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.StandbyReboot.Enable
2.API should return StandbyReboot fetaure is enabled or not</expected_output>
    <priority>High</priority>
    <test_stub_interface></test_stub_interface>
    <test_script>RDKV_WebPA_StandbyReboot_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebPA_StandbyReboot_Enable')
...
if "SUCCESS" in result.upper():
    ...
    paramName = "Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.StandbyReboot.Enable"
    testValue = "1"
