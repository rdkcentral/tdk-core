...
6. Check that the cobalt application successfully launches after the device is rebooted while cobalt is in a hibernated state</automation_approch>
...
6. After a device reboot, the cobalt app should successfully launch even if it was in a hibernated state before the reboot</expected_output>
