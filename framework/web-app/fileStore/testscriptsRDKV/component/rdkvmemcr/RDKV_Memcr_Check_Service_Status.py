...
<xml>
  ...
  <name>RDKV_Memcr_Check_Service_Status</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_01</test_case_id>
    <test_objective>Check whether the memcr service is running or not</test_objective>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Check_Service_Status');
