...
<xml>
  ...
  <test_cases>
    ...
    <automation_approch>1. Retrieve the AppHibernate RFC parameter from the device configuration 2. Check the status of the Memcr service 3. Check the status of the cobalt app: if it is hibernated, restore it; if it is suspended, launch it; if it is already running, take no action 4. If it is not running at all, proceed to launch the app 5. Suspend the cobalt app and verify the application's state 6. Restore the cobalt app and verify the application's state 7. Hibernate the cobalt app and verify the application's state</automation_approch>
