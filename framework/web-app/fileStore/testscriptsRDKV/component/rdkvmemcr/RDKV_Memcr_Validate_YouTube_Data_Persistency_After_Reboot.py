...
<xml>
  ...
  <test_cases>
    ...
    <api_or_interface_used>org.rdk.RDKShell.1.getClients,org.rdk.RDKShell.1.getState,org.rdk.RDKShell.1.restore,org.rdk.RDKShell.1.kill,org.rdk.RDKShell.1.launch,org.rdk.RDKShell.1.generateKey,org.rdk.System.1.reboot</api_or_interface_used>
    <input_parameters>1. MEMCR_APPHIBERNATE_PARAMETER 2. MEMCR_COMPRESSED_APP_IMAGE_FILEPATH</input_parameters>
    <automation_approch>1. Retrieve the AppHibernate RFC parameter from the device configuration 2. Check the status of the Memcr service 3.Verify if the cobalt app is running if it is, terminate it 4. Launch the cobalt again 5. Check if the cobalt app enters a hibernated state by using the Home keycode(36), without relying on the suspend API 6. After the reboot, check that the app is no longer in the hibernated state and that it does not persist</automation_approch>
