...
<xml>
  ...
  <name>RDKV_Memcr_Verify_YouTubeTV_AppRestore_After_Hibernate_StandbyMode_WakeUp</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_24</test_case_id>
...
6. Check that the YouTube TV application successfully restores its functionality after being hibernated, placed in standby mode, and subsequently woken up</automation_approch>
...
6. The YouTube TV application should successfully restore its functionality after being hibernated, placed in standby mode, and subsequently woken up</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_Verify_YouTubeTV_AppRestore_After_Hibernate_StandbyMode_WakeUp</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Verify_YouTubeTV_AppRestore_After_Hibernate_StandbyMode_WakeUp');
