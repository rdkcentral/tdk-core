...
<xml>
  ...
  <name>RDKV_Memcr_Validate_YouTubeTV_Hibernate_API_Error_Without_App_Launch_Test</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_23</test_case_id>
    <test_objective>To ensure a validation error occurs when attempting a hibernate call without launching the app</test_objective>
...
3. If the YouTube TV app is hibernated, it should be restored and launched; if suspended, it should be launched; if already running, no action should be taken
4. Triggering the hibernate API without launching the YouTube TV app should result in appropriate error handling</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_Validate_YouTubeTV_Hibernate_API_Error_Without_App_Launch_Test</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Validate_YouTubeTV_Hibernate_API_Error_Without_App_Launch_Test');
