...
6. Check that the cobalt application successfully restores its functionality after being hibernated, placed in standby mode, and subsequently woken up</automation_approch>
...
6. The cobalt application should successfully restore its functionality after being hibernated, placed in standby mode, and subsequently woken up</expected_output>
