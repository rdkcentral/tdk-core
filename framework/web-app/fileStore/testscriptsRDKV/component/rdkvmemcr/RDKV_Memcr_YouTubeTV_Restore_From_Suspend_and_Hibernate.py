...
<xml>
  ...
  <name>RDKV_Memcr_YouTubeTV_Restore_From_Suspend_and_Hibernate</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_17</test_case_id>
    <test_objective>Restore the application state from various conditions, such as suspended and hibernated states</test_objective>
...
5. Suspend the YouTube TV app and verify the application's state
6. Restore the YouTube TV app and verify the application's state
7. Hibernate the YouTube TV app and verify the application's state</automation_approch>
...
5. When the YouTube TV app is suspended, its state should reflect hibernated as expected
6. After restoring the YouTube TV app, its state should reflect suspended as expected
7. When the YouTube TV app is hibernated, its state should reflect hibernated as expected</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_YouTubeTV_Restore_From_Suspend_and_Hibernate</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_YouTubeTV_Restore_From_Suspend_and_Hibernate');
