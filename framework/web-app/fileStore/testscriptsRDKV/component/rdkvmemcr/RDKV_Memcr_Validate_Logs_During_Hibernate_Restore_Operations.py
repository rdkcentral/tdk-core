...
<xml>
  ...
  <name>RDKV_Memcr_Validate_Logs_During_Hibernate_Restore_Operations</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_13</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Validate_Logs_During_Hibernate_Restore_Operations');
