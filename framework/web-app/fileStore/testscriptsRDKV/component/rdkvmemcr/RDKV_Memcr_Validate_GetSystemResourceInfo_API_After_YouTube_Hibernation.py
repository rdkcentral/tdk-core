...
<xml>
  ...
  <name>RDKV_Memcr_Validate_GetSystemResourceInfo_API_After_YouTube_Hibernation</name>
  ...
  <test_cases>
    <test_case_id>rdkvmemcr_10</test_case_id>
...
5. Check that the getSystemResourceInfo API returns resource information about the app
6. Suspend the app and verify that the getSystemResourceInfo API does not return resource information about the app while it is in hibernated state</automation_approch>
...
6. While the cobalt app is in a hibernated state, the getSystemResourceInfo API should not return resource details for the app</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>Nil</test_stub_interface>
    <test_script>RDKV_Memcr_Validate_GetSystemResourceInfo_API_After_YouTube_Hibernation</test_script>
    <skipped>Nil</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Memcr_Validate_GetSystemResourceInfo_API_After_YouTube_Hibernation');
