...
<xml>
  ...
  <name>FOG_Tune_SetRate_64RW_32FW</name>
  ...
  <test_cases>
    <test_case_id>TC_FOG_10</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Tune_SetRate_64RW_32FW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Tune_SetRate_64RW_32FW');
aampObj.configureTestCase(ip,port,'FOG_Tune_SetRate_64RW_32FW');
