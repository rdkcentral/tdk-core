...
<xml>
  ...
  <name>FOG_Tune_SetRate_Pause</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>check if event is received for setrate for pause</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_15</test_case_id>
    <test_objective>check if event is received for setrate for pause</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Tune_SetRate_Pause</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Tune_SetRate_Pause');
aampObj.configureTestCase(ip,port,'FOG_Tune_SetRate_Pause');
