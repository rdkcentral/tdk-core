...
<xml>
  ...
  <name>FOG_Check_Seek_to_Live</name>
  ...
  <test_cases>
    <test_case_id>TC_FOG_34</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Check_Seek_to_Live</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Check_Seek_to_Live');
aampObj.configureTestCase(ip,port,'FOG_Check_Seek_to_Live');
