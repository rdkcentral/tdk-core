...
<xml>
  ...
  <name>FOG_Tune_SetRate_32FW</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>check if setrate fails for FF without doing RW</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_08</test_case_id>
    <test_objective>check if setrate fails for FF without doing RW</test_objective>
...
4. Aamp Agent invokes SetRate API with value 32
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Tune_SetRate_32FW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Tune_SetRate_32FW');
aampObj.configureTestCase(ip,port,'FOG_Tune_SetRate_32FW');
