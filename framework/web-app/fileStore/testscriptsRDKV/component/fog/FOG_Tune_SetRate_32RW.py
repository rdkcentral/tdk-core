...
<xml>
  ...
  <name>FOG_Tune_SetRate_32RW</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>check if event is received for setrate value -32</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_07</test_case_id>
    <test_objective>check if event is received for setrate value -32</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Tune_SetRate_32RW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Tune_SetRate_32RW');
aampObj.configureTestCase(ip,port,'FOG_Tune_SetRate_32RW');
