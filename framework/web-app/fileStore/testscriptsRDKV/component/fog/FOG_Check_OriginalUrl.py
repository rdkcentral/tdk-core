...
<xml>
  ...
  <name>FOG_Check_OriginalUrl</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if the OriginalUrl in the recording details is correct</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Check if the OriginalUrl in the recording details is correct</test_objective>
...
Initialize devicesettings manager.</pre_requisite>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Check_OriginalUrl</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Check_OriginalUrl');
aampObj.configureTestCase(ip,port,'FOG_Check_OriginalUrl');
