...
<xml>
  ...
  <name>FOG_Check_PlaybackUrl</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if the PlaybackUrl in the recording details is correct</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_05</test_case_id>
    <test_objective>Check if the PlaybackUrl in the recording details is correct</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Check_PlaybackUrl</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Check_PlaybackUrl');
aampObj.configureTestCase(ip,port,'FOG_Check_PlaybackUrl');
