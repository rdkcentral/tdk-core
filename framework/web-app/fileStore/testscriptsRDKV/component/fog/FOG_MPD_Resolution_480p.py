...
<xml>
  ...
  <name>FOG_MPD_Resolution_480p</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate resolution in FOG with respect to set resolution to 480p</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_29</test_case_id>
    <test_objective>Validate resolution in FOG with respect to set resolution to 480p</test_objective>
...
Initialize devicesetting manager
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_MPD_Resolution_480p</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FOG_MPD_Resolution_480p');
...
if resolution_set == "True":
        ...
        sysObj.configureTestCase(ip,port,'FOG_MPD_Resolution_480p');
        aampObj.configureTestCase(ip,port,'FOG_MPD_Resolution_480p');
