...
<xml>
  ...
  <name>FOG_MPD_Check_TSB_Deleted_After_Stop</name>
  ...
  <test_cases>
    <test_case_id>TC_FOG_36</test_case_id>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_MPD_Check_TSB_Deleted_After_Stop</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_MPD_Check_TSB_Deleted_After_Stop');
aampObj.configureTestCase(ip,port,'FOG_MPD_Check_TSB_Deleted_After_Stop');
