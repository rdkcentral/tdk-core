...
<xml>
  ...
  <name>FOG_Check_TSBSize_Increasing</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if data size is growing inside tsb location</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_02</test_case_id>
    <test_objective>Check if data size is growing inside tsb location</test_objective>
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Check_TSBSIzeIncreasing</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Check_TSBSize_Increasing');
aampObj.configureTestCase(ip,port,'FOG_Check_TSBSize_Increasing');
