...
<xml>
  ...
  <name>FOG_MPD_Check_TSBSize_Increasing</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if data size is growing inside tsb location for fog mpd stream</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_24</test_case_id>
    <test_objective>Check if data size is growing inside tsb location for fog mpd stream</test_objective>
...
6. TM checks if the data size is increasing inside tsb location and returns SUCCESS/FAILURE 
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_MPD_Check_TSBSize_Increasing</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_MPD_Check_TSBSize_Increasing');
aampObj.configureTestCase(ip,port,'FOG_MPD_Check_TSBSize_Increasing');
