...
<xml>
  ...
  <name>FOG_Tune_SetRate_16RW</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>check if event is received for setrate value -16</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_FOG_06</test_case_id>
    <test_objective>check if event is received for setrate value -16</test_objective>
...
4. Aamp Agent invokes SetRate API with value -16
...
libsystemutilstub.so.0.0.0</test_stub_interface>
    <test_script>FOG_Tune_SetRate_16RW</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'FOG_Tune_SetRate_16RW');
aampObj.configureTestCase(ip,port,'FOG_Tune_SetRate_16RW');
