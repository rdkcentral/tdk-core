...
<xml>
  ...
  <name>RDKV_RFC_TelemetryEndpoint_Enable</name>
  ...
  <test_cases>
    <test_case_id>rdkvxconfrfc_15</test_case_id>
    <test_objective>Verify whether the given xconf server setting for Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.TelemetryEndpoint.Enable is reflected in the box</test_objective>
    ...
    <test_script>RDKV_RFC_TelemetryEndpoint_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_TelemetryEndpoint_Enable');
...
if "SUCCESS" in result.upper():
    ...
    if expectedResult in actualresult.upper():
        ...
        if expectedResult in actualresult.upper():
            ...
            rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.TelemetryEndpoint.Enable"
            ...
            if "true" in actualvalue or "false" in actualvalue or len(actualvalue)==0:
                ...
                feature_name="TelemetryEndpoint.Enable"
