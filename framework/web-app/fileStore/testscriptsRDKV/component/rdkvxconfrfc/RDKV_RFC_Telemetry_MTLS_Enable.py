...
<xml>
  ...
  <name>RDKV_RFC_Telemetry_MTLS_Enable</name>
  ...
  <test_cases>
    <test_case_id>rdkvxconfrfc_16</test_case_id>
    <test_objective>Verify whether the given xconf server setting for Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.MTLS.Enable is reflected in the box</test_objective>
...
5: Telemetry.MTLS.Enable RFC parameter value should be checked and noted before making changes
...
10: Confirm that the value set for the Telemetry.MTLS.Enable RFC parameter on the Xconf server is correctly applied and reflected in the device
11: Telemetry.MTLS.Enable RFC parameter value must be reverted to its original state
12: Feature and its corresponding rule must be deleted from the Xconf server</expected_output>
    ...
    <test_script>RDKV_RFC_Telemetry_MTLS_Enable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_Telemetry_MTLS_Enable');
        ...
        if "FAILURE" not in detail:
            ...
            if "FAILURE" not in detail:
                ...
                if "FAILURE" not in detail:
                    ...
                    rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.MTLS.Enable"
                    ...
                    if "true" in actualvalue or "false" in actualvalue or len(actualvalue)==0:
                        ...
                        feature_name="Telemetry.MTLS.Enable"
