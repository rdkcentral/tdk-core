...
<xml>
  ...
  <name>RDKV_RFC_XDial_FriendlyNameEnable</name>
  ...
  <test_cases>
    <test_case_id>rdkvxconfrfc_09</test_case_id>
    <test_objective>Verify whether the given xconf server setting for Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.FriendlyNameEnable is reflected in the box</test_objective>
    ...
    <test_script>RDKV_RFC_XDial_FriendlyNameEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_XDial_FriendlyNameEnable');
...
if "SUCCESS" in result.upper():
    ...
    if expectedResult in actualresult.upper():
        ...
        if expectedResult in actualresult.upper():
            ...
            rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.FriendlyNameEnable"
