...
<xml>
  ...
  <name>RDKV_RFC_XDial_WolWakeEnable</name>
  ...
  <test_cases>
    <test_case_id>rdkvxconfrfc_10</test_case_id>
    <test_objective>Verify whether the given xconf server setting for Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.WolWakeEnable is reflected in the box</test_objective>
    ...
    <test_script>RDKV_RFC_XDial_WolWakeEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_RFC_XDial_WolWakeEnable');
...
if "SUCCESS" in result.upper():
    ...
    if expectedResult in actualresult.upper():
        ...
        if expectedResult in actualresult.upper():
            ...
            rfcparameter="Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.WolWakeEnable"
            ...
            if "true" in actualvalue or "false" in actualvalue or len(actualvalue)==0:
                ...
                feature_name="XDial.WolWakeEnable"
