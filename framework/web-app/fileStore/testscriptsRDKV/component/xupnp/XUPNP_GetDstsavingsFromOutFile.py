...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>XUPNP_GetDstsavingsFromOutFile</name>
  <primitive_test_id/>
...
Testcase ID: CT_XUPNP_57</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_57</test_case_id>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetDstsavingsFromOutFile</test_script>
    <skipped>No</skipped>
...
xUpnpObj.configureTestCase(ip,port,'XUPNP_GetDstsavingsFromOutFile');
