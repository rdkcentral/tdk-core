...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>XUPNP_BcastControllerIDEvt</name>
  <primitive_test_id/>
...
Testcase ID: CT_XUPNP_36</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_36</test_case_id>
    <test_objective>To broadcast ControllerID event and check if xcal-device process receives it.</test_objective>
...
9. IARMBUS_Agent deregisters from the IARM Bus Daemon.</automation_approch>
    ...
    <test_script>XUPNP_BcastControllerIDEvt</test_script>
    <skipped>No</skipped>
