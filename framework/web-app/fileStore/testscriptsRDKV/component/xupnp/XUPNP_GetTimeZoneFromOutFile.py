...
Testcase ID: CT_XUPNP_18</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_18</test_case_id>
    <test_objective>To get timezone value from xdiscovery output file.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetTimeZoneFromOutFile</test_script>
    <skipped>No</skipped>
