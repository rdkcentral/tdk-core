...
Testcase ID: CT_XUPNP_06</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_06</test_case_id>
    <test_objective>To get build version value from xdiscovery output file.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetBuildVersionFromOutFile</test_script>
    <skipped>No</skipped>
