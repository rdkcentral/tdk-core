...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>XUPNP_GetSystemIdsFromOutFile</name>
  <primitive_test_id/>
  <primitive_test_name>XUPNP_ReadXDiscOutputFile</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get systemIds value from xdiscovery output file.
Testcase ID: CT_XUPNP_17</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_17</test_case_id>
    <test_objective>To get systemIds value from xdiscovery output file.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetSystemIdsFromOutFile</test_script>
    <skipped>No</skipped>
