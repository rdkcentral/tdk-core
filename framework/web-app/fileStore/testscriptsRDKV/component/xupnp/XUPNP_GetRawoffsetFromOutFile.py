...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>XUPNP_GetRawoffsetFromOutFile</name>
  <primitive_test_id/>
  <primitive_test_name>XUPNP_ReadXDiscOutputFile</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the raw offset value from xdiscovery output file.
Testcase ID: CT_XUPNP_51</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_XUPNP_51</test_case_id>
    <test_objective>To get the raw offset value from xdiscovery output file.
</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>XUPNP_GetRawoffsetFromOutFile</test_script>
    <skipped>No</skipped>
...
xUpnpObj.configureTestCase(ip,port,'XUPNP_GetRawoffsetFromOutFile');
