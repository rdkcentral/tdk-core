...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_WebAudio_GetStreamInfo_MP3</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the webaudio can decode the MP3 stream and get the details like codec, channels, duration etc.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_10</test_case_id>
    <test_objective>To check if the webaudio can decode the MP3 stream and get the details like codec, channels, duration etc.</test_objective>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to decode the MP3 stream and give the stream details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_CERT_WebAudio_GetStreamInfo_MP3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_WebAudio_GetStreamInfo_MP3');
...
if expectedResult in result.upper():
    ...
    tdkTestObj.addParameter("VariableList","browser_instance,webinspect_port,chromedriver_path,log_check_method,mp3_audio_url,mp3_stream_info")
