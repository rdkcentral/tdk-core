...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_AudioParam</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the AudioParam details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_26</test_case_id>
    <test_objective>To get the AudioParam details from the device browser</test_objective>
...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audioparam-exponentialRampToValueAtTime-nocontext-crash.html,audioparam-exponentialRampToValueAtTime.html,webaudio/audioparam-connect-audioratesignal.html,audioparam-obsolete-api.html,audioparam-setValueAtTime.html,audioparam-summingjunction.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should be able to get the AudioParam details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_WebAudio_AudioParam</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_AudioParam');
...
webaudio_test_url = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-exponentialRampToValueAtTime-nocontext-crash.html'
webaudio_test_url2 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-exponentialRampToValueAtTime.html'
webaudio_test_url3 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-connect-audioratesignal.html'
webaudio_test_url4 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-obsolete-api.html'
webaudio_test_url5 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-setValueAtTime.html'
webaudio_test_url6 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/audioparam-summingjunction.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            files_info = [
                {"tail_num": 1,"url": webaudio_test_url},
                ...
                {"tail_num": 3,"url": webaudio_test_url6}
            ]
