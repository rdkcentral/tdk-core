...
stream_url= WebAudioVariables.webm_opus_audio_url
...
if expectedResult in result.upper():
    ...
    tdkTestObj.addParameter("VariableList","browser_instance,webinspect_port,chromedriver_path,log_check_method,webm_opus_audio_url")
