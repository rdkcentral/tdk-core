...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>RDKV_CERT_WebAudio_AudioPlayback_MP3</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To test if the MP3 audio playback is working fine in device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To test if the MP3 audio playback is working fine in device browser</test_objective>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_CERT_WebAudio_AudioPlayback_MP3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_WebAudio_AudioPlayback_MP3');
