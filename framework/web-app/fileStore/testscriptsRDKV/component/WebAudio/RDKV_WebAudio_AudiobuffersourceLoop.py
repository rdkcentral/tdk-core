...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To verify that the audiobuffersource loop details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To ensure that the audiobuffersource loop details from the device browser</test_objective>
...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>audiobuffersource-loop-comprehensive.html, audiobuffersource-loop-grain-no-duration.html, audiobuffersource-loop-points.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should correctly apply the audiobuffersource loop details</expected_output>
...
webaudio_test_url3 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/AudioBufferSource/audiobuffersource-loop-points.html'
