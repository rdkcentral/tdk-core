...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_WebAudio_WebAudioSupport</name>
  <primitive_test_id/>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    ...
    <test_script>RDKV_CERT_WebAudio_WebAudioSupport</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_WebAudio_CheckWebAudioSupportTest');
...
webaudio_test_url = obj.url+"/fileStore/lightning-apps/webaudio/CheckWebAudioSupport.html"
