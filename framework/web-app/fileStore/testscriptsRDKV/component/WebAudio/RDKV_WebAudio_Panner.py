...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>panner-cone-gain-nan.html</input_parameters>
...
webaudio_test_url3 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/panner-equalpower.html'
webaudio_test_url4 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/panner-equalpower-stereo.html'
webaudio_test_url5 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/pannernode-basic.html'
webaudio_test_url6 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/panner-node-exceptions.html'
