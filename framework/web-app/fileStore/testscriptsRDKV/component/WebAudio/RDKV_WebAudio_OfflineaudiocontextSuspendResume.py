...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_WebAudio_OfflineaudiocontextSuspendResume</name>
  <primitive_test_id/>
  <primitive_test_name>webaudio_prerequisite</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify that the offlineaudiocontext suspend resume details from the device browser</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>WebAudio_114</test_case_id>
    <test_objective>To ensure that the offlineaudiocontext suspend resume details from the device browser</test_objective>
...
All the variables in WebAudioVariables.py must be filled.</pre_requisite>
    ...
    <input_parameters>offlineaudiocontext-suspend-resume-basic.html, offlineaudiocontext-suspend-resume-eventhandler.html, offlineaudiocontext-suspend-resume-graph-manipulation.html, offlineaudiocontext-suspend-resume-promise.html, offlineaudiocontext-suspend-resume-sequence.html</input_parameters>
...
2. Check for the required logs in wpeframework log or in the webinspect page</automation_approch>
    <expected_output>The browser should correctly apply the offlineaudiocontext suspend resume details</expected_output>
    <priority>High</priority>
    <test_stub_interface>WebAudio</test_stub_interface>
    <test_script>RDKV_WebAudio_OfflineaudiocontextSuspendResume</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_WebAudio_OfflineaudiocontextSuspendResume');
...
webaudio_test_url = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/offlineaudiocontext-suspend-resume-basic.html'
webaudio_test_url2 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/offlineaudiocontext-suspend-resume-eventhandler.html'
webaudio_test_url3 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/offlineaudiocontext-suspend-resume-graph-manipulation.html'
webaudio_test_url4 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/offlineaudiocontext-suspend-resume-promise.html'
webaudio_test_url5 = obj.url+WebAudioVariables.wpe_webkit_testcases_path+'/offlineaudiocontext-suspend-resume-sequence.html'
...
if expectedResult in result.upper():
    ...
    if expectedResult in pre_req_status:
        ...
        if expectedResult in result:
            ...
            files_info = [
                {"tail_num": 3,"url": webaudio_test_url},
                {"tail_num": 3,"url": webaudio_test_url2},
                {"tail_num": 3,"url": webaudio_test_url3},
                {"tail_num": 3,"url": webaudio_test_url4},
                {"tail_num": 3,"url": webaudio_test_url5}
            ]
