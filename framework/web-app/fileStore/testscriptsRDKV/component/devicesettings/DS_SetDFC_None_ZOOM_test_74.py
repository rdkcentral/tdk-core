...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>624</id>
  <version>1</version>
  <name>DS_SetDFC_None_ZOOM_test_74</name>
  <primitive_test_id>79</primitive_test_id>
  <primitive_test_name>DS_SetDFC</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the NONE Zoom Settings of Video Device
Test Case ID : CT_DS_74</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_74</test_case_id>
    <test_objective>Device Setting –  Get and Set the display video device mode for the video device with None zoom.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetDFC_None_ZOOM_test_74</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		print "Details: ",dfcdetails
                ...
                if expectedresult in actualresult:
                        print "SUCCESS :Application successfully gets and sets the zoom settingt as None for the video device";
			tdkTestObj.setResultStatus("SUCCESS");
                else:
