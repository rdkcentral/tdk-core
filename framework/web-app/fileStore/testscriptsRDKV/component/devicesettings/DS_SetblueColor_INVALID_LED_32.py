...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>595</id>
  <version>2</version>
  <name>DS_SetblueColor_INVALID_LED_32</name>
  ...
  <status>FREE</status>
  <synopsis>This test script Sets and gets the Blue Color for an Invalid Front panel Indicator(Negative Scenario).
Test Case ID : CT_DS_32.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_32</test_case_id>
    <test_objective>Device Setting – Get and Set the color for an invalid indicator.</test_objective>
...
Checkpoint 1.Check for the error as the 'INVALID"Indicator provided is not present</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TestMgr_DS_managerInitialize
TestMgr_DS_FP_FP_getSupportedColors
TestMgr_DS_FP_setColor
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetblueColor_INVALID_LED_32</test_script>
    <skipped>No</skipped>
