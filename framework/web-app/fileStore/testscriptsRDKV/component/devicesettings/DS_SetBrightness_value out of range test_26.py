...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>589</id>
  <version>1</version>
  <name>DS_SetBrightness_value out of range test_26</name>
  <primitive_test_id>76</primitive_test_id>
  <primitive_test_name>DS_SetBrightness</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the out of range value for Brightness of the given Front panel Indicator
Test Case ID : CT_DS_26</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_26</test_case_id>
    <test_objective>Device Setting – Get and Set brightness for front panel Indicator with negative value.</test_objective>
...
E.g.: Value is -50.</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetBrightness_value out of range test_26</test_script>
    <skipped>No</skipped>
