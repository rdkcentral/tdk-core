...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>623</id>
  <version>1</version>
  <name>DS_SetStereoMode_INVALID_FORMAT_73</name>
  <primitive_test_id>85</primitive_test_id>
  <primitive_test_name>DS_SetStereoMode</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the INVALID Stereo Mode of Audio.
...
Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_73</test_case_id>
    <test_objective>Device Setting –  Get and set stereo format by passing invalid value.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetStereoMode_INVALID_FORMAT_73</test_script>
    <skipped>No</skipped>
