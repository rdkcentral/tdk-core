...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>629</id>
  <version>2</version>
  <name>DS_Resolution_720p_test_83</name>
  <primitive_test_id>72</primitive_test_id>
  <primitive_test_name>DS_Resolution</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the 720p Resolution of Video Output Port
...
Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_83</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution setting with 720p</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_720p_test_83</test_script>
    <skipped>No</skipped>
