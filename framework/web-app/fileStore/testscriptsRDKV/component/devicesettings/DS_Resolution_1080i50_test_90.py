...
Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_90</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution setting with 1080i50</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_1080i50_test_90</test_script>
    <skipped>No</skipped>
