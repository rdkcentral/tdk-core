...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>631</id>
  <version>1</version>
  <name>DS_Resolution_Invalid_port_test_93</name>
  <primitive_test_id>83</primitive_test_id>
  <primitive_test_name>DS_SetResolution</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the Resolution of an invalid Video Output Port
Test Case ID:CT_DS_93.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_93</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution setting with 1080i for an invalid port name.</test_objective>
...
E.g.: 1080i
GetVideoOutputPort: string -
E.g: HDMI8</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_Invalid_port_test_93</test_script>
    <skipped>No</skipped>
