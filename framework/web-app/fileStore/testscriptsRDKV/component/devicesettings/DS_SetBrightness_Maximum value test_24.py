...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>587</id>
  <version>1</version>
  <name>DS_SetBrightness_Maximum value test_24</name>
  <primitive_test_id>76</primitive_test_id>
  <primitive_test_name>DS_SetBrightness</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the maximum Brightness of the given Front panel Indicator
Test Case ID : CT_DS_24</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_24</test_case_id>
    <test_objective>Device Setting – Get and Set brightness for front panel Indicator with Maximum value.</test_objective>
...
E.g.: Value is  100. </input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetBrightness_Maximum value test_24</test_script>
    <skipped>No</skipped>
