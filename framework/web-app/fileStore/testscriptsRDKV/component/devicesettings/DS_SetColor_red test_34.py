...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>584</id>
  <version>2</version>
  <name>DS_SetColor_red test_34</name>
  ...
  <status>FREE</status>
  <synopsis>This test script Sets and gets the Red Color for the Front panel Indicator
Test Case ID : CT_DS_34</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_34</test_case_id>
    <test_objective>Device Setting – Get and Set the color of the POWER LED to RED color.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetColor_red test_34</test_script>
    <skipped>No</skipped>
