...
TestcaseID: CT_DS118</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS118</test_case_id>
    <test_objective>Check resolution value change after STB reboot</test_objective>
...
4. Device_Settings_Agent will check for the display resolution and will return SUCCESS or FAILURE based on the value set in step 2</automation_approch>
    <except_output>Checkpoint 1 Check for return value of the resolution before and after reboot</except_output>
    <priority>High</priority>
    <test_stub_interface>TestMgr_DS_managerInitialize
TestMgr_DS_VOP_setResolution
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution_Persistent_118</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>DELIA-4993 </remarks>
  </test_cases>
</xml>
