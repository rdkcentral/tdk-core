...
TestcaseID: CT_DS131</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS131</test_case_id>
    <test_objective>Test enable HDCP authentication with invalid key input</test_objective>
...
device::Manager::DeInitialize()</api_or_interface_used>
    <input_parameters>bool protectContent = 1, string key = 'ffff', int keySize = 1, bool useMfrKey = 0</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_EnableHDCP_InvalidKey_131</test_script>
    <skipped>No</skipped>
