...
<xml>
  ...
  <name>DS_setSURROUND_PASSTHRUFormat_8005_5</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Device Setting –  Get and set stereo mode first to SURROUND and then PASSTHRU and to SURROUND in SPDIF and HDMi.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'DS_setSURROUND_PASSTHRUFormat_8005_5');
