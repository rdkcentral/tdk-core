...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>596</id>
  <version>1</version>
  <name>DS_SetBlink_valid_test_38</name>
  <primitive_test_id>75</primitive_test_id>
  <primitive_test_name>DS_SetBlink</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the in range value for blink feature of given Front panel Indicator
Test Case ID : CT_DS_38</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_38</test_case_id>
    <test_objective>Device Setting – Get and Set the blink value of the POWER LED</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetBlink_valid_test_38</test_script>
    <skipped>No</skipped>
