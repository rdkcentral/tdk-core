...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>205</id>
  <version>3</version>
  <name>DS_Resolution test_16</name>
  <primitive_test_id>72</primitive_test_id>
  <primitive_test_name>DS_Resolution</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the Resolution of Video Output Port Test Case ID : CT_DS_16.Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_16</test_case_id>
    <test_objective>Device Setting –  Get and Set the display Resolution settings.</test_objective>
...
E.g.: 480i,720p,1080i</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_Resolution test_16</test_script>
    <skipped>No</skipped>
