...
Test Case ID : CT_DS_15</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DS_15</test_case_id>
    <test_objective>Device Setting –  Get and Set the display video device mode(Zoom) for the video device.</test_objective>
...
device::Manager::DeInitialize()</api_or_interface_used>
    <input_parameters>setDFC : int -Id
setDFC : String -
E.g.: Full , Platform, None</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetDFC test_15</test_script>
    <skipped>No</skipped>
