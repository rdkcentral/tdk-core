...
<xml>
  ...
  <name>HWPerformance_Stress-ng_Network</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Execute Stress-ng opensource performance tool it will test network stress in the system</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_17</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool will test network stress in the system</test_objective>
    ...
    <input_parameters>sh TDK_HWPerfTools_Executor.sh Network</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_Network</test_script>
    <skipped>No</skipped>
...
sysUtilObj.configureTestCase(ip,port,'HWPerformance_Stress-ng_Network');
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
         ...
         command = "sh TDK_HWPerfTools_Executor.sh Network"
