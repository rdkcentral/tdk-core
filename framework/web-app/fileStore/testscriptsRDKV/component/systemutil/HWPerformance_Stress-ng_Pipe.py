...
<xml>
  ...
  <name>HWPerformance_Stress-ng_Pipe</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>stress-ng is a tool is used to test HWPerformance stress-ng pipe</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_10</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool will test pipe stress in the system</test_objective>
    ...
    <input_parameters>--pipe 0 -t 30 --metrics-brief --log-file /tmp/stressng-report.txt</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_Pipe</test_script>
    <skipped>No</skipped>
...
sysUtilObj.configureTestCase(ip,port,'HWPerformance_Stress-ng_Pipe');
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    App_with_args="stress-ng --pipe 0 -t 30 --metrics-brief --log-file /tmp/stressng-report.txt;"
    Parse_log="sh ${TDK_PATH}/HWPerf_metric_parser.sh stress-ng_Pipe;"
