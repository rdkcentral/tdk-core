...
<xml>
  ...
  <name>HWPerformance_Stress-ng_ThermalZoneTest</name>
  ...
  <test_cases>
  <test_case_id>TC_HWPerformance_22</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool will test thermalzone stress in the system</test_objective>
    ...
    <input_parameters>sh TDK_HWPerfTools_Executor.sh ThermalZoneTest</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_ThermalZoneTest</test_script>
    <skipped>No</skipped>
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
    ...
    if expectedresult in actualresult:
        if details:
            ...
            result=hardwarePerformanceThresholdComparison(sysUtilObj,details,unit=" C",reverserscheck="false")
