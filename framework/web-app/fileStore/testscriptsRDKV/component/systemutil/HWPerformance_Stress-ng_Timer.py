...
<xml>
  ...
  <name>HWPerformance_Stress-ng_Timer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>EExecute Stress-ng opensource performance tool it will test Timer stress in the system</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HWPerformance_18</test_case_id>
    <test_objective>Execute Stress-ng opensource performance tool will test timer stress in the system</test_objective>
   ...
   <input_parameters>sh TDK_HWPerfTools_Executor.sh Timer</input_parameters>
    ...
    <test_script>HWPerformance_Stress-ng_Timer</test_script>
    <skipped>No</skipped>
