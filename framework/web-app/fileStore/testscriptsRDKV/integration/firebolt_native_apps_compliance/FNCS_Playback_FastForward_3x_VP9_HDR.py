...
<xml>
  ...
  <name>FNCS_Playback_FastForward_3x_VP9_HDR</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do fast forward of a VP9_HDR stream with playback rate 3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_377</test_case_id>
    <test_objective>Test to do fast forward of a VP9_HDR stream with playback rate 3</test_objective>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_FastForward_3x_VP9_HDR</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_FastForward_3x_VP9_HDR');
