...
<xml>
  ...
  <name>FNCS_Playback_Audio_Change_with_Pause_AAC_EAC3</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_129</test_case_id>
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FNCS_Playback_Audio_Change_with_Pause_AAC_EAC3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Audio_Change_with_Pause_AAC_EAC3');
...
if "SUCCESS" in result.upper():
    ...
    #Sample command = "mediapipelinetests test_audio_change_with_pause <AAC_STREAM_URL> checkavstatus=yes timeout=20"
