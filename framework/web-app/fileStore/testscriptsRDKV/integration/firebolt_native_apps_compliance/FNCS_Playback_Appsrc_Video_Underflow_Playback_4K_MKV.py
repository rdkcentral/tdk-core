...
<xml>
  ...
  <name>FNCS_Playback_Appsrc_Video_Underflow_Playback_4K_MKV</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_301</test_case_id>
...
2. Test stream url for an Appsrc_Video_Underflow_Playback_MKV stream should be updated in the config variable video_src_url_4k_av1_mkv inside MediaValidationVariables.py library inside filestore
...
test_url - Appsrc_Video_Underflow_Playback_4k_MKV url from MediaValidationVariables library (MediaValidationVariables.video_src_url_4k_av1_mkv)
...
Checkpoint 2. Verify that the output returned from tdk_mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Appsrc_Video_Underflow_Playback_4K_MKV</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Appsrc_Video_Underflow_Playback_4K_MKV');
...
if "SUCCESS" in result.upper():
    ...
    #Sample command = "tdk_mediapipelinetests test_appsrc_video_underflow <Appsrc_Video_Underflow_Playback_MKV_STREAM_URL> checkavstatus=yes timeout=20"
