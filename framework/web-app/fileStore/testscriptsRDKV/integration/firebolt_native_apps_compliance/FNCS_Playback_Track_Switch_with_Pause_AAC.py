...
<xml>
  ...
  <name>FNCS_Playback_Track_Switch_with_Pause_AAC</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_131</test_case_id>
...
2. Test stream url for a multi track AAC stream should be updated in the config variable video_src_url_multi_audio_aac inside MediaValidationVariables.py library inside filestore.
...
test_url - multi track url with AAC audio streams from MediaValidationVariables library (MediaValidationVariables.video_src_url_multi_audio_aac)
...
3.Retrieve the video_src_url_multi_audio_aac variable from MediaValidationVariables library
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FNCS_Playback_Track_Switch_with_Pause_AAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Track_Switch_with_Pause_AAC');
...
if "SUCCESS" in result.upper():
    ...
    test_url = MediaValidationVariables.video_src_url_multi_audio_aac
    ...
    if expectedResult in actualresult.upper() and output:
        ...
        if expectedResult in executionStatus:
            ...
            print("AAC track switch was successfull")
