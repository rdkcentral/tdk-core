...
<xml>
  ...
  <name>FNCS_Playback_Appsrc_Audio_Underflow_Signal_AAC</name>
...
2. Test stream url for an Appsrc_Audio_Underflow_Signal_AV1 stream should be updated in the config variable audio_src_url_mp4_aac inside MediaValidationVariables.py library inside filestore
...
test_url - Appsrc_Audio_Underflow_Signal_AV1 url from MediaValidationVariables library (MediaValidationVariables.audio_src_url_mp4_aac)
...
Checkpoint 2. Verify that the output returned from tdk_mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Appsrc_Audio_Underflow_Signal_AAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Appsrc_Audio_Underflow_Signal_AAC');
