...
<xml>
  ...
  <name>FNCS_Essos_Direct_EGL_Validation</name>
  ...
  <rdk_versions />
  <test_cases>
    <test_case_id>FNCS_GRAPHICS_02</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Essos_Direct_EGL_Validation');
...
if "SUCCESS" in result.upper():
    ...
    command = "cd /opt/TDK ; sh RunGraphicsTDKTest.sh Essos 30"
