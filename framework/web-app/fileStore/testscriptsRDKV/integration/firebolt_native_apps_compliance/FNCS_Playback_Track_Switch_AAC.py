...
<xml>
  ...
  <name>FNCS_Playback_Track_Switch_AAC</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_128</test_case_id>
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FNCS_Playback_Track_Switch_AAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Track_Switch_AAC');
