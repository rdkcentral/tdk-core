...
<xml>
  ...
  <name>FNCS_Playback_4K_Resolution_AV1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test the video playback with resolution set to 2160p through 'playbin' and 'westerossink' gst elements</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_110</test_case_id>
...
2. Test stream url for an 2160p stream should be updated in the config variable video_src_url_mp4_2160p_av1 inside MediaValidationVariables.py library inside filestore
...
test_url - 2160p av1 mp4 url from MediaValidationVariables library (MediaValidationVariables.video_src_url_mp4_2160p_av1)
...
5.Retrieve the video_src_url_mp4_2160p_av1 variable from MediaValidationVariables library
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_4K_Resolution_AV1</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_4K_Resolution_AV1');
...
if "SUCCESS" in result.upper():
    ...
    test_url = MediaValidationVariables.video_src_url_mp4_2160p_av1
