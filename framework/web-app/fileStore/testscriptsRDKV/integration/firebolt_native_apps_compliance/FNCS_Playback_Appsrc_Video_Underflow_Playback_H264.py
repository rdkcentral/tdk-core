...
<xml>
  ...
  <name>FNCS_Playback_Appsrc_Video_Underflow_Playback_H264</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_244</test_case_id>
...
2. Test stream url for an Appsrc_Video_Underflow_Playback_H264 stream should be updated in the config variable video_src_url_mp4_30fps inside MediaValidationVariables.py library inside filestore
...
test_url - Appsrc_Video_Underflow_Playback_H264 url from MediaValidationVariables library (MediaValidationVariables.video_src_url_h264_30fps)
...
3.Retrieve the video_src_url_mp4_30fps variable from MediaValidationVariables library
...
Checkpoint 2. Verify that the output returned from tdk_mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FNCS_Playback_Appsrc_Video_Underflow_Playback_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Appsrc_Video_Underflow_Playback_H264');
...
if "SUCCESS" in result.upper():
    ...
    #Sample command = "mediapipelinetests test_generic_playback <Appsrc_Video_Underflow_Playback_H264_STREAM_URL> checkavstatus=yes timeout=20"
