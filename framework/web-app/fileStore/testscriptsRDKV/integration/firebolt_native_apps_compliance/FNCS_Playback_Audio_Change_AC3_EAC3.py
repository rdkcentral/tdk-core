...
<xml>
  ...
  <name>FNCS_Playback_Audio_Change_AC3_EAC3</name>
  ...
  <test_cases>
    <test_case_id>FNCS_PLAYBACK_120</test_case_id>
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FNCS_Playback_Audio_Change_AC3_EAC3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FNCS_Playback_Audio_Change_AC3_EAC3');
