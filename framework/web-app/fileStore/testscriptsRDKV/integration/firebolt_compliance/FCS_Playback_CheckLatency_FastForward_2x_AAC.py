...
<xml>
  ...
  <name>FCS_Playback_CheckLatency_FastForward_2x_AAC</name>
  ...
  <test_cases>
    <test_case_id>FCS_Playback_103</test_case_id>
...
Checkpoint 2. Verify that the latency during playback is within the latency threshold</expected_output>
    ...
    <test_script>FCS_Playback_CheckLatency_FastForward_2x_AAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_CheckLatency_FastForward_2x_AAC')
