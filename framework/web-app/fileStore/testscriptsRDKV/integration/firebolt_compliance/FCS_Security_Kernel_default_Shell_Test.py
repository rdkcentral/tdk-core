...
<xml>
  ...
  <name>FCS_Security_Kernel_default_Shell_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify default shell MUST be set to /dev/null</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FCS_Security_16</test_case_id>
    <test_objective>Verify default shell MUST be set to /dev/null</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Video Accelerator,RPI,RDK TV</test_setup>
    <pre_requisite></pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>Verify the out for following command echo "$SHELL"</automation_approch>
    <expected_output>default shell MUST be set to /dev/null </expected_output>
    <priority>Low</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>FCS_Security_Kernel_default_Shell_Test</test_script>
    <skipped>No</skipped>
