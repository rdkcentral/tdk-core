...
<xml>
  ...
  <name>FCS_Security_Kernel_debugfs_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if Kernel debugfs is disabled </synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <rdk_versions />
  <test_cases>
    <test_case_id>FCS_Security_04</test_case_id>
    <test_objective>Test if Kernel debugfs is disabled</test_objective>
...
2.Check if kernel debugfs is disabled by investigating "/sys/kernel/debug" directory.</automation_approch>
    <expected_output>No directories must be present in "/sys/kernel/debug"</expected_output>
    <priority>Medium</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>FCS_Security_Kernel_debugfs_Test</test_script>
    <skipped></skipped>
