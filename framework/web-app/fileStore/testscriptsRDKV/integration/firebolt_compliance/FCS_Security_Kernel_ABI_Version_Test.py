...
<xml>
  ...
  <name>FCS_Security_Kernel_ABI_Version_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if Kernel ABI(Application Binary Interface) version check is enabled.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <rdk_versions />
  <test_cases>
    <test_case_id>FCS_Security_02</test_case_id>
    <test_objective>Check if Kernel ABI(Application Binary Interface) version check is enabled.</test_objective>
...
2.Check if ABI version of Kernel is obtained from DUT using "uname" command.</automation_approch>
    <expected_output>ABI version must be obatined from DUT</expected_output>
    <priority>High</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>FCS_Security_Kernel_ABI_Version_Test</test_script>
    <skipped></skipped>
