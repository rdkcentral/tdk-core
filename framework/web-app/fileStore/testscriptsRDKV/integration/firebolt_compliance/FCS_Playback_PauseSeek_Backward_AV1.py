...
<xml>
  ...
  <name>FCS_Playback_PauseSeek_Backward_AV1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do backward seek on a AV1 stream with pause operation</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>FCS_PLAYBACK_176</test_case_id>
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0" or it contains the string "failed: 0"</expected_output>
    ...
    <test_script>FCS_Playback_PauseSeek_Backward_AV1</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_PauseSeek_Backward_AV1');
