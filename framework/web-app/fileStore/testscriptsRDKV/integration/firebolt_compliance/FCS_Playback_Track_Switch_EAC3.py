...
<xml>
  ...
  <name>FCS_Playback_Track_Switch_EAC3</name>
  ...
  <test_cases>
    <test_case_id>FCS_PLAYBACK_141</test_case_id>
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FCS_Playback_Track_Switch_EAC3</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_Track_Switch_EAC3');
