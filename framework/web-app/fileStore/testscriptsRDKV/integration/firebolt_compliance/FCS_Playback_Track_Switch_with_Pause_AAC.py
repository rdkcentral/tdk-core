...
<xml>
  ...
  <name>FCS_Playback_Track_Switch_with_Pause_AAC</name>
  ...
  <test_cases>
    <test_case_id>FCS_PLAYBACK_138</test_case_id>
...
2.Check if Audio switch is happened properly.</expected_output>
    ...
    <test_script>FCS_Playback_Track_Switch_with_Pause_AAC</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_Track_Switch_with_Pause_AAC');
...
if "SUCCESS" in sysutilloadModuleStatus.upper():
    ...
    if expectedResult in actualresult.upper() and output:
        ...
        if expectedResult in executionStatus:
            ...
            print("AAC track switch with pause was successfull")
            ...
            print("AAC track switch with pause failed")
    else:
        tdkTestObj.setResultStatus("FAILURE")
