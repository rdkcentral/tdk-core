...
<xml>
  ...
  <name>FCS_Playback_Audio_Underflow_Signal_Test</name>
...
7.Based on the ExecuteCommand() return value and the output returned from the mediapipelinetests application, TM return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>FCS_Playback_Audio_Underflow_Signal_Test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_Audio_Underflow_Signal_Test')
