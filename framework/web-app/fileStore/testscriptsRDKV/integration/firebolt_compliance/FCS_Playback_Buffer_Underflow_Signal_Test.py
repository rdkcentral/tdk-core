...
<xml>
  ...
  <name>FCS_Playback_Buffer_Underflow_Signal_Test</name>
  ...
  <test_cases>
    <test_case_id>FCS_PLAYBACK_132</test_case_id>
...
7.Based on the ExecuteCommand() return value and the output returned from the mediapipelinetests application, TM return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>FCS_Playback_Buffer_Underflow_Signal_Test</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_Buffer_Underflow_Signal_Test')
