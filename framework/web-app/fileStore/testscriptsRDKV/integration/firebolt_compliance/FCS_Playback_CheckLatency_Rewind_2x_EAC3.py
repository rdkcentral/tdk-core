...
<xml>
  ...
  <name>FCS_Playback_CheckLatency_Rewind_2x_EAC3</name>
  ...
  <test_cases>
    <test_case_id>FCS_Playback_108</test_case_id>
...
test_url - eac3 stream url from MediaValidationVariables library (MediaValidationVariables.video_src_url_ec3)
...
Checkpoint 2. Verify that the latency during playback is within the latency threshold</expected_output>
    ...
    <test_script>FCS_Playback_CheckLatency_Rewind_2x_EAC3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_CheckLatency_Rewind_2x_EAC3')
