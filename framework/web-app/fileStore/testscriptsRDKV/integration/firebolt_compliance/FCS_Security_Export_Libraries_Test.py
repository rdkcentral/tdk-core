...
<xml>
  ...
  <name>FCS_Security_Export_Libraries_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if LD_LIBRARY_PATH is used to hardcode LIBRARY_PATH</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <rdk_versions />
  <test_cases>
    <test_case_id>FCS_Security_03</test_case_id>
    <test_objective>Test if LD_LIBRARY_PATH is used to hardcode LIBRARY_PATH</test_objective>
...
2.Check if LD_LIBRARY_PATH is used to hardcode LIBRARY_PATH in export command.</automation_approch>
    <expected_output>LD_LIBRARY_PATH shouldn't be used to specify LIBRARY_PATH</expected_output>
    <priority>High</priority>
    <test_stub_interface>libsystemutilstub.so.0</test_stub_interface>
    <test_script>FCS_Security_Export_Libraries_Test</test_script>
    <skipped></skipped>
