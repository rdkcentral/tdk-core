...
<xml>
  ...
  <name>FCS_iCrypto_InterfaceTests</name>
...
Checkpoint 2. Verify that the output returned from cgfacetests contains the strings "TOTAL:" and "0 FAILED"</expected_output>
    ...
    <test_script>FCS_iCrypto_InterfaceTests</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'FCS_iCrypto_InterfaceTests');
...
if "SUCCESS" in sysutilLoadStatus.upper():
    ...
    if log_transfer:
        ...
        FCS_iCrypto_utility.RunSuiteWithoutLogTransfer(obj,Test)
