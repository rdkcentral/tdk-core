...
<xml>
  ...
  <name>FCS_Playback_CheckLatency_Rewind_2x_AC3</name>
  ...
  <test_cases>
    <test_case_id>FCS_Playback_107</test_case_id>
...
Checkpoint 2. Verify that the latency during playback is within the latency threshold</expected_output>
    ...
    <test_script>FCS_Playback_CheckLatency_Rewind_2x_AC3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_CheckLatency_Rewind_2x_AC3')
...
if "SUCCESS" in sysutilloadModuleStatus.upper():
    ...
    #Sample command = "mediapipelinetests test_trickplay <AC3_STREAM_URL> checkavstatus=yes operations=rewind2x:20"
