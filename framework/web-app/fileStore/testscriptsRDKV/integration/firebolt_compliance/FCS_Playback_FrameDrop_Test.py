...
<xml>
  ...
  <name>FCS_Playback_FrameDrop_Test</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to do Videoplayback of a FrameDrop_Test stream through videotestsrc gst element and fpsdisplaysink</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
Checkpoint 2. Verify that the output returned from mediapipelinetests contains the strings "Failures: 0" and "Errors: 0", or "failed: 0"</expected_output>
    ...
    <test_script>FCS_Playback_FrameDrop_Test</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysUtilObj.configureTestCase(ip,port,'FCS_Playback_FrameDrop_Test')
