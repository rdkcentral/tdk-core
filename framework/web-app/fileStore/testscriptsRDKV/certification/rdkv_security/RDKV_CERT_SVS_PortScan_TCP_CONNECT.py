...
<xml>
  ...
  <name>RDKV_CERT_SVS_PortScan_TCP_CONNECT</name>
...
4. Pass/fail the test based on the absence/presence of additional open ports</automation_approch>
    ...
    <test_script>RdkvSecurity_PortScan_TCP_CONNECT</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_SVS_PortScan_TCP_CONNECT');
