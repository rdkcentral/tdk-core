...
<xml>
  ...
  <name>RDKV_CERT_RVS_Cobalt_Hibernate_Toggle_PowerStates</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to perform continuous toggling of power states as ON and Standby for given number of times when cobalt is present in Hibernate state and check whether cobalt state persisted over toggling of power states</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_68</test_case_id>
    <test_objective>The objective of this test is to perform continuous toggling of power states as ON and Standby for given number of times when cobalt is present in Hibernate state and check whether cobalt state persisted over toggling of power states</test_objective>
...
8. Check if the CPU and Memory usage is within 90%.
Outside loop
9. Revert everything back</automation_approch>
    <expected_output>The cobalt should persist in hibernate state and  device must be stable after power toggling stress test</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_stability</test_stub_interface>
    <test_script>RDKV_CERT_RVS_Cobalt_Hibernate_Toggle_PowerStates</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_Cobalt_Hibernate_Toggle_PowerStates');
