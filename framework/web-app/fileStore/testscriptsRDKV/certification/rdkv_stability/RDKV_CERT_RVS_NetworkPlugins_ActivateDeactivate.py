...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>RDKV_CERT_RVS_NetworkPlugins_ActivateDeactivate</name>
  <primitive_test_id/>
  ...
  <test_cases>
    ...
    <test_objective>The objective of this script is to activate and deactivate network related plugins for given number of times and validate CPU load and memory usage.</test_objective>
...
2. Change the status of plugins in a loop, validate controller plugin status and validate the cpu and memory load in the loop.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_NetworkPlugins_ActivateDeactivate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_NetworkPlugins_ActivateDeactivate');
...
if expectedResult in (result.upper() and pre_condition_status):
    ...
    plugins = "org.rdk.Network,org.rdk.Wifi,org.rdk.Bluetooth"
    status = "SUCCESS"
