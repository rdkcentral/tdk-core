...
<xml>
  ...
  <name>RDKV_CERT_RVS_LightningApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The Objective of the test is to calculate memory usage of the LightningApp by keeping the 
 web inspect port open for playback of mp4 video for long duration</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>The Objective of the test is to calculate memory usage of the LightningApp by keeping the 
 web inspect port open for playback of mp4 video for long duration</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI,Accelerator</test_setup>
    <pre_requisite>1. As a prerequisite disable all other plugins and enable Lightning app</pre_requisite>
...
4.Calcute the Memory usage  </automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_LightningApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_LightningApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect');
deviceIP =str(ip)
...
if expectedResult in result.upper():
    ...
    if status == "SUCCESS":
        ...
        if current_url != None and expectedResult in result:
            ...
            print("\n Set Lightning Application URL 1\n")
