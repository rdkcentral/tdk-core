...
<xml>
  ...
  <name>RDKV_CERT_RVS_HtmlApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The Objective of the test is to calculate memory usage of the HtmlApp by keeping the 
 web inspect port open for playback of mp4 video for long duration</synopsis>
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_76</test_case_id>
    <test_objective>The Objective of the test is to calculate memory usage of the HtmlApp by keeping the 
 web inspect port open for playback of mp4 video for long duration</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI,Accelerator</test_setup>
    <pre_requisite>1. As a prerequisite disable all other plugins and enable Html app</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>1. The URL of the application to be launched.
2, Memory Usage Threshold limit.</input_parameters>
    <automation_approch>1.Open HtmlApp web inspect port
2. Set the application URL in HtmlApp
...
4.Calcute the Memory usage  </automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_HtmlApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_HtmlApp_LongDuration_Video_Playback_MemoryUsage_WithWebinspect');
deviceIP =str(ip)
