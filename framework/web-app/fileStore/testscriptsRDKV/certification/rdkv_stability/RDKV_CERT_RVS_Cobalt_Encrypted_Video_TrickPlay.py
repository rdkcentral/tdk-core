...
<xml>
  ...
  <name>RDKV_CERT_RVS_Cobalt_Encrypted_Video_TrickPlay</name>
...
7. Revert plugin.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_Cobalt_Encrypted_Video_TrickPlay</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_Cobalt_Encrypted_Video_TrickPlay');
...
if expectedResult in (result.upper() and pre_condition_status):
    cobalt_test_url = StabilityTestVariables.encrypt_test_url;
    test_time_in_mins = StabilityTestVariables.encrypt_trickplay_duration
