...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>RDKV_CERT_RVS_WebKitBrowser_SuspendResume</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_validateCPULoad</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to suspend and resume the WebKit browser for a given number of times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_05</test_case_id>
    <test_objective>The objective of this test is to suspend and resume the WebKit browser for a given number of times.</test_objective>
...
2. Suspend webkit using RDKShell plugin .
3. Resume webkit using RDKShell plugin.
...
6. Revert all values.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_WebKitBrowser_SuspendResume</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_RVS_WebKitBrowser_SuspendResume');
