...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>RDKV_CERT_RVS_Cobalt_LifeCycleManagement</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_executeLifeCycle</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to launch Cobalt then play a video URL, suspend, resume, move behind and front then destroy. The script will repeat this for a minimum of 1000 times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_STABILITY_40</test_case_id>
    <test_objective>The objective of this test is to launch Cobalt then play a video URL, suspend, resume, move behind and front then destroy. The script will repeat this for a minimum of 1000 times.</test_objective>
...
2. Set given  videeo URL using deeplink method of Cobalt
...
9. Validate the CPU load and memory usage using DeviceInfo.1.systeminfo method</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_Cobalt_LifeCycleManagement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_Cobalt_LifeCycleManagement');
