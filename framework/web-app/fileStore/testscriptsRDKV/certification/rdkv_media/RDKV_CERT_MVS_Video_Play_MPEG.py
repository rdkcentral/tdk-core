...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Play_MPEG</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit instance and perform video play operation of mpeg stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_95</test_case_id>
    <test_objective>Test Script to launch a lightning Video player application via Webkit instance and perform video play operation of mpeg  stream for few minutes and close the player        </test_objective>
...
video_src_url_mpeg: string
mpeg_url_type:string
...
4. App starts playing the mpeg stream video and closes the player after the provided duration.
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Play_MPEG</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_MPEG')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_mpeg
        ...
        setURLArgument("type",MediaValidationVariables.mpeg_url_type)
        ...
        video_test_urls = []
        test_counter = 0
        players_list = str(MediaValidationVariables.codec_mpeg).split(",")
        ...
        #url=<video_mepeg_url>.mpd&operations=close(60)&autotest=true&type=dash
