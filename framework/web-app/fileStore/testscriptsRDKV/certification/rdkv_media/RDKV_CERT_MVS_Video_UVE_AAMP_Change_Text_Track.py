...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Change_Text_Track</name>
...
video_src_url_multi_text_tracks: string</input_parameters>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Change_Text_Track</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Change_Text_Track')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_multi_text_tracks
