...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Play_Widevine_MultiKey_DASH</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit instance and perform video play operation of  widevine DRM protected multikey dash encryption stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_266</test_case_id>
    <test_objective>Test Script to launch a lightning Video player application via Webkit instance and perform video play operation of  widevine DRM protected multikey dash encryption stream for few minutes and close the player</test_objective>
...
video_src_url_widevine_multikey_dash: string
video_src_url_widevine_multikey_dash_drmconfigs:string
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Play_Widevine_MultiKey_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_Widevine_MultiKey_DASH')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_widevine_multikey_dash
        ...
        setURLArgument("drmconfigs",MediaValidationVariables.video_src_url_widevine_multikey_dash_drmconfigs)
        ...
        #url=<video_src_url_playready_multikey_dash>.mpd&drmconfigs=com.widevine(license_url)&operations=close(60)&autotest=true&type=dash
