...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_SHAKA_Play_PlayReady_HLS_H264</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Shaka player application via Webkit instance and perform video play operation of PlayReady DRM protected H.264 codec hls stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_729</test_case_id>
    <test_objective>Test Script to launch a lightning Shaka player application via Webkit instance and perform video play operation of PlayReady DRM protected H.264 codec hls stream for few minutes and close the player</test_objective>
...
4.  App starts playing the PlayReady DRM protected h.264 hls stream video and closes the player after the provided duration.
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_SHAKA_Play_PlayReady_HLS_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_SHAKA_Play_PlayReady_HLS_H264')
...
MediaValidationVariables.video_src_url_playready_hls_h264_drmconfigs)
        ...
        #url=<playready_hls_h264_url>.m3u8&drmconfigs=com.playready(license_url)&operations=close(60)&autotest=true
