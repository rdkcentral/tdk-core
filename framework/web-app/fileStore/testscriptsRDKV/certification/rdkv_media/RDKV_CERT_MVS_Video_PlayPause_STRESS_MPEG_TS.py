...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_PlayPause_STRESS_MPEG_TS</name>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_PlayPause_STRESS_MPEG_TS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_PlayPause_STRESS_MPEG_TS')
