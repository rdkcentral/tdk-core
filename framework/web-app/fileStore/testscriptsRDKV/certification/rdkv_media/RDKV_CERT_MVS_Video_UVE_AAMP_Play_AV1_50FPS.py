...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_AAMP_Play_AV1_50FPS</name>
  ...
  <test_cases>
    <test_case_id>RDKV_Media_Validation_335</test_case_id>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_AAMP_Play_AV1_50FPS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_AAMP_Play_AV1_50FPS')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS" and config_status == "SUCCESS":
        ...
        #url=<video_av1_50fps_url>.mpd&operations=close(60)&autotest=true
