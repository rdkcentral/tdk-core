...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_PlayPause_STRESS_HDR</name>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_PlayPause_STRESS_HDR</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_PlayPause_STRESS_HDR')
...
if expectedResult in result.upper():
	...
	# Getting the complete test app URL for selected players
        ...
        #url=<video_mp4_url>&operations=pause(5),play(5),repeat(15)&autotest=true&type=mp4
