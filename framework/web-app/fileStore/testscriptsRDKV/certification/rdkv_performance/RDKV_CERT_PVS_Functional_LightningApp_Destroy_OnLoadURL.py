...
<xml>
  ...
  <name>RDKV_CERT_PVS_Functional_LightningApp_Destroy_OnLoadURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to load URL in LightningApp, destroy the plugin, check whether LightningApp is stable and able to load URL again in it after launching the plugin again.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_89</test_case_id>
    <test_objective>The objective of this test is to load URL in LightningApp, destroy the plugin, check whether LightningApp is stable and able to load URL again in it after launching the plugin again.</test_objective>
...
10. Destroy the plugin</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Functional_LightningApp_Destroy_OnLoadURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_LightningApp_Destroy_OnLoadURL')
