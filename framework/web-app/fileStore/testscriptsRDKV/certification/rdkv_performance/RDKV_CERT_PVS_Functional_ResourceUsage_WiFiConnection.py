...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>RDKV_CERT_PVS_Functional_ResourceUsage_WiFiConnection</name>
  <primitive_test_id/>
...
The CPU load and memory usage must be within the expected range</expected_output>
    ...
    <test_script>RDKV_CERT_PVS_Functional_ResourceUsage_WiFiConnection</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_ResourceUsage_WiFiConnection');
