...
<xml>
  ...
  <name>RDKV_CERT_PVS_Browser_Strike_1080_resolution</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate the browser score using strike tool for 1080p resolution</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
 ...
 <advanced_script>false</advanced_script>
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_100</test_case_id>
    <test_objective>The objective of this test is to validate the browser score using strike tool for 1080p resolution</test_objective>
...
2. Create websocket connection to the webinspect page of WebKit
...
5. Validate the score using threshold value</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Browser_Strike_1080_resolution</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Browser_Strike_1080_resolution')
