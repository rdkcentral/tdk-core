...
<xml>
  ...
  <name>RDKV_CERT_PVS_Functional_ResourceUsage_HtmlApp_Launch_StandbyToOn</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to calculate the resource usage during HtmlApp launch in standby mode to ON</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to calculate the resource usage during Htmlapp launch in standby mode to ON.</test_objective>
...
Resource usage should be within the expected range.</expected_output>
    ...
    <test_script>RDKV_CERT_PVS_Functional_ResourceUsage_HtmlApp_Launch_StandbyToOn</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_ResourceUsage_HtmlApp_Launch_StandbyToOn');
