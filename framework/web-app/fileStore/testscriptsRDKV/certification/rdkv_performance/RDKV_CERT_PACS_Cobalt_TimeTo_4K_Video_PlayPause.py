...
<xml>
  ...
  <name>RDKV_CERT_PACS_Cobalt_TimeTo_4K_Video_PlayPause</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate the time taken to play and pause a 4K video on YouTube.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to validate the time taken to play and pause a 4K video on YouTube.</test_objective>
...
4. Get wpeframework logs related with video playback and parse the time stamp
...
10. Deactivate the Cobalt plugin.
    ...
    <test_script>RDKV_CERT_PACS_Cobalt_TimeTo_4K_Video_PlayPause</test_script>
    <skipped>No</skipped>
...
if expectedResult in result.upper():
    ...
    if cobalt_test_url == "":
        print ("\n Please configure the 4Kvideo_test_url value\n")
