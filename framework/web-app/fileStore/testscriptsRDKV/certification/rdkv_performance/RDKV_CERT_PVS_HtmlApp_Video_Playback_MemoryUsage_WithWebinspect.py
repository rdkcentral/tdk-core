...
<xml>
  ...
  <name>RDKV_CERT_PVS_HtmlApp_Video_Playback_MemoryUsage_WithWebinspect</name>
 ...
 web inspect port open for play and pause operations of mp4 video</synopsis>
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_160</test_case_id>
    <test_objective>The Objective of the test is to calculate memory usage of the HtmlApp by keeping the 
 web inspect port open for play and pause operations of mp4 video</test_objective>
    <test_type>Positive</test_type>
    <test_setup>RPI,Accelerator</test_setup>
    <pre_requisite>1. As a prerequisite disable all other plugins and enable html app.
</pre_requisite>
...
4.Calcute the Memory usage </automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_HtmlApp_Video_Playback_MemoryUsage_WithWebinspect</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_HtmlApp_Video_Playback_MemoryUsage_WithWebinspect');
deviceIP =str(ip)
