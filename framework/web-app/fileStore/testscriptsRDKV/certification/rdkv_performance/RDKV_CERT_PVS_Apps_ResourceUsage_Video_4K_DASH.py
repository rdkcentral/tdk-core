...
<xml>
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to get the CPU and Memory usage while playing an 4k dash video</test_objective>
...
3. Get the cpu load and memory usage after playing the 4k dash video
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Apps_ResourceUsage_Video_4K_DASH');
