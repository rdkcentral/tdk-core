...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_PACS_WiFi_Cobalt_Video_PlayPause</name>
  <primitive_test_id/>
...
Video must pause after pressing space key and it should continue to play after space key is pressed again.
    ...
    <test_script>RDKV_CERT_PACS_WiFi_Cobalt_Video_PlayPause</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PACS_WiFi_Cobalt_Video_PlayPause');
