...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RDKV_CERT_PVS_Functional_HtmlApp_ResourceUsage_onLoadURL</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_setValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to validate the resource usage after setting a Html page URL in HtmlApp plugin.</synopsis>
  <groups_id/>
...
6. Revert the status of HtmlApp.</automation_approch>
    ...
    <test_script>RDKV_CERT_PVS_Functional_HtmlApp_ResourceUsage_onLoadURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PVS_Functional_HtmlApp_ResourceUsage_onLoadURL')
