...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>RDKV_CERT_PACS_Cobalt_PlayNext</name>
  <primitive_test_id/>
...
4. Revert all values.</automation_approch>
    ...
    <test_script>RDKV_CERT_PACS_Cobalt_PlayNext</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PACS_Cobalt_PlayNext');
