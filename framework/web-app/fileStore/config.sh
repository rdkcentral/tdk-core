...
log_dir="$backup_dir/deployment_logs"

# Create the log directory if it doesn't exist
mkdir -p "$log_dir"

# Log file path
log_file="/mnt/TM_BACKUP/deployment_logs/deployment_log_$(date +%Y%m%d_%H%M%S).log"
echo "Starting script execution at $(date)" | tee -a "$log_file"

# Variables
source_file_video="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvRDKServiceConfig/Video_Accelerator.config"
backup_dir_video="$backup_dir/tdkvRDKServiceConfig"
destination_dir_video="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvRDKServiceConfig/"
source_file_device="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvDeviceConfig/sampleThunderDisabled.config"
backup_dir_device="$backup_dir/tdkvDeviceConfig"
destination_dir_device="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvDeviceConfig/"
source_file_device_capabilities="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvDeviceCapabilities/Video_Accelerator_deviceCapability.ini"
backup_dir_device_capabilities="$backup_dir/tdkvDeviceCapabilities"
destination_dir_device_capabilities="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/tdkvDeviceCapabilities/"
# Variables
backup_file_browser_validation="$backup_dir/BrowserPerformanceVariables.py"
source_file_browser_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/BrowserPerformanceVariables.py"
destination_dir_browser_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/"

backup_file_media_validation="$backup_dir/MediaValidationVariables.py"
source_file_media_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/MediaValidationVariables.py"
destination_dir_media_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/"

backup_file_performance_validation="$backup_dir/PerformanceTestVariables.py"
source_file_performance_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/PerformanceTestVariables.py"
destination_dir_performance_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/"

backup_file_stability_validation="$backup_dir/StabilityTestVariables.py"
source_file_stability_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/StabilityTestVariables.py"
destination_dir_stability_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/"

backup_file_ipchange_validation="$backup_dir/IPChangeDetectionVariables.py"
source_file_ipchange_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/IPChangeDetectionVariables.py"
destination_dir_ipchange_validation="/opt/apache-tomcat-7.0.96/webapps/rdk-test-tool/fileStore/"
