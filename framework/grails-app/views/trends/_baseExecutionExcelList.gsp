	...
	<g:else>
		<g:if test="${executionInstanceList}">
			<table style="table-layout: fixed;">
				<tbody>
					<tr>
						<td style="width:150px;">Selected Base Execution : 
						</td>
						<td style="width: 25%; overflow: hidden; word-wrap: break-word;" id="selectedExecution"></td>
						<td><input type="button" class=" buttons" value="Confirm" onclick="baseExecutionSelection('${executionIdList}');"/> <br></td>
					</tr>
				</tbody>
			</table>
